...
```
Invoke-NSUpdateResponderParam [[-Timeout] <Int32>] [[-UndefAction] <String>] [[-Session] <PSObject>]
...
Available settings function as follows: * NOOP - Send the request to the protected server.
