...
```
Invoke-NSAddResponderAction [-BypassSafetycheck <String>] [-Comment <String>] [-HeaderS <String[]>]
 [-HTMLPage <String>] [-Name] <String> [-Reasonphrase <String>] [-ResponseStatuscode <Int32>]
 [-Target <String>] -Type <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
Available settings function as follows: * respondwith \<target\> - Respond to the request with the expression specified as the target.
