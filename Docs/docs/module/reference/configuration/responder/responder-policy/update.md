...
```
Invoke-NSUpdateResponderPolicy [-Action <String>] [-AppFlowAction <String>] [-Comment <String>]
 [-LogAction <String>] [-Name] <String> [-Rule <String>] [-UndefAction <String>] [-Session <PSObject>]
...
These are: * NOOP - Send the request to the protected server instead of responding to it.
