...
```
Invoke-NSAddIPsecProfile [-Encalgo <String[]>] [-HashAlgo <String[]>] [-IkeretryInterval <Int32>]
 [-Ikeversion <String>] [-Lifetime <Int32>] [-LivenesscheckInterval <Int32>] [-Name] <String>
 [-PeerpublicKey <String>] [-Perfectforwardsecrecy <String>] [-PrivateKey <String>] [-Psk <String>]
 [-PublicKey <String>] [-Replaywindowsize <Int32>] [-Retransmissiontime <Int32>] [-Session <PSObject>]
