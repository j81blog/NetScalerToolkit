...
### All (Default)
```
Invoke-NSGetTransFormGlobalTransformPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Type <String>]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetTransFormGlobalTransformPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
