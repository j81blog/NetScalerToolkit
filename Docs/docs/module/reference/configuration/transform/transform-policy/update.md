...
```
Invoke-NSUpdateTransformPolicy [-Comment <String>] [-LogAction <String>] [-Name] <String>
 [-ProfileName <String>] [-Rule <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
