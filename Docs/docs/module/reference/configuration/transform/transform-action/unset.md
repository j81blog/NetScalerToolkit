...
```
Invoke-NSUnsetTransformAction [-Name] <String> [-Comment] [-CookieDomainfrom] [-CookieDomaininto] [-ReqURLFrom]
 [-ReqURLInto] [-ResURLFrom] [-ResURLInto] [-State] [-Session <PSObject>] [-IgnoreNotFound]
