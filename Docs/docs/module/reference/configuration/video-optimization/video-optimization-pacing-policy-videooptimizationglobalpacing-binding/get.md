...
### All (Default)
```
Invoke-NSGetVideoOptimizationPacingPolicyVideooptimizationglobalpacingBinding [-Filter <Hashtable>]
...
### ByName
```
Invoke-NSGetVideoOptimizationPacingPolicyVideooptimizationglobalpacingBinding [-Name] <String>
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVideoOptimizationPacingPolicyVideooptimizationglobalpacingBinding [-Count] [-Session <PSObject>]
