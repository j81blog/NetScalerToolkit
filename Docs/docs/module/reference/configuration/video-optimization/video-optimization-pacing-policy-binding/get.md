...
### All (Default)
```
Invoke-NSGetVideoOptimizationPacingPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVideoOptimizationPacingPolicyBinding [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
