...
### All (Default)
```
Invoke-NSGetVideoOptimizationDetectionPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVideoOptimizationDetectionPolicyBinding [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
