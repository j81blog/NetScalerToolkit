...
### All (Default)
```
Invoke-NSGetVideoOptimizationDetectionPolicyVideooptimizationglobaldetectionBinding [-Filter <Hashtable>]
...
### ByName
```
Invoke-NSGetVideoOptimizationDetectionPolicyVideooptimizationglobaldetectionBinding [-Name] <String>
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVideoOptimizationDetectionPolicyVideooptimizationglobaldetectionBinding [-Count]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
