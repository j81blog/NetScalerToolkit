...
```
Invoke-NSUnsetVideoOptimizationPacingAction [-Name] <String> [-Comment] [-Rate] [-Session <PSObject>]
...
### -Name
Name for the video optimization pacing action.
...
Default value: 1000 Minimum value = 1 Maximum value = 2147483647
