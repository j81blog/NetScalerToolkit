...
### All (Default)
```
Invoke-NSGetVideoOptimizationDetectionPolicyLabelBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVideoOptimizationDetectionPolicyLabelBinding [-LabelName] <String> [-Session <PSObject>]
