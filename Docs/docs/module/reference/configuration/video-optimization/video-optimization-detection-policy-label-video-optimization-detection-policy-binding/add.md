...
```
Invoke-NSAddVideoOptimizationDetectionPolicyLabelVideoOptimizationDetectionPolicyBinding
 [-GotoPriorityExpression <String>] [-Invoke <Boolean>] [-InvokeLabelName <String>] [-LabelName] <String>
 [-LabelType <String>] -PolicyName <String> -Priority <Int32> [-Session <PSObject>] [-IgnoreNotFound]
...
Available settings function as follows: * vserver - Invoke an unnamed policy label associated with a virtual server.
