...
### All (Default)
```
Invoke-NSGetVideooptimizationglobalpacingVideoOptimizationPacingPolicyBinding [-Filter <Hashtable>]
 [-ViewSummary] [-Type <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVideooptimizationglobalpacingVideoOptimizationPacingPolicyBinding [-Count] [-Session <PSObject>]
