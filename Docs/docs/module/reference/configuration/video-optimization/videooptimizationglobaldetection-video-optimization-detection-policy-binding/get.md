...
### All (Default)
```
Invoke-NSGetVideooptimizationglobaldetectionVideoOptimizationDetectionPolicyBinding [-Filter <Hashtable>]
...
### Count
```
Invoke-NSGetVideooptimizationglobaldetectionVideoOptimizationDetectionPolicyBinding [-Count]
