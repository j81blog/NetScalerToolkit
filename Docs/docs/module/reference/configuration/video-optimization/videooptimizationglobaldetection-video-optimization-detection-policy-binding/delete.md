...
```
Invoke-NSDeleteVideooptimizationglobaldetectionVideoOptimizationDetectionPolicyBinding [-PolicyName] <String>
 [[-Type] <String>] [-Priority] <Int32> [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
