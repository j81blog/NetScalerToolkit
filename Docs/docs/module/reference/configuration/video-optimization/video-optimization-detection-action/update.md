...
```
Invoke-NSUpdateVideoOptimizationDetectionAction [-Comment <String>] [-Name] <String> [-Type <String>]
...
### -Comment
Comment.
Any type of information about this video optimization detection action.
...
### -Name
Name for the video optimization detection action.
...
### -Type
Type of video optimization action.
Available settings function as follows: * clear_text_pd - Cleartext PD type is detected.
...
* trigger_body_detection - Possible cleartext ABR is detected.
Triggers body content detection.
