...
```
Invoke-NSUpdateHANode [-DeadInterval <Int32>] [-Failsafe <String>] [-Haprop <String>] [-Hastatus <String>]
 [-Hasync <String>] [-HelloInterval <Int32>] [[-Id] <Int32>] [-MaxFlips <Int32>] [-MaxFliptime <Int32>]
 [-SyncstatusstrictMode <String>] [-Syncvlan <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
