...
### All (Default)
```
Invoke-NSGetTMSessionPolicyAuthenticationVServerBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetTMSessionPolicyAuthenticationVServerBinding [-Name] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetTMSessionPolicyAuthenticationVServerBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
