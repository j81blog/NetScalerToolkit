...
### All (Default)
```
Invoke-NSGetTmglobalAuditNSLogPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetTmglobalAuditNSLogPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
