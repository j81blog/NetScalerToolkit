...
### All (Default)
```
Invoke-NSGetTmglobalAuditSyslogPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetTmglobalAuditSyslogPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
