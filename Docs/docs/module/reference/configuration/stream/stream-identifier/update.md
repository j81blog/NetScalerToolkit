...
# Invoke-NSUpdateStreamIdentifier
...
```
Invoke-NSUpdateStreamIdentifier [-AcceptanceThreshold <String>] [-AppFlowLog <String>]
 [-BreachThreshold <Int32>] [-Interval <Int32>] [-Log <String>] [-LoginTerval <Int32>] [-Loglimit <Int32>]
