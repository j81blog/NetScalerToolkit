...
```
Invoke-NSUnsetStreamIdentifier [-Name] <String> [-AcceptanceThreshold] [-AppFlowLog] [-BreachThreshold]
 [-Interval] [-Log] [-LoginTerval] [-Loglimit] [-MaxTransActionThreshold] [-MinTransActionThreshold]
 [-Samplecount] [-SelectorName] [-SNMPTrap] [-Sort] [-Trackackonlypackets] [-TracktransActionS]
