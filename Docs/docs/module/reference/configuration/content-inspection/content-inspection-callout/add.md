...
```
Invoke-NSAddContentInspectionCallout [-Comment <String>] [-Name] <String> [-ProfileName <String>]
 -Resultexpr <String> -ReturnType <String> [-ServerIp <String>] [-ServerName <String>] [-ServerPort <Int32>]
...
### -Type
Type of the Content Inspection callout.
It must be one of the following: * ICAP - Sends ICAP request to the configured ICAP server.
