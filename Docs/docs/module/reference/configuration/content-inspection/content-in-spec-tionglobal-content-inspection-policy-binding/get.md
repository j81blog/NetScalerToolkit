...
### All (Default)
```
Invoke-NSGetContentInSpecTionglobalContentInspectionPolicyBinding [-Filter <Hashtable>] [-ViewSummary]
...
### Count
```
Invoke-NSGetContentInSpecTionglobalContentInspectionPolicyBinding [-Count] [-Session <PSObject>]
