...
```
Invoke-NSAddContentInspectionProfile [-Egressinterface <String>] [-Egressvlan <Int32>]
 [-Ingressinterface <String>] [-Ingressvlan <Int32>] [-IPTunnel <String>] [-Name] <String> -Type <String>
...
### -Type
Type of ContentInspection profile.
Following types are available to configure: INLINEINSPECTION : To inspect the packets/requests using IPS.
