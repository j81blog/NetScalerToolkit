...
```
Invoke-NSUpdateContentInSpecTionparameter [[-UndefAction] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
...
Available settings function as follows: * NOINSPECTION - Do not Inspect the traffic.
