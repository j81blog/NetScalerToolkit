...
```
Invoke-NSUpdateContentInspectionAction [-IcapProfileName <String>] [-IfServerDown <String>] [-Name] <String>
 [-ServerIp <String>] [-ServerName <String>] [-ServerPort <Int32>] [-WasmProfileName <String>]
