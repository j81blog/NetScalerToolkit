...
# Invoke-NSUnsetIptunnelparam

## SYNOPSIS
Clears one or more NetScaler iptunnelparam resource properties.

## SYNTAX

```
Invoke-NSUnsetIptunnelparam [-Dropfrag] [-DropfragcpuThreshold] [-Enablestrictrx] [-Enablestricttx] [-Mac]
 [-Srcip] [-Srciproundrobin] [-UseClientsOurceip] [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUnsetIptunnelparam -Dropfrag YES -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetIptunnelparam -Dropfrag YES -WhatIf
```
