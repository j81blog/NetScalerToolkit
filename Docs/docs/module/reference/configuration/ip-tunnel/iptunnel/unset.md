...
## SYNOPSIS
Clears one or more NetScaler iptunnel resource properties.

## SYNTAX

```
Invoke-NSUnsetIPTunnel [-Name] <String> [-DestPort] [-Tosinherit] [-Vlantagging] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUnsetIPTunnel -Name 'example' -DestPort  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetIPTunnel -Name 'example' -DestPort  -WhatIf
```
