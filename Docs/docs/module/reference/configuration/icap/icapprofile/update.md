...
# Invoke-NSUpdateICAPProfile

## SYNOPSIS
Updates a NetScaler nsicapprofile resource.

## SYNTAX

```
Invoke-NSUpdateICAPProfile [-Allow204 <String>] [-ConnectionKeepalive <String>] [-HostHeader <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateICAPProfile -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateICAPProfile -Name 'example' -WhatIf
```
