...
## SYNOPSIS
Creates a NetScaler lbvserver_service_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerServiceBinding [-Name] <String> [-Order <Int32>] [-ServiceGroupName <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerServiceBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerServiceBinding -Name 'example' -WhatIf
```
