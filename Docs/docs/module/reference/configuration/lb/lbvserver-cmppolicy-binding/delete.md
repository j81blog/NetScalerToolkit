...
## SYNOPSIS
Removes a NetScaler lbvserver_cmppolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerCMPPolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerCMPPolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerCMPPolicyBinding -Name 'lbvserver_cmppolicy_binding_example' | Invoke-NSDeleteLBVServerCMPPolicyBinding -Confirm:$false
```
