...
# Invoke-NSDeleteLBAction

## SYNOPSIS
Removes a NetScaler lbaction resource.

## SYNTAX

```
Invoke-NSDeleteLBAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBAction -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBAction -Name 'lbaction_example' | Invoke-NSDeleteLBAction -Confirm:$false
```
