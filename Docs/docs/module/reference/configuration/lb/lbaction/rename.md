...
# Invoke-NSRenameLBAction

## SYNOPSIS
Renames a NetScaler lbaction resource.

## SYNTAX

```
Invoke-NSRenameLBAction [-Name] <String> -NewName <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSRenameLBAction -Name 'example' -NewName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSRenameLBAction -Name 'example' -NewName 'example' -WhatIf
```
