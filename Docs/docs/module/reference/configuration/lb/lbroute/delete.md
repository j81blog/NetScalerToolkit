...
## SYNOPSIS
Removes a NetScaler lbroute resource.

## SYNTAX

```
Invoke-NSDeleteLBRoute [-Network] <String> -NetMask <String> [-TrafficDomain <Int32>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBRoute -Network 'example' -NetMask '255.255.255.255' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBRoute -Network 'lbroute_example' | Invoke-NSDeleteLBRoute -Confirm:$false
```
