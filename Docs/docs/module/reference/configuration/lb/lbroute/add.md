...
## SYNOPSIS
Creates a NetScaler lbroute resource.

## SYNTAX

```
Invoke-NSAddLBRoute -GatewayName <String> -NetMask <String> [-Network] <String> [-TrafficDomain <Int32>]
...
### EXAMPLE 1
```
Invoke-NSAddLBRoute -Network 'example' -GatewayName 'example' -NetMask '255.255.255.255' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBRoute -Network 'example' -GatewayName 'example' -NetMask '255.255.255.255' -WhatIf
```
