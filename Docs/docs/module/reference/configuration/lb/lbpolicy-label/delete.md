...
# Invoke-NSDeleteLBPolicyLabel

## SYNOPSIS
Removes a NetScaler lbpolicylabel resource.

## SYNTAX

```
Invoke-NSDeleteLBPolicyLabel [-LabelName] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBPolicyLabel -LabelName 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBPolicyLabel -LabelName 'lbpolicylabel_example' | Invoke-NSDeleteLBPolicyLabel -Confirm:$false
```
