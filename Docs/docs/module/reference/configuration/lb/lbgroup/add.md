...
## SYNOPSIS
Creates a NetScaler lbgroup resource.

## SYNTAX

```
Invoke-NSAddLBGroup [-BackupPersistenceTimeout <Int32>] [-CookieDomain <String>] [-CookieName <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBGroup -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBGroup -Name 'example' -WhatIf
```
