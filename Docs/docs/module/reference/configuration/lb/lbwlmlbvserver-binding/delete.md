...
```powershell
Invoke-NSDeleteLBWLMLBVServerBinding -WlmName <String> -VServerName <String> [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
