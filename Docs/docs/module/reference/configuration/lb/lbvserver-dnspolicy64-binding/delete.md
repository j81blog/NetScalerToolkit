...
## SYNOPSIS
Removes a NetScaler lbvserver_dnspolicy64_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerDNSPolicy64Binding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerDNSPolicy64Binding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerDNSPolicy64Binding -Name 'lbvserver_dnspolicy64_binding_example' | Invoke-NSDeleteLBVServerDNSPolicy64Binding -Confirm:$false
```
