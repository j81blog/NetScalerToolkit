...
## SYNOPSIS
Creates a NetScaler lbvserver_dnspolicy64_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerDNSPolicy64Binding [-Bindpoint <String>] [-GotoPriorityExpression <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerDNSPolicy64Binding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerDNSPolicy64Binding -Name 'example' -WhatIf
```
