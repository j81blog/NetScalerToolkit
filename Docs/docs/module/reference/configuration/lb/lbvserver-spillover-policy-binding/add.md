...
## SYNOPSIS
Creates a NetScaler lbvserver_spilloverpolicy_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerSpilloverPolicyBinding [-Bindpoint <String>] [-GotoPriorityExpression <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerSpilloverPolicyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerSpilloverPolicyBinding -Name 'example' -WhatIf
```
