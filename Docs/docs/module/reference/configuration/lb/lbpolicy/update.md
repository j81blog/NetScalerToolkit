...
# Invoke-NSUpdateLBPolicy

## SYNOPSIS
Updates a NetScaler lbpolicy resource.

## SYNTAX

```
Invoke-NSUpdateLBPolicy [-Action <String>] [-Comment <String>] [-LogAction <String>] [-Name] <String>
...
### EXAMPLE 1
```
Invoke-NSUpdateLBPolicy -Name 'example' -Comment 'Updated by automation' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateLBPolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
```
