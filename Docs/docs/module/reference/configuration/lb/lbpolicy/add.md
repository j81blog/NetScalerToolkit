...
# Invoke-NSAddLBPolicy

## SYNOPSIS
Creates a NetScaler lbpolicy resource.

## SYNTAX

```
Invoke-NSAddLBPolicy -Action <String> [-Comment <String>] [-LogAction <String>] [-Name] <String> -Rule <String>
...
### EXAMPLE 1
```
Invoke-NSAddLBPolicy -Name 'example' -Action 'example' -Rule 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBPolicy -Name 'example' -Action 'example' -Rule 'example' -WhatIf
```
...
Available settings function as follows: * NOLBACTION - Does not consider LB actions in making LB decision.
