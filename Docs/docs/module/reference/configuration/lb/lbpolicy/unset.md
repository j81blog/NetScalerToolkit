...
## SYNOPSIS
Clears one or more NetScaler lbpolicy resource properties.

## SYNTAX

```
Invoke-NSUnsetLBPolicy [-Name] <String> [-Comment] [-LogAction] [-UndefAction] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUnsetLBPolicy -Name 'example' -Comment 'Updated by automation' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetLBPolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
```
