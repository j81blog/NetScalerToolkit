...
## SYNOPSIS
Removes a NetScaler lbvserver_auditsyslogpolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerAuditSyslogPolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerAuditSyslogPolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerAuditSyslogPolicyBinding -Name 'lbvserver_auditsyslogpolicy_binding_example' | Invoke-NSDeleteLBVServerAuditSyslogPolicyBinding -Confirm:$false
```
