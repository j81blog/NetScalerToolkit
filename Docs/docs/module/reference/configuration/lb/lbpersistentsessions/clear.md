...
# Invoke-NSClearLbpersistentsessions

## SYNOPSIS
Clears NetScaler lbpersistentsessions data.

## SYNTAX

```
Invoke-NSClearLbpersistentsessions [[-PersistenceParameter] <String>] [[-VServer] <String>]
...
### EXAMPLE 2
```
Invoke-NSClearLbpersistentsessions  -WhatIf
```
