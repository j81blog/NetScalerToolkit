...
## SYNOPSIS
Removes a NetScaler lbvserver_auditnslogpolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerAuditNSLogPolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerAuditNSLogPolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerAuditNSLogPolicyBinding -Name 'lbvserver_auditnslogpolicy_binding_example' | Invoke-NSDeleteLBVServerAuditNSLogPolicyBinding -Confirm:$false
```
