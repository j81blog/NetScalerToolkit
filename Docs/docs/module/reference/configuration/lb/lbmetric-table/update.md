...
# Invoke-NSUpdateLBMetricTable

## SYNOPSIS
Updates a NetScaler lbmetrictable resource.

## SYNTAX

```
Invoke-NSUpdateLBMetricTable -Metric <String> [-Metrictable] <String> -SNMPOid <String> [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUpdateLBMetricTable -Metrictable 'example' -Metric 'example' -SNMPOid 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateLBMetricTable -Metrictable 'example' -Metric 'example' -SNMPOid 'example' -WhatIf
```
