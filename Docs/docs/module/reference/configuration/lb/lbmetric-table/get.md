...
## SYNOPSIS
Gets NetScaler lbmetrictable configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetLBMetricTable [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetLBMetricTable [-Metrictable] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetLBMetricTable [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetLBMetricTable -Metrictable 'lbmetrictable_example'
```

### EXAMPLE 3
```
Invoke-NSGetLBMetricTable -Filter @{ servicetype = 'HTTP' }
```

## PARAMETERS

### -Metrictable
Name for the metric table.
