...
# Invoke-NSAddLBMetricTable

## SYNOPSIS
Creates a NetScaler lbmetrictable resource.

## SYNTAX

```
Invoke-NSAddLBMetricTable [-Metrictable] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddLBMetricTable -Metrictable 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBMetricTable -Metrictable 'example' -WhatIf
```
