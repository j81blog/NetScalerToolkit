...
## SYNOPSIS
Removes a NetScaler lbmetrictable resource.

## SYNTAX

```
Invoke-NSDeleteLBMetricTable [-Metrictable] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBMetricTable -Metrictable 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBMetricTable -Metrictable 'lbmetrictable_example' | Invoke-NSDeleteLBMetricTable -Confirm:$false
```
