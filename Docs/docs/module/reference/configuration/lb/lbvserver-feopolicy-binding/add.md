...
## SYNOPSIS
Creates a NetScaler lbvserver_feopolicy_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerFEOPolicyBinding [-Bindpoint <String>] [-GotoPriorityExpression <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerFEOPolicyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerFEOPolicyBinding -Name 'example' -WhatIf
```
