...
## SYNOPSIS
Removes a NetScaler lbvserver_feopolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerFEOPolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerFEOPolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerFEOPolicyBinding -Name 'lbvserver_feopolicy_binding_example' | Invoke-NSDeleteLBVServerFEOPolicyBinding -Confirm:$false
```
