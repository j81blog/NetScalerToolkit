...
## SYNOPSIS
Creates a NetScaler lbgroup_lbvserver_binding resource.

## SYNTAX

```
Invoke-NSAddLBGroupLBVServerBinding [-Name] <String> -VServerName <String> [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddLBGroupLBVServerBinding -Name 'example' -VServerName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBGroupLBVServerBinding -Name 'example' -VServerName 'example' -WhatIf
```
