...
```powershell
Invoke-NSDeleteLBGroupLBVServerBinding -Name <String> -VServerName <String> [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
