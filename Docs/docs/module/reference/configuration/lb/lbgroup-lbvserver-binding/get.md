...
## SYNOPSIS
Gets NetScaler lbgroup_lbvserver_binding configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetLBGroupLBVServerBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetLBGroupLBVServerBinding [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetLBGroupLBVServerBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetLBGroupLBVServerBinding -Name 'lbgroup_lbvserver_binding_example'
```

### EXAMPLE 3
```
Invoke-NSGetLBGroupLBVServerBinding -Filter @{ servicetype = 'HTTP' }
```
