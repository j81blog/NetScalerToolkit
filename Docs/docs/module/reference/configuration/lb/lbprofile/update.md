...
# Invoke-NSUpdateLBProfile

## SYNOPSIS
Updates a NetScaler lbprofile resource.

## SYNTAX

```
Invoke-NSUpdateLBProfile [-ComputedadcCookieAttribute <String>] [-CookiePassphrase <String>] [-DBSLB <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateLBProfile -LBProfileName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateLBProfile -LBProfileName 'example' -WhatIf
```
