...
## SYNOPSIS
Creates a NetScaler lbvserver_appqoepolicy_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerAppQoEPolicyBinding [-Bindpoint <String>] [-GotoPriorityExpression <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerAppQoEPolicyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerAppQoEPolicyBinding -Name 'example' -WhatIf
```
