...
## SYNOPSIS
Creates a NetScaler lbvserver_videooptimizationdetectionpolicy_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerVideoOptimizationDetectionPolicyBinding [-Bindpoint <String>]
 [-GotoPriorityExpression <String>] [-Invoke <Boolean>] [-LabelName <String>] [-LabelType <String>]
 [-Name] <String> [-Order <Int32>] [-PolicyName <String>] [-Priority <Int32>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerVideoOptimizationDetectionPolicyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerVideoOptimizationDetectionPolicyBinding -Name 'example' -WhatIf
```
