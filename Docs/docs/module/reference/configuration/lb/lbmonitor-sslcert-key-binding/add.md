...
## SYNOPSIS
Creates a NetScaler lbmonitor_sslcertkey_binding resource.

## SYNTAX

```
Invoke-NSAddLBMonitorSSLCertKeyBinding [-Ca <Boolean>] [-CertKeyName <String>] [-Crlcheck <String>]
 [-MonItorName] <String> [-OCSPCheck <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddLBMonitorSSLCertKeyBinding -MonItorName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBMonitorSSLCertKeyBinding -MonItorName 'example' -WhatIf
```
