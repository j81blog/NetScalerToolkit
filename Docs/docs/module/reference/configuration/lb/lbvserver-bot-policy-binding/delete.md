...
## SYNOPSIS
Removes a NetScaler lbvserver_botpolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerBotPolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerBotPolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerBotPolicyBinding -Name 'lbvserver_botpolicy_binding_example' | Invoke-NSDeleteLBVServerBotPolicyBinding -Confirm:$false
```
