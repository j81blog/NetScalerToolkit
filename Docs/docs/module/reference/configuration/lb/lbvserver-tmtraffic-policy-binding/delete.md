...
## SYNOPSIS
Removes a NetScaler lbvserver_tmtrafficpolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerTMTrafficPolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerTMTrafficPolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerTMTrafficPolicyBinding -Name 'lbvserver_tmtrafficpolicy_binding_example' | Invoke-NSDeleteLBVServerTMTrafficPolicyBinding -Confirm:$false
```
