...
## SYNOPSIS
Creates a NetScaler lbvserver_tmtrafficpolicy_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerTMTrafficPolicyBinding [-Bindpoint <String>] [-GotoPriorityExpression <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerTMTrafficPolicyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerTMTrafficPolicyBinding -Name 'example' -WhatIf
```
