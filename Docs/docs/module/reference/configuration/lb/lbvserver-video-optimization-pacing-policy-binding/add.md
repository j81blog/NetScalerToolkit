...
## SYNOPSIS
Creates a NetScaler lbvserver_videooptimizationpacingpolicy_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerVideoOptimizationPacingPolicyBinding [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerVideoOptimizationPacingPolicyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerVideoOptimizationPacingPolicyBinding -Name 'example' -WhatIf
```
