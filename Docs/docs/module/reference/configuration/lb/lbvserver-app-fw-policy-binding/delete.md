...
## SYNOPSIS
Removes a NetScaler lbvserver_appfwpolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerAppFwPolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerAppFwPolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerAppFwPolicyBinding -Name 'lbvserver_appfwpolicy_binding_example' | Invoke-NSDeleteLBVServerAppFwPolicyBinding -Confirm:$false
```
