...
# Invoke-NSUnsetLBVServer

## SYNOPSIS
Clears one or more NetScaler lbvserver resource properties.

## SYNTAX

```
Invoke-NSUnsetLBVServer [-Name] <String> [-ADFSProxyProfile] [-APIProfile] [-AppFlowLog] [-Authentication]
 [-AuthenticationHost] [-Authn401] [-AuthnProfile] [-AuthnVServerName] [-BackupLBMethod]
 [-BackupPersistenceTimeout] [-BackupVServer] [-Cacheable] [-CltTimeout] [-Comment] [-ConnFailover]
 [-CookieName] [-DataLength] [-DataOffset] [-DBProfileName] [-DBSLB] [-DisablePrimaryOnDown] [-DNSOverHTTPS]
 [-DNSProfileName] [-DownStateFlush] [-HashLength] [-HealthThreshold] [-HTTPProfileName] [-HTTPSRedirectURL]
 [-ICMPVsrResponse] [-InsertVServerIPPort] [-IPSet] [-L2Conn] [-LBMethod] [-LBProfileName] [-ListenPolicy]
 [-ListenPriority] [-M] [-MacModeRetainVLAN] [-MaxAutoscaleMembers] [-MinAutoscaleMembers]
 [-MSSQLServerVersion] [-MySQLCharacterSet] [-MySQLProtocolVersion] [-MySQLServerCapabilities]
 [-MySQLServerVersion] [-NetMask] [-NetProfile] [-NewServiceRequest] [-NewServiceRequestIncrementInterval]
 [-NewServiceRequestUnit] [-OracleServerVersion] [-Order] [-OrderThreshold] [-PersistaVPNO]
 [-PersistenceBackup] [-PersistenceType] [-PersistMask] [-ProbeProtocol] [-ProbeSuccessResponseCode] [-Push]
 [-PushLabel] [-PushMultiClients] [-PushVServer] [-QUICBridgeProfileName] [-QUICProfileName]
 [-RecursionAvailable] [-RedirectFromPort] [-RedirectPortRewrite] [-RedirURL] [-RedirURLFlags] [-Resrule]
 [-RetainConnectionsOnCluster] [-Rhistate] [-RTSPNAT] [-Rule] [-ServiceName] [-Sessionless] [-Skippersistency]
 [-SoBackupAction] [-SoMethod] [-SoPersistence] [-SoPersistenceTimeout] [-SoThreshold] [-TCPProbePort]
 [-TCPProfileName] [-Timeout] [-ToggleOrder] [-Tosid] [-TrofsPersistence] [-V6NetmaskLen] [-V6PersistMaskLen]
 [-VIPHeader] [-WASMModule] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
...
### EXAMPLE 1
```
Invoke-NSUnsetLBVServer -Name 'example' -ADFSProxyProfile  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetLBVServer -Name 'example' -ADFSProxyProfile  -WhatIf
```
