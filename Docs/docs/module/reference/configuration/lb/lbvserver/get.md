...
## SYNOPSIS
Gets NetScaler load balancing virtual server configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetLBVServer [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetLBVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetLBVServer [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetLBVServer -Name 'lbvserver_example'
```

### EXAMPLE 3
```
Invoke-NSGetLBVServer -Filter @{ servicetype = 'HTTP' }
```
