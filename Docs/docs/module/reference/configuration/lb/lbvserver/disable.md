...
# Invoke-NSDisableLBVServer

## SYNOPSIS
Disables a NetScaler load balancing virtual server.

## SYNTAX

```
Invoke-NSDisableLBVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisableLBVServer -Name 'lbvserver_example' -PassThru
```
