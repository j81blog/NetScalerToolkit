...
# Invoke-NSEnableLBVServer

## SYNOPSIS
Enables a NetScaler load balancing virtual server.

## SYNTAX

```
Invoke-NSEnableLBVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnableLBVServer -Name 'lbvserver_example' -PassThru
```
