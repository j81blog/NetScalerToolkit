...
# Invoke-NSRenameLBVServer

## SYNOPSIS
Renames a NetScaler lbvserver resource.

## SYNTAX

```
Invoke-NSRenameLBVServer [-Name] <String> -NewName <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSRenameLBVServer -Name 'example' -NewName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSRenameLBVServer -Name 'example' -NewName 'example' -WhatIf
```
