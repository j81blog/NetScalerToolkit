...
# Invoke-NSDeleteLBVServer

## SYNOPSIS
Removes a NetScaler load balancing virtual server.

## SYNTAX

```
Invoke-NSDeleteLBVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServer -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServer -Name 'lbvserver_example' | Invoke-NSDeleteLBVServer -Confirm:$false
```
