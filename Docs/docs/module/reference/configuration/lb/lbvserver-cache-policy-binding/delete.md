...
## SYNOPSIS
Removes a NetScaler lbvserver_cachepolicy_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerCachePolicyBinding [-Name] <String> [-PolicyName <String>] [-Bindpoint <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerCachePolicyBinding -Name 'example' -PolicyName 'example' -Bindpoint REQUEST -Priority 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerCachePolicyBinding -Name 'lbvserver_cachepolicy_binding_example' | Invoke-NSDeleteLBVServerCachePolicyBinding -Confirm:$false
```
