...
# Invoke-NSDeleteLBMonitor

## SYNOPSIS
Removes a NetScaler lbmonitor resource.

## SYNTAX

```
Invoke-NSDeleteLBMonitor [-MonItorName] <String> -Type <String> [-ResponseCode <String[]>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBMonitor -MonItorName 'example' -Type 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBMonitor -MonItorName 'lbmonitor_example' | Invoke-NSDeleteLBMonitor -Confirm:$false
```
