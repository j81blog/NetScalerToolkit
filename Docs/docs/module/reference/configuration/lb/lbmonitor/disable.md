...
## SYNOPSIS
Disables a NetScaler lbmonitor resource.

## SYNTAX

```
Invoke-NSDisableLBMonitor [-MonItorName] <String> [-ServiceGroupName <String>] [-ServiceName <String>]
...
### EXAMPLE 1
```
Invoke-NSDisableLBMonitor -MonItorName 'lbmonitor_example' -PassThru
```
