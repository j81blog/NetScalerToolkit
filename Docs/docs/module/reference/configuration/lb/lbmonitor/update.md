...
# Invoke-NSUpdateLBMonitor

## SYNOPSIS
Updates a NetScaler lbmonitor resource.

## SYNTAX

```
Invoke-NSUpdateLBMonitor [-Acctapplicationid <String>] [-Action <String>] [-Alertretries <Int32>]
 ...
 [-MaxForwards <Int32>] [-Metric <String>] [-Metrictable <String>] [-MetricThreshold <Int32>]
 [-Metricweight <Int32>] [-MonItorName] <String> [-MqttClientIdentifier <String>] [-Mqttversion <Int32>]
 [-MssqlProtocolVersion <String>] [-NetProfile <String>] [-OracleSid <String>] [-OriginHost <String>]
 [-Originrealm <String>] [-Password <String>] [-ProductName <String>] [-Query <String>] [-QueryType <String>]
 [-RadAccountSession <String>] [-RadAccountType <Int32>] [-Radapn <String>] [-Radframedip <String>]
 [-RadKey <String>] [-Radmsisdn <String>] [-Radnasid <String>] [-RadnaSIP <String>] [-Recv <String>]
 [-ResponseCode <String[]>] [-ResponseTimeout <Int32>] [-ResponseTimeoutThresh <Int32>] [-Retries <Int32>]
 [-Reverse <String>] [-RtspRequest <String>] [-Scriptargs <String>] [-ScriptName <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateLBMonitor -MonItorName 'example' -Type 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateLBMonitor -MonItorName 'example' -Type 'example' -WhatIf
```
...
A value zero disables the metric and it will not be used for load calculation.
Minimum length = 1 Maximum length = 37
