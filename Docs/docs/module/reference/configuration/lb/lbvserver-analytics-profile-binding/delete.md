...
## SYNOPSIS
Removes a NetScaler lbvserver_analyticsprofile_binding resource.

## SYNTAX

```
Invoke-NSDeleteLBVServerAnalyticsProfileBinding [-Name] <String> [-AnalyticsProfile <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteLBVServerAnalyticsProfileBinding -Name 'example' -AnalyticsProfile 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetLBVServerAnalyticsProfileBinding -Name 'lbvserver_analyticsprofile_binding_example' | Invoke-NSDeleteLBVServerAnalyticsProfileBinding -Confirm:$false
```
