...
## SYNOPSIS
Creates a NetScaler lbvserver_servicegroup_binding resource.

## SYNTAX

```
Invoke-NSAddLBVServerServiceGroupBinding [-Name] <String> [-Order <Int32>] [-ServiceGroupName <String>]
 [-ServiceName <String>] [-Weight <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddLBVServerServiceGroupBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddLBVServerServiceGroupBinding -Name 'example' -WhatIf
```
...
### -Weight
Integer specifying the weight of the service.
A larger number specifies a greater weight.
Defines the capacity of the service relative to the other services in the load balancing configuration.
