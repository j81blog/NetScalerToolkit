...
### All (Default)
```
Invoke-NSGetServiceGroupServiceGroupMemberBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetServiceGroupServiceGroupMemberBinding [-ServiceGroupName] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetServiceGroupServiceGroupMemberBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
