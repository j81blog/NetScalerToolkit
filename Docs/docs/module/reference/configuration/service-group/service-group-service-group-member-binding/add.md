...
```
Invoke-NSAddServiceGroupServiceGroupMemberBinding [-CustomServerID <String>] [-DBSTTL <Int32>]
 [-HashID <Int32>] [-Ip <String>] [-NameServer <String>] [-Order <Int32>] [-Port <Int32>] [-ServerID <Int32>]
 [-ServerName <String>] [-ServiceGroupName] <String> [-State <String>] [-Weight <Int32>] [-Session <PSObject>]
