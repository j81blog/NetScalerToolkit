...
### All (Default)
```
Invoke-NSGetServiceGroup [-Filter <Hashtable>] [-ViewSummary] [-IncludeMembers] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetServiceGroup [-ServiceGroupName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetServiceGroup [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
