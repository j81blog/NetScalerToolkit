...
```
Invoke-NSUnsetCacheContentGroup [-Name] <String> [-Absexpiry] [-Absexpirygmt] [-Alwaysevalpolicies]
 [-Cachecontrol] [-Expireatlastbyte] [-Flashcache] [-Heurexpiryparam] [-Hitparams] [-Hitselector]
 [-Ignoreparamvaluecase] [-Ignorereloadreq] [-Ignorereqcachinghdrs] [-InsertAge] [-InsertEtag] [-InsertVia]
 [-Invalparams] [-InvalrestrictedtoHost] [-Invalselector] [-LazyDNSResolve] [-MatchCookieS] [-MaxRessize]
 [-Memlimit] [-MinHits] [-MinRessize] [-Persistha] [-Pinned] [-Polleverytime] [-Prefetch] [-PrefetchMaxPending]
 [-Prefetchperiod] [-Prefetchperiodmillisec] [-QUICKabortsize] [-Relexpiry] [-Relexpirymillisec]
 [-RemoveCookieS] [-Weaknegrelexpiry] [-Weakposrelexpiry] [-Session <PSObject>] [-IgnoreNotFound]
