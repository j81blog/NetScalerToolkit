...
```
Invoke-NSUpdateCacheparameter [[-CacheevictionPolicy] <String>] [[-EnableBypass] <String>]
 [[-Enablehaobjpersist] <String>] [[-MaxPostlen] <Int32>] [[-Memlimit] <Int32>] [[-PrefetchMaxPending] <Int32>]
 [[-UndefAction] <String>] [[-Verifyusing] <String>] [[-Via] <String>] [[-Session] <PSObject>]
