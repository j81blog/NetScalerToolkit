...
### All (Default)
```
Invoke-NSGetCacheSelector [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetCacheSelector [-SelectorName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetCacheSelector [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
