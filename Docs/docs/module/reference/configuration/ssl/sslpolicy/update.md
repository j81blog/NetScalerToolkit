...
# Invoke-NSUpdateSSLPolicy

## SYNOPSIS
Updates a NetScaler sslpolicy resource.

## SYNTAX

```
Invoke-NSUpdateSSLPolicy [-Action <String>] [-Comment <String>] [-Name] <String> [-Rule <String>]
 [-UndefAction <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
...
### EXAMPLE 1
```
Invoke-NSUpdateSSLPolicy -Name 'example' -Comment 'Updated by automation' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateSSLPolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
```
