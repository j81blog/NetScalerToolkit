...
## SYNOPSIS
Gets NetScaler sslpolicy configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLPolicy [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLPolicy [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLPolicy [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetSSLPolicy -Name 'sslpolicy_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLPolicy -Filter @{ servicetype = 'HTTP' }
```
