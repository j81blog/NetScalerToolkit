...
# Invoke-NSUpdateSSLCrl

## SYNOPSIS
Updates a NetScaler sslcrl resource.

## SYNTAX

```
Invoke-NSUpdateSSLCrl [-Basedn <String>] [-Binary <String>] [-Binddn <String>] [-CaCert <String>]
 [-CrlName] <String> [-Day <Int32>] [-Interval <String>] [-Method <String>] [-Password <String>]
 [-Port <Int32>] [-Refresh <String>] [-Scope <String>] [-Server <String>] [-Time <String>] [-URL <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateSSLCrl -CrlName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateSSLCrl -CrlName 'example' -WhatIf
```
