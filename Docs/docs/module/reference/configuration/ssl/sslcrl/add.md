...
## SYNOPSIS
Creates a NetScaler sslcrl resource.

## SYNTAX

```
Invoke-NSAddSSLCrl [-Basedn <String>] [-Binary <String>] [-Binddn <String>] [-CaCert <String>]
 [-CrlName] <String> -Crlpath <String> [-Day <Int32>] [-InForm <String>] [-Interval <String>]
 [-Method <String>] [-Password <String>] [-Port <Int32>] [-Refresh <String>] [-Scope <String>]
 [-Server <String>] [-Time <String>] [-URL <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddSSLCrl -CrlName 'example' -Crlpath 'example' -Port 80 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddSSLCrl -CrlName 'example' -Crlpath 'example' -Port 80 -WhatIf
```
...
/var/netscaler/ssl/ is the default path.
Minimum length = 1
...
### -InForm
Input format of the CRL file.
The two formats supported on the appliance are: PEM - Privacy Enhanced Mail.
