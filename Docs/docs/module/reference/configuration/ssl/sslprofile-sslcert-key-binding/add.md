...
## SYNOPSIS
Creates a NetScaler sslprofile_sslcertkey_binding resource.

## SYNTAX

```
Invoke-NSAddSSLProfileSSLCertKeyBinding [-CertKeyName <String>] [-CipherPriority <Int32>]
 [-ForgingcaCertKey <Boolean>] [-Name] <String> [-SSLIcaCertKey <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddSSLProfileSSLCertKeyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddSSLProfileSSLCertKeyBinding -Name 'example' -WhatIf
```
