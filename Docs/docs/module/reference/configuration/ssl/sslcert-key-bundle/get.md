...
## SYNOPSIS
Gets NetScaler sslcertkeybundle configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLCertKeyBundle [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLCertKeyBundle [-CertKeyBundleName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLCertKeyBundle [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetSSLCertKeyBundle -CertKeyBundleName 'sslcertkeybundle_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLCertKeyBundle -Filter @{ servicetype = 'HTTP' }
```
