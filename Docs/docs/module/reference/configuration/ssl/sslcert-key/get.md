...
## SYNOPSIS
Gets NetScaler sslcertkey configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLCertKey [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLCertKey [-CertKey] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLCertKey [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetSSLCertKey -CertKey 'sslcertkey_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLCertKey -Filter @{ servicetype = 'HTTP' }
```
