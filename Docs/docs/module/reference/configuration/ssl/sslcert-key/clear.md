...
# Invoke-NSClearSSLCertKey

## SYNOPSIS
Clears NetScaler sslcertkey data.

## SYNTAX

```
Invoke-NSClearSSLCertKey [-CertKey] <String> [-OCSPStaplingcache <Boolean>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSClearSSLCertKey -CertKey 'example'
```

### EXAMPLE 2
```
Invoke-NSClearSSLCertKey -CertKey 'example' -WhatIf
```
