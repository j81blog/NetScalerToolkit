...
## SYNOPSIS
Gets NetScaler sslcacertbundle configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLCaCertBundle [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLCaCertBundle [-CaCertBundleName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLCaCertBundle [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetSSLCaCertBundle -CaCertBundleName 'sslcacertbundle_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLCaCertBundle -Filter @{ servicetype = 'HTTP' }
```
