...
## SYNOPSIS
Gets NetScaler sslcertkeybundle_sslvserver_binding configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLCertKeyBundleSSLVServerBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLCertKeyBundleSSLVServerBinding [-CertKeyBundleName] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLCertKeyBundleSSLVServerBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetSSLCertKeyBundleSSLVServerBinding -CertKeyBundleName 'sslcertkeybundle_sslvserver_binding_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLCertKeyBundleSSLVServerBinding -Filter @{ servicetype = 'HTTP' }
```
