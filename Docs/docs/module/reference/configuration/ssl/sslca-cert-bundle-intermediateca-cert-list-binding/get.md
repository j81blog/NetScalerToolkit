...
## SYNOPSIS
Gets NetScaler sslcacertbundle_intermediatecacertlist_binding configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLCaCertBundleIntermediatecaCertListBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLCaCertBundleIntermediatecaCertListBinding [-CaCertBundleName] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLCaCertBundleIntermediatecaCertListBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetSSLCaCertBundleIntermediatecaCertListBinding -CaCertBundleName 'sslcacertbundle_intermediatecacertlist_binding_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLCaCertBundleIntermediatecaCertListBinding -Filter @{ servicetype = 'HTTP' }
```
...
The name will be used for bind/unbind/update operations.
