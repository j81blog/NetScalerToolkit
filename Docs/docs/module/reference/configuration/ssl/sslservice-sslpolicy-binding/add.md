...
## SYNOPSIS
Creates a NetScaler sslservice_sslpolicy_binding resource.

## SYNTAX

```
Invoke-NSAddSSLServiceSSLPolicyBinding [-GotoPriorityExpression <String>] [-Invoke <Boolean>]
 [-LabelName <String>] [-LabelType <String>] [-PolicyName <String>] [-Priority <Int32>] [-ServiceName] <String>
...
### EXAMPLE 1
```
Invoke-NSAddSSLServiceSSLPolicyBinding -ServiceName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddSSLServiceSSLPolicyBinding -ServiceName 'example' -WhatIf
```
