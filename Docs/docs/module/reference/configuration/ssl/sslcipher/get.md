...
## SYNOPSIS
Gets NetScaler sslcipher configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLCipher [-Filter <Hashtable>] [-ViewSummary] [-SSLProfile <String>] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLCipher [-CipherGroupName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLCipher [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetSSLCipher -CipherGroupName 'sslcipher_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLCipher -Filter @{ servicetype = 'HTTP' }
```

## PARAMETERS

### -CipherGroupName
Name for the user-defined cipher group.
