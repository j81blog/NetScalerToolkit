...
## SYNOPSIS
Gets NetScaler sslcertkeybundle_intermediatecertlinks_binding configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLCertKeyBundleIntermediateCertLinksBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLCertKeyBundleIntermediateCertLinksBinding [-CertKeyBundleName] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLCertKeyBundleIntermediateCertLinksBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetSSLCertKeyBundleIntermediateCertLinksBinding -CertKeyBundleName 'sslcertkeybundle_intermediatecertlinks_binding_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLCertKeyBundleIntermediateCertLinksBinding -Filter @{ servicetype = 'HTTP' }
```
