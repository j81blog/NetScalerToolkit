...
## SYNOPSIS
Gets NetScaler sslocspresponder configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetSSLOCSPResponder [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSSLOCSPResponder [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSSLOCSPResponder [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetSSLOCSPResponder -Name 'sslocspresponder_example'
```

### EXAMPLE 3
```
Invoke-NSGetSSLOCSPResponder -Filter @{ servicetype = 'HTTP' }
```
