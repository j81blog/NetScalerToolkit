...
## SYNOPSIS
Updates a NetScaler nsacl6 resource.

## SYNTAX

```
Invoke-NSUpdateACL6 [-Acl6Name] <String> [-AclAction <String>] [-Destipop <String>] [-DestIPv6 <Boolean>]
 ...
 [-Stateful <String>] [-Vlan <Int32>] [-Vxlan <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateACL6 -Acl6Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateACL6 -Acl6Name 'example' -WhatIf
```
