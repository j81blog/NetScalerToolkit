...
# Invoke-NSDisableACL6

## SYNOPSIS
Disables a NetScaler nsacl6 resource.

## SYNTAX

```
Invoke-NSDisableACL6 [-Acl6Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisableACL6 -Acl6Name 'nsacl6_example' -PassThru
```
