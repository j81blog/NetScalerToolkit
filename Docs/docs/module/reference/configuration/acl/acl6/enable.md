...
## SYNOPSIS
Enables a NetScaler nsacl6 resource.

## SYNTAX

```
Invoke-NSEnableACL6 [-Acl6Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnableACL6 -Acl6Name 'nsacl6_example' -PassThru
```
