...
## SYNOPSIS
Creates a NetScaler nsacl resource.

## SYNTAX

```
Invoke-NSAddACL -AclAction <String> [-AclName] <String> [-Destip <Boolean>] [-DestipDataSet <String>]
 [-Destipop <String>] [-Destipval <String>] [-DestPort <Boolean>] [-DestPortDataSet <String>]
 [-DestPortOp <String>] [-DestPortVal <String>] [-DfdHash <String>] [-Established <Boolean>]
 [-ICMPCode <Int32>] [-ICMPType <Int32>] [-Interface <String>] [-Logstate <String>] [-Nodeid <Int32>]
 [-Priority <Int32>] [-Protocol <String>] [-ProtocolNumber <Int32>] [-Ratelimit <Int32>] [-Srcip <Boolean>]
 ...
 [-Stateful <String>] [-TrafficDomain <Int32>] [-Ttl <Int32>] [-Type <String>] [-Vlan <Int32>] [-Vxlan <Int32>]
...
### EXAMPLE 1
```
Invoke-NSAddACL -AclName 'example' -AclAction BRIDGE -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddACL -AclName 'example' -AclAction BRIDGE -WhatIf
```
...
### -State
Enable or disable the extended ACL rule.
After you apply the extended ACL rules, the Citrix ADC compares incoming packets against the enabled extended ACL rules.
