...
## SYNOPSIS
Disables a NetScaler nsacl resource.

## SYNTAX

```
Invoke-NSDisableACL [-AclName] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisableACL -AclName 'nsacl_example' -PassThru
```
