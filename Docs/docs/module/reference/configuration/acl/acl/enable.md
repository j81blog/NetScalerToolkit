...
## SYNOPSIS
Enables a NetScaler nsacl resource.

## SYNTAX

```
Invoke-NSEnableACL [-AclName] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnableACL -AclName 'nsacl_example' -PassThru
```
