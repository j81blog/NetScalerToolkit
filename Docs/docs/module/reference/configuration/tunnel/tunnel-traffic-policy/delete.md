...
## SYNOPSIS
Removes a NetScaler tunneltrafficpolicy resource.

## SYNTAX

```
Invoke-NSDeleteTunnelTrafficPolicy [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteTunnelTrafficPolicy -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetTunnelTrafficPolicy -Name 'tunneltrafficpolicy_example' | Invoke-NSDeleteTunnelTrafficPolicy -Confirm:$false
```
