...
## SYNOPSIS
Clears one or more NetScaler tunneltrafficpolicy resource properties.

## SYNTAX

```
Invoke-NSUnsetTunnelTrafficPolicy [-Name] <String> [-Comment] [-LogAction] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUnsetTunnelTrafficPolicy -Name 'example' -Comment 'Updated by automation' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetTunnelTrafficPolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
```
