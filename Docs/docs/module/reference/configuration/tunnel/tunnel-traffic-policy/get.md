...
## SYNOPSIS
Gets NetScaler tunneltrafficpolicy configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetTunnelTrafficPolicy [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetTunnelTrafficPolicy [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetTunnelTrafficPolicy [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetTunnelTrafficPolicy -Name 'tunneltrafficpolicy_example'
```

### EXAMPLE 3
```
Invoke-NSGetTunnelTrafficPolicy -Filter @{ servicetype = 'HTTP' }
```
