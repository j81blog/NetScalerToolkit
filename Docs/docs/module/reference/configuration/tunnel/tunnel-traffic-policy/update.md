...
## SYNOPSIS
Updates a NetScaler tunneltrafficpolicy resource.

## SYNTAX

```
Invoke-NSUpdateTunnelTrafficPolicy [-Action <String>] [-Comment <String>] [-LogAction <String>]
 [-Name] <String> [-Rule <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateTunnelTrafficPolicy -Name 'example' -Comment 'Updated by automation' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateTunnelTrafficPolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
```
