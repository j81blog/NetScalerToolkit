...
## SYNOPSIS
Creates a NetScaler tunneltrafficpolicy resource.

## SYNTAX

```
Invoke-NSAddTunnelTrafficPolicy -Action <String> [-Comment <String>] [-LogAction <String>] [-Name] <String>
...
### EXAMPLE 1
```
Invoke-NSAddTunnelTrafficPolicy -Name 'example' -Action 'example' -Rule 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddTunnelTrafficPolicy -Name 'example' -Action 'example' -Rule 'example' -WhatIf
```
