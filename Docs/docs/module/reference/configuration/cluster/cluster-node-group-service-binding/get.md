...
### All (Default)
```
Invoke-NSGetClusterNodeGroupServiceBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetClusterNodeGroupServiceBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
