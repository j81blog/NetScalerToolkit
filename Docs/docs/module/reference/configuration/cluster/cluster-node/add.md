...
```
Invoke-NSAddClusterNode [-Backplane <String>] [-Delay <Int32>] -Ipaddress <String> [-NodeGroup <String>]
 [-Nodeid] <Int32> [-Priority <Int32>] [-State <String>] [-TunnelMode <String>] [-Session <PSObject>]
...
### -Ipaddress
Citrix ADC IP (NSIP) address of the appliance to add to the cluster.
