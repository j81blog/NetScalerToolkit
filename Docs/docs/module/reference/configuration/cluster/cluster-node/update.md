...
```
Invoke-NSUpdateClusterNode [-Backplane <String>] [-Delay <Int32>] [-Nodeid] <Int32> [-Priority <Int32>]
 [-State <String>] [-TunnelMode <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
