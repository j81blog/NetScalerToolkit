...
```powershell
Invoke-NSDeleteClusterNode -Nodeid <Int32> [-ClearnodeGroupConfig <String>] [-Force <Boolean>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
