...
```
Invoke-NSAddClusterInstance [-Backplanebasedview <String>] [-CLID] <Int32> [-ClusterProxyArp <String>]
 [-DeadInterval <Int32>] [-DfdRetainL2params <String>] [-HelloInterval <Int32>] [-Inc <String>]
 [-Preemption <String>] [-ProcessLocal <String>] [-QuorumType <String>] [-RetainConnectionsOnCluster <String>]
 [-Secureheartbeats <String>] [-SyncstatusstrictMode <String>] [-Session <PSObject>] [-IgnoreNotFound]
