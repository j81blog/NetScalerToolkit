...
### All (Default)
```
Invoke-NSGetClusterNodeGroupGSLBVServerBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetClusterNodeGroupGSLBVServerBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
