...
### All (Default)
```
Invoke-NSGetClusterPropstatus [-Filter <Hashtable>] [-ViewSummary] [-Nodeid <Int32>] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetClusterPropstatus [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
