...
### All (Default)
```
Invoke-NSGetClusterNodeGroupVPNVServerBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetClusterNodeGroupVPNVServerBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
