...
## SYNOPSIS
Creates a NetScaler vlan_nsip_binding resource.

## SYNTAX

```
Invoke-NSAddVlanIPBinding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>] [-OwnerGroup <String>]
...
### EXAMPLE 1
```
Invoke-NSAddVlanIPBinding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVlanIPBinding -Id 1 -WhatIf
```
