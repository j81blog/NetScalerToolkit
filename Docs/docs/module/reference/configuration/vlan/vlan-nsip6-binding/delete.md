...
## SYNOPSIS
Removes a NetScaler vlan_nsip6_binding resource.

## SYNTAX

```
Invoke-NSDeleteVlanNSIP6Binding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteVlanNSIP6Binding -Id 1 -Ipaddress 'example' -NetMask '255.255.255.255' -OwnerGroup 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetVlanNSIP6Binding -Id 'vlan_nsip6_binding_example' | Invoke-NSDeleteVlanNSIP6Binding -Confirm:$false
```
