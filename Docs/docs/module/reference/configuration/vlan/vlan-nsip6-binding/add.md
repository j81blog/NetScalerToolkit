...
## SYNOPSIS
Creates a NetScaler vlan_nsip6_binding resource.

## SYNTAX

```
Invoke-NSAddVlanNSIP6Binding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>] [-OwnerGroup <String>]
...
### EXAMPLE 1
```
Invoke-NSAddVlanNSIP6Binding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVlanNSIP6Binding -Id 1 -WhatIf
```
