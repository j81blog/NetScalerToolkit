...
## SYNOPSIS
Removes a NetScaler vlan_linkset_binding resource.

## SYNTAX

```
Invoke-NSDeleteVlanLinkSetBinding [-Id] <Int32> [-Ifnum <String>] [-Tagged <Boolean>] [-OwnerGroup <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteVlanLinkSetBinding -Id 1 -Ifnum 'example' -Tagged $true -OwnerGroup 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetVlanLinkSetBinding -Id 'vlan_linkset_binding_example' | Invoke-NSDeleteVlanLinkSetBinding -Confirm:$false
```
