...
## SYNOPSIS
Removes a NetScaler vlan_channel_binding resource.

## SYNTAX

```
Invoke-NSDeleteVlanChannelBinding [-Id] <Int32> [-Ifnum <String>] [-Tagged <Boolean>] [-OwnerGroup <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteVlanChannelBinding -Id 1 -Ifnum 'example' -Tagged $true -OwnerGroup 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetVlanChannelBinding -Id 'vlan_channel_binding_example' | Invoke-NSDeleteVlanChannelBinding -Confirm:$false
```
