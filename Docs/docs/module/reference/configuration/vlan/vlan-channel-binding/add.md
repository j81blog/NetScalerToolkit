...
## SYNOPSIS
Creates a NetScaler vlan_channel_binding resource.

## SYNTAX

```
Invoke-NSAddVlanChannelBinding [-Id] <Int32> [-Ifnum <String>] [-OwnerGroup <String>] [-Tagged <Boolean>]
...
### EXAMPLE 1
```
Invoke-NSAddVlanChannelBinding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVlanChannelBinding -Id 1 -WhatIf
```
