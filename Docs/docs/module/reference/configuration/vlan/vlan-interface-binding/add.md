...
## SYNOPSIS
Creates a NetScaler vlan_interface_binding resource.

## SYNTAX

```
Invoke-NSAddVlanInterfaceBinding [-Id] <Int32> [-Ifnum <String>] [-OwnerGroup <String>] [-Tagged <Boolean>]
...
### EXAMPLE 1
```
Invoke-NSAddVlanInterfaceBinding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVlanInterfaceBinding -Id 1 -WhatIf
```
