...
## SYNOPSIS
Removes a NetScaler vlan_interface_binding resource.

## SYNTAX

```
Invoke-NSDeleteVlanInterfaceBinding [-Id] <Int32> [-Ifnum <String>] [-Tagged <Boolean>] [-OwnerGroup <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteVlanInterfaceBinding -Id 1 -Ifnum 'example' -Tagged $true -OwnerGroup 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetVlanInterfaceBinding -Id 'vlan_interface_binding_example' | Invoke-NSDeleteVlanInterfaceBinding -Confirm:$false
```
