...
# Invoke-NSDeleteVxlanNSIP6Binding

## SYNOPSIS
Removes a NetScaler vxlan_nsip6_binding resource.

## SYNTAX

```
Invoke-NSDeleteVxlanNSIP6Binding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSDeleteVxlanNSIP6Binding -Id 1 -Ipaddress 'example' -NetMask '255.255.255.255' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetVxlanNSIP6Binding -Id 'vxlan_nsip6_binding_example' | Invoke-NSDeleteVxlanNSIP6Binding -Confirm:$false
```
