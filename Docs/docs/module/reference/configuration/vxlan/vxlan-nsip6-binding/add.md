...
# Invoke-NSAddVxlanNSIP6Binding

## SYNOPSIS
Creates a NetScaler vxlan_nsip6_binding resource.

## SYNTAX

```
Invoke-NSAddVxlanNSIP6Binding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddVxlanNSIP6Binding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVxlanNSIP6Binding -Id 1 -WhatIf
```
