...
# Invoke-NSAddVxlanIPBinding

## SYNOPSIS
Creates a NetScaler vxlan_nsip_binding resource.

## SYNTAX

```
Invoke-NSAddVxlanIPBinding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddVxlanIPBinding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVxlanIPBinding -Id 1 -WhatIf
```
