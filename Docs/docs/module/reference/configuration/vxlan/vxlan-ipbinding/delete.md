...
# Invoke-NSDeleteVxlanIPBinding

## SYNOPSIS
Removes a NetScaler vxlan_nsip_binding resource.

## SYNTAX

```
Invoke-NSDeleteVxlanIPBinding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSDeleteVxlanIPBinding -Id 1 -Ipaddress 'example' -NetMask '255.255.255.255' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetVxlanIPBinding -Id 'vxlan_nsip_binding_example' | Invoke-NSDeleteVxlanIPBinding -Confirm:$false
```
