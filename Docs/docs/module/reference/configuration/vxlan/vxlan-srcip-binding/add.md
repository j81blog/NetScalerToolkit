...
# Invoke-NSAddVxlanSrcipBinding

## SYNOPSIS
Creates a NetScaler vxlan_srcip_binding resource.

## SYNTAX

```
Invoke-NSAddVxlanSrcipBinding [-Id] <Int32> [-Srcip <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddVxlanSrcipBinding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVxlanSrcipBinding -Id 1 -WhatIf
```
