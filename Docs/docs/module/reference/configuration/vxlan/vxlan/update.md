...
## SYNOPSIS
Updates a NetScaler vxlan resource.

## SYNTAX

```
Invoke-NSUpdateVxlan [-Dynamicrouting <String>] [-Id] <Int32> [-Innervlantagging <String>]
 [-IPv6Dynamicrouting <String>] [-Port <Int32>] [-Vlan <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateVxlan -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateVxlan -Id 1 -WhatIf
```
