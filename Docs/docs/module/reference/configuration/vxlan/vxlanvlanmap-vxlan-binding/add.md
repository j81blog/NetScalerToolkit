...
## SYNOPSIS
Creates a NetScaler vxlanvlanmap_vxlan_binding resource.

## SYNTAX

```
Invoke-NSAddVxlanvlanmapVxlanBinding [-Name] <String> [-Vlan <String[]>] [-Vxlan <Int32>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddVxlanvlanmapVxlanBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVxlanvlanmapVxlanBinding -Name 'example' -WhatIf
```
