...
## SYNOPSIS
Clears one or more NetScaler vrid6 resource properties.

## SYNTAX

```
Invoke-NSUnsetVrid6 [-Id] <Int32> [-Ownernode] [-Preemption] [-Preemptiondelaytimer] [-Priority] [-Sharing]
...
### EXAMPLE 1
```
Invoke-NSUnsetVrid6 -Id 1 -Ownernode  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetVrid6 -Id 1 -Ownernode  -WhatIf
```
