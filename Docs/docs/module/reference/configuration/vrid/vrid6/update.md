...
## SYNOPSIS
Updates a NetScaler vrid6 resource.

## SYNTAX

```
Invoke-NSUpdateVrid6 [-Id] <Int32> [-Ownernode <Int32>] [-Preemption <String>] [-Preemptiondelaytimer <Int32>]
...
### EXAMPLE 1
```
Invoke-NSUpdateVrid6 -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateVrid6 -Id 1 -WhatIf
```
