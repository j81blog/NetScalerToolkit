...
```powershell
Invoke-NSDeleteVrid6 -Id <Int32> [-All <Boolean>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
