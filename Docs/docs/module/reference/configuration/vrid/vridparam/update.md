...
## SYNOPSIS
Updates a NetScaler vridparam resource.

## SYNTAX

```
Invoke-NSUpdateVridparam [[-DeadInterval] <Int32>] [[-HelloInterval] <Int32>] [[-Sendtomaster] <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateVridparam  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateVridparam  -WhatIf
```
