...
# Invoke-NSUnsetVridparam

## SYNOPSIS
Clears one or more NetScaler vridparam resource properties.

## SYNTAX

```
Invoke-NSUnsetVridparam [-DeadInterval] [-HelloInterval] [-Sendtomaster] [[-Session] <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUnsetVridparam -DeadInterval  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetVridparam -DeadInterval  -WhatIf
```
...
Default value: 1000 Minimum value = 200 Maximum value = 1000
