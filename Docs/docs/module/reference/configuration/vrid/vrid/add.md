...
## SYNOPSIS
Creates a NetScaler vrid resource.

## SYNTAX

```
Invoke-NSAddVrid [-Id] <Int32> [-Ownernode <Int32>] [-Preemption <String>] [-Preemptiondelaytimer <Int32>]
...
### EXAMPLE 1
```
Invoke-NSAddVrid -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVrid -Id 1 -WhatIf
```
