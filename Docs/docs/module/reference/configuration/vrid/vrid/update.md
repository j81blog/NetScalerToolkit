...
## SYNOPSIS
Updates a NetScaler vrid resource.

## SYNTAX

```
Invoke-NSUpdateVrid [-Id] <Int32> [-Ownernode <Int32>] [-Preemption <String>] [-Preemptiondelaytimer <Int32>]
...
### EXAMPLE 1
```
Invoke-NSUpdateVrid -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateVrid -Id 1 -WhatIf
```
