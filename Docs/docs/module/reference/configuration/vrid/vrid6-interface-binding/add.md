...
## SYNOPSIS
Creates a NetScaler vrid6_interface_binding resource.

## SYNTAX

```
Invoke-NSAddVrid6InterfaceBinding [-Id] <Int32> [-Ifnum <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddVrid6InterfaceBinding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVrid6InterfaceBinding -Id 1 -WhatIf
```
