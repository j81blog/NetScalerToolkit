...
# Invoke-NSAddVrid6ChannelBinding

## SYNOPSIS
Creates a NetScaler vrid6_channel_binding resource.

## SYNTAX

```
Invoke-NSAddVrid6ChannelBinding [-Id] <Int32> [-Ifnum <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddVrid6ChannelBinding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVrid6ChannelBinding -Id 1 -WhatIf
```
