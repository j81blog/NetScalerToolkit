...
## SYNOPSIS
Updates a NetScaler nspbr6 resource.

## SYNTAX

```
Invoke-NSUpdatePBR6 [-Action <String>] [-Destipop <String>] [-DestIPv6 <Boolean>] [-DestIPv6Val <String>]
 ...
 [-Nexthopval <String>] [-Nexthopvlan <Int32>] [-Priority <Int32>] [-Protocol <String>]
 [-ProtocolNumber <Int32>] [-Srcipop <String>] [-SrcIPv6 <Boolean>] [-SrcIPv6Val <String>] [-Srcmac <String>]
 [-SrcmacMask <String>] [-SrcPort <Boolean>] [-SrcPortOp <String>] [-SrcPortVal <String>] [-Vlan <Int32>]
...
### EXAMPLE 1
```
Invoke-NSUpdatePBR6 -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdatePBR6 -Name 'example' -WhatIf
```
