...
## SYNOPSIS
Enables a NetScaler nspbr6 resource.

## SYNTAX

```
Invoke-NSEnablePBR6 [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnablePBR6 -Name 'nspbr6_example' -PassThru
```
