...
## SYNOPSIS
Disables a NetScaler nspbr6 resource.

## SYNTAX

```
Invoke-NSDisablePBR6 [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisablePBR6 -Name 'nspbr6_example' -PassThru
```
