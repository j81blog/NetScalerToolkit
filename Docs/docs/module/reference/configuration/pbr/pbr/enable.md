...
## SYNOPSIS
Enables a NetScaler nspbr resource.

## SYNTAX

```
Invoke-NSEnablePBR [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnablePBR -Name 'nspbr_example' -PassThru
```
