...
## SYNOPSIS
Clears one or more NetScaler nspbr resource properties.

## SYNTAX

```
Invoke-NSUnsetPBR [-Name] <String> [-Destip] [-DestPort] [-Interface] [-IPTunnel] [-MonItor] [-Msr] [-Nexthop]
 [-Protocol] [-Srcip] [-Srcmac] [-SrcmacMask] [-SrcPort] [-Targettd] [-Vlan] [-Vxlan] [-Vxlanvlanmap]
...
### EXAMPLE 1
```
Invoke-NSUnsetPBR -Name 'example' -Destip  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetPBR -Name 'example' -Destip  -WhatIf
```
