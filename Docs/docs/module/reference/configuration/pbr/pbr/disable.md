...
## SYNOPSIS
Disables a NetScaler nspbr resource.

## SYNTAX

```
Invoke-NSDisablePBR [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisablePBR -Name 'nspbr_example' -PassThru
```
