...
```
Invoke-NSAddSNMPTrapSNMPUserBinding [-Securitylevel <String>] [-TrafficDomain <Int32>] [-TrapClass] <String>
 -TrapDestination <String> -UserName <String> [-Version <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
Default value: authNoPriv, Possible values = noAuthNoPriv, authNoPriv, authPriv
