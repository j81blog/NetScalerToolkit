...
```
Invoke-NSDeleteSNMPTrapSNMPUserBinding [-TrapClass] <String> -TrapDestination <String> [-TrafficDomain <Int32>]
 [-Version <String>] -UserName <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
