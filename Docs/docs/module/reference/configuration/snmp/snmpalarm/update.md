...
```
Invoke-NSUpdateSNMPAlarm [-Logging <String>] [-Normalvalue <Int32>] [-Severity <String>] [-State <String>]
 [-ThresholdValue <Int32>] [-Time <Int32>] [-TrapName] <String> [-Session <PSObject>] [-IgnoreNotFound]
