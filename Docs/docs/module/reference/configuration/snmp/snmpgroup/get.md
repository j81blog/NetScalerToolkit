...
### All (Default)
```
Invoke-NSGetSNMPGroup [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSNMPGroup [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
