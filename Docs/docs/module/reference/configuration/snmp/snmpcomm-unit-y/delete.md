...
```
Invoke-NSDeleteSNMPCommUnitY [-CommUnitYName] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
Can consist of 1 to 32 characters that include uppercase and lowercase letters,numbers and special characters.
