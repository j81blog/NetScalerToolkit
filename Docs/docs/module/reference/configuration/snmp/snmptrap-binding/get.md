...
```
Invoke-NSGetSNMPTrapBinding [-Filter <Hashtable>] [-ViewSummary] [-Version <String>] [-TrapClass <String>]
 [-TrapDestination <String>] [-TrafficDomain <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
