...
### All (Default)
```
Invoke-NSGetSNMPManager [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSNMPManager [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
