...
```
Invoke-NSUnsetSNMPTrap [-TrapClass] <String> [-AllPartitionS] [-CommUnitYName] [-DestPort] [-Severity] [-Srcip]
 [-TrafficDomain] [-TrapDestination] [-Version] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
