...
# Invoke-NSDeleteMAPBMR

## SYNOPSIS
Removes a NetScaler mapbmr resource.

## SYNTAX

```
Invoke-NSDeleteMAPBMR [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteMAPBMR -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetMAPBMR -Name 'mapbmr_example' | Invoke-NSDeleteMAPBMR -Confirm:$false
```
