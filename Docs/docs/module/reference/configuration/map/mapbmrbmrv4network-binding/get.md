...
## SYNOPSIS
Gets NetScaler mapbmr_bmrv4network_binding configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetMAPBMRBmrv4networkBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetMAPBMRBmrv4networkBinding [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetMAPBMRBmrv4networkBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetMAPBMRBmrv4networkBinding -Name 'mapbmr_bmrv4network_binding_example'
```

### EXAMPLE 3
```
Invoke-NSGetMAPBMRBmrv4networkBinding -Filter @{ servicetype = 'HTTP' }
```
