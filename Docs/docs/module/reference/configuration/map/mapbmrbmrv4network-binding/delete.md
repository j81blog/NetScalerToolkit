...
## SYNOPSIS
Removes a NetScaler mapbmr_bmrv4network_binding resource.

## SYNTAX

```
Invoke-NSDeleteMAPBMRBmrv4networkBinding [-Name] <String> -Network <String> [-NetMask <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteMAPBMRBmrv4networkBinding -Name 'example' -Network 'example' -NetMask '255.255.255.255' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetMAPBMRBmrv4networkBinding -Name 'mapbmr_bmrv4network_binding_example' | Invoke-NSDeleteMAPBMRBmrv4networkBinding -Confirm:$false
```
