...
## SYNOPSIS
Creates a NetScaler mapbmr_bmrv4network_binding resource.

## SYNTAX

```
Invoke-NSAddMAPBMRBmrv4networkBinding [-Name] <String> [-NetMask <String>] -Network <String>
...
### EXAMPLE 1
```
Invoke-NSAddMAPBMRBmrv4networkBinding -Name 'example' -Network 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddMAPBMRBmrv4networkBinding -Name 'example' -Network 'example' -WhatIf
```
