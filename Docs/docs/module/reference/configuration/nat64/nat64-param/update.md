...
## SYNOPSIS
Updates a NetScaler nat64param resource.

## SYNTAX

```
Invoke-NSUpdateNAT64Param [-Nat64fragHeader <String>] [-Nat64ignoretos <String>] [-Nat64v6mtu <Int32>]
 [-Nat64zerochecksum <String>] [[-TrafficDomain] <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateNAT64Param -TrafficDomain 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNAT64Param -TrafficDomain 1 -WhatIf
```
