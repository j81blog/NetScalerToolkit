...
# Invoke-NSDeleteNAT64

## SYNOPSIS
Removes a NetScaler nat64 resource.

## SYNTAX

```
Invoke-NSDeleteNAT64 [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteNAT64 -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetNAT64 -Name 'nat64_example' | Invoke-NSDeleteNAT64 -Confirm:$false
```
