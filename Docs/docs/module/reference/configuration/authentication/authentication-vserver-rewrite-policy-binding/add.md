...
## SYNOPSIS
Creates a NetScaler authenticationvserver_rewritepolicy_binding resource.

## SYNTAX

```
Invoke-NSAddAuthenticationVServerRewritePolicyBinding [-Bindpoint <String>] [-GotoPriorityExpression <String>]
 [-GroupExtrAction <Boolean>] [-Name] <String> [-Nextfactor <String>] [-Policy <String>] [-Priority <Int32>]
 [-Secondary <Boolean>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
...
### EXAMPLE 1
```
Invoke-NSAddAuthenticationVServerRewritePolicyBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAuthenticationVServerRewritePolicyBinding -Name 'example' -WhatIf
```
