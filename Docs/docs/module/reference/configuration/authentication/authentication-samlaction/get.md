...
## SYNOPSIS
Gets NetScaler authenticationsamlaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationSAMLAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationSAMLAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationSAMLAction [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationSAMLAction -Name 'authenticationsamlaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationSAMLAction -Filter @{ servicetype = 'HTTP' }
```
