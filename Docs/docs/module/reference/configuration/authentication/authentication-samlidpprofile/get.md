...
## SYNOPSIS
Gets NetScaler authenticationsamlidpprofile configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationSAMLIDPProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationSAMLIDPProfile [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationSAMLIDPProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationSAMLIDPProfile -Name 'authenticationsamlidpprofile_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationSAMLIDPProfile -Filter @{ servicetype = 'HTTP' }
```
