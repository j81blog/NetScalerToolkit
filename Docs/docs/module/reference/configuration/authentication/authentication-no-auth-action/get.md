...
## SYNOPSIS
Gets NetScaler authenticationnoauthaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationNoAuthAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationNoAuthAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationNoAuthAction [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationNoAuthAction -Name 'authenticationnoauthaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationNoAuthAction -Filter @{ servicetype = 'HTTP' }
```
