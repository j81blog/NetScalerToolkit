...
## SYNOPSIS
Updates a NetScaler authenticationnegotiateaction resource.

## SYNTAX

```
Invoke-NSUpdateAuthenticationNegotiateAction [-DefaultAuthenticationGroup <String>] [-Domain <String>]
 [-DomainUser <String>] [-DomainUserPasswd <String>] [-KeyTab <String>] [-Name] <String> [-Ntlmpath <String>]
 [-Ou <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [-PassThru]
...
### EXAMPLE 1
```
Invoke-NSUpdateAuthenticationNegotiateAction -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateAuthenticationNegotiateAction -Name 'example' -WhatIf
```
...
### -KeyTab
The path to the keytab file that is used to decrypt kerberos tickets presented to Citrix ADC.
If keytab is not available, domain/username/password can be specified in the negotiate action configuration.
Minimum length = 1
