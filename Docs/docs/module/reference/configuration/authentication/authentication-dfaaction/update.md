...
## SYNOPSIS
Updates a NetScaler authenticationdfaaction resource.

## SYNTAX

```
Invoke-NSUpdateAuthenticationDFAAction [-ClientId <String>] [-DefaultAuthenticationGroup <String>]
 [-Name] <String> [-Passphrase <String>] [-ServerURL <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateAuthenticationDFAAction -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateAuthenticationDFAAction -Name 'example' -WhatIf
```
