...
## SYNOPSIS
Gets NetScaler authenticationemailaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationEmailAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationEmailAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationEmailAction [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationEmailAction -Name 'authenticationemailaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationEmailAction -Filter @{ servicetype = 'HTTP' }
```
