...
## SYNOPSIS
Gets NetScaler authenticationcertaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationCertAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationCertAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationCertAction [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationCertAction -Name 'authenticationcertaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationCertAction -Filter @{ servicetype = 'HTTP' }
```
