...
## SYNOPSIS
Gets NetScaler authenticationadfsproxyprofile configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationADFSProxyProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationADFSProxyProfile [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationADFSProxyProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationADFSProxyProfile -Name 'authenticationadfsproxyprofile_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationADFSProxyProfile -Filter @{ servicetype = 'HTTP' }
```
