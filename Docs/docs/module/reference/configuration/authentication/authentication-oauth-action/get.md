...
## SYNOPSIS
Gets NetScaler authenticationoauthaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationOAuthAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationOAuthAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationOAuthAction [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationOAuthAction -Name 'authenticationoauthaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationOAuthAction -Filter @{ servicetype = 'HTTP' }
```
