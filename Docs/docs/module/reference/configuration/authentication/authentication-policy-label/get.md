...
## SYNOPSIS
Gets NetScaler authenticationpolicylabel configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationPolicyLabel [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationPolicyLabel [-LabelName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationPolicyLabel [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationPolicyLabel -LabelName 'authenticationpolicylabel_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationPolicyLabel -Filter @{ servicetype = 'HTTP' }
```
