...
## SYNOPSIS
Updates a NetScaler authenticationcitrixauthaction resource.

## SYNTAX

```
Invoke-NSUpdateAuthenticationCitrixAuthAction [-Authentication <String>] [-AuthenticationType <String>]
 [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [-PassThru]
...
### EXAMPLE 1
```
Invoke-NSUpdateAuthenticationCitrixAuthAction -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateAuthenticationCitrixAuthAction -Name 'example' -WhatIf
```
...
### -AuthenticationType
Type of the Citrix Authentication implementation.
Default implementation uses Citrix Cloud Connector.
Default value: CITRIXCONNECTOR Possible values = CITRIXCONNECTOR, ATHENA
