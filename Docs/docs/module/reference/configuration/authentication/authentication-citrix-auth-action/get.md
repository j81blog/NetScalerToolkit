...
## SYNOPSIS
Gets NetScaler authenticationcitrixauthaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationCitrixAuthAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationCitrixAuthAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationCitrixAuthAction [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationCitrixAuthAction -Name 'authenticationcitrixauthaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationCitrixAuthAction -Filter @{ servicetype = 'HTTP' }
```
