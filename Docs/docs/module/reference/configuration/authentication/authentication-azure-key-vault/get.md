...
## SYNOPSIS
Gets NetScaler authenticationazurekeyvault configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationAzureKeyVault [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationAzureKeyVault [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationAzureKeyVault [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationAzureKeyVault -Name 'authenticationazurekeyvault_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationAzureKeyVault -Filter @{ servicetype = 'HTTP' }
```
