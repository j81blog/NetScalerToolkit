...
## SYNOPSIS
Updates a NetScaler authenticationazurekeyvault resource.

## SYNTAX

```
Invoke-NSUpdateAuthenticationAzureKeyVault [-Authentication <String>] [-ClientId <String>]
 [-ClientsEcret <String>] [-DefaultAuthenticationGroup <String>] [-Name] <String> [-PushService <String>]
 [-RefreshInterval <Int32>] [-ServiceKeyName <String>] [-SignatureAlg <String>] [-Tenantid <String>]
 [-Tokenendpoint <String>] [-VaultName <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateAuthenticationAzureKeyVault -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateAuthenticationAzureKeyVault -Name 'example' -WhatIf
```
