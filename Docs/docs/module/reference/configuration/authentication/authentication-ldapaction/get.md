...
## SYNOPSIS
Gets NetScaler authenticationldapaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationLDAPAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationLDAPAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationLDAPAction [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationLDAPAction -Name 'authenticationldapaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationLDAPAction -Filter @{ servicetype = 'HTTP' }
```
