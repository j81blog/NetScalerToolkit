...
## SYNOPSIS
Gets NetScaler authenticationoauthidppolicy configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationOAuthIDPPolicy [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationOAuthIDPPolicy [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationOAuthIDPPolicy [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationOAuthIDPPolicy -Name 'authenticationoauthidppolicy_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationOAuthIDPPolicy -Filter @{ servicetype = 'HTTP' }
```
