...
## SYNOPSIS
Gets NetScaler authenticationoauthidpprofile configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationOAuthIDPProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationOAuthIDPProfile [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationOAuthIDPProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationOAuthIDPProfile -Name 'authenticationoauthidpprofile_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationOAuthIDPProfile -Filter @{ servicetype = 'HTTP' }
```
