...
## SYNOPSIS
Creates a NetScaler authenticationcaptchaaction resource.

## SYNTAX

```
Invoke-NSAddAuthenticationCaptchaAction [-DefaultAuthenticationGroup <String>] [-Name] <String>
 [-ScoreThreshold <Int32>] -SecretKey <String> [-ServerURL <String>] -SiteKey <String> [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddAuthenticationCaptchaAction -Name 'example' -SecretKey 'example' -SiteKey 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAuthenticationCaptchaAction -Name 'example' -SecretKey 'example' -SiteKey 'example' -WhatIf
```
...
Default value: 5 Minimum value = 0 Maximum value = 10
