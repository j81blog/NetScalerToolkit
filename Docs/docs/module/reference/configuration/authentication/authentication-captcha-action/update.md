...
## SYNOPSIS
Updates a NetScaler authenticationcaptchaaction resource.

## SYNTAX

```
Invoke-NSUpdateAuthenticationCaptchaAction [-DefaultAuthenticationGroup <String>] [-Name] <String>
 [-ScoreThreshold <Int32>] [-SecretKey <String>] [-ServerURL <String>] [-SiteKey <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateAuthenticationCaptchaAction -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateAuthenticationCaptchaAction -Name 'example' -WhatIf
```
