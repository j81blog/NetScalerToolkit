...
## SYNOPSIS
Gets NetScaler authenticationcaptchaaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationCaptchaAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationCaptchaAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationCaptchaAction [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationCaptchaAction -Name 'authenticationcaptchaaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationCaptchaAction -Filter @{ servicetype = 'HTTP' }
```
