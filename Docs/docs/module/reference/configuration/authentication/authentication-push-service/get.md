...
## SYNOPSIS
Gets NetScaler authenticationpushservice configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAuthenticationPushService [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuthenticationPushService [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuthenticationPushService [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAuthenticationPushService -Name 'authenticationpushservice_example'
```

### EXAMPLE 3
```
Invoke-NSGetAuthenticationPushService -Filter @{ servicetype = 'HTTP' }
```
