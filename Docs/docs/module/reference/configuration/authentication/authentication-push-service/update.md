...
## SYNOPSIS
Updates a NetScaler authenticationpushservice resource.

## SYNTAX

```
Invoke-NSUpdateAuthenticationPushService [-ClientId <String>] [-ClientsEcret <String>] [-CustomErid <String>]
 [-Name] <String> [-RefreshInterval <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateAuthenticationPushService -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateAuthenticationPushService -Name 'example' -WhatIf
```
