...
```
Invoke-NSImportResponderHTMLPage [-CaCertFile <String>] [-Comment <String>] [-Name] <String>
...
The certificate should be imported using "import ssl certfile" CLI command or equivalent in API or GUI.
If certificate name is not configured, then default root CA certificates are used for peer's certificate verification.
