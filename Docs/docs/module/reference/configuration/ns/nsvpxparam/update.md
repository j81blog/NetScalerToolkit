...
## SYNOPSIS
Updates a NetScaler nsvpxparam resource.

## SYNTAX

```
Invoke-NSUpdateNsvpxparam [[-Cpuyield] <String>] [[-KvmvirtioMultiQueue] <String>]
 [[-Masterclockcpu1] <String>] [[-Ownernode] <Int32>] [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateNsvpxparam  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNsvpxparam  -WhatIf
```
