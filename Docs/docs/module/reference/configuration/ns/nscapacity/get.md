...
## SYNOPSIS
Gets NetScaler nscapacity configuration.

## SYNTAX

```
Invoke-NSGetNscapacity [-Filter <Hashtable>] [-ViewSummary] [-Ignoreexpiry] [-Nodeid <Int32>]
...
### EXAMPLE 2
```
Invoke-NSGetNscapacity -Filter @{ servicetype = 'HTTP' }
```
