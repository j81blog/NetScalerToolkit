...
## SYNOPSIS
Updates a NetScaler nslicenseparameters resource.

## SYNTAX

```
Invoke-NSUpdateNslicenseparameters [[-Alert1graceTimeout] <Int32>] [[-Alert2graceTimeout] <Int32>]
 [[-HeartbeatInterval] <Int32>] [[-InventoryrefreshInterval] <Int32>] [[-Licenseexpiryalerttime] <Int32>]
...
### EXAMPLE 1
```
Invoke-NSUpdateNslicenseparameters  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNslicenseparameters  -WhatIf
```
