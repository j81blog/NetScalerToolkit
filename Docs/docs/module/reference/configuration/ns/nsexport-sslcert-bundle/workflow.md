...
# Invoke-NSExportSSLCertBundle

## SYNOPSIS
Exports NetScaler sslcertbundle data.

## SYNTAX

```
Invoke-NSExportSSLCertBundle [-Name] <String> [-Src] <String> [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSExportSSLCertBundle -Name 'example' -Src 'example'
```

### EXAMPLE 2
```
Invoke-NSExportSSLCertBundle -Name 'example' -Src 'example' -WhatIf
```

## PARAMETERS

### -Name
Name to assign to the imported certificate bundle.
...
### -Src
URL specifying the protocol, host, and path, including file name, to the certificate bundle to be imported or exported.
For example, http://www.example.com/cert_bundle_file.
