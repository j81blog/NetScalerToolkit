...
# Invoke-NSImportAppFwSignatures

## SYNOPSIS
Imports NetScaler appfwsignatures data.

## SYNTAX

```
Invoke-NSImportAppFwSignatures [-Action <String[]>] [-AutoenablenewSignatures <String>] [-Category <String>]
 [-Comment <String>] [-Enabled <String>] [-Merge <Boolean>] [-Name] <String> [-Overwrite <Boolean>]
 [-PreservedefActionS <Boolean>] [-Ruleid <String>] [-Sha1 <String>] -Src <String> [-VendorType <String>]
 [-Xslt <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [-WhatIf]
...
### EXAMPLE 1
```
Invoke-NSImportAppFwSignatures -Name 'example' -Src 'example'
```

### EXAMPLE 2
```
Invoke-NSImportAppFwSignatures -Name 'example' -Src 'example' -WhatIf
```
...
Minimum value = 1 Maximum value = 2000000
