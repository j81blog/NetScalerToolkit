...
## SYNOPSIS
Updates a NetScaler nsdhcpparams resource.

## SYNTAX

```
Invoke-NSUpdateNsdhcpparams [[-DhcpClient] <String>] [[-Saveroute] <String>] [[-Session] <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUpdateNsdhcpparams  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNsdhcpparams  -WhatIf
```
