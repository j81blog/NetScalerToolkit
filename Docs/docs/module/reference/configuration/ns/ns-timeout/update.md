...
# Invoke-NSUpdateNsTimeout

## SYNOPSIS
Updates a NetScaler nstimeout resource.

## SYNTAX

```
Invoke-NSUpdateNsTimeout [[-AnyClient] <Int32>] [[-AnyServer] <Int32>] [[-AnyTCPClient] <Int32>]
 [[-AnyTCPServer] <Int32>] [[-Client] <Int32>] [[-Halfclose] <Int32>] [[-HTTPClient] <Int32>]
 [[-HTTPSErver] <Int32>] [[-NewConnIdleTimeout] <Int32>] [[-NonTCPZombie] <Int32>]
 [[-ReducedfinTimeout] <Int32>] [[-ReducedrstTimeout] <Int32>] [[-Server] <Int32>] [[-TCPClient] <Int32>]
 [[-TCPServer] <Int32>] [[-Zombie] <Int32>] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateNsTimeout  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNsTimeout  -WhatIf
```
