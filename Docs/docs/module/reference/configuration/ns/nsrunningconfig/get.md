...
## SYNOPSIS
Gets NetScaler nsrunningconfig configuration.

## SYNTAX

```
Invoke-NSGetNsrunningconfig [-Filter <Hashtable>] [-ViewSummary] [-Withdefaults] [-Session <PSObject>]
...
### EXAMPLE 2
```
Invoke-NSGetNsrunningconfig -Filter @{ servicetype = 'HTTP' }
```
