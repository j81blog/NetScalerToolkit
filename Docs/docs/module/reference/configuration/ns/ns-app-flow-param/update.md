...
# Invoke-NSUpdateNsAppFlowParam

## SYNOPSIS
Updates a NetScaler nsappflowparam resource.

## SYNTAX

```
Invoke-NSUpdateNsAppFlowParam [[-ClientTrafficonly] <String>] [[-HTTPCookie] <String>] [[-HTTPHost] <String>]
 [[-HTTPMethod] <String>] [[-HTTPReferer] <String>] [[-HTTPURL] <String>] [[-HTTPUserAgent] <String>]
 [[-Templaterefresh] <Int32>] [[-UDPPmtu] <Int32>] [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateNsAppFlowParam  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNsAppFlowParam  -WhatIf
```
