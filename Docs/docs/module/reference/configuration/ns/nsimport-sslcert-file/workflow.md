...
# Invoke-NSImportSSLCertFile

## SYNOPSIS
Imports NetScaler sslcertfile data.

## SYNTAX

```
Invoke-NSImportSSLCertFile [-Name] <String> [-Src] <String> [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSImportSSLCertFile -Name 'example' -Src 'example'
```

### EXAMPLE 2
```
Invoke-NSImportSSLCertFile -Name 'example' -Src 'example' -WhatIf
```

## PARAMETERS

### -Name
Name to assign to the imported certificate file.
...
### -Src
URL specifying the protocol, host, and path, including file name, to the certificate file to be imported.
For example, http://www.example.com/cert_file.
