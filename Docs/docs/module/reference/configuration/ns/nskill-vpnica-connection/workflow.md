...
# Invoke-NSKillVPNIcaConnection

## SYNOPSIS
Invokes the kill operation for a NetScaler vpnicaconnection resource.

## SYNTAX

```
Invoke-NSKillVPNIcaConnection [[-All] <Boolean>] [[-ProductName] <String>] [[-TenantName] <String>]
 [[-TransProto] <String>] [[-UserName] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 2
```
Invoke-NSKillVPNIcaConnection  -WhatIf
```
