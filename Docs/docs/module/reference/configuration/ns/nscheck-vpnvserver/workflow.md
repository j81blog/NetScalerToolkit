...
# Invoke-NSCheckVPNVServer

## SYNOPSIS
Invokes the check operation for a NetScaler vpnvserver resource.

## SYNTAX

```
Invoke-NSCheckVPNVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSCheckVPNVServer -Name 'example'
```

### EXAMPLE 2
```
Invoke-NSCheckVPNVServer -Name 'example' -WhatIf
```
