...
## SYNOPSIS
Invokes the send operation for a NetScaler arp resource.

## SYNTAX

```
Invoke-NSSendArp [-All <Boolean>] [[-Ipaddress] <String>] [-TrafficDomain <Int32>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSSendArp -Ipaddress 'example'
```

### EXAMPLE 2
```
Invoke-NSSendArp -Ipaddress 'example' -WhatIf
```
