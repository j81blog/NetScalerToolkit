...
# Invoke-NSImportSSLKeyFile

## SYNOPSIS
Imports NetScaler sslkeyfile data.

## SYNTAX

```
Invoke-NSImportSSLKeyFile [-Name] <String> [[-Password] <String>] [-Src] <String> [[-Session] <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSImportSSLKeyFile -Name 'example' -Src 'example'
```

### EXAMPLE 2
```
Invoke-NSImportSSLKeyFile -Name 'example' -Src 'example' -WhatIf
```

## PARAMETERS

### -Name
Name to assign to the imported key file.
...
For example, http://www.example.com/key_file.
