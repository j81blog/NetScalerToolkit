...
# Invoke-NSUpdateNsHTTPParam

## SYNOPSIS
Updates a NetScaler nshttpparam resource.

## SYNTAX

```
Invoke-NSUpdateNsHTTPParam [[-ConMultiPlex] <String>] [[-Dropinvalreqs] <String>] [[-HTTP2ServerSide] <String>]
 [[-IgnoreConnEctcodingscheme] <String>] [[-Insnssrvrhdr] <String>] [[-LogerrResponse] <String>]
 [[-MarkConnReqinval] <String>] [[-MarkHTTP09inval] <String>] [[-MaxReusepool] <Int32>] [[-Nssrvrhdr] <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateNsHTTPParam  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNsHTTPParam  -WhatIf
```
