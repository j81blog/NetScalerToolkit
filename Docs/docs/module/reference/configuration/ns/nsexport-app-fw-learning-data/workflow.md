...
```powershell
Invoke-NSExportAppFwLearningData -ProfileName <String> -Securitycheck <String> [-Target <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
