...
# Invoke-NSUpdateNSIP6

## SYNOPSIS
Updates a NetScaler nsip6 resource.

## SYNTAX

```
Invoke-NSUpdateNSIP6 [-AdvertiseondefaultPartition <String>] [-Decrementhoplimit <String>]
 ...
 [-Ospf6lsaType <String>] [-Ospfarea <Int32>] [-OwnerDownResponse <String>] [-Restrictaccess <String>]
 [-SNMP <String>] [-Ssh <String>] [-State <String>] [-Tag <Int32>] [-TrafficDomain <Int32>] [-Telnet <String>]
 [-Vrid6 <Int32>] [-VServer <String>] [-VServerRhilevel <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateNSIP6 -IPv6Address 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateNSIP6 -IPv6Address 'example' -WhatIf
```
