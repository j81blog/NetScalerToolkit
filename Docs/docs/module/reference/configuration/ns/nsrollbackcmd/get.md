...
## SYNOPSIS
Gets NetScaler nsrollbackcmd configuration.

## SYNTAX

```
Invoke-NSGetNsrollbackcmd [-Filter <Hashtable>] [-ViewSummary] [-FileName <String>] [-OutType <String>]
...
### EXAMPLE 2
```
Invoke-NSGetNsrollbackcmd -Filter @{ servicetype = 'HTTP' }
```
