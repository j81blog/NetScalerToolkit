...
# Invoke-NSDiffNSConfig

## SYNOPSIS
Invokes the diff operation for a NetScaler nsconfig resource.

## SYNTAX

```
Invoke-NSDiffNSConfig [[-Config1] <String>] [[-Config2] <String>] [[-IgnoredeviceSpecIfic] <Boolean>]
 [[-OutType] <String>] [[-Template] <Boolean>] [[-Session] <PSObject>] [-IgnoreNotFound]
