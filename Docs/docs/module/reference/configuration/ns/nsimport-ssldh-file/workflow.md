...
# Invoke-NSImportSSLDhFile

## SYNOPSIS
Imports NetScaler ssldhfile data.

## SYNTAX

```
Invoke-NSImportSSLDhFile [-Name] <String> [-Src] <String> [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSImportSSLDhFile -Name 'example' -Src 'example'
```

### EXAMPLE 2
```
Invoke-NSImportSSLDhFile -Name 'example' -Src 'example' -WhatIf
```

## PARAMETERS

### -Name
Name to assign to the imported DH file.
...
### -Src
URL specifying the protocol, host, and path, including file name, to the DH file to be imported.
For example, http://www.example.com/dh_file.
