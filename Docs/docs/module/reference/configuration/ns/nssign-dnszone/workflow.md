...
```
Invoke-NSSignDNSZone [-KeyName <String[]>] [-ZoneName] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### -KeyName
Name of the public/private DNS key pair with which to sign the zone.
You can sign a zone with up to four keys.
Minimum length = 1
