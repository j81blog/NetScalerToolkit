...
# Invoke-NSResetInterface

## SYNOPSIS
Resets NetScaler Interface data.

## SYNTAX

```
Invoke-NSResetInterface [-Id] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSResetInterface -Id 'example'
```

### EXAMPLE 2
```
Invoke-NSResetInterface -Id 'example' -WhatIf
```
