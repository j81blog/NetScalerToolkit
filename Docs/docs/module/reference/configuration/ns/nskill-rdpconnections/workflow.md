...
```powershell
Invoke-NSKillRDPConnections [-All <Boolean>] [-UserName <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
