...
# Invoke-NSImportSSLCrlFile

## SYNOPSIS
Imports NetScaler sslcrlfile data.

## SYNTAX

```
Invoke-NSImportSSLCrlFile [-Name] <String> [-Src] <String> [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSImportSSLCrlFile -Name 'example' -Src 'example'
```

### EXAMPLE 2
```
Invoke-NSImportSSLCrlFile -Name 'example' -Src 'example' -WhatIf
```

## PARAMETERS

### -Name
Name to assign to the imported CRL file.
...
### -Src
URL specifying the protocol, host, and path, including file name to the CRL file to be imported.
For example, http://www.example.com/crl_file.
