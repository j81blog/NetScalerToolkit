...
```
Invoke-NSImportAPISpecFile [-Name] <String> [-Overwrite <Boolean>] -Src <String> [-Session <PSObject>]
...
### -Name
Name to assign to the imported spec file.
...
### -Src
URL specifying the protocol, host, and path, including file name, to the spec file to be imported.
For example, http://www.example.com/spec_file.
