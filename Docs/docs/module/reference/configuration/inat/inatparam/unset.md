...
## SYNOPSIS
Clears one or more NetScaler inatparam resource properties.

## SYNTAX

```
Invoke-NSUnsetINATParam [-TrafficDomain] <Int32> [-Nat46v6prefix] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUnsetINATParam -TrafficDomain 1 -Nat46v6prefix  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetINATParam -TrafficDomain 1 -Nat46v6prefix  -WhatIf
```
