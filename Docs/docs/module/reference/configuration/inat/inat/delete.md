...
## SYNOPSIS
Removes a NetScaler inat resource.

## SYNTAX

```
Invoke-NSDeleteINAT [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteINAT -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetINAT -Name 'inat_example' | Invoke-NSDeleteINAT -Confirm:$false
```
