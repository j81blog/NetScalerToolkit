...
## SYNOPSIS
Updates a NetScaler inat resource.

## SYNTAX

```
Invoke-NSUpdateINAT [-ConnFailover <String>] [-Ftp <String>] [-Mode <String>] [-Name] <String>
 [-Privateip <String>] [-ProxyIp <String>] [-TCPProxy <String>] [-Tftp <String>] [-UseProxyPort <String>]
 [-USIP <String>] [-Usnip <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateINAT -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateINAT -Name 'example' -WhatIf
```
...
That is, synchronize all connection-related information for the INAT session.
...
### -Privateip
IP address of the server to which the packet is sent by the Citrix ADC.
