...
```
Invoke-NSUpdateRewriteParam [[-Timeout] <Int32>] [[-UndefAction] <String>] [[-Session] <PSObject>]
...
Available settings function as follows: * NOREWRITE - Do not modify the message.
