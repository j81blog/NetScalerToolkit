...
```
Invoke-NSUnsetDNSParameter [-AutosaveKeyOps] [-Cacheecszeroprefix] [-CachehitBypass] [-Cachenoexpire]
 [-CacheRecordS] [-DNS64Timeout] [-DNSRootreferral] [-DNSSec] [-EcsMaxSubnets] [-MaxCachesize]
 [-MaxNegativecachesize] [-MaxNegcachettl] [-MaxPipeline] [-MaxTtl] [-MaxUDPPacketsize] [-MinTtl]
 [-NameLookupPriority] [-NxdomainratelimitThreshold] [-Recursion] [-Resolutionorder]
 [-ResolverMaxActiveresolutions] [-ResolverMaxTCPConnectionS] [-ResolverMaxTCPTimeout] [-Retries]
 [-SplitpktqueryProcessIng] [-Zonetransfer] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
