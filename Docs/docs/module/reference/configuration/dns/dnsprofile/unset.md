...
```
Invoke-NSUnsetDNSProfile [-DNSProfileName] <String> [-CacheecsResponseS] [-CachenegativeResponseS]
 [-CacheRecordS] [-DNSAnswerseclogging] [-DNSErrorLogging] [-DNSExtendedlogging] [-DNSQuerylogging]
 [-DropMultiQueryRequest] [-InsertEcs] [-MaxCacheableEcsprefixLength] [-MaxCacheableEcsprefixLength6]
 [-Recursiveresolution] [-Replaceecs] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
