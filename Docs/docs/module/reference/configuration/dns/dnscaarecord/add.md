...
```
Invoke-NSAddDNSCAARecord [-Domain] <String> [-Flag <String>] [-Tag <String>] [-Ttl <Int32>]
 -Valuestring <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
