...
```
Invoke-NSUpdateDNSAction [-ActionName] <String> [-DNSProfileName <String>] [-Ipaddress <String[]>]
 [-PreferredloCLISt <String[]>] [-Ttl <Int32>] [-ViewName <String>] [-Session <PSObject>] [-IgnoreNotFound]
