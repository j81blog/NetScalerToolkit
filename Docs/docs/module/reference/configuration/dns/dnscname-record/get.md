...
### All (Default)
```
Invoke-NSGetDNSCNameRecord [-Filter <Hashtable>] [-ViewSummary] [-Type <String>] [-Nodeid <Int32>]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetDNSCNameRecord [-AliasName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetDNSCNameRecord [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
