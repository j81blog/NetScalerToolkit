...
```
Invoke-NSAddDNSAction64 [-ActionName] <String> [-Excluderule <String>] [-Mappedrule <String>] -Prefix <String>
...
Only if the mappedrule is evaluated to true the corresponding ipv4 address is used for synthesis using respective prefix, otherwise the A RR is discarded.
