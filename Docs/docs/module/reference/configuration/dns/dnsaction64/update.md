...
```
Invoke-NSUpdateDNSAction64 [-ActionName] <String> [-Excluderule <String>] [-Mappedrule <String>]
 [-Prefix <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
