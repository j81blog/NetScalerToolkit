...
```powershell
Invoke-NSDeleteDNSAddRecord -HostName <String> [-Ecssubnet <String>] -Ipaddress <String> [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
