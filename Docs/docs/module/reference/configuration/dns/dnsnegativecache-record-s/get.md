...
### All (Default)
```
Invoke-NSGetDNSNegativecacheRecordS [-Filter <Hashtable>] [-ViewSummary] [-Nodeid <Int32>]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetDNSNegativecacheRecordS [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
