...
### All (Default)
```
Invoke-NSGetDNSPTRRecord [-Filter <Hashtable>] [-ViewSummary] [-Type <String>] [-Nodeid <Int32>]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetDNSPTRRecord [-Reversedomain] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetDNSPTRRecord [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
