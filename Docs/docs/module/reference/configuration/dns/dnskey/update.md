...
```
Invoke-NSUpdateDNSKey [-Autorollover <String>] [-Expires <Int32>] [-KeyName] <String>
 [-Notificationperiod <Int32>] [-Revoke <Boolean>] [-RolloverMethod <String>] [-Ttl <Int32>] [-UnitS1 <String>]
 [-UnitS2 <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
