...
```
Invoke-NSUnsetDNSKey [-KeyName] <String> [-Autorollover] [-Expires] [-Notificationperiod] [-RolloverMethod]
 [-Ttl] [-UnitS1] [-UnitS2] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
