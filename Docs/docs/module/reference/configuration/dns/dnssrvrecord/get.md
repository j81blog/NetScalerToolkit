...
### All (Default)
```
Invoke-NSGetDNSSRVRecord [-Filter <Hashtable>] [-ViewSummary] [-Domain <String>] [-Target <String>]
...
### Count
```
Invoke-NSGetDNSSRVRecord [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
