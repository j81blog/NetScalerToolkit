...
```
Invoke-NSUpdateDNSSRVRecord [-Domain] <String> [-Port <Int32>] [-Priority <Int32>] -Target <String>
 [-Ttl <Int32>] [-Weight <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
