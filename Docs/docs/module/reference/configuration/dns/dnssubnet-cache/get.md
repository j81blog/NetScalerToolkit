...
### All (Default)
```
Invoke-NSGetDNSSubnetCache [-Filter <Hashtable>] [-ViewSummary] [-Nodeid <Int32>] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetDNSSubnetCache [-Ecssubnet] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetDNSSubnetCache [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
