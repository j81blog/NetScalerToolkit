...
```powershell
Invoke-NSUpdateDNSPolicy64 [-Action <String>] -Name <String> [-Rule <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>] [-PassThru <SwitchParameter>]
```
