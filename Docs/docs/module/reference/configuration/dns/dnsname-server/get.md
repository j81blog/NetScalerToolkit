...
### All (Default)
```
Invoke-NSGetDNSNameServer [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetDNSNameServer [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
