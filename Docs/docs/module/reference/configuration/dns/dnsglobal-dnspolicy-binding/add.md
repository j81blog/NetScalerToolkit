...
```
Invoke-NSAddDNSGlobalDNSPolicyBinding [[-GotoPriorityExpression] <String>] [[-Invoke] <Boolean>]
...
### -Priority
Specifies the priority of the policy with which it is bound.
Maximum allowed priority should be less than 65535.
