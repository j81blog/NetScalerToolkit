...
```powershell
Invoke-NSGetDNSDsFile [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-KeyName <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
