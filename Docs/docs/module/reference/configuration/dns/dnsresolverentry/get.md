...
### All (Default)
```
Invoke-NSGetDNSResolverentry [-Filter <Hashtable>] [-ViewSummary] [-Detail] [-Nodeid <Int32>]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetDNSResolverentry [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
