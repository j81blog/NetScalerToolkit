...
### All (Default)
```
Invoke-NSGetDNSZoneBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetDNSZoneBinding [-ZoneName] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
