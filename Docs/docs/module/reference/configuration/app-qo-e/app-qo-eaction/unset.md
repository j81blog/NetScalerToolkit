...
```
Invoke-NSUnsetAppQoEAction [-Name] <String> [-AltContentPath] [-AltContentSvcName] [-Delay] [-DosAction]
 [-MaxConn] [-Numretries] [-Polqdepth] [-Priority] [-Priqdepth] [-Retryonreset] [-RetryonTimeout] [-TCPProfile]
