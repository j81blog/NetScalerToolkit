...
### All (Default)
```
Invoke-NSGetAppQoECustomResponse [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAppQoECustomResponse [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
