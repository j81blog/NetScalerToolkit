...
```
Invoke-NSAddAuthorizationPolicyLabelAuthorizationPolicyBinding [-GotoPriorityExpression <String>]
 [-Invoke <Boolean>] [-InvokeLabelName <String>] [-LabelName] <String> [-LabelType <String>]
