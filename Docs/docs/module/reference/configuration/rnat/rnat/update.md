...
## SYNOPSIS
Updates a NetScaler rnat resource.

## SYNTAX

```
Invoke-NSUpdateRnat [-AclName <String>] [-ConnFailover <String>] [[-Name] <String>] [-Natip <String>]
 [-NetMask <String>] [-Network <String>] [-OwnerGroup <String>] [-RedirectPort <Int32>]
 [-Srcippersistency <String>] [-TrafficDomain <Int32>] [-UseProxyPort <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUpdateRnat -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateRnat -Name 'example' -WhatIf
```
