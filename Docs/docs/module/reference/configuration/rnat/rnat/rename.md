...
## SYNOPSIS
Renames a NetScaler rnat resource.

## SYNTAX

```
Invoke-NSRenameRnat [-Name] <String> -NewName <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSRenameRnat -Name 'example' -NewName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSRenameRnat -Name 'example' -NewName 'example' -WhatIf
```
