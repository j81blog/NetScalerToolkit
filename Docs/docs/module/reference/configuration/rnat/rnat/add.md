...
## SYNOPSIS
Creates a NetScaler rnat resource.

## SYNTAX

```
Invoke-NSAddRnat [-AclName <String>] [-ConnFailover <String>] [-Name] <String> [-NetMask <String>]
 [-Network <String>] [-OwnerGroup <String>] [-RedirectPort <Int32>] [-Srcippersistency <String>]
 [-TrafficDomain <Int32>] [-UseProxyPort <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddRnat -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddRnat -Name 'example' -WhatIf
```
