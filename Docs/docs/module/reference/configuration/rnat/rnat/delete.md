...
## SYNOPSIS
Removes a NetScaler rnat resource.

## SYNTAX

```
Invoke-NSDeleteRnat [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteRnat -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetRnat -Name 'rnat_example' | Invoke-NSDeleteRnat -Confirm:$false
```
