...
## SYNOPSIS
Updates a NetScaler rnatparam resource.

## SYNTAX

```
Invoke-NSUpdateRnatparam [[-Srcippersistency] <String>] [[-TCPProxy] <String>] [[-Session] <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUpdateRnatparam  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateRnatparam  -WhatIf
```
