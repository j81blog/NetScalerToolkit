...
## SYNOPSIS
Clears NetScaler rnat6 data.

## SYNTAX

```
Invoke-NSClearRnat6 [-Name] <String> [-OwnerGroup <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSClearRnat6 -Name 'example'
```

### EXAMPLE 2
```
Invoke-NSClearRnat6 -Name 'example' -WhatIf
```
