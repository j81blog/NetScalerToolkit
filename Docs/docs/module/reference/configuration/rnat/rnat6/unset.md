...
## SYNOPSIS
Clears one or more NetScaler rnat6 resource properties.

## SYNTAX

```
Invoke-NSUnsetRnat6 [-Name] <String> [-OwnerGroup] [-RedirectPort] [-Srcippersistency] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUnsetRnat6 -Name 'example' -OwnerGroup  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetRnat6 -Name 'example' -OwnerGroup  -WhatIf
```
