...
## SYNOPSIS
Creates a NetScaler rnat_retainsourceportset_binding resource.

## SYNTAX

```
Invoke-NSAddRnatRetainSourcePortSetBinding [-Name] <String> [-RetainSourcePortRange <String>]
...
### EXAMPLE 1
```
Invoke-NSAddRnatRetainSourcePortSetBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddRnatRetainSourcePortSetBinding -Name 'example' -WhatIf
```
