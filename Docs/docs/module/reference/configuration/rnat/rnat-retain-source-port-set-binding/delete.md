...
## SYNOPSIS
Removes a NetScaler rnat_retainsourceportset_binding resource.

## SYNTAX

```
Invoke-NSDeleteRnatRetainSourcePortSetBinding [-Name] <String> [-RetainSourcePortRange <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteRnatRetainSourcePortSetBinding -Name 'example' -RetainSourcePortRange 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetRnatRetainSourcePortSetBinding -Name 'rnat_retainsourceportset_binding_example' | Invoke-NSDeleteRnatRetainSourcePortSetBinding -Confirm:$false
```
