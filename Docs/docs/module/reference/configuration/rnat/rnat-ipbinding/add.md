...
## SYNOPSIS
Creates a NetScaler rnat_nsip_binding resource.

## SYNTAX

```
Invoke-NSAddRnatIPBinding [-Name] <String> [-Natip <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddRnatIPBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddRnatIPBinding -Name 'example' -WhatIf
```
