...
### All (Default)
```
Invoke-NSGetAnalyticsGlobalAnalyticsProfileBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAnalyticsGlobalAnalyticsProfileBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
