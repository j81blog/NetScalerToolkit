...
### All (Default)
```
Invoke-NSGetAuditSyslogGlobalAuditSyslogPolicyBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuditSyslogGlobalAuditSyslogPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
