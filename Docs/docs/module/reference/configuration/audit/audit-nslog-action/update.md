...
```
Invoke-NSUpdateAuditNSLogAction [-Acl <String>] [-Alg <String>] [-AppFlowExPort <String>]
 [-ContentInSpecTionlog <String>] [-DateFormAt <String>] [-Denylistviolations <String>]
 [-Domainresolvenow <Boolean>] [-Domainresolveretry <Int32>] [-Logfacility <String>] [-Loglevel <String[]>]
 [-Lsn <String>] [-Name] <String> [-ProtocolViolations <String>] [-ServerDomainName <String>]
