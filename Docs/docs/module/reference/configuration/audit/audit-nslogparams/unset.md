...
```
Invoke-NSUnsetAuditNslogparams [-Acl] [-Alg] [-AppFlowExPort] [-ContentInSpecTionlog] [-DateFormAt]
 [-Denylistviolations] [-Logfacility] [-Loglevel] [-Lsn] [-ProtocolViolations] [-ServerIp] [-ServerPort]
