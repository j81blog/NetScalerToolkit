...
### All (Default)
```
Invoke-NSGetAuditSyslogPolicyAuthenticationVServerBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAuditSyslogPolicyAuthenticationVServerBinding [-Name] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuditSyslogPolicyAuthenticationVServerBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
