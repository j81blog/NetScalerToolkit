...
```
Invoke-NSUpdateAuditMessageAction [-BypassSafetycheck <String>] [-Loglevel <String>] [-Logtonewnslog <String>]
 [-Name] <String> [-Stringbuilderexpr <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
The following loglevels are valid: * EMERGENCY - Events that indicate an immediate crisis on the server.
