...
### All (Default)
```
Invoke-NSGetAuditNslogglobalAuditNSLogPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAuditNslogglobalAuditNSLogPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
