...
```
Invoke-NSAddAAAUserIntranetIPBinding [-GotoPriorityExpression <String>] [-IntranetIP <String>]
 [-NetMask <String>] [-UserName] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
