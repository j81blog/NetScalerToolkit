...
```
Invoke-NSAddAAAGroupAAAUserBinding [-GotoPriorityExpression <String>] [-GroupName] <String>
 [-UserName <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
