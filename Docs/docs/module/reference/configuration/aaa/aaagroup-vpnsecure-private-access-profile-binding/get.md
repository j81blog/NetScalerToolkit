...
### All (Default)
```
Invoke-NSGetAAAGroupVPNSecurePrivateAccessProfileBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAAAGroupVPNSecurePrivateAccessProfileBinding [-GroupName] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAAAGroupVPNSecurePrivateAccessProfileBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
