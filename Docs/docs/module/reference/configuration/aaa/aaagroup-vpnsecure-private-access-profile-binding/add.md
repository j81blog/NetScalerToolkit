...
```
Invoke-NSAddAAAGroupVPNSecurePrivateAccessProfileBinding [-GotoPriorityExpression <String>]
 [-GroupName] <String> [-SecureprivateaccessProfile <String>] [-Session <PSObject>] [-IgnoreNotFound]
