...
### All (Default)
```
Invoke-NSGetAAAPreauthenticationPolicyVPNVServerBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAAAPreauthenticationPolicyVPNVServerBinding [-Name] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAAAPreauthenticationPolicyVPNVServerBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
