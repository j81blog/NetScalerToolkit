...
### All (Default)
```
Invoke-NSGetAAAGlobalAAAPreauthenticationPolicyBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAAAGlobalAAAPreauthenticationPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
