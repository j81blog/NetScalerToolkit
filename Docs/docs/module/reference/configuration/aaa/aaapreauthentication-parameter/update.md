...
```
Invoke-NSUpdateAAAPreauthenticationParameter [[-DeleteFileS] <String>] [[-KillProcess] <String>]
 [[-PreauthenticationAction] <String>] [[-Rule] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
