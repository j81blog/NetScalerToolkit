...
# Invoke-NSUpdateAAAOtpparameter
...
```
Invoke-NSUpdateAAAOtpparameter [[-Encryption] <String>] [[-MaxOtpdevices] <Int32>] [[-Session] <PSObject>]
...
### -Encryption
To encrypt otp secret in AD or not.
...
### -MaxOtpdevices
Maximum number of otp devices user can register.
Default value is 4.
Max value is 255.
Default value: 4 Minimum value = 0 Maximum value = 255
