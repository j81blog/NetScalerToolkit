...
```
Invoke-NSAddAAAUserVPNIntranetApplicationBinding [-GotoPriorityExpression <String>]
 [-IntranetApplication <String>] [-UserName] <String> [-Session <PSObject>] [-IgnoreNotFound]
