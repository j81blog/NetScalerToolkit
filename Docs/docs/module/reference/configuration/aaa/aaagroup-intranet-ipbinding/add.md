...
```
Invoke-NSAddAAAGroupIntranetIPBinding [-GotoPriorityExpression <String>] [-GroupName] <String>
 [-IntranetIP <String>] [-NetMask <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
