...
```
Invoke-NSAddAAAUserIntranetIp6Binding [-GotoPriorityExpression <String>] [-IntranetIp6 <String>]
 [-Numaddr <Int32>] [-UserName] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
