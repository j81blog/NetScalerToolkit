...
```
Invoke-NSAddAAAUserVPNSecurePrivateAccessProfileBinding [-GotoPriorityExpression <String>]
 [-SecureprivateaccessProfile <String>] [-UserName] <String> [-Session <PSObject>] [-IgnoreNotFound]
