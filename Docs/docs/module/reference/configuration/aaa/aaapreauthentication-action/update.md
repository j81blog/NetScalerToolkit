...
```
Invoke-NSUpdateAAAPreauthenticationAction [-DefaultepaGroup <String>] [-DeleteFileS <String>]
 [-KillProcess <String>] [-Name] <String> [-PreauthenticationAction <String>] [-Session <PSObject>]
