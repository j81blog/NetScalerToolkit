...
```
Invoke-NSUpdateAAACertParams [[-DefaultAuthenticationGroup] <String>] [[-GroupNameField] <String>]
 [[-UserNameField] <String>] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
