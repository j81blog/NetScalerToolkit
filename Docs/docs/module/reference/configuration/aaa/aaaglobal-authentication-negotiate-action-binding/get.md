...
### All (Default)
```
Invoke-NSGetAAAGlobalAuthenticationNegotiateActionBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAAAGlobalAuthenticationNegotiateActionBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
