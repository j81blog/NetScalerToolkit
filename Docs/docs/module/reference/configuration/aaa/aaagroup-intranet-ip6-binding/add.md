...
```
Invoke-NSAddAAAGroupIntranetIp6Binding [-GotoPriorityExpression <String>] [-GroupName] <String>
 [-IntranetIp6 <String>] [-Numaddr <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
