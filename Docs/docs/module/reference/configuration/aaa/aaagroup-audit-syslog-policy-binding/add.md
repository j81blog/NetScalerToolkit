...
```
Invoke-NSAddAAAGroupAuditSyslogPolicyBinding [-GotoPriorityExpression <String>] [-GroupName] <String>
 [-Policy <String>] [-Priority <Int32>] [-Type <String>] [-Session <PSObject>] [-IgnoreNotFound]
