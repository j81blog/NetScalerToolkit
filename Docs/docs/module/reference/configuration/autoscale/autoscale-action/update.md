...
# Invoke-NSUpdateAutoscaleAction
...
```
Invoke-NSUpdateAutoscaleAction [-Name] <String> [-Parameters <String>] [-ProfileName <String>]
 [-Quiettime <Int32>] [-Vmdestroygraceperiod <Int32>] [-VServer <String>] [-Session <PSObject>]
