...
```
Invoke-NSUnsetLSNGroup [-GroupName] <String> [-Ftp] [-Ftpcm] [-Logging] [-PortBlocksize] [-Pptp] [-Rtspalg]
 [-Sessionlogging] [-Sessionsync] [-SIPAlg] [-SNMPTrapLimit] [-Session <PSObject>] [-IgnoreNotFound]
