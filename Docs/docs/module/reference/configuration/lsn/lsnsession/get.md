...
### All (Default)
```
Invoke-NSGetLsnsession [-Filter <Hashtable>] [-ViewSummary] [-NatType <String>] [-ClientName <String>]
 [-Network <String>] [-NetMask <String>] [-Network6 <String>] [-TrafficDomain <Int32>] [-Natip <String>]
...
### Count
```
Invoke-NSGetLsnsession [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
