...
```
Invoke-NSAddLSNAppsProfile [-AppsProfileName] <String> [-Filtering <String>] [-Ippooling <String>]
 [-L2info <String>] [-Mapping <String>] [-TCPProxy <String>] [-TrafficDomain <Int32>]
