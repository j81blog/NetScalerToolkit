...
```
Invoke-NSUpdateLSNAppsProfile [-AppsProfileName] <String> [-Filtering <String>] [-Ippooling <String>]
 [-L2info <String>] [-Mapping <String>] [-TCPProxy <String>] [-TrafficDomain <Int32>] [-Session <PSObject>]
