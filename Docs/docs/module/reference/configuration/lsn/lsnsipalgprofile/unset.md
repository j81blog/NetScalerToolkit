...
```
Invoke-NSUnsetLSNSIPALGProfile [-SIPAlgProfileName] <String> [-DataSessionidleTimeout] [-Opencontactpinhole]
 [-OpenRecordRoutepinhole] [-Openregisterpinhole] [-Openroutepinhole] [-OpenviAPINhole] [-RegistrationTimeout]
 [-RPort] [-SIPDstPortRange] [-SIPSessionTimeout] [-SIPSrcPortRange] [-SIPTransPortProtocol]
