...
```powershell
Invoke-NSAddLSNSIPALGProfile [-DataSessionidleTimeout <Int32>] [-Opencontactpinhole <String>] [-OpenRecordRoutepinhole <String>] [-Openregisterpinhole <String>] [-Openroutepinhole <String>] [-OpenviAPINhole <String>] [-RegistrationTimeout <Int32>] [-RPort <String>] -SIPAlgProfileName <String> [-SIPDstPortRange <String>] [-SIPSessionTimeout <Int32>] [-SIPSrcPortRange <String>] -SIPTransPortProtocol <String> [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>] [-PassThru <SwitchParameter>]
```
