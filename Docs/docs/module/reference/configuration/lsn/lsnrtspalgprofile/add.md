...
```
Invoke-NSAddLSNRTSPALGProfile [-RtspalgProfileName] <String> [-RtspidleTimeout <Int32>] -RtspPortRange <String>
 [-RtsptransPortProtocol <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
