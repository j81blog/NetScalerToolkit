...
```
Invoke-NSUnsetLSNRTSPALGProfile [-RtspalgProfileName] <String> [-RtspidleTimeout] [-RtspPortRange]
 [-RtsptransPortProtocol] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
...
Default value: TCP Possible values = TCP, UDP
