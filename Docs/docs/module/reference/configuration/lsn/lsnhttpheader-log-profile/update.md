...
```
Invoke-NSUpdateLSNHTTPHeaderLogProfile [-HTTPHdrlogProfileName] <String> [-LogHost <String>]
 [-LogMethod <String>] [-LogURL <String>] [-Logversion <String>] [-Session <PSObject>] [-IgnoreNotFound]
