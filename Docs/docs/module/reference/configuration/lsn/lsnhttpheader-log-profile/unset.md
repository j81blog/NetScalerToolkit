...
```
Invoke-NSUnsetLSNHTTPHeaderLogProfile [-HTTPHdrlogProfileName] <String> [-LogHost] [-LogMethod] [-LogURL]
 [-Logversion] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [-PassThru]
