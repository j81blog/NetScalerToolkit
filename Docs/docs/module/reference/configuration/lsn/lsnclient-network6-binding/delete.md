...
```
Invoke-NSDeleteLSNClientNetwork6Binding [-ClientName] <String> [-Network <String>] [-NetMask <String>]
 [-Network6 <String>] [-TrafficDomain <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
