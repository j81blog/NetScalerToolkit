...
### All (Default)
```
Invoke-NSGetLsndeterMinIsticnat [-Filter <Hashtable>] [-ViewSummary] [-ClientName <String>]
 [-Network6 <String>] [-Subscrip <String>] [-TrafficDomain <Int32>] [-Natip <String>] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetLsndeterMinIsticnat [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
