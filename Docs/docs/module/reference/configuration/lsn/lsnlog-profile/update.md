...
```
Invoke-NSUpdateLSNLogProfile [-AnalyticsProfile <String>] [-Logcompact <String>] [-Logipfix <String>]
 [-LogProfileName] <String> [-Logsessdeletion <String>] [-Logsubscrinfo <String>] [-Session <PSObject>]
