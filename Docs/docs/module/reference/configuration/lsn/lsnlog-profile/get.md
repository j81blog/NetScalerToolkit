...
### All (Default)
```
Invoke-NSGetLSNLogProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetLSNLogProfile [-LogProfileName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetLSNLogProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
