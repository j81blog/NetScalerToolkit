...
### All (Default)
```
Invoke-NSGetLSNPoolBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetLSNPoolBinding [-PoolName] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
