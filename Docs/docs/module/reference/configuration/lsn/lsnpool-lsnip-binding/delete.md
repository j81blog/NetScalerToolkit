...
```powershell
Invoke-NSDeleteLSNPoolLsnipBinding -PoolName <String> [-Ownernode <Int32>] [-Lsnip <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
