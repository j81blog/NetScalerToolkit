...
### All (Default)
```
Invoke-NSGetSystemGlobalAuditNSLogPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSystemGlobalAuditNSLogPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
