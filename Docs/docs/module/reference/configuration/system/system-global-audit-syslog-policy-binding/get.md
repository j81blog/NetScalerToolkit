...
### All (Default)
```
Invoke-NSGetSystemGlobalAuditSyslogPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSystemGlobalAuditSyslogPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
