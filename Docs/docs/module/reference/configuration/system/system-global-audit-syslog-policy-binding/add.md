...
```
Invoke-NSAddSystemGlobalAuditSyslogPolicyBinding [[-GotoPriorityExpression] <String>] [[-Nextfactor] <String>]
 [[-PolicyName] <String>] [[-Priority] <Int32>] [[-Session] <PSObject>] [-IgnoreNotFound]
