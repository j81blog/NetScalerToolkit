...
```
Invoke-NSUnsetSystemUser [-UserName] <String> [-Allowedmanagementinterface] [-Externalauth] [-Logging]
 [-MaxSession] [-Promptstring] [-Timeout] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
