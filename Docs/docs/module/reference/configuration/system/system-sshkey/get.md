...
```powershell
Invoke-NSGetSystemSSHKey [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-SshKeyType <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
