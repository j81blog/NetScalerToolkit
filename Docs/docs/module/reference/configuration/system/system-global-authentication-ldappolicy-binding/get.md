...
### All (Default)
```
Invoke-NSGetSystemGlobalAuthenticationLDAPPolicyBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSystemGlobalAuthenticationLDAPPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
