...
```
Invoke-NSUnsetSystemCpuparam [-PeMode] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### -PeMode
Set PEmode to DEFAULT/CPUBOUND.
Distribute the PE weights equally if PEmode is set to CPUBOUND.
