...
```powershell
Invoke-NSGetSystemScalablemgmtthreads [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-Nodeid <Int32>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
