...
### All (Default)
```
Invoke-NSGetSystemRestorePoint [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetSystemRestorePoint [-FileName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSystemRestorePoint [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
