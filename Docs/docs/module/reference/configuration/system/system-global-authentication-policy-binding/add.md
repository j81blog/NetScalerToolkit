...
```
Invoke-NSAddSystemGlobalAuthenticationPolicyBinding [[-GotoPriorityExpression] <String>]
 [[-Nextfactor] <String>] [[-PolicyName] <String>] [[-Priority] <Int32>] [[-Session] <PSObject>]
...
Applicable only for advanced authentication policies.
...
Applicable for advanced authentication policy binding.
