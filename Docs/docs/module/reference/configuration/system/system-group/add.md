...
```
Invoke-NSAddSystemGroup [-Allowedmanagementinterface <String[]>] [-Daystoexpire <Int32>] [-GroupName] <String>
 [-Promptstring <String>] [-Timeout <Int32>] [-Warnpriorndays <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
