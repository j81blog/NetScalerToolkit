...
```powershell
Invoke-NSDeleteSystemGlobalAuthenticationLocalPolicyBinding [-PolicyName <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
