...
### All (Default)
```
Invoke-NSGetSystemGlobalAuthenticationLocalPolicyBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetSystemGlobalAuthenticationLocalPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
