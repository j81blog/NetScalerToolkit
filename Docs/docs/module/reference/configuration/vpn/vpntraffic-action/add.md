...
## SYNOPSIS
Creates a NetScaler vpntrafficaction resource.

## SYNTAX

```
Invoke-NSAddVPNTrafficAction [-AppTimeout <Int32>] [-FormSSOAction <String>] [-Fta <String>] [-Hdx <String>]
 [-KCDAccount <String>] [-Name] <String> [-Passwdexpression <String>] [-Proxy <String>] -Qual <String>
...
### EXAMPLE 1
```
Invoke-NSAddVPNTrafficAction -Name 'example' -Qual http -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVPNTrafficAction -Name 'example' -Qual http -WhatIf
```
