...
## SYNOPSIS
Updates a NetScaler vpntrafficaction resource.

## SYNTAX

```
Invoke-NSUpdateVPNTrafficAction [-AppTimeout <Int32>] [-FormSSOAction <String>] [-Fta <String>] [-Hdx <String>]
 [-KCDAccount <String>] [-Name] <String> [-Passwdexpression <String>] [-Proxy <String>]
 [-SAMLSSOProfile <String>] [-SSO <String>] [-UserExpression <String>] [-Wanscaler <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateVPNTrafficAction -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateVPNTrafficAction -Name 'example' -WhatIf
```
...
Minimum value = 1 Maximum value = 715827
...
Form-based single sign-on allows users to log on one time to all protected applications in your network, instead of requiring them to log on separately to access each one.
...
Default value: "Default" Minimum length = 1 Maximum length = 32
