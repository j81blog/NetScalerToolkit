...
## SYNOPSIS
Gets NetScaler vpnsessionaction configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetVPNSessionAction [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVPNSessionAction [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVPNSessionAction [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetVPNSessionAction -Name 'vpnsessionaction_example'
```

### EXAMPLE 3
```
Invoke-NSGetVPNSessionAction -Filter @{ servicetype = 'HTTP' }
```
