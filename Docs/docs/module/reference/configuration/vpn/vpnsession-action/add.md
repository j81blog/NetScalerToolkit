...
# Invoke-NSAddVPNSessionAction

## SYNOPSIS
Creates a NetScaler vpnsessionaction resource.

## SYNTAX

```
Invoke-NSAddVPNSessionAction [-AdvancedClientLessVPNMode <String>] [-AllowedLoginGroupS <String>]
...
### EXAMPLE 1
```
Invoke-NSAddVPNSessionAction -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVPNSessionAction -Name 'example' -WhatIf
```
