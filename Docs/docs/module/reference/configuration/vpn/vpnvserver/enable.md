...
# Invoke-NSEnableVPNVServer

## SYNOPSIS
Enables a NetScaler vpnvserver resource.

## SYNTAX

```
Invoke-NSEnableVPNVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnableVPNVServer -Name 'vpnvserver_example' -PassThru
```
