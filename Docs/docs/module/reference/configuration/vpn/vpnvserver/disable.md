...
# Invoke-NSDisableVPNVServer

## SYNOPSIS
Disables a NetScaler vpnvserver resource.

## SYNTAX

```
Invoke-NSDisableVPNVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisableVPNVServer -Name 'vpnvserver_example' -PassThru
```
