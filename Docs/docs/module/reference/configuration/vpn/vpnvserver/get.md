...
## SYNOPSIS
Gets NetScaler vpnvserver configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetVPNVServer [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVPNVServer [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVPNVServer [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetVPNVServer -Name 'vpnvserver_example'
```

### EXAMPLE 3
```
Invoke-NSGetVPNVServer -Filter @{ servicetype = 'HTTP' }
```
