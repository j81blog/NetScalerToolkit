...
# Invoke-NSAddVPNVServer

## SYNOPSIS
Creates a NetScaler vpnvserver resource.

## SYNTAX

```
Invoke-NSAddVPNVServer [-AccessrestrictedPageRedirect <String>] [-Advancedepa <String>] [-AppFlowLog <String>]
 [-Authentication <String>] [-AuthnProfile <String>] [-CertKeyNameS <String>]
 [-CginfrahomePageRedirect <String>] [-Comment <String>] [-DeploymentType <String>] [-DeviceCert <String>]
 [-Deviceposture <String>] [-Doublehop <String>] [-DownStateFlush <String>] [-Dtls <String>]
 [-FailedLoginTimeout <Int32>] [-HTTPProfileName <String>] [-Icaonly <String>]
 [-IcaProxySessionmigration <String>] [-ICMPVsrResponse <String>] [-IPSet <String>] [-IPv46 <String>]
 [-L2Conn <String>] [-Linuxepapluginupgrade <String>] [-ListenPolicy <String>] [-ListenPriority <Int32>]
 [-LoginOnce <String>] [-Logoutonsmartcardremoval <String>] [-Macepapluginupgrade <String>]
 [-MaxAAAUserS <Int32>] [-MaxLoginAttempts <Int32>] [-Name] <String> [-NetProfile <String>]
 [-PCoIPVServerProfileName <String>] [-Port <Int32>] [-QUICProfileName <String>] [-Range <Int32>]
 [-RDPServerProfileName <String>] [-Rhistate <String>] [-Samesite <String>] [-Secureprivateaccess <String>]
 -ServiceType <String> [-State <String>] [-TCPProfileName <String>] [-UserDomains <String>]
 [-VServerFqdn <String>] [-WASMModule <String>] [-Windowsepapluginupgrade <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddVPNVServer -Name 'example' -ServiceType HTTP -IPv46 '192.0.2.10' -Port 80 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVPNVServer -Name 'example' -ServiceType HTTP -IPv46 '192.0.2.10' -Port 80 -WhatIf
```
...
### -DeploymentType
.
Default value: 5 Possible values = NONE, ICA_WEBINTERFACE, ICA_STOREFRONT, MOBILITY
...
### -IPv46
IPv4 or IPv6 address of the Citrix Gateway virtual server.
...
### -Range
Range of Citrix Gateway virtual server IP addresses.
The consecutively numbered range of IP addresses begins with the address specified by the IP Address parameter.
...
Default value: SSL Possible values = SSL, DTLS, HTTP_QUIC
...
If the virtual server is disabled, requests are not processed.
Default value: ENABLED Possible values = ENABLED, DISABLED
