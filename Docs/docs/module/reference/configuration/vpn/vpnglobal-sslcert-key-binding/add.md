...
## SYNOPSIS
Creates a NetScaler vpnglobal_sslcertkey_binding resource.

## SYNTAX

```
Invoke-NSAddVPNGlobalSSLCertKeyBinding [[-CaCert] <String>] [[-CertKeyName] <String>] [[-Crlcheck] <String>]
 [[-GotoPriorityExpression] <String>] [[-OCSPCheck] <String>] [[-UserDataEncryptionKey] <String>]
...
### EXAMPLE 1
```
Invoke-NSAddVPNGlobalSSLCertKeyBinding  -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVPNGlobalSSLCertKeyBinding  -WhatIf
```
