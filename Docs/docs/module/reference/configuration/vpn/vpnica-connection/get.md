...
## SYNOPSIS
Gets NetScaler vpnicaconnection configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetVPNIcaConnection [-Filter <Hashtable>] [-ViewSummary] [-UserName <String>] [-TransProto <String>]
...
### Count
```
Invoke-NSGetVPNIcaConnection [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetVPNIcaConnection -Filter @{ servicetype = 'HTTP' }
```
