...
## SYNOPSIS
Creates a NetScaler vpnglobal_vpnurlpolicy_binding resource.

## SYNTAX

```
Invoke-NSAddVPNGlobalVPNURLPolicyBinding [[-GotoPriorityExpression] <String>] [[-GroupExtrAction] <Boolean>]
 [[-PolicyName] <String>] [[-Priority] <Int32>] [[-Secondary] <Boolean>] [[-Session] <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSAddVPNGlobalVPNURLPolicyBinding  -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVPNGlobalVPNURLPolicyBinding  -WhatIf
```
