...
## SYNOPSIS
Gets NetScaler vpntrafficpolicy configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetVPNTrafficPolicy [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVPNTrafficPolicy [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVPNTrafficPolicy [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetVPNTrafficPolicy -Name 'vpntrafficpolicy_example'
```

### EXAMPLE 3
```
Invoke-NSGetVPNTrafficPolicy -Filter @{ servicetype = 'HTTP' }
```

## PARAMETERS

### -Name
Name for the traffic policy.
