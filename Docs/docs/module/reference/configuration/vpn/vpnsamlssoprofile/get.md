...
## SYNOPSIS
Gets NetScaler vpnsamlssoprofile configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetVPNSAMLSSOProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVPNSAMLSSOProfile [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVPNSAMLSSOProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetVPNSAMLSSOProfile -Name 'vpnsamlssoprofile_example'
```

### EXAMPLE 3
```
Invoke-NSGetVPNSAMLSSOProfile -Filter @{ servicetype = 'HTTP' }
```
