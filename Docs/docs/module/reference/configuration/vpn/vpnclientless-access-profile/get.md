...
## SYNOPSIS
Gets NetScaler vpnclientlessaccessprofile configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetVPNClientlessAccessProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetVPNClientlessAccessProfile [-ProfileName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetVPNClientlessAccessProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetVPNClientlessAccessProfile -ProfileName 'vpnclientlessaccessprofile_example'
```

### EXAMPLE 3
```
Invoke-NSGetVPNClientlessAccessProfile -Filter @{ servicetype = 'HTTP' }
```
