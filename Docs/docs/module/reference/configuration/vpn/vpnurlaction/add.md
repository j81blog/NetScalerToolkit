...
# Invoke-NSAddVPNURLAction

## SYNOPSIS
Creates a NetScaler vpnurlaction resource.

## SYNTAX

```
Invoke-NSAddVPNURLAction -ActualURL <String> [-ApplicationType <String>] [-ClientLessaccess <String>]
 [-Comment <String>] [-IconURL <String>] -LinkName <String> [-Name] <String> [-SAMLSSOProfile <String>]
 [-SSOType <String>] [-VServerName <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddVPNURLAction -Name 'example' -ActualURL 'example' -LinkName 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddVPNURLAction -Name 'example' -ActualURL 'example' -LinkName 'example' -WhatIf
```
...
Allows single sign-on and other HTTP processing on NetScaler Gateway for HTTPS resources.
