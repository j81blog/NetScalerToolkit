...
```
Invoke-NSUnsetRDPClientProfile [-Name] <String> [-AddUserNameInRDPFile] [-AudiocaptureMode] [-KeyBoardhook]
 [-MultiMonItorsupPort] [-Psk] [-RandomizeRDPFileName] [-RDPCookieValidity] [-RDPCustomParams] [-RDPFileName]
 [-RDPHost] [-RDPLinkattribute] [-RDPListenEr] [-RDPURLOverride] [-RDPValidateClientIp] [-RedirectCLIPboard]
 [-RedirectComPortS] [-RedirectDrives] [-RedirectPnpdevices] [-RedirectPrinters] [-VideoplaybackMode]
