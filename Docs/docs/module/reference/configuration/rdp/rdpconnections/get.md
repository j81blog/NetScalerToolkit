...
### All (Default)
```
Invoke-NSGetRDPConnections [-Filter <Hashtable>] [-ViewSummary] [-UserName <String>] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetRDPConnections [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
