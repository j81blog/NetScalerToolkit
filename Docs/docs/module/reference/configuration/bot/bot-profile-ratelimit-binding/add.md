...
```
Invoke-NSAddBotProfileRatelimitBinding [-BotBindComment <String>] [-BotRateLimitAction <String[]>]
 [-BotRateLimitEnabled <String>] [-BotRateLimitType <String>] [-BotRateLimitURL <String>]
 [-BotRatelimit <Boolean>] [-Condition <String>] [-CookieName <String>] [-Countrycode <String>]
 [-LimitType <String>] [-LogMessage <String>] [-Name] <String> [-Rate <Int32>] [-Timeslice <Int32>]
...
### -BotRateLimitAction
One or more actions to be taken when the current rate becomes more than the configured rate.
Only LOG action can be combined with DROP, REDIRECT, RESPOND_STATUS_TOO_MANY_REQUESTS or RESET action.
Default value: NONE Possible values = NONE, LOG, DROP, REDIRECT, RESET, RESPOND_STATUS_TOO_MANY_REQUESTS
