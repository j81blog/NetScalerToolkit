...
```
Invoke-NSAddBotProfileIpreputationBinding [-BotBindComment <String>] [-BotIprepAction <String[]>]
 [-BotIprepEnabled <String>] [-BotIpreputation <Boolean>] [-Category <String>] [-LogMessage <String>]
