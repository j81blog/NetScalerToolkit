...
```powershell
Invoke-NSDeleteBotProfileIpreputationBinding -Name <String> [-BotIpreputation <Boolean>] [-Category <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
