...
```
Invoke-NSDeleteBotProfileWhitelistBinding [-Name] <String> [-BotWhitelist <Boolean>]
 [-BotWhitelistValue <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
