...
```
Invoke-NSAddBotProfileWhitelistBinding [-BotBindComment <String>] [-BotWhitelist <Boolean>]
 [-BotWhitelistEnabled <String>] [-BotWhitelistType <String>] [-BotWhitelistValue <String>] [-Log <String>]
...
### -BotWhitelist
Whitelist binding.
Maximum 32 bindings can be configured per profile for Whitelist detection.
