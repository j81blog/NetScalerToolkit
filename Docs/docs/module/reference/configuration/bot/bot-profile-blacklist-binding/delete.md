...
```
Invoke-NSDeleteBotProfileBlacklistBinding [-Name] <String> [-BotBlacklist <Boolean>]
 [-BotBlacklistValue <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
