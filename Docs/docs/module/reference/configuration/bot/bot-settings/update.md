...
```
Invoke-NSUpdateBotSettings [[-DefaultnonintrusiveProfile] <String>] [[-DefaultProfile] <String>]
 [[-DfpRequestLimit] <Int32>] [[-JavascriptName] <String>] [[-ProxyPassword] <String>] [[-ProxyPort] <Int32>]
 [[-ProxyServer] <String>] [[-ProxyUserName] <String>] [[-SessionCookieName] <String>]
 [[-SessionTimeout] <Int32>] [[-SignatureAutoupdate] <String>] [[-SignatureURL] <String>]
 [[-TrapURLAutogenerate] <String>] [[-TrapURLInterval] <Int32>] [[-TrapURLLength] <Int32>]
