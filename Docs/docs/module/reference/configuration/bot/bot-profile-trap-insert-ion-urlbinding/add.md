...
```
Invoke-NSAddBotProfileTrapInsertIonURLBinding [-BotBindComment <String>] [-BotTrapURL <String>]
 [-BotTrapURLInsertIonEnabled <String>] [-LogMessage <String>] [-Name] <String> [-TrapInsertIonURL <Boolean>]
