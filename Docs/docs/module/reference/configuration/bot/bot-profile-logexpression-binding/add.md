...
```
Invoke-NSAddBotProfileLogexpressionBinding [-BotBindComment <String>] [-BotLogExpressionEnabled <String>]
 [-BotLogExpressionName <String>] [-BotLogExpressionValue <String>] [-Logexpression <Boolean>]
 [-LogMessage <String>] [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
