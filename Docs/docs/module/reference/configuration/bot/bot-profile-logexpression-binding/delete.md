...
```
Invoke-NSDeleteBotProfileLogexpressionBinding [-Name] <String> [-Logexpression <Boolean>]
 [-BotLogExpressionName <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
