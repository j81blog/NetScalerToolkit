...
```
Invoke-NSUpdateCSVServer [-APIProfile <String>] [-AppFlowLog <String>] [-Authentication <String>]
 [-AuthenticationHost <String>] [-Authn401 <String>] [-AuthnProfile <String>] [-AuthnVServerName <String>]
 [-BackupIp <String>] [-BackupPersistenceTimeout <Int32>] [-BackupVServer <String>] [-Cacheable <String>]
 [-Casesensitive <String>] [-CltTimeout <Int32>] [-Comment <String>] [-CookieDomain <String>]
 [-CookieName <String>] [-CookieTimeout <Int32>] [-DBProfileName <String>] [-DisablePrimaryOnDown <String>]
 [-DNSOverHTTPS <String>] [-DNSProfileName <String>] [-DNSRecordType <String>] [-DomainName <String>]
 ...
 [-PersistenceType <String>] [-PersistMask <String>] [-Precedence <String>] [-ProbePort <Int32>]
 [-ProbeProtocol <String>] [-ProbeSuccessResponseCode <String>] [-Push <String>] [-PushLabel <String>]
 [-PushMultiClients <String>] [-PushVServer <String>] [-QUICProfileName <String>] [-RedirectFromPort <Int32>]
 [-RedirectPortRewrite <String>] [-RedirectURL <String>] [-Rhistate <String>] [-RTSPNAT <String>]
 [-Sitedomainttl <Int32>] [-SoBackupAction <String>] [-SoMethod <String>] [-SoPersistence <String>]
 [-SoPersistenceTimeout <Int32>] [-SoThreshold <Int32>] [-Stateupdate <String>] [-TCPProbePort <Int32>]
 [-TCPProfileName <String>] [-Timeout <Int32>] [-Ttl <Int32>] [-V6PersistMaskLen <Int32>] [-VIPHeader <String>]
