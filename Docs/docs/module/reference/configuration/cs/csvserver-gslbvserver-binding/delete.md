...
```
Invoke-NSDeleteCSVServerGSLBVServerBinding [-Name] <String> [-VServer <String>] [-Session <PSObject>]
...
For Example: bind cs vserver cs1 -vserver gslb1 or bind cs vserver cs1 -vserver vpn1.
Minimum length = 1
