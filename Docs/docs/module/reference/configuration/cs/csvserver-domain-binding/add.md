...
```
Invoke-NSAddCSVServerDomainBinding [-BackupIp <String>] [-CookieDomain <String>] [-CookieTimeout <Int32>]
 [-DomainName <String>] [-Name] <String> [-Sitedomainttl <Int32>] [-Ttl <Int32>] [-Session <PSObject>]
