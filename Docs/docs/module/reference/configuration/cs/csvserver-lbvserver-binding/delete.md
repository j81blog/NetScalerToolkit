...
```
Invoke-NSDeleteCSVServerLBVServerBinding [-Name] <String> [-LBVServer <String>] [-Session <PSObject>]
...
Use this param for Default binding only.
For Example: bind cs vserver cs1 -lbvserver lb1.
Minimum length = 1
