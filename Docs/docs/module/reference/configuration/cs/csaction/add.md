...
```
Invoke-NSAddCSAction [-Comment <String>] [-Name] <String> [-TargetlbVServer <String>] [-TargetVServer <String>]
 [-TargetVServerExpr <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
