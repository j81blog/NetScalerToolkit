...
# Invoke-NSRenameSpilloverPolicy
...
```
Invoke-NSRenameSpilloverPolicy [-Name] <String> -NewName <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### -NewName
New name for the spillover policy.
