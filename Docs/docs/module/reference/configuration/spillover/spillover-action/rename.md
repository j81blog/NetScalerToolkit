...
# Invoke-NSRenameSpilloverAction
...
```
Invoke-NSRenameSpilloverAction [-Name] <String> -NewName <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### -NewName
New name for the spillover action.
