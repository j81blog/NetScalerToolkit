...
```
Invoke-NSAddGSLBVServerSpilloverPolicyBinding [-GotoPriorityExpression <String>] [-Name] <String>
 [-Order <Int32>] [-PolicyName <String>] [-Priority <Int32>] [-Type <String>] [-Session <PSObject>]
