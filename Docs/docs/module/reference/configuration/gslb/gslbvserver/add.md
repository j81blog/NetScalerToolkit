...
```
Invoke-NSAddGSLBVServer [-AppFlowLog <String>] [-BackupLBMethod <String>] [-BackupSessionTimeout <Int32>]
 [-Comment <String>] [-Considereffectivestate <String>] [-DisablePrimaryOnDown <String>]
 [-DNSRecordType <String>] [-Dynamicweight <String>] [-Ecs <String>] [-Ecsaddrvalidation <String>]
 [-Edr <String>] [-IpType <String>] [-LBMethod <String>] [-Mir <String>] [-Name] <String> [-NetMask <String>]
 [-OrderThreshold <Int32>] [-PersistenceId <Int32>] [-PersistenceType <String>] [-PersistMask <String>]
 [-Rule <String>] -ServiceType <String> [-SoBackupAction <String>] [-SoMethod <String>]
 [-SoPersistence <String>] [-SoPersistenceTimeout <Int32>] [-SoThreshold <Int32>] [-State <String>]
 [-Timeout <Int32>] [-ToggleOrder <String>] [-Tolerance <Int32>] [-V6NetmaskLen <Int32>]
