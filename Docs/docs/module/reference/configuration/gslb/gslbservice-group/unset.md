...
```
Invoke-NSUnsetGSLBServiceGroup [-ServiceGroupName] <String> [-AppFlowLog] [-CIP] [-CIPHeader] [-CltTimeout]
 [-Comment] [-DownStateFlush] [-DupWeight] [-HashID] [-HealthMonitor] [-MaxBandwidth] [-MaxClient]
 [-MonitorNameSvc] [-MonThreshold] [-Order] [-Port] [-Publicip] [-PublicPort] [-ServerName] [-SitePersistence]
 [-Siteprefix] [-SvrTimeout] [-Weight] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
