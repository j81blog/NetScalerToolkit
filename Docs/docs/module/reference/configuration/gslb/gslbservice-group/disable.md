...
```
Invoke-NSDisableGSLBServiceGroup [-ServiceGroupName] <String> [-Delay <Int32>] [-Graceful <String>]
 [-Port <Int32>] [-ServerName <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
