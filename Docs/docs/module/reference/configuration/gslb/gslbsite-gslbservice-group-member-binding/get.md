...
### All (Default)
```
Invoke-NSGetGSLBSiteGSLBServiceGroupMemberBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetGSLBSiteGSLBServiceGroupMemberBinding [-SiteName] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetGSLBSiteGSLBServiceGroupMemberBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```
...
If you specify a site name, details of all the site's constituent services are also displayed.
Minimum length = 1
