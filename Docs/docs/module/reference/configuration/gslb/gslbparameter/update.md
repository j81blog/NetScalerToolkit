...
```
Invoke-NSUpdateGSLBParameter [[-Automaticconfigsync] <String>] [[-DroplDNSReq] <String>]
 [[-GSLBConfigsyncMonItor] <String>] [[-GSLBSvcstatedelaytime] <Int32>] [[-GSLBSyncInterval] <Int32>]
 [[-GSLBSynclocFileS] <String>] [[-GSLBSyncMode] <String>] [[-GSLBSyncsaveconfigcommand] <String>]
 [[-LDNSEntryTimeout] <Int32>] [[-LDNSMask] <String>] [[-LDNSProbeOrder] <String[]>]
 [[-MepkeepaliveTimeout] <Int32>] [[-Rtttolerance] <Int32>] [[-Sourceipwhitelisting] <String>]
 [[-SvcstateLearningTime] <Int32>] [[-UndefAction] <String>] [[-Usekrpcchannelforsync] <String>]
 [[-V6lDNSMaskLen] <Int32>] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
