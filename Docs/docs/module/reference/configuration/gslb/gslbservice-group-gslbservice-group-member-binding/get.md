...
### All (Default)
```
Invoke-NSGetGSLBServiceGroupGSLBServiceGroupMemberBinding [-Filter <Hashtable>] [-ViewSummary]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetGSLBServiceGroupGSLBServiceGroupMemberBinding [-ServiceGroupName] <String> [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetGSLBServiceGroupGSLBServiceGroupMemberBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
