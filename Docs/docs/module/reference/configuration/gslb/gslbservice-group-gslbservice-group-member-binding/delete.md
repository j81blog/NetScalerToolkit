...
```
Invoke-NSDeleteGSLBServiceGroupGSLBServiceGroupMemberBinding [-ServiceGroupName] <String> [-Ip <String>]
 [-ServerName <String>] [-Port <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
