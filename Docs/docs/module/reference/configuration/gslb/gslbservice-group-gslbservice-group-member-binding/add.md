...
```
Invoke-NSAddGSLBServiceGroupGSLBServiceGroupMemberBinding [-HashID <Int32>] [-Ip <String>] [-Order <Int32>]
 [-Port <Int32>] [-Publicip <String>] [-PublicPort <Int32>] [-ServerName <String>] [-ServiceGroupName] <String>
 [-Siteprefix <String>] [-State <String>] [-Weight <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
