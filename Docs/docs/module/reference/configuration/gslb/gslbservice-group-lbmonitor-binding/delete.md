...
```powershell
Invoke-NSDeleteGSLBServiceGroupLBMonitorBinding -ServiceGroupName <String> [-Port <Int32>] [-MonItorName <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
