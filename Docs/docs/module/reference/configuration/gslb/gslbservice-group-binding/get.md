...
### All (Default)
```
Invoke-NSGetGSLBServiceGroupBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetGSLBServiceGroupBinding [-ServiceGroupName] <String> [-Session <PSObject>] [-IgnoreNotFound]
