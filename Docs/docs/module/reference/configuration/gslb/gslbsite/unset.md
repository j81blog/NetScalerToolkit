...
```
Invoke-NSUnsetGSLBSite [-SiteName] <String> [-BackupParentlist] [-Krpcnodesrcip] [-Metricexchange]
 [-Naptrreplacementsuffix] [-Nwmetricexchange] [-Sessionexchange] [-TriggerMonItor] [-Session <PSObject>]
