...
# Invoke-NSEnableInterface

## SYNOPSIS
Enables a NetScaler Interface resource.

## SYNTAX

```
Invoke-NSEnableInterface [-Id] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnableInterface -Id 'Interface_example' -PassThru
```
