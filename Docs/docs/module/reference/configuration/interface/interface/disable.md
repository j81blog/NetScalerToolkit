...
# Invoke-NSDisableInterface

## SYNOPSIS
Disables a NetScaler Interface resource.

## SYNTAX

```
Invoke-NSDisableInterface [-Id] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisableInterface -Id 'Interface_example' -PassThru
```
