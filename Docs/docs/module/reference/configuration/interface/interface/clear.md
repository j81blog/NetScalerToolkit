...
## SYNOPSIS
Clears NetScaler Interface data.

## SYNTAX

```
Invoke-NSClearInterface [-Id] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSClearInterface -Id 'example'
```

### EXAMPLE 2
```
Invoke-NSClearInterface -Id 'example' -WhatIf
```
