...
# Invoke-NSAddOnLinkIPv6Prefix

## SYNOPSIS
Creates a NetScaler onlinkipv6prefix resource.

## SYNTAX

```
Invoke-NSAddOnLinkIPv6Prefix [-Autonomusprefix <String>] [-DecremeNTPRefixlifetimes <String>]
...
### EXAMPLE 1
```
Invoke-NSAddOnLinkIPv6Prefix -IPv6Prefix 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddOnLinkIPv6Prefix -IPv6Prefix 'example' -WhatIf
```
