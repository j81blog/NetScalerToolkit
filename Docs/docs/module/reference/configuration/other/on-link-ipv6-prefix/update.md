...
# Invoke-NSUpdateOnLinkIPv6Prefix

## SYNOPSIS
Updates a NetScaler onlinkipv6prefix resource.

## SYNTAX

```
Invoke-NSUpdateOnLinkIPv6Prefix [-Autonomusprefix <String>] [-DecremeNTPRefixlifetimes <String>]
 [-Depricateprefix <String>] [-IPv6Prefix] <String> [-Onlinkprefix <String>] [-Prefixpreferredlifetime <Int32>]
 [-Prefixvalidelifetime <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateOnLinkIPv6Prefix -IPv6Prefix 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateOnLinkIPv6Prefix -IPv6Prefix 'example' -WhatIf
```
