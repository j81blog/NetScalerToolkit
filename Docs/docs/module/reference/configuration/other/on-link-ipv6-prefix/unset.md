...
# Invoke-NSUnsetOnLinkIPv6Prefix

## SYNOPSIS
Clears one or more NetScaler onlinkipv6prefix resource properties.

## SYNTAX

```
Invoke-NSUnsetOnLinkIPv6Prefix [-IPv6Prefix] <String> [-Autonomusprefix] [-DecremeNTPRefixlifetimes]
 [-Depricateprefix] [-Onlinkprefix] [-Prefixpreferredlifetime] [-Prefixvalidelifetime] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUnsetOnLinkIPv6Prefix -IPv6Prefix 'example' -Autonomusprefix YES -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetOnLinkIPv6Prefix -IPv6Prefix 'example' -Autonomusprefix YES -WhatIf
```
