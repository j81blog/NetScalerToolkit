...
# Invoke-NSAddCentralManagementServer

## SYNOPSIS
Creates a NetScaler nscentralmanagementserver resource.

## SYNTAX

```
Invoke-NSAddCentralManagementServer [-Activationcode <String>] [-Adcpassword <String>] [-AdcUserName <String>]
 [-DeviceProfileName <String>] [-Ipaddress <String>] [-Password <String>] [-ServerName <String>]
 [-Type] <String> [-UserName <String>] [-ValidateCert <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddCentralManagementServer -Type CLOUD -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddCentralManagementServer -Type CLOUD -WhatIf
```
...
### -Password
Password for access to central management server.
Required for any user account.
Minimum length = 1 Maximum length = 127
...
### -UserName
Username for access to central management server.
