...
```powershell
Invoke-NSGetOspfDataBase [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-ProcessId <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
