...
```powershell
Invoke-NSGetRoutemap [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-Name <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
