...
```
Invoke-NSUnsetOspf6router [-Addressfamily] [-Afparams] [-Metric] [-MetricType] [-Passiveinterface] [-Protocol]
 [-Redistribute] [-Routemap] [-Routerdynamicrouting] [-Routerid] [-Tagid] [[-Session] <PSObject>]
