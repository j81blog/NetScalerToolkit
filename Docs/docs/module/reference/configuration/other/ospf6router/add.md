...
```
Invoke-NSAddOspf6router [[-Addressfamily] <String>] [[-Afparams] <String>] [[-Metric] <String>]
 [[-MetricType] <String>] [[-Passiveinterface] <String>] [[-Protocol] <String>] [[-Redistribute] <String>]
 [[-Routemap] <String>] [[-Routerdynamicrouting] <String>] [[-Routerid] <String>] [-Tagid] <String>
...
Possible values: bgp, connected, isis, kernel, ospf, rip, static
