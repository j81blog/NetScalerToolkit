...
# Invoke-NSAddChannelInterfaceBinding

## SYNOPSIS
Creates a NetScaler channel_interface_binding resource.

## SYNTAX

```
Invoke-NSAddChannelInterfaceBinding [-Id] <String> -Ifnum <String[]> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddChannelInterfaceBinding -Id 'example' -Ifnum 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddChannelInterfaceBinding -Id 'example' -Ifnum 'example' -WhatIf
```
