...
```powershell
Invoke-NSDeleteChannelInterfaceBinding -Id <String> -Ifnum <String[]> [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
