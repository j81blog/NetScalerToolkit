...
## SYNOPSIS
Gets NetScaler channel_interface_binding configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetChannelInterfaceBinding [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetChannelInterfaceBinding [-Id] <String> [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetChannelInterfaceBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetChannelInterfaceBinding -Id 'channel_interface_binding_example'
```

### EXAMPLE 3
```
Invoke-NSGetChannelInterfaceBinding -Filter @{ servicetype = 'HTTP' }
```
