...
## SYNOPSIS
Removes a NetScaler bridgetable resource.

## SYNTAX

```
Invoke-NSDeleteBridgeTable [-Mac] <String> [-Vxlan] <Int32> [-Vtep] <String> [[-Devicevlan] <Int32>]
...
### EXAMPLE 1
```
Invoke-NSDeleteBridgeTable -Mac 'example' -Vxlan 1 -Vtep 'example' -Devicevlan 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetBridgeTable  | Invoke-NSDeleteBridgeTable -Confirm:$false
```
