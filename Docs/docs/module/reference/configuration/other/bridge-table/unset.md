...
# Invoke-NSUnsetBridgeTable

## SYNOPSIS
Clears one or more NetScaler bridgetable resource properties.

## SYNTAX

```
Invoke-NSUnsetBridgeTable [-BridgeAge] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUnsetBridgeTable -BridgeAge  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetBridgeTable -BridgeAge  -WhatIf
```
