...
## SYNOPSIS
Updates a NetScaler bridgetable resource.

## SYNTAX

```
Invoke-NSUpdateBridgeTable [[-BridgeAge] <Int32>] [[-Session] <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateBridgeTable  -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateBridgeTable  -WhatIf
```
