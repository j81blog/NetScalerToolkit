...
```
Invoke-NSAddEndpointInfo [[-EndpointKind] <String>] [-EndpointLabelSJson <String>] [-EndpointmetaData <String>]
 -EndpointName <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
...
### -EndpointLabelSJson
String representing labels in json form.
Maximum length 16K.
Minimum length = 1
