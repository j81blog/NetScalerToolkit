...
```
Invoke-NSUpdateEndpointInfo [[-EndpointKind] <String>] [-EndpointLabelSJson <String>]
 [-EndpointmetaData <String>] -EndpointName <String> [-Session <PSObject>] [-IgnoreNotFound]
