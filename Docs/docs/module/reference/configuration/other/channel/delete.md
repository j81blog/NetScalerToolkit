...
# Invoke-NSDeleteChannel

## SYNOPSIS
Removes a NetScaler channel resource.

## SYNTAX

```
Invoke-NSDeleteChannel [-Id] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteChannel -Id 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetChannel -Id 'channel_example' | Invoke-NSDeleteChannel -Confirm:$false
```
