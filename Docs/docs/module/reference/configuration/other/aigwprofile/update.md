...
# Invoke-NSUpdateAIGWProfile

## SYNOPSIS
Updates a NetScaler nsaigwprofile resource.

## SYNTAX

```
Invoke-NSUpdateAIGWProfile [-Name] <String> [-Quotarefreshfrequency <Int32>] [-Tokenquota <Int32>]
...
### EXAMPLE 1
```
Invoke-NSUpdateAIGWProfile -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateAIGWProfile -Name 'example' -WhatIf
```
