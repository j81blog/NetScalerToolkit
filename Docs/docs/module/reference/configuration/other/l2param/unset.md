...
# Invoke-NSUnsetL2param

## SYNOPSIS
Clears one or more NetScaler l2param resource properties.

## SYNTAX

```
Invoke-NSUnsetL2param [-BdggrpProxyArp] [-Bdgsetting] [-BridgeAgeTimeout] [-Garponvridintf] [-Garpreply]
 [-MacModeFwdmypkt] [-MaxBridgeCollision] [-MbfinstLearning] [-Mbfpeermacupdate] [-ProxyArp]
 [-Returntoethernetsender] [-Rstintfonhafo] [-SkipProxyIngbsdtraffic] [-Stopmacmoveupdate] [-Usemymac]
 [-UsenetProfileBsdtraffic] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
...
### EXAMPLE 1
```
Invoke-NSUnsetL2param -BdggrpProxyArp ENABLED -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetL2param -BdggrpProxyArp ENABLED -WhatIf
```
