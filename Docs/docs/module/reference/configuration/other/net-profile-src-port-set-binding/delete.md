...
## SYNOPSIS
Removes a NetScaler netprofile_srcportset_binding resource.

## SYNTAX

```
Invoke-NSDeleteNetProfileSrcPortSetBinding [-Name] <String> [-SrcPortRange <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSDeleteNetProfileSrcPortSetBinding -Name 'example' -SrcPortRange 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetNetProfileSrcPortSetBinding -Name 'netprofile_srcportset_binding_example' | Invoke-NSDeleteNetProfileSrcPortSetBinding -Confirm:$false
```
