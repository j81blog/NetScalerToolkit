...
```
Invoke-NSUpdateQUICProfile [-Ackdelayexponent <Int32>] [-ActiveConnectionIdlimit <Int32>]
 [-ActiveConnectionMigration <String>] [-Congestionctrlalgorithm <String>] [-InitialMaxData <Int32>]
 [-InitialMaxStreamDataBidiLocal <Int32>] [-InitialMaxStreamDataBidiremote <Int32>]
 [-InitialMaxStreamDataUni <Int32>] [-InitialMaxStreamsbidi <Int32>] [-InitialMaxStreamsuni <Int32>]
 [-MaxAckdelay <Int32>] [-MaxIdleTimeout <Int32>] [-MaxUDPDataGramsperburst <Int32>]
 [-MaxUDPPayloadsize <Int32>] [-Name] <String> [-NewtokenvalidiTypeRiod <Int32>]
 [-RetrytokenvalidiTypeRiod <Int32>] [-Statelessaddressvalidation <String>] [-Session <PSObject>]
