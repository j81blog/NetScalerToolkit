...
# Invoke-NSUnsetQUICBridgeProfile
...
```
Invoke-NSUnsetQUICBridgeProfile [-Name] <String> [-Routingalgorithm] [-ServerIdLength] [-Session <PSObject>]
...
Default value: PLAINTEXT Possible values = PLAINTEXT
...
Default value: 4 Minimum value = 2 Maximum value = 38
