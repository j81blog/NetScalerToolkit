...
```
Invoke-NSAddOspfrouter [[-Area] <String>] [[-Ipaddress] <String>] [[-Metric] <String>] [[-MetricType] <String>]
 [[-NetMask] <String>] [[-Networks] <String>] [[-OspfProcessId] <String>] [[-Passiveinterface] <String>]
 [-ProcessId] <String> [[-Protocol] <String>] [[-Redistribute] <String>] [[-Routemap] <String>]
 [[-Routerdynamicrouting] <String>] [[-Routerid] <String>] [[-Tag] <String>] [[-Session] <PSObject>]
