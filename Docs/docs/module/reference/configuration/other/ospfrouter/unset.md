...
```
Invoke-NSUnsetOspfrouter [-Area] [-Ipaddress] [-Metric] [-MetricType] [-NetMask] [-Networks] [-OspfProcessId]
 [-Passiveinterface] [-ProcessId] [-Protocol] [-Redistribute] [-Routemap] [-Routerdynamicrouting] [-Routerid]
 [-Tag] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [-PassThru]
...
Possible values: bgp, connected, intranet, isis, kernel, ospf, rip, static
