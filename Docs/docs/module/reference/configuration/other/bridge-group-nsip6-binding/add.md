...
## SYNOPSIS
Creates a NetScaler bridgegroup_nsip6_binding resource.

## SYNTAX

```
Invoke-NSAddBridgeGroupNSIP6Binding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>]
 [-OwnerGroup <String>] [-TrafficDomain <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddBridgeGroupNSIP6Binding -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddBridgeGroupNSIP6Binding -Id 1 -WhatIf
```
