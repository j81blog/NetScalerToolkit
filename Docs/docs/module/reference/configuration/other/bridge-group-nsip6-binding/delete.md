...
## SYNOPSIS
Removes a NetScaler bridgegroup_nsip6_binding resource.

## SYNTAX

```
Invoke-NSDeleteBridgeGroupNSIP6Binding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>]
 [-TrafficDomain <Int32>] [-OwnerGroup <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteBridgeGroupNSIP6Binding -Id 1 -Ipaddress 'example' -NetMask '255.255.255.255' -OwnerGroup 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetBridgeGroupNSIP6Binding -Id 'bridgegroup_nsip6_binding_example' | Invoke-NSDeleteBridgeGroupNSIP6Binding -Confirm:$false
```
