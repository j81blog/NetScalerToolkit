...
```
Invoke-NSUpdateSubscriberProfile [-Ip] <String> [-ServicePath <String>] [-Subscriberrules <String[]>]
 [-SubscriptionidType <String>] [-Subscriptionidvalue <String>] [-Vlan <Int32>] [-Session <PSObject>]
...
### -Subscriberrules
Rules configured for this subscriber.
This is similar to rules received from PCRF for dynamic subscriber sessions.
...
Default value: 0 Minimum value = 0 Maximum value = 4096
