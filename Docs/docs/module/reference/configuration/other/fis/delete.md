...
## SYNOPSIS
Removes a NetScaler fis resource.

## SYNTAX

```
Invoke-NSDeleteFIS [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteFIS -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetFIS -Name 'fis_example' | Invoke-NSDeleteFIS -Confirm:$false
```
