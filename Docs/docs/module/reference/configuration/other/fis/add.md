...
## SYNOPSIS
Creates a NetScaler fis resource.

## SYNTAX

```
Invoke-NSAddFIS [-Name] <String> [-Ownernode <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddFIS -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddFIS -Name 'example' -WhatIf
```
...
### -Ownernode
ID of the cluster node for which you are creating the FIS.
