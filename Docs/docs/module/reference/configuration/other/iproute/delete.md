...
```
Invoke-NSDeleteIproute [[-Nexthop] <String>] [-Prefix] <String> [-PrefixLength] <String>
 [-Addressfamily] <String> [[-Interface] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
