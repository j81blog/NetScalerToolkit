...
```
Invoke-NSAddOspf6interface [[-Areaid] <String>] [[-Cost] <String>] [[-DeadInterval] <String>]
 [[-HelloInterval] <String>] [[-Instanceid] <String>] [-Name] <String> [[-NetworkType] <String>]
 [[-Priority] <String>] [[-RetransmitInterval] <String>] [[-Routerdynamicrouting] <String>] [[-Tagid] <String>]
 [[-Transmitdelay] <String>] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
