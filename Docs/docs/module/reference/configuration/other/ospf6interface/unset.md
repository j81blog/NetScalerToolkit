...
```
Invoke-NSUnsetOspf6interface [-Areaid] [-Cost] [-DeadInterval] [-HelloInterval] [-Instanceid] [-Name]
 [-NetworkType] [-Priority] [-RetransmitInterval] [-Routerdynamicrouting] [-Tagid] [-Transmitdelay]
