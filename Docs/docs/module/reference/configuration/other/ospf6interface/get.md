...
```powershell
Invoke-NSGetOspf6interface [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-Name <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
