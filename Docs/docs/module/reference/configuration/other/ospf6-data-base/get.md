...
```powershell
Invoke-NSGetOspf6DataBase [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-Tagid <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
