...
```
Invoke-NSUnsetBgprouter [-Activate] [-Address] [-Addressfamily] [-AdvertisementInterval] [-Afparams]
 [-AsoriginationInterval] [-ConnEcttimer] [-Direction] [-Keepalivetimerconfig] [-LocalAs] [-Md5password]
 [-MultiHopbfd] [-Name] [-Neighbor] [-Protocol] [-Redistribute] [-Remoteas] [-Routemap] [-Routerdynamicrouting]
 [-Routerid] [-Singlehopbfd] [-TCPMss] [-Updatesource] [[-Session] <PSObject>] [-IgnoreNotFound]
