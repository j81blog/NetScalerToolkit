...
# Invoke-NSUpdateRoute6

## SYNOPSIS
Updates a NetScaler route6 resource.

## SYNTAX

```
Invoke-NSUpdateRoute6 [-Advertise <String>] [-Cost <Int32>] [-Distance <Int32>] [-Gateway <String>]
 [-MonItor <String>] [-Msr <String>] [-Network] <String> [-TrafficDomain <Int32>] [-Vlan <Int32>]
 [-Vxlan <Int32>] [-Weight <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateRoute6 -Network 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateRoute6 -Network 'example' -WhatIf
```
