...
# Invoke-NSClearRoute6

## SYNOPSIS
Clears NetScaler route6 data.

## SYNTAX

```
Invoke-NSClearRoute6 [-RouteType] <String> [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSClearRoute6 -RouteType CONNECTED
```

### EXAMPLE 2
```
Invoke-NSClearRoute6 -RouteType CONNECTED -WhatIf
```
