...
## SYNOPSIS
Updates a NetScaler ipv6 resource.

## SYNTAX

```
Invoke-NSUpdateIPv6 [-Dodad <String>] [-Natprefix <String>] [-Ndbasereachtime <Int32>]
 [-Ndretransmissiontime <Int32>] [-RaLearning <String>] [-RouterRedirectIon <String>]
 [[-TrafficDomain] <Int32>] [-USIPNatprefix <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateIPv6 -TrafficDomain 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateIPv6 -TrafficDomain 1 -WhatIf
```
