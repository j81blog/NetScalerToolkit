...
```
Invoke-NSUpdateServer [-Comment <String>] [-Domainresolvenow <Boolean>] [-Domainresolveretry <Int32>]
 [-Ipaddress <String>] [-Name] <String> [-Translationip <String>] [-TranslationMask <String>]
