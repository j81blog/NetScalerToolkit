...
## SYNOPSIS
Gets NetScaler nstcpprofile configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetTCPProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetTCPProfile [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetTCPProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetTCPProfile -Name 'nstcpprofile_example'
```

### EXAMPLE 3
```
Invoke-NSGetTCPProfile -Filter @{ servicetype = 'HTTP' }
```
