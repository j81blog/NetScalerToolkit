...
# Invoke-NSUpdateTCPProfile

## SYNOPSIS
Updates a NetScaler nstcpprofile resource.

## SYNTAX

```
Invoke-NSUpdateTCPProfile [-Ackaggregation <String>] [-Ackonpush <String>] [-ApplyadaptiveTCP <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateTCPProfile -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateTCPProfile -Name 'example' -WhatIf
```
