...
```
Invoke-NSUpdateDbdbProfile [-ConMultiPlex <String>] [-Enablecachingconmuxoff <String>]
 [-Interpretquery <String>] [-KCDAccount <String>] [-Name] <String> [-Stickiness <String>]
