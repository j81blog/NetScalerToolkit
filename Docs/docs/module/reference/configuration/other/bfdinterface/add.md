...
```
Invoke-NSAddBfdinterface [[-Interval] <String>] [[-MinRx] <String>] [[-MultiPlier] <String>] [-Name] <String>
 [[-Passive] <String>] [[-Routerdynamicrouting] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
