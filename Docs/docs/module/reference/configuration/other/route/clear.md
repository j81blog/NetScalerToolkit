...
## SYNOPSIS
Clears NetScaler route data.

## SYNTAX

```
Invoke-NSClearRoute [-RouteType] <String> [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSClearRoute -RouteType CONNECTED
```

### EXAMPLE 2
```
Invoke-NSClearRoute -RouteType CONNECTED -WhatIf
```
