...
## SYNOPSIS
Updates a NetScaler route resource.

## SYNTAX

```
Invoke-NSUpdateRoute [-Advertise <String>] [-Cost1 <Int32>] [-Distance <Int32>] -Gateway <String>
 [-MonItor <String>] [-Msr <String>] -NetMask <String> [-Network] <String> [-Protocol <String[]>]
 [-TrafficDomain <Int32>] [-Weight <Int32>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateRoute -Network 'example' -Gateway 'example' -NetMask '255.255.255.255' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateRoute -Network 'example' -Gateway 'example' -NetMask '255.255.255.255' -WhatIf
```
