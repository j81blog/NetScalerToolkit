...
## SYNOPSIS
Updates a NetScaler bridgegroup resource.

## SYNTAX

```
Invoke-NSUpdateBridgeGroup [-Dynamicrouting <String>] [-Id] <Int32> [-IPv6Dynamicrouting <String>]
...
### EXAMPLE 1
```
Invoke-NSUpdateBridgeGroup -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateBridgeGroup -Id 1 -WhatIf
```
