...
# Invoke-NSUnsetBridgeGroup

## SYNOPSIS
Clears one or more NetScaler bridgegroup resource properties.

## SYNTAX

```
Invoke-NSUnsetBridgeGroup [-Id] <Int32> [-Dynamicrouting] [-IPv6Dynamicrouting] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUnsetBridgeGroup -Id 1 -Dynamicrouting ENABLED -PassThru
```

### EXAMPLE 2
```
Invoke-NSUnsetBridgeGroup -Id 1 -Dynamicrouting ENABLED -WhatIf
```
