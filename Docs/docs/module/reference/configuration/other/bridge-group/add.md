...
## SYNOPSIS
Creates a NetScaler bridgegroup resource.

## SYNTAX

```
Invoke-NSAddBridgeGroup [-Dynamicrouting <String>] [-Id] <Int32> [-IPv6Dynamicrouting <String>]
...
### EXAMPLE 1
```
Invoke-NSAddBridgeGroup -Id 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddBridgeGroup -Id 1 -WhatIf
```
