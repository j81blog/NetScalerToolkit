...
## SYNOPSIS
Creates a NetScaler ipset resource.

## SYNTAX

```
Invoke-NSAddIPSet [-Name] <String> [-TrafficDomain <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddIPSet -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddIPSet -Name 'example' -WhatIf
```
