...
## SYNOPSIS
Creates a NetScaler ip6tunnel resource.

## SYNTAX

```
Invoke-NSAddIP6Tunnel -Local <String> [-Name] <String> [-OwnerGroup <String>] -Remote <String>
...
### EXAMPLE 1
```
Invoke-NSAddIP6Tunnel -Name 'example' -Local 'example' -Remote 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddIP6Tunnel -Name 'example' -Local 'example' -Remote 'example' -WhatIf
```
