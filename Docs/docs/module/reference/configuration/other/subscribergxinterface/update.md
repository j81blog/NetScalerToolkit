...
```
Invoke-NSUpdateSubscribergxinterface [[-CerRequestTimeout] <Int32>] [[-HealthCheck] <String>]
 [[-HealthCheckttl] <Int32>] [[-Holdonsubscriberabsence] <String>] [[-Idlettl] <Int32>]
 [[-Negativettl] <Int32>] [[-NegativettllimitedSuccess] <String>] [[-Pcrfrealm] <String>]
 [[-Purgesdbongxfailure] <String>] [[-RequestRetryattempts] <Int32>] [[-RequestTimeout] <Int32>]
 [[-RevalidationTimeout] <Int32>] [[-Service] <String>] [[-ServicePathavp] <String>]
 [[-ServicePathvendorid] <Int32>] [[-VServer] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
...
### -Pcrfrealm
PCRF realm is of type DiameterIdentity and contains the realm of PCRF to which the message is to be routed.
This is the realm used in Destination-Realm AVP by Citrix ADC Gx client (as a Diameter node).
Minimum length = 1
