...
### All (Default)
```
Invoke-NSGetRouterdynamicrouting [-Filter <Hashtable>] [-ViewSummary] [-Commandstring <String>]
...
### Count
```
Invoke-NSGetRouterdynamicrouting [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
