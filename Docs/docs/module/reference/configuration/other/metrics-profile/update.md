...
# Invoke-NSUpdateMetricsProfile

## SYNOPSIS
Updates a NetScaler metricsprofile resource.

## SYNTAX

```
Invoke-NSUpdateMetricsProfile [-Collector <String>] [-Metrics <String>] [-Metricsauthtoken <String>]
 [-MetricsendpointURL <String>] [-MetricsexPortFrequency <Int32>] [-Name] <String> [-OutputMode <String>]
 [-SchemaFile <String>] [-ServeMode <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
### EXAMPLE 1
```
Invoke-NSUpdateMetricsProfile -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateMetricsProfile -Name 'example' -WhatIf
```
