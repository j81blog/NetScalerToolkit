...
# Invoke-NSAddExtension

## SYNOPSIS
Creates a NetScaler nsextension resource.

## SYNTAX

```
Invoke-NSAddExtension [-Comment <String>] [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddExtension -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddExtension -Name 'example' -WhatIf
```
