...
## SYNOPSIS
Removes a NetScaler bridgegroup_nsip_binding resource.

## SYNTAX

```
Invoke-NSDeleteBridgeGroupIPBinding [-Id] <Int32> [-Ipaddress <String>] [-NetMask <String>]
...
### EXAMPLE 1
```
Invoke-NSDeleteBridgeGroupIPBinding -Id 1 -Ipaddress 'example' -NetMask '255.255.255.255' -OwnerGroup 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetBridgeGroupIPBinding -Id 'bridgegroup_nsip_binding_example' | Invoke-NSDeleteBridgeGroupIPBinding -Confirm:$false
```
