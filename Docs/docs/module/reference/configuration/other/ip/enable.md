...
## SYNOPSIS
Enables a NetScaler nsip resource.

## SYNTAX

```
Invoke-NSEnableIP [-Ipaddress] <String> [-TrafficDomain <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSEnableIP -Ipaddress 'nsip_example' -PassThru
```
