...
## SYNOPSIS
Disables a NetScaler nsip resource.

## SYNTAX

```
Invoke-NSDisableIP [-Ipaddress] <String> [-TrafficDomain <Int32>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSDisableIP -Ipaddress 'nsip_example' -PassThru
```
