...
### All (Default)
```
Invoke-NSGetLocationFile6 [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetLocationFile6 [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
