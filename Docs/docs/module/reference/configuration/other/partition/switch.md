...
# Invoke-NSSwitchPartition

## SYNOPSIS
Switches to a NetScaler partition.

## SYNTAX

```
Invoke-NSSwitchPartition [-Force <Boolean>] [-PartitionName] <String> [-Save <Boolean>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSSwitchPartition -PartitionName 'example'
```

### EXAMPLE 2
```
Invoke-NSSwitchPartition -PartitionName 'example' -WhatIf
```

## PARAMETERS

### -Force
Switches to new admin partition without prompt for saving configuration.
