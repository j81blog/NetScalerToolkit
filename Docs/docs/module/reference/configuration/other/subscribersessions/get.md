...
### All (Default)
```
Invoke-NSGetSubscribersessions [-Filter <Hashtable>] [-ViewSummary] [-Ip <String>] [-Vlan <Int32>]
...
### Count
```
Invoke-NSGetSubscribersessions [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
