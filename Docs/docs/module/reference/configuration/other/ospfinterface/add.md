...
```
Invoke-NSAddOspfinterface [[-AuthKey] <String>] [[-AuthType] <String>] [[-Bfd] <String>] [[-Cost] <String>]
 [[-DeadInterval] <String>] [[-HelloInterval] <String>] [[-Mtu] <String>] [-Name] <String>
 [[-NetworkType] <String>] [[-Priority] <String>] [[-RetransmitInterval] <String>]
 [[-Routerdynamicrouting] <String>] [[-Transmitdelay] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
