...
```
Invoke-NSUnsetOspfinterface [-AuthKey] [-AuthType] [-Bfd] [-Cost] [-DeadInterval] [-HelloInterval] [-Mtu]
 [-Name] [-NetworkType] [-Priority] [-RetransmitInterval] [-Routerdynamicrouting] [-Transmitdelay]
