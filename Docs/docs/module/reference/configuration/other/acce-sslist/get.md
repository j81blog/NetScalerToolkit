...
```powershell
Invoke-NSGetAcceSSLIst [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-Id <String>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
