...
```
Invoke-NSAddAcceSSLIst [[-Action] <String>] [[-Address] <String>] [[-Id] <String>] [[-Remark] <String>]
 [[-Routerdynamicrouting] <String>] [[-Rules] <String>] [[-Wildcard] <String>] [[-Session] <PSObject>]
