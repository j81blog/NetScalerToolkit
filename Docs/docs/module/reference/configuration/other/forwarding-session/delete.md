...
# Invoke-NSDeleteForwardingSession

## SYNOPSIS
Removes a NetScaler forwardingsession resource.

## SYNTAX

```
Invoke-NSDeleteForwardingSession [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSDeleteForwardingSession -Name 'example' -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetForwardingSession -Name 'forwardingsession_example' | Invoke-NSDeleteForwardingSession -Confirm:$false
```
