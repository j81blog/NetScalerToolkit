...
## SYNOPSIS
Creates a NetScaler forwardingsession resource.

## SYNTAX

```
Invoke-NSAddForwardingSession [-Acl6Name <String>] [-AclName <String>] [-ConnFailover <String>]
 [-Name] <String> [-NetMask <String>] [-Network <String>] [-ProcessLocal <String>] [-Sourceroutecache <String>]
...
### EXAMPLE 1
```
Invoke-NSAddForwardingSession -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddForwardingSession -Name 'example' -WhatIf
```
