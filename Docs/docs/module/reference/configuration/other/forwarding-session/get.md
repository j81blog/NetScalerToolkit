...
## SYNOPSIS
Gets NetScaler forwardingsession configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetForwardingSession [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetForwardingSession [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetForwardingSession [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetForwardingSession -Name 'forwardingsession_example'
```

### EXAMPLE 3
```
Invoke-NSGetForwardingSession -Filter @{ servicetype = 'HTTP' }
```
