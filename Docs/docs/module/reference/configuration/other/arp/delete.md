...
## SYNOPSIS
Removes a NetScaler arp resource.

## SYNTAX

```
Invoke-NSDeleteArp [-Ipaddress] <String> [-TrafficDomain <Int32>] [-All <Boolean>] [-Ownernode <Int32>]
...
### EXAMPLE 1
```
Invoke-NSDeleteArp -Ipaddress 'example' -All $true -Ownernode 1 -Confirm:$false
```

### EXAMPLE 2
```
Invoke-NSGetArp -Ipaddress 'arp_example' | Invoke-NSDeleteArp -Confirm:$false
```
