...
# Invoke-NSUpdateVariable

## SYNOPSIS
Updates a NetScaler nsvariable resource.

## SYNTAX

```
Invoke-NSUpdateVariable [-Comment <String>] [-Expires <Int32>] [-Iffull <String>] [-Ifnovalue <String>]
 [-Ifvaluetoobig <String>] [-Init <String>] [-Name] <String> [-Type <String>] [-Session <PSObject>]
...
### EXAMPLE 1
```
Invoke-NSUpdateVariable -Name 'example' -Comment 'Updated by automation' -PassThru
```

### EXAMPLE 2
```
Invoke-NSUpdateVariable -Name 'example' -Comment 'Updated by automation' -WhatIf
```
