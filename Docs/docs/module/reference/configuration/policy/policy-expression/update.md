...
```
Invoke-NSUpdatePolicyExpression [-ClientsEcurityMessage <String>] [-Comment <String>] [-Name] <String>
 [-Value <String>] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
