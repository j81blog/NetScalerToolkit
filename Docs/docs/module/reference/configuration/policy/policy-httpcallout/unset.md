...
```
Invoke-NSUnsetPolicyHTTPCallout [-Name] <String> [-Bodyexpr] [-Cacheforsecs] [-Comment] [-Fullreqexpr]
 [-HeaderS] [-HostExpr] [-HTTPMethod] [-Ipaddress] [-Parameters] [-Port] [-Resultexpr] [-URLStemexpr]
 [-VServer] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [-PassThru]
