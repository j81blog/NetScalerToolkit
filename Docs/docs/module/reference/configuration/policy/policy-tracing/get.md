...
### All (Default)
```
Invoke-NSGetPolicyTracing [-Filter <Hashtable>] [-ViewSummary] [-TransActionId <String>] [-Detail <String>]
...
### Count
```
Invoke-NSGetPolicyTracing [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
...
Default value: all Possible values = brief, all
