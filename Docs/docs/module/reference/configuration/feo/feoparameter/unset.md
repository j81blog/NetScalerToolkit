...
```
Invoke-NSUnsetFeoparameter [-Cssinlinethressize] [-Imginlinethressize] [-JpegqualiTypeRcent]
 [-Jsinlinethressize] [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
...
Default value: 1024 Minimum value = 1 Maximum value = 2048
...
Range: 0 - 100.
Default value: 75 Minimum value = 0 Maximum value = 100
