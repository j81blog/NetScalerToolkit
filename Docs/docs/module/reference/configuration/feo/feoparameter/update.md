...
```
Invoke-NSUpdateFeoparameter [[-Cssinlinethressize] <Int32>] [[-Imginlinethressize] <Int32>]
 [[-JpegqualiTypeRcent] <Int32>] [[-Jsinlinethressize] <Int32>] [[-Session] <PSObject>] [-IgnoreNotFound]
