...
## SYNOPSIS
Creates a NetScaler appfwprofile_sqlinjection_binding resource.

## SYNTAX

```
Invoke-NSAddAppFwProfileSqlinjectionBinding [-AsScanLocationSql <String>] [-AsValueExprSql <String>]
 [-AsValueTypeSql <String>] [-Comment <String>] [-FormActionURLSql <String>] [-Isautodeployed <String>]
 [-IsregexSql <String>] [-IsvalueregexSql <String>] [-Name] <String> [-Resourceid <String>]
 [-RuleType <String>] [-Sqlinjection <String>] [-State <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddAppFwProfileSqlinjectionBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAppFwProfileSqlinjectionBinding -Name 'example' -WhatIf
```
