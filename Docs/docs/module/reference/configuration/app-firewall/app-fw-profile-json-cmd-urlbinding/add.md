...
## SYNOPSIS
Creates a NetScaler appfwprofile_jsoncmdurl_binding resource.

## SYNTAX

```
Invoke-NSAddAppFwProfileJsonCmdURLBinding [-AsValueExprJsonCmd <String>] [-AsValueTypeJsonCmd <String>]
 [-Comment <String>] [-Isautodeployed <String>] [-IsKeyRegexJsonCmd <String>] [-IsvalueregexJsonCmd <String>]
 [-JsonCmdURL <String>] [-KeyNameJsonCmd <String>] [-Name] <String> [-Resourceid <String>] [-RuleType <String>]
...
### EXAMPLE 1
```
Invoke-NSAddAppFwProfileJsonCmdURLBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAppFwProfileJsonCmdURLBinding -Name 'example' -WhatIf
```
