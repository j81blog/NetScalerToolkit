...
## SYNOPSIS
Creates a NetScaler appfwprofile_fieldformat_binding resource.

## SYNTAX

```
Invoke-NSAddAppFwProfileFieldFormAtBinding [-Comment <String>] [-FieldFormAt <String>]
 [-FieldFormAtMaxLength <Int32>] [-FieldFormAtMinLength <Int32>] [-FieldType <String>]
 [-FormActionURLFf <String>] [-Isautodeployed <String>] [-IsregexFf <String>] [-Name] <String>
 [-Resourceid <String>] [-RuleType <String>] [-State <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 1
```
Invoke-NSAddAppFwProfileFieldFormAtBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAppFwProfileFieldFormAtBinding -Name 'example' -WhatIf
```
