...
## SYNOPSIS
Gets NetScaler appfwfieldtype configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAppFwFieldType [-Filter <Hashtable>] [-ViewSummary] [-Nocharmaps] [-Session <PSObject>]
 [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAppFwFieldType [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAppFwFieldType [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAppFwFieldType -Name 'appfwfieldtype_example'
```

### EXAMPLE 3
```
Invoke-NSGetAppFwFieldType -Filter @{ servicetype = 'HTTP' }
```
