...
## SYNOPSIS
Creates a NetScaler appfwprofile_restvalidation_binding resource.

## SYNTAX

```
Invoke-NSAddAppFwProfileRestvalidationBinding [-Comment <String>] [-Isautodeployed <String>] [-Name] <String>
 [-Resourceid <String>] [-RestValidationAction <String>] [-Restvalidation <String>] [-RuleType <String>]
...
### EXAMPLE 1
```
Invoke-NSAddAppFwProfileRestvalidationBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAppFwProfileRestvalidationBinding -Name 'example' -WhatIf
```
