...
## SYNOPSIS
Gets NetScaler appfwglobal_appfwpolicy_binding configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAppFwGlobalAppFwPolicyBinding [-Filter <Hashtable>] [-ViewSummary] [-Type <String>]
 [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAppFwGlobalAppFwPolicyBinding [-Count] [-Session <PSObject>] [-IgnoreNotFound]
...
### EXAMPLE 2
```
Invoke-NSGetAppFwGlobalAppFwPolicyBinding -Filter @{ servicetype = 'HTTP' }
```
