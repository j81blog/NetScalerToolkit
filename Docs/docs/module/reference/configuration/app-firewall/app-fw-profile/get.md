...
## SYNOPSIS
Gets NetScaler appfwprofile configuration.

## SYNTAX

### All (Default)
```
Invoke-NSGetAppFwProfile [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### ByName
```
Invoke-NSGetAppFwProfile [-Name] <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetAppFwProfile [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
 [-ThrowOnWarning] [<CommonParameters>]
```
...
### EXAMPLE 2
```
Invoke-NSGetAppFwProfile -Name 'appfwprofile_example'
```

### EXAMPLE 3
```
Invoke-NSGetAppFwProfile -Filter @{ servicetype = 'HTTP' }
```
