...
## SYNOPSIS
Creates a NetScaler appfwprofile_jsonxssurl_binding resource.

## SYNTAX

```
Invoke-NSAddAppFwProfileJsonXssURLBinding [-AsValueExprJsonXss <String>] [-AsValueTypeJsonXss <String>]
 [-Comment <String>] [-Isautodeployed <String>] [-IsKeyRegexJsonXss <String>] [-IsvalueregexJsonXss <String>]
 [-JsonXssURL <String>] [-KeyNameJsonXss <String>] [-Name] <String> [-Resourceid <String>] [-RuleType <String>]
...
### EXAMPLE 1
```
Invoke-NSAddAppFwProfileJsonXssURLBinding -Name 'example' -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAppFwProfileJsonXssURLBinding -Name 'example' -WhatIf
```
