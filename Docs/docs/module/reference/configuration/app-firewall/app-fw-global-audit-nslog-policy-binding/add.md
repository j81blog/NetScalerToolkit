...
## SYNOPSIS
Creates a NetScaler appfwglobal_auditnslogpolicy_binding resource.

## SYNTAX

```
Invoke-NSAddAppFwGlobalAuditNSLogPolicyBinding [[-GotoPriorityExpression] <String>] [[-Invoke] <Boolean>]
 [[-LabelName] <String>] [[-LabelType] <String>] [-PolicyName] <String> [-Priority] <Int32> [[-State] <String>]
...
### EXAMPLE 1
```
Invoke-NSAddAppFwGlobalAuditNSLogPolicyBinding -PolicyName 'example' -Priority 1 -PassThru
```

### EXAMPLE 2
```
Invoke-NSAddAppFwGlobalAuditNSLogPolicyBinding -PolicyName 'example' -Priority 1 -WhatIf
```
...
This is applicable to classic policies only.
