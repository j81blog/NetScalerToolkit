...
```
Invoke-NSUnsetAppFlowAction [-Name] <String> [-BotInsight] [-Ciinsight] [-ClientsIdemeasurements] [-Collectors]
 [-Comment] [-Distributionalgorithm] [-PageTracking] [-Securityinsight] [-VideoAnalytics] [-WebInsight]
