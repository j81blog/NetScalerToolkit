...
```
Invoke-NSAddAppFlowAction [-BotInsight <String>] [-Ciinsight <String>] [-ClientsIdemeasurements <String>]
 [-Collectors <String[]>] [-Comment <String>] [-Distributionalgorithm <String>] [-Metricslog <Boolean>]
 [-Name] <String> [-PageTracking <String>] [-Securityinsight <String>] [-TransActionLog <String>]
 [-VideoAnalytics <String>] [-WebInsight <String>] [-Session <PSObject>] [-IgnoreNotFound]
...
Default value: ALL Possible values = ALL, ANOMALOUS
