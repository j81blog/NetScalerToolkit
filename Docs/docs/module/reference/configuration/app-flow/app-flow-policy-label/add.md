...
# Invoke-NSAddAppFlowPolicyLabel
...
```
Invoke-NSAddAppFlowPolicyLabel [-LabelName] <String> [-PolicyLabelType <String>] [-Session <PSObject>]
...
Default value: HTTP Possible values = HTTP, OTHERTCP, HTTP_QUIC
