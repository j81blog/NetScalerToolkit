...
```
Invoke-NSAddAppFlowGlobalAppFlowPolicyBinding [[-GotoPriorityExpression] <String>] [[-Invoke] <Boolean>]
...
Specify vserver for a policy label associated with a virtual server, or policylabel for a user-defined policy label.
