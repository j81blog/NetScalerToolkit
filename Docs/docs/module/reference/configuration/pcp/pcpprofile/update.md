...
```
Invoke-NSUpdatePCPProfile [-AnnounceMultiCount <Int32>] [-Mapping <String>] [-MaxMaplife <Int32>]
 [-MinMaplife <Int32>] [-Name] <String> [-Peer <String>] [-ThiRDPArty <String>] [-Session <PSObject>]
