...
```
Invoke-NSAddICALatencyProfile [-L7latencyMaxNotifycount <Int32>] [-L7latencyMonItoring <String>]
 [-L7latencynotifyInterval <Int32>] [-L7latencyThresholdFactor <Int32>] [-L7latencywaittime <Int32>]
