...
```powershell
Invoke-NSGetIcaglobalBinding [-Filter <Hashtable>] [-ViewSummary <SwitchParameter>] [-Session <PSObject>] [-IgnoreNotFound <SwitchParameter>] [-ReturnNullOnNotFound <SwitchParameter>] [-ThrowOnWarning <SwitchParameter>]
```
