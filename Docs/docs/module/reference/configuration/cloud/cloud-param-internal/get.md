...
### All (Default)
```
Invoke-NSGetCloudParamInternal [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetCloudParamInternal [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
