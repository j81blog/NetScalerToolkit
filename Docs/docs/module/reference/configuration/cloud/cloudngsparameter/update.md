...
```
Invoke-NSUpdateCloudngsparameter [[-Allowdtls12] <String>] [[-Allowedudtversion] <String>]
 [[-Blockonallowedngstktprof] <String>] [[-CsVServerTicketingdecouple] <String>] [[-Wafprotection] <String>]
...
Default value: V4 Possible values = V4, V5, V6, V7
...
### -Wafprotection
Configure WAF protection for CGS deployment.
The available options are: * EDGE - Edge APIs are WAF protected.
...
Default value: DEFAULT Possible values = DEFAULT, DISABLED, EDGE
