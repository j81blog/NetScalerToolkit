...
```
Invoke-NSAddCloudTunnelVServer [-ListenPolicy <String>] [-ListenPriority <Int32>] [-Name] <String>
 -ServiceType <String> [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound] [-ThrowOnWarning]
