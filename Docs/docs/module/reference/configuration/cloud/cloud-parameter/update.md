...
```
Invoke-NSUpdateCloudParameter [[-Activationcode] <String>] [[-ConnEctorresidence] <String>]
 [[-Controllerfqdn] <String>] [[-ControllerPort] <Int32>] [[-CustomErid] <String>] [[-Deployment] <String>]
 [[-Instanceid] <String>] [[-Resourcelocation] <String>] [[-Session] <PSObject>] [-IgnoreNotFound]
