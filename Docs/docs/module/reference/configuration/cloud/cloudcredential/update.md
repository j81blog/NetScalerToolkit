...
```
Invoke-NSUpdateCloudcredential [-Applicationid] <String> [-Applicationsecret] <String>
 [-Tenantidentifier] <String> [[-Session] <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
