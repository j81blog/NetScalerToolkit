...
```
Invoke-NSUpdateCloudRoutes [-ClientIpaddress <String>] [-Name] <String> -Routesvpcnetwork <String>
 [-Vipsubnet <String>] [-Vipvpcnetwork <String>] [-Session <PSObject>] [-IgnoreNotFound]
