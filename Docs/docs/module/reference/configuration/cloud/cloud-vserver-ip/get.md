...
### All (Default)
```
Invoke-NSGetCloudVServerIp [-Filter <Hashtable>] [-ViewSummary] [-Session <PSObject>] [-IgnoreNotFound]
 [-ReturnNullOnNotFound] [-ThrowOnWarning] [<CommonParameters>]
```

### Count
```
Invoke-NSGetCloudVServerIp [-Count] [-Session <PSObject>] [-IgnoreNotFound] [-ReturnNullOnNotFound]
