# Generated NetScalerToolkit Configuration bundle for category 'user'.

# region Invoke-NSAddUserProtocol
function Invoke-NSAddUserProtocol {
    <#
    .SYNOPSIS
        Creates a NetScaler userprotocol resource.
    .DESCRIPTION
    ...
    .PARAMETER Name
        Unique name for the user protocol. Not case sensitive. Must begin with an ASCII letter or underscore (_) character, and must consist only of ASCII alphanumeric or underscore characters. Minimum length = 1
    .PARAMETER TransPort
        Transport layer's protocol. Possible values = TCP, SSL
    ...
    .EXAMPLE
        Invoke-NSAddUserProtocol -Name 'example' -TransPort TCP -PassThru
    .EXAMPLE
        Invoke-NSAddUserProtocol -Name 'example' -TransPort TCP -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('Extension')) { $properties['extension'] = $Extension }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create userprotocol')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type userprotocol -Payload @{ userprotocol = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetUserProtocol -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddUserProtocol

# region Invoke-NSAddUserVServer
function Invoke-NSAddUserVServer {
    <#
    .SYNOPSIS
        Creates a NetScaler uservserver resource.
    .DESCRIPTION
    ...
    .PARAMETER State
        Initial state of the user vserver. Default value: ENABLED Possible values = ENABLED, DISABLED
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddUserVServer -Name 'example' -Defaultlb 'example' -Ipaddress 'example' -Port 80 -UserProtocol 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddUserVServer -Name 'example' -Defaultlb 'example' -Ipaddress 'example' -Port 80 -UserProtocol 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    $properties = [System.Collections.Generic.Dictionary[string, object]]::new([System.StringComparer]::Ordinal)
    if ($PSBoundParameters.ContainsKey('Comment')) { $properties['comment'] = $Comment }
    if ($PSBoundParameters.ContainsKey('Defaultlb')) { $properties['defaultlb'] = $Defaultlb }
    if ($PSBoundParameters.ContainsKey('Ipaddress')) { $properties['ipaddress'] = $Ipaddress }
    if ($PSBoundParameters.ContainsKey('Name')) { $properties['name'] = $Name }
    if ($PSBoundParameters.ContainsKey('Params')) { $properties['Params'] = $Params }
    if ($PSBoundParameters.ContainsKey('Port')) { $properties['port'] = $Port }
    if ($PSBoundParameters.ContainsKey('State')) { $properties['state'] = $State }
    if ($PSBoundParameters.ContainsKey('UserProtocol')) { $properties['userprotocol'] = $UserProtocol }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create uservserver')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type uservserver -Payload @{ uservserver = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetUserVServer -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddUserVServer

# region Invoke-NSDeleteUserProtocol
function Invoke-NSDeleteUserProtocol {
    <#
    .SYNOPSIS
        Removes a NetScaler userprotocol resource.
    .DESCRIPTION
        Configuration for user protocol resource.
    .PARAMETER Name
        Unique name for the user protocol. Not case sensitive. Must begin with an ASCII letter or underscore (_) character, and must consist only of ASCII alphanumeric or underscore characters. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteUserProtocol -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetUserProtocol -Name 'userprotocol_example' | Invoke-NSDeleteUserProtocol -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete userprotocol')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type userprotocol -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteUserProtocol

# region Invoke-NSDeleteUserVServer
function Invoke-NSDeleteUserVServer {
    <#
    .SYNOPSIS
        Removes a NetScaler uservserver resource.
    .DESCRIPTION
        Configuration for virtual server resource.
    .PARAMETER Name
        Name for the virtual server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my vserver" or 'my vserver'). . Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteUserVServer -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetUserVServer -Name 'uservserver_example' | Invoke-NSDeleteUserVServer -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete uservserver')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type uservserver -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteUserVServer

# region Invoke-NSDisableUserVServer
function Invoke-NSDisableUserVServer {
    <#
    .SYNOPSIS
        Disables a NetScaler uservserver resource.
    .DESCRIPTION
        Configuration for virtual server resource.
    .PARAMETER Name
        Name for the virtual server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my vserver" or 'my vserver'). . Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSDisableUserVServer -Name 'uservserver_example' -PassThru
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Disable uservserver')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type uservserver -Action disable -Payload @{ uservserver = $body } -RawResponse | Out-Null
...
# endregion Invoke-NSDisableUserVServer

# region Invoke-NSEnableUserVServer
function Invoke-NSEnableUserVServer {
    <#
    .SYNOPSIS
        Enables a NetScaler uservserver resource.
    .DESCRIPTION
        Configuration for virtual server resource.
    .PARAMETER Name
        Name for the virtual server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my vserver" or 'my vserver'). . Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSEnableUserVServer -Name 'uservserver_example' -PassThru
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Enable uservserver')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type uservserver -Action enable -Payload @{ uservserver = $body } -RawResponse | Out-Null
...
# endregion Invoke-NSEnableUserVServer

# region Invoke-NSGetUserProtocol
function Invoke-NSGetUserProtocol {
    <#
    .SYNOPSIS
        Gets NetScaler userprotocol configuration.
    .DESCRIPTION
        Configuration for user protocol resource.
    .PARAMETER Name
        Unique name for the user protocol. Not case sensitive. Must begin with an ASCII letter or underscore (_) character, and must consist only of ASCII alphanumeric or underscore characters. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetUserProtocol
    .EXAMPLE
        Invoke-NSGetUserProtocol -Name 'userprotocol_example'
    .EXAMPLE
        Invoke-NSGetUserProtocol -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetUserProtocol

# region Invoke-NSGetUserVServer
function Invoke-NSGetUserVServer {
    <#
    .SYNOPSIS
        Gets NetScaler uservserver configuration.
    .DESCRIPTION
        Configuration for virtual server resource.
    .PARAMETER Name
        Name for the virtual server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my vserver" or 'my vserver'). . Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetUserVServer
    .EXAMPLE
        Invoke-NSGetUserVServer -Name 'uservserver_example'
    .EXAMPLE
        Invoke-NSGetUserVServer -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetUserVServer

# region Invoke-NSUnsetUserProtocol
function Invoke-NSUnsetUserProtocol {
    <#
    .SYNOPSIS
        Clears one or more NetScaler userprotocol resource properties.
    .DESCRIPTION
        Configuration for user protocol resource.
    .PARAMETER Name
        Unique name for the user protocol. Not case sensitive. Must begin with an ASCII letter or underscore (_) character, and must consist only of ASCII alphanumeric or underscore characters. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetUserProtocol -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUnsetUserProtocol -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Clear userprotocol properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type userprotocol -Action unset -Payload @{ userprotocol = $body } -RawResponse
...
# endregion Invoke-NSUnsetUserProtocol

# region Invoke-NSUnsetUserVServer
function Invoke-NSUnsetUserVServer {
    <#
    .SYNOPSIS
        Clears one or more NetScaler uservserver resource properties.
    .DESCRIPTION
        Configuration for virtual server resource.
    .PARAMETER Name
        Name for the virtual server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my vserver" or 'my vserver'). . Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetUserVServer -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUnsetUserVServer -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = @{ name = $Name }
        if ($PSBoundParameters.ContainsKey('Comment')) { $body['comment'] = $true }
        if ($PSBoundParameters.ContainsKey('Params')) { $body['Params'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$Name", 'Clear uservserver properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type uservserver -Action unset -Payload @{ uservserver = $body } -RawResponse
...
# endregion Invoke-NSUnsetUserVServer

# region Invoke-NSUpdateUserProtocol
function Invoke-NSUpdateUserProtocol {
    <#
    .SYNOPSIS
        Updates a NetScaler userprotocol resource.
    .DESCRIPTION
        Configuration for user protocol resource.
    .PARAMETER Comment
        Any comments associated with the protocol.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateUserProtocol -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUpdateUserProtocol -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update userprotocol')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type userprotocol -Payload @{ userprotocol = $body } -RawResponse
...
# endregion Invoke-NSUpdateUserProtocol

# region Invoke-NSUpdateUserVServer
function Invoke-NSUpdateUserVServer {
    <#
    .SYNOPSIS
        Updates a NetScaler uservserver resource.
    .DESCRIPTION
        Configuration for virtual server resource.
    .PARAMETER Comment
        Any comments that you might want to associate with the virtual server.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateUserVServer -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUpdateUserVServer -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update uservserver')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type uservserver -Payload @{ uservserver = $body } -RawResponse
...
# endregion Invoke-NSUpdateUserVServer

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBUU4tGIENyzbd+
# 8o9X6hcB0bZwylojrdLHqm+VUwH43KCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgb/WL
# d6pxTdMXB44Ub+N8NjsjrQs7tu7G+JgE+XU9hXcwDQYJKoZIhvcNAQEBBQAEggGA
# fwJ5yGkeQwVzMD0k14NEWAYVGcUsW0CbjXqcdXbuEGYM7zpRIr77+P1I+KQXfU9r
# MaJ0pWB18TmvhuwiekB66CdEQSNHR7WlwdqHFNBcuAmB+gXwIZgUOk8ATm/jt/gP
# JZXlpiZeQEfDBcyQypSM4sOb/FWbKgumEX+6IkEwmXvCHArlUInXaN58EmV3ucP1
# G5AVckhgoWgyWO7l505qxYlvRi64aQqchxyfQG85V7DNlm4yE3BDd074KK5pofUy
# 1nO3ZDNd9JjZeTi1ZXXu/Qs7zf05R3vROS2FuD4u4XxW8l+yR44LaWTogW2on9kN
# oBVtaghordXx97D8xEGKzoOf973UL1PEVrgt9dsS4GEe9qOwTahP71/F0nFmKlcE
# SgpI+uA1QFcNG373H3CFc+o3+YmWcuAJBc9krW1TbwGpNppd2kNyKM2eqCM2EpCe
# nCXZIV1muCMR3cKuMqx0yutPhpF99V6LSIsxDrSyCukI97K8SApFNdn1cURVX1/9
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIGeHaPZgjxI4nTweyzF7
# CHAVaw25sB2+1OLmdI2t1MUIAgZqNWdtxRQYEzIwMjYwODAzMTI1MjUwLjQ0OFow
...
# IgQgBfyWscmpn9vnEuY3/QjK2vHvlzqACe+RIQjN/BZ4CX0wgd0GCyqGSIb3DQEJ
...
# kTahOynpFQpsK7T7qt7engOZRjANBgkqhkiG9w0BAQsFAASCAgB1W8C9xqd16XgW
# fYgt7SLEaV0Hf+QF85o1qcE7Z9o2v3RzDtyRqrTFXZw7JhAIdpA5hrNBEjTr9azA
# XPnglAbVay6MBBpeZTDgB4KR5JBSDi0rso2y/dme5T1sgYUzBfx1gC+7c7/G4iiZ
# U8qsCz/47KQ6LWhlAfvTGTT8bdTjgJ+xPHiOEEI0J/C8zghlz5S7v9uGnP7L1KZq
# WRuxyJG8vn7cirmvFbqQ8oin3HzELyZuHzZe5sTtbgpFQ1026348EPNE6DbgbVeh
# u0km7wl3vuj6Igf8oxunGbj+D4rFLAPvzknbYf8+nNeJFi4EEpNTdVXF0TILo3nC
# qBQA+dS5KinNxeMwfRIGwjOy1MHZNai/3VpuWlPbj+ldMTn2knI3XXpSDaOpucKf
# GR5h7TyL162CXRReLe4Mp5ivOaeBDsYATHKn1PwVC1e6MnYfMSA13mgrWfylKxy3
# RcWzi+w3R/vpTXn3zgmhLdOt8iINe3eqT4LnWIB8o07i/PsM1/Mh9c0dzS2L3bYS
# 7cUlosytsHhmQvioHbIMqYpFCqQ/g3KI27EPeKHZOH0GefFAAdo0yT1sZMqH1ona
# BpHxSaqvX14DhHEd7uu6tfRPO+jtTKQOHgFqKgIF+511TMZT9MsDewl7Pkerkc/S
# b4d93/lH2sFjUxYlhxyq8HWZFexKdw==
