# Generated NetScalerToolkit Configuration bundle for category 'adm'.

# region Invoke-NSGetAdmparameter
function Invoke-NSGetAdmparameter {
    <#
    .SYNOPSIS
        Gets NetScaler admparameter configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAdmparameter -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
...
# endregion Invoke-NSGetAdmparameter

# region Invoke-NSUnsetAdmparameter
function Invoke-NSUnsetAdmparameter {
    <#
    .SYNOPSIS
        Clears one or more NetScaler admparameter resource properties.
    .DESCRIPTION
        Configuration for ADM parameter resource.
    ...
    .EXAMPLE
        Invoke-NSUnsetAdmparameter -AdmServiceConnEct ENABLED -PassThru
    .EXAMPLE
        Invoke-NSUnsetAdmparameter -AdmServiceConnEct ENABLED -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = @{}
        if ($PSBoundParameters.ContainsKey('AdmServiceConnEct')) { $body['admserviceconnect'] = $true }

        if ($body.Count -le 0) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess('admparameter', 'Clear admparameter properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type admparameter -Action unset -Payload @{ admparameter = $body } -RawResponse

            return $response
        }
    }
}
# endregion Invoke-NSUnsetAdmparameter

# region Invoke-NSUpdateAdmparameter
function Invoke-NSUpdateAdmparameter {
    <#
    .SYNOPSIS
        Updates a NetScaler admparameter resource.
    .DESCRIPTION
        Configuration for ADM parameter resource.
    .PARAMETER AdmServiceConnEct
        Parameter to enable/disable Citrix ADM Service Connect. This feature helps you discover your Citrix ADC instances effortlessly on Citrix ADM service and get insights and curated machine learning based recommendations for applications and Citrix ADC infrastructure. This feature lets the Citrix ADC instance automatically send system, usage and telemetry data to Citrix ADM service. View here [https://docs.citrix.com/en-us/citrix-adc/13/data-governance.html] to learn more about this feature. Use of this feature is subject to the Citrix End User ServiceAgreement. View here [https://www.citrix.com/buy/licensing/agreements.html]. Default value: ENABLED Possible values = ENABLED, DISABLED
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateAdmparameter  -PassThru
    .EXAMPLE
        Invoke-NSUpdateAdmparameter  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSBoundParameters.ContainsKey('AdmServiceConnEct')) { $properties['admserviceconnect'] = $AdmServiceConnEct }
    ...
    if ($PSCmdlet.ShouldProcess('admparameter', 'Update admparameter')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type admparameter -Payload @{ admparameter = $body } -RawResponse

        return $response
    }
}
# endregion Invoke-NSUpdateAdmparameter

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBKbqIx/0lYOKLD
# x0MrEeadUzJacJx+O61wByUfq/xBwqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg9GeV
# RE6T+6X0mrLSTz3koKALmIvzriFah+x4uFlsEFswDQYJKoZIhvcNAQEBBQAEggGA
# IkQlNHbzgvhBfuUhkWfjar1tF8BZc6WMLUWUgDZu3ysBOi26dY/TrAgUi8WRxhro
# VDBsxbujN3zJfdLcGQGf7j7yh2Mg+IJv2GBiv5rLkDxud/ImMckNaHPQBK23qBwA
# AOr3yo6zmVAHpGeRZLXwwwsNgN2VJOv5kqWojUTFaAN20dKioWWm9ir/69+R/t4n
