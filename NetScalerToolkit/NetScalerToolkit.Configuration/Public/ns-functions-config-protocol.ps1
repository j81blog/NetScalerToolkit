# Generated NetScalerToolkit Configuration bundle for category 'protocol'.

# region Invoke-NSClearProtocolHTTPBand
function Invoke-NSClearProtocolHTTPBand {
    <#
    .SYNOPSIS
        Clears NetScaler protocolhttpband data.
    .DESCRIPTION
        Configuration for HTTP request/response band resource.
    .PARAMETER Type
        Type of statistics to display. Possible values = REQUEST, RESPONSE, MQTT_JUMBO_REQ
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSClearProtocolHTTPBand -Type REQUEST
    .EXAMPLE
        Invoke-NSClearProtocolHTTPBand -Type REQUEST -WhatIf
    .OUTPUTS
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('protocolhttpband', 'Clear protocolhttpband')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type protocolhttpband -Action clear -Payload @{ protocolhttpband = $body } -RawResponse
        }
    }
}
# endregion Invoke-NSClearProtocolHTTPBand

# region Invoke-NSGetProtocolHTTPBand
function Invoke-NSGetProtocolHTTPBand {
    <#
    .SYNOPSIS
        Gets NetScaler protocolhttpband configuration.
    .DESCRIPTION
        Configuration for HTTP request/response band resource.
    .PARAMETER Type
        Type of statistics to display. Possible values = REQUEST, RESPONSE, MQTT_JUMBO_REQ
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetProtocolHTTPBand
    .EXAMPLE
        Invoke-NSGetProtocolHTTPBand -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetProtocolHTTPBand

# region Invoke-NSUnsetProtocolHTTPBand
function Invoke-NSUnsetProtocolHTTPBand {
    <#
    .SYNOPSIS
        Clears one or more NetScaler protocolhttpband resource properties.
    .DESCRIPTION
        Configuration for HTTP request/response band resource.
    ...
    .EXAMPLE
        Invoke-NSUnsetProtocolHTTPBand -Reqbandsize  -PassThru
    .EXAMPLE
        Invoke-NSUnsetProtocolHTTPBand -Reqbandsize  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = @{}
        if ($PSBoundParameters.ContainsKey('Reqbandsize')) { $body['reqbandsize'] = $true }
        if ($PSBoundParameters.ContainsKey('ResponseBandsize')) { $body['respbandsize'] = $true }

        if ($body.Count -le 0) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess('protocolhttpband', 'Clear protocolhttpband properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type protocolhttpband -Action unset -Payload @{ protocolhttpband = $body } -RawResponse

            return $response
        }
    }
}
# endregion Invoke-NSUnsetProtocolHTTPBand

# region Invoke-NSUpdateProtocolHTTPBand
function Invoke-NSUpdateProtocolHTTPBand {
    <#
    .SYNOPSIS
        Updates a NetScaler protocolhttpband resource.
    .DESCRIPTION
        Configuration for HTTP request/response band resource.
    .PARAMETER Reqbandsize
        Band size, in bytes, for HTTP request band statistics. For example, if you specify a band size of 100 bytes, statistics will be maintained and displayed for the following size ranges: 0 - 99 bytes 100 - 199 bytes 200 - 299 bytes and so on. Default value: 100 Minimum value = 50
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateProtocolHTTPBand  -PassThru
    .EXAMPLE
        Invoke-NSUpdateProtocolHTTPBand  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSBoundParameters.ContainsKey('Reqbandsize')) { $properties['reqbandsize'] = $Reqbandsize }
    if ($PSBoundParameters.ContainsKey('ResponseBandsize')) { $properties['respbandsize'] = $ResponseBandsize }
    ...
    if ($PSCmdlet.ShouldProcess('protocolhttpband', 'Update protocolhttpband')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type protocolhttpband -Payload @{ protocolhttpband = $body } -RawResponse

        return $response
    }
}
# endregion Invoke-NSUpdateProtocolHTTPBand

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABC