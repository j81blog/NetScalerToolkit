# Generated NetScalerToolkit Configuration bundle for category 'autoscale'.

# region Invoke-NSAddAutoscaleAction
function Invoke-NSAddAutoscaleAction {
    <#
    .SYNOPSIS
        Creates a NetScaler autoscaleaction resource.
    .DESCRIPTION
        Configuration for autoscale action resource.
    .PARAMETER Name
        ActionScale action name. Minimum length = 1
    .PARAMETER Parameters
        Parameters to use in the action. Minimum length = 1
    .PARAMETER ProfileName
        AutoScale profile name. Minimum length = 1
    .PARAMETER Quiettime
        Time in seconds no other policy is evaluated or action is taken. Default value: 300
    .PARAMETER Type
        The type of action. Possible values = SCALE_UP, SCALE_DOWN
    ...
    .EXAMPLE
        Invoke-NSAddAutoscaleAction -Name 'example' -Parameters 'example' -ProfileName 'example' -Type SCALE_UP -VServer 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddAutoscaleAction -Name 'example' -Parameters 'example' -ProfileName 'example' -Type SCALE_UP -VServer 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('Quiettime')) { $properties['quiettime'] = $Quiettime }
    if ($PSBoundParameters.ContainsKey('Type')) { $properties['type'] = $Type }
    if ($PSBoundParameters.ContainsKey('Vmdestroygraceperiod')) { $properties['vmdestroygraceperiod'] = $Vmdestroygraceperiod }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create autoscaleaction')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type autoscaleaction -Payload @{ autoscaleaction = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetAutoscaleAction -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddAutoscaleAction

# region Invoke-NSAddAutoscalePolicy
function Invoke-NSAddAutoscalePolicy {
    <#
    .SYNOPSIS
        Creates a NetScaler autoscalepolicy resource.
    .DESCRIPTION
        Configuration for Autoscale policy resource.
    .PARAMETER Action
        The autoscale profile associated with the policy. Minimum length = 1
    .PARAMETER Comment
        Comments associated with this autoscale policy.
    .PARAMETER LogAction
        The log action associated with the autoscale policy.
    .PARAMETER Name
        The name of the autoscale policy. Minimum length = 1
    .PARAMETER Rule
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddAutoscalePolicy -Name 'example' -Action 'example' -Rule 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddAutoscalePolicy -Name 'example' -Action 'example' -Rule 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create autoscalepolicy')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type autoscalepolicy -Payload @{ autoscalepolicy = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetAutoscalePolicy -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddAutoscalePolicy

# region Invoke-NSAddAutoscaleProfile
function Invoke-NSAddAutoscaleProfile {
    <#
    .SYNOPSIS
        Creates a NetScaler autoscaleprofile resource.
    .DESCRIPTION
        Configuration for autoscale profile resource.
    .PARAMETER APIKey
        api key for authentication with service. Minimum length = 1
    .PARAMETER Name
        AutoScale profile name. Minimum length = 1
    .PARAMETER Sharedsecret
        shared secret for authentication with service. Minimum length = 1
    .PARAMETER Type
        The type of profile. Possible values = CLOUDSTACK
    .PARAMETER URL
        URL providing the service. Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddAutoscaleProfile -Name 'example' -APIKey 'example' -Sharedsecret 'example' -Type CLOUDSTACK -URL 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddAutoscaleProfile -Name 'example' -APIKey 'example' -Sharedsecret 'example' -Type CLOUDSTACK -URL 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    $properties = [System.Collections.Generic.Dictionary[string, object]]::new([System.StringComparer]::Ordinal)
    if ($PSBoundParameters.ContainsKey('APIKey')) { $properties['apikey'] = $APIKey }
    if ($PSBoundParameters.ContainsKey('Name')) { $properties['name'] = $Name }
    if ($PSBoundParameters.ContainsKey('Sharedsecret')) { $properties['sharedsecret'] = $Sharedsecret }
    if ($PSBoundParameters.ContainsKey('Type')) { $properties['type'] = $Type }
    if ($PSBoundParameters.ContainsKey('URL')) { $properties['url'] = $URL }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create autoscaleprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type autoscaleprofile -Payload @{ autoscaleprofile = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetAutoscaleProfile -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddAutoscaleProfile

# region Invoke-NSDeleteAutoscaleAction
function Invoke-NSDeleteAutoscaleAction {
    <#
    .SYNOPSIS
        Removes a NetScaler autoscaleaction resource.
    .DESCRIPTION
        Configuration for autoscale action resource.
    .PARAMETER Name
        ActionScale action name. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteAutoscaleAction -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetAutoscaleAction -Name 'autoscaleaction_example' | Invoke-NSDeleteAutoscaleAction -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete autoscaleaction')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type autoscaleaction -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteAutoscaleAction

# region Invoke-NSDeleteAutoscalePolicy
function Invoke-NSDeleteAutoscalePolicy {
    <#
    .SYNOPSIS
        Removes a NetScaler autoscalepolicy resource.
    .DESCRIPTION
        Configuration for Autoscale policy resource.
    .PARAMETER Name
        The name of the autoscale policy. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteAutoscalePolicy -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetAutoscalePolicy -Name 'autoscalepolicy_example' | Invoke-NSDeleteAutoscalePolicy -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete autoscalepolicy')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type autoscalepolicy -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteAutoscalePolicy

# region Invoke-NSDeleteAutoscaleProfile
function Invoke-NSDeleteAutoscaleProfile {
    <#
    .SYNOPSIS
        Removes a NetScaler autoscaleprofile resource.
    .DESCRIPTION
        Configuration for autoscale profile resource.
    .PARAMETER Name
        AutoScale profile name. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteAutoscaleProfile -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetAutoscaleProfile -Name 'autoscaleprofile_example' | Invoke-NSDeleteAutoscaleProfile -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete autoscaleprofile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type autoscaleprofile -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteAutoscaleProfile

# region Invoke-NSGetAutoscaleAction
function Invoke-NSGetAutoscaleAction {
    <#
    .SYNOPSIS
        Gets NetScaler autoscaleaction configuration.
    .DESCRIPTION
        Configuration for autoscale action resource.
    .PARAMETER Name
        ActionScale action name. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetAutoscaleAction
    .EXAMPLE
        Invoke-NSGetAutoscaleAction -Name 'autoscaleaction_example'
    .EXAMPLE
        Invoke-NSGetAutoscaleAction -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAutoscaleAction

# region Invoke-NSGetAutoscalePolicy
function Invoke-NSGetAutoscalePolicy {
    <#
    .SYNOPSIS
        Gets NetScaler autoscalepolicy configuration.
    .DESCRIPTION
        Configuration for Autoscale policy resource.
    .PARAMETER Name
        The name of the autoscale policy. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetAutoscalePolicy
    .EXAMPLE
        Invoke-NSGetAutoscalePolicy -Name 'autoscalepolicy_example'
    .EXAMPLE
        Invoke-NSGetAutoscalePolicy -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAutoscalePolicy

# region Invoke-NSGetAutoscalePolicyBinding
function Invoke-NSGetAutoscalePolicyBinding {
    <#
    .SYNOPSIS
        Gets NetScaler autoscalepolicy_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAutoscalePolicyBinding -Name 'autoscalepolicy_binding_example'
    .EXAMPLE
        Invoke-NSGetAutoscalePolicyBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAutoscalePolicyBinding

# region Invoke-NSGetAutoscalePolicyTimerBinding
function Invoke-NSGetAutoscalePolicyTimerBinding {
    <#
    .SYNOPSIS
        Gets NetScaler autoscalepolicy_nstimer_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAutoscalePolicyTimerBinding -Name 'autoscalepolicy_nstimer_binding_example'
    .EXAMPLE
        Invoke-NSGetAutoscalePolicyTimerBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'autoscalepolicy_nstimer_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAutoscalePolicyTimerBinding

# region Invoke-NSGetAutoscaleProfile
function Invoke-NSGetAutoscaleProfile {
    <#
    .SYNOPSIS
        Gets NetScaler autoscaleprofile configuration.
    .DESCRIPTION
        Configuration for autoscale profile resource.
    .PARAMETER Name
        AutoScale profile name. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetAutoscaleProfile
    .EXAMPLE
        Invoke-NSGetAutoscaleProfile -Name 'autoscaleprofile_example'
    .EXAMPLE
        Invoke-NSGetAutoscaleProfile -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAutoscaleProfile

# region Invoke-NSRenameAutoscalePolicy
function Invoke-NSRenameAutoscalePolicy {
    <#
    .SYNOPSIS
        Renames a NetScaler autoscalepolicy resource.
    .DESCRIPTION
        Configuration for Autoscale policy resource.
    .PARAMETER Name
        The name of the autoscale policy. Minimum length = 1
    .PARAMETER NewName
        The new name of the autoscale policy. Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSRenameAutoscalePolicy -Name 'example' -NewName 'example' -PassThru
    .EXAMPLE
        Invoke-NSRenameAutoscalePolicy -Name 'example' -NewName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Rename autoscalepolicy')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type autoscalepolicy -Action rename -Payload @{ autoscalepolicy = $body } -RawResponse

            if ($PassThru) {
                return Invoke-NSGetAutoscalePolicy -Name $NewName -Session $Session
            }
...
# endregion Invoke-NSRenameAutoscalePolicy

# region Invoke-NSUnsetAutoscaleAction
function Invoke-NSUnsetAutoscaleAction {
    <#
    .SYNOPSIS
        Clears one or more NetScaler autoscaleaction resource properties.
    .DESCRIPTION
        Configuration for autoscale action resource.
    .PARAMETER Name
        ActionScale action name. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetAutoscaleAction -Name 'example' -Quiettime  -PassThru
    .EXAMPLE
        Invoke-NSUnsetAutoscaleAction -Name 'example' -Quiettime  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = @{ name = $Name }
        if ($PSBoundParameters.ContainsKey('Quiettime')) { $body['quiettime'] = $true }
        if ($PSBoundParameters.ContainsKey('Vmdestroygraceperiod')) { $body['vmdestroygraceperiod'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$Name", 'Clear autoscaleaction properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type autoscaleaction -Action unset -Payload @{ autoscaleaction = $body } -RawResponse
...
# endregion Invoke-NSUnsetAutoscaleAction

# region Invoke-NSUnsetAutoscalePolicy
function Invoke-NSUnsetAutoscalePolicy {
    <#
    .SYNOPSIS
        Clears one or more NetScaler autoscalepolicy resource properties.
    .DESCRIPTION
        Configuration for Autoscale policy resource.
    .PARAMETER Name
        The name of the autoscale policy. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetAutoscalePolicy -Name 'example' -Action  -PassThru
    .EXAMPLE
        Invoke-NSUnsetAutoscalePolicy -Name 'example' -Action  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Clear autoscalepolicy properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type autoscalepolicy -Action unset -Payload @{ autoscalepolicy = $body } -RawResponse
...
# endregion Invoke-NSUnsetAutoscalePolicy

# region Invoke-NSUpdateAutoscaleAction
function Invoke-NSUpdateAutoscaleAction {
    <#
    .SYNOPSIS
        Updates a NetScaler autoscaleaction resource.
    .DESCRIPTION
        Configuration for autoscale action resource.
    .PARAMETER Name
        ActionScale action name. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateAutoscaleAction -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdateAutoscaleAction -Name 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update autoscaleaction')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type autoscaleaction -Payload @{ autoscaleaction = $body } -RawResponse
...
# endregion Invoke-NSUpdateAutoscaleAction

# region Invoke-NSUpdateAutoscalePolicy
function Invoke-NSUpdateAutoscalePolicy {
    <#
    .SYNOPSIS
        Updates a NetScaler autoscalepolicy resource.
    .DESCRIPTION
        Configuration for Autoscale policy resource.
    .PARAMETER Action
        The autoscale profile associated with the policy. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateAutoscalePolicy -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUpdateAutoscalePolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update autoscalepolicy')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type autoscalepolicy -Payload @{ autoscalepolicy = $body } -RawResponse
...
# endregion Invoke-NSUpdateAutoscalePolicy

# region Invoke-NSUpdateAutoscaleProfile
function Invoke-NSUpdateAutoscaleProfile {
    <#
    .SYNOPSIS
        Updates a NetScaler autoscaleprofile resource.
    .DESCRIPTION
        Configuration for autoscale profile resource.
    .PARAMETER APIKey
        api key for authentication with service. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateAutoscaleProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdateAutoscaleProfile -Name 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update autoscaleprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type autoscaleprofile -Payload @{ autoscaleprofile = $body } -RawResponse
...
# endregion Invoke-NSUpdateAutoscaleProfile

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIMS4YU7EparUN
# QvoDA/0tODQpNrH6L6WqMqp7H5jG8qCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgzCK6
# LB9O1xF9o7XTQetkfoigviYTSJ2CuqDWWo2fA6swDQYJKoZIhvcNAQEBBQAEggGA
# WsSQlDI3z/0GoNJBeeoI1GCulwkgc4gURNdf8K+4+8ajeVv3cNE22aS9H1i5LZ6K
# R6gzEs3poI1KfMdZkok8Q8XGcvZw899g7zqBEcx1tKIwtxfdroNK/GX5b/+YuaWo
# V3tGcrZrf+/7m30B7qBVqWGeSrp48W0sfpPMDTMUYOQAfjLrSxIS8/XXbXI/QP27
# ZdI2QyWpUebuYWM6UmRQTNcR10qj9EGu0tgfhCgUdkPcqBlBAuHylgtrNWKU0T8R
# FBdN738UC34vi2yq11akVJInokhjut7832r0LOLWSl1XH3WBxjfa6pegcIapMqDL
# NQ8b4tgL/x/jFmTtLXUb8jGvzsm08b9/fBWdtPZUsapyABZnZLniWvWFa556Qw48
# PF5R4kWGlKxYYPunnQZIIUV8tKBdduXmuAQIA/KhVLM61S+PIOyxYfV6t9z3GwT3
# oaFVThA0b6UZ1gmJQAfIi1yaaKvd9JZMD15U/4YW3D6fgrIZiZUmXiB6Y03FRDnd
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIMPvHuG28aLMJI7Lit2R
# 0h4z3FFODYyjSL7ORNXeysQTAgZqNTBfn9sYEzIwMjYwODAzMTI1MTEyLjQwNVow
...
# IgQgxfpwohHXvC3dz4wH2P2jJ4DPhQV0OzMr1Y0rWBFnpRQwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgBQbpvxzztOmyje
# 4HCSXs5oEjDT71+muI7SdBLYW2DXj8qq8IVlF9tNWjBnT7Ltt2Gq2yenBpsXBSjn
# eFYT9DQ/Kqv5+TslbQvWG8dL4etYNmkxP7PkggZXQd9jver33h+2Xy6B1jVQzi6t
# gIEmTIHG49tBYNqkuyp+PXl77Bh8JxD2taJCv40Hk+wNkdZ3N1HWejOa8ajn7DvM
# b4o1OJ9J6K26u1o3PD6KlSe4rtctsYTKbjKWvq6+lK1M/rAL8xjJX/ghQMEPjFmb
# GF4nx4N5ACQ2UtHBlHXtU4VJgVNHRM1cUjdSwLv2fK++E90mQqzHUN/vhZASMJcH
# DTwqSTcJ1dXQDQnIRpdodJCW7S5Q3aJEA3HikumE6GzksLjgKKOaxOWM/0PVE8as
# 1JWlLl0JveQr+3pnJqe51YVX0pnol6PNA7w+PI6P2hthmADXYGIWydXTH1jcxNdl
# 7zl7JTAloE+ygWMjixVIhrffU2ayoMRUwAZsmKUiDOTgkZ4DaTor3Us+rffiHERp
# D1pIsywKbHsjlZ22gtSLmz2A4m6QxoNV9YgOmz3du+HdhB4+zowbrIF0EYlJKHqT
# RmkN1plaNovlfvdwBFop2ALx1u/sjPvsCwzLEQtrey+04VwJRnDOGJWvLb4VTir3
# dtVoS4Kx3zpbH0ZvgxQkA2lh/eOThw==
