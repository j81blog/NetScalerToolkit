# Generated NetScalerToolkit Configuration bundle for category 'wasm'.

# region Invoke-NSAddWASMModule
function Invoke-NSAddWASMModule {
    <#
    .SYNOPSIS
        Creates a NetScaler wasmmodule resource.
    .DESCRIPTION
        Configuration for WASM Module resource.
    .PARAMETER Comment
        Any type of information about this WASM module.
    .PARAMETER ModuleFile
        File name of the WASM module. Minimum length = 1 Maximum length = 255
    .PARAMETER Name
        The name of the WASM module file. Minimum length = 1 Maximum length = 127
    .PARAMETER SettingFile
        The WASM module filename contains module-specific configuration settings.
    .PARAMETER SignatureFile
        The SHA256 file contains the hash value used to validate the WASM module.. Minimum length = 1 Maximum length = 255
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddWASMModule -Name 'example' -ModuleFile 'example' -SignatureFile 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddWASMModule -Name 'example' -ModuleFile 'example' -SignatureFile 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('ModuleFile')) { $properties['modulefile'] = $ModuleFile }
    if ($PSBoundParameters.ContainsKey('Name')) { $properties['name'] = $Name }
    if ($PSBoundParameters.ContainsKey('SettingFile')) { $properties['settingfile'] = $SettingFile }
    if ($PSBoundParameters.ContainsKey('SignatureFile')) { $properties['signaturefile'] = $SignatureFile }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create wasmmodule')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type wasmmodule -Payload @{ wasmmodule = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetWASMModule -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddWASMModule

# region Invoke-NSDeleteWasmFile
function Invoke-NSDeleteWasmFile {
    <#
    .SYNOPSIS
        Removes a NetScaler wasmfile resource.
    .DESCRIPTION
        Configuration for WASM module related files resource.
    .PARAMETER Name
        Name to assign to the WASM mdoule/signature page object on the Citrix ADC. Minimum length = 1 Maximum length = 31
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteWasmFile -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetWasmFile  | Invoke-NSDeleteWasmFile -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('wasmfile', 'Delete wasmfile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type wasmfile -Query $query -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteWasmFile

# region Invoke-NSDeleteWASMModule
function Invoke-NSDeleteWASMModule {
    <#
    .SYNOPSIS
        Removes a NetScaler wasmmodule resource.
    .DESCRIPTION
        Configuration for WASM Module resource.
    .PARAMETER Name
        The name of the WASM module file. Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteWASMModule -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetWASMModule -Name 'wasmmodule_example' | Invoke-NSDeleteWASMModule -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete wasmmodule')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type wasmmodule -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteWASMModule

# region Invoke-NSGetWasmFile
function Invoke-NSGetWasmFile {
    <#
    .SYNOPSIS
        Gets NetScaler wasmfile configuration.
    .DESCRIPTION
        Configuration for WASM module related files resource.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetWasmFile
    .EXAMPLE
        Invoke-NSGetWasmFile -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetWasmFile

# region Invoke-NSGetWASMModule
function Invoke-NSGetWASMModule {
    <#
    .SYNOPSIS
        Gets NetScaler wasmmodule configuration.
    .DESCRIPTION
        Configuration for WASM Module resource.
    .PARAMETER Name
        The name of the WASM module file. Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetWASMModule
    .EXAMPLE
        Invoke-NSGetWASMModule -Name 'wasmmodule_example'
    .EXAMPLE
        Invoke-NSGetWASMModule -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetWASMModule

# region Invoke-NSImportWasmFile
function Invoke-NSImportWasmFile {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
        Configuration for WASM module related files resource.
    .PARAMETER Comment
        Any comments to preserve information about the WASM page object. Maximum length = 128
    .PARAMETER FileType
        WASM file type to be imported. Default value: Module Possible values = Module, Signature, Setting
    .PARAMETER Name
        Name to assign to the WASM mdoule/signature page object on the Citrix ADC. Minimum length = 1 Maximum length = 31
    .PARAMETER Overwrite
    ...
    param(
        ...
        [Parameter()]
        [ValidateSet('Module', 'Signature', 'Setting')]
        [string] $FileType,
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('FileType')) { $body['filetype'] = $FileType }
        ...
        if ($PSCmdlet.ShouldProcess('wasmfile', 'Import wasmfile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type wasmfile -Action Import -Payload @{ wasmfile = $body } -RawResponse
        }
    }
}
# endregion Invoke-NSImportWasmFile

# region Invoke-NSUnsetWASMModule
function Invoke-NSUnsetWASMModule {
    <#
    .SYNOPSIS
        Clears one or more NetScaler wasmmodule resource properties.
    .DESCRIPTION
        Configuration for WASM Module resource.
    .PARAMETER Name
        The name of the WASM module file. Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetWASMModule -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUnsetWASMModule -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('SettingFile')) { $body['settingfile'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$Name", 'Clear wasmmodule properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type wasmmodule -Action unset -Payload @{ wasmmodule = $body } -RawResponse
...
# endregion Invoke-NSUnsetWASMModule

# region Invoke-NSUpdateWasmFile
function Invoke-NSUpdateWasmFile {
    <#
    .SYNOPSIS
        Invokes the change operation for a NetScaler wasmfile resource.
    .DESCRIPTION
        Configuration for WASM module related files resource.
    .PARAMETER Name
        Name to assign to the WASM mdoule/signature page object on the Citrix ADC. Minimum length = 1 Maximum length = 31
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSUpdateWasmFile 
    .EXAMPLE
        Invoke-NSUpdateWasmFile  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('wasmfile', 'Change wasmfile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type wasmfile -Action update -Payload @{ wasmfile = $body } -RawResponse
        }
    }
}
# endregion Invoke-NSUpdateWasmFile

# region Invoke-NSUpdateWASMModule
function Invoke-NSUpdateWASMModule {
    <#
    .SYNOPSIS
        Updates a NetScaler wasmmodule resource.
    .DESCRIPTION
        Configuration for WASM Module resource.
    .PARAMETER Comment
        Any type of information about this WASM module.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateWASMModule -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUpdateWASMModule -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update wasmmodule')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type wasmmodule -Payload @{ wasmmodule = $body } -RawResponse
...
# endregion Invoke-NSUpdateWASMModule

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCRs3WHwgtkQW3h
# rNhzAtgCJw+83pSqzAIm+UF6nlhrrqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQ