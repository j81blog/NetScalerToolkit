# Generated NetScalerToolkit Configuration bundle for category 'kafka'.

# region Invoke-NSAddKafkaCluster
function Invoke-NSAddKafkaCluster {
    <#
    .SYNOPSIS
        Creates a NetScaler kafkacluster resource.
    .DESCRIPTION
        Configuration for Kafka cluster resource.
    .PARAMETER Name
        Name for the Kafka cluster. Minimum length = 1 Maximum length = 127
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddKafkaCluster -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddKafkaCluster -Name 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create kafkacluster')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type kafkacluster -Payload @{ kafkacluster = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetKafkaCluster -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddKafkaCluster

# region Invoke-NSAddKafkaClusterServiceGroupBinding
function Invoke-NSAddKafkaClusterServiceGroupBinding {
    <#
    .SYNOPSIS
        Creates a NetScaler kafkacluster_servicegroup_binding resource.
    .DESCRIPTION
        Binding object showing the servicegroup that can be bound to kafkacluster.
    .PARAMETER Name
        Name for the Kafka cluster. Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddKafkaClusterServiceGroupBinding -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddKafkaClusterServiceGroupBinding -Name 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create kafkacluster_servicegroup_binding')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type kafkacluster_servicegroup_binding -Payload @{ kafkacluster_servicegroup_binding = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetKafkaClusterServiceGroupBinding -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddKafkaClusterServiceGroupBinding

# region Invoke-NSDeleteKafkaCluster
function Invoke-NSDeleteKafkaCluster {
    <#
    .SYNOPSIS
        Removes a NetScaler kafkacluster resource.
    .DESCRIPTION
        Configuration for Kafka cluster resource.
    .PARAMETER Name
        Name for the Kafka cluster. Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteKafkaCluster -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetKafkaCluster -Name 'kafkacluster_example' | Invoke-NSDeleteKafkaCluster -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete kafkacluster')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type kafkacluster -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteKafkaCluster

# region Invoke-NSDeleteKafkaClusterServiceGroupBinding
function Invoke-NSDeleteKafkaClusterServiceGroupBinding {
    <#
    .SYNOPSIS
        Removes a NetScaler kafkacluster_servicegroup_binding resource.
    .DESCRIPTION
        Binding object showing the servicegroup that can be bound to kafkacluster.
    .PARAMETER Name
        Name for the Kafka cluster. Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteKafkaClusterServiceGroupBinding -Name 'example' -ServiceGroupName 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetKafkaClusterServiceGroupBinding -Name 'kafkacluster_servicegroup_binding_example' | Invoke-NSDeleteKafkaClusterServiceGroupBinding -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete kafkacluster_servicegroup_binding')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type kafkacluster_servicegroup_binding -Resource $Name -Query $query -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteKafkaClusterServiceGroupBinding

# region Invoke-NSGetKafkaCluster
function Invoke-NSGetKafkaCluster {
    <#
    .SYNOPSIS
        Gets NetScaler kafkacluster configuration.
    .DESCRIPTION
        Configuration for Kafka cluster resource.
    .PARAMETER Name
        Name for the Kafka cluster. Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetKafkaCluster
    .EXAMPLE
        Invoke-NSGetKafkaCluster -Name 'kafkacluster_example'
    .EXAMPLE
        Invoke-NSGetKafkaCluster -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetKafkaCluster

# region Invoke-NSGetKafkaClusterBinding
function Invoke-NSGetKafkaClusterBinding {
    <#
    .SYNOPSIS
        Gets NetScaler kafkacluster_binding configuration.
    .DESCRIPTION
        Binding object which returns the resources bound to kafkacluster.
    .PARAMETER Name
        Name for the Kafka cluster. Minimum length = 1 Maximum length = 127
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    ...
    .EXAMPLE
        Invoke-NSGetKafkaClusterBinding -Name 'kafkacluster_binding_example'
    .EXAMPLE
        Invoke-NSGetKafkaClusterBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetKafkaClusterBinding

# region Invoke-NSGetKafkaClusterServiceGroupBinding
function Invoke-NSGetKafkaClusterServiceGroupBinding {
    <#
    .SYNOPSIS
        Gets NetScaler kafkacluster_servicegroup_binding configuration.
    .DESCRIPTION
        Binding object showing the servicegroup that can be bound to kafkacluster.
    .PARAMETER Name
        Name for the Kafka cluster. Minimum length = 1 Maximum length = 127
    ...
    .EXAMPLE
        Invoke-NSGetKafkaClusterServiceGroupBinding -Name 'kafkacluster_servicegroup_binding_example'
    .EXAMPLE
        Invoke-NSGetKafkaClusterServiceGroupBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 