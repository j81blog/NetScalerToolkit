# Generated NetScalerToolkit Configuration bundle for category 'reputation'.

# region Invoke-NSGetReputationSettings
function Invoke-NSGetReputationSettings {
    <#
    .SYNOPSIS
        Gets NetScaler reputationsettings configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetReputationSettings
    .EXAMPLE
        Invoke-NSGetReputationSettings -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
...
# endregion Invoke-NSGetReputationSettings

# region Invoke-NSUnsetReputationSettings
function Invoke-NSUnsetReputationSettings {
    <#
    .SYNOPSIS
        Clears one or more NetScaler reputationsettings resource properties.
    .DESCRIPTION
        Configuration for Reputation service settings resource.
    ...
    .PARAMETER ProxyServer
        Proxy server IP to get Reputation data. Minimum length = 1
    ...
    .EXAMPLE
        Invoke-NSUnsetReputationSettings -ProxyPassword  -PassThru
    .EXAMPLE
        Invoke-NSUnsetReputationSettings -ProxyPassword  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('reputationsettings', 'Clear reputationsettings properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type reputationsettings -Action unset -Payload @{ reputationsettings = $body } -RawResponse

            return $response
        }
    }
}
# endregion Invoke-NSUnsetReputationSettings

# region Invoke-NSUpdateReputationSettings
function Invoke-NSUpdateReputationSettings {
    <#
    .SYNOPSIS
        Updates a NetScaler reputationsettings resource.
    .DESCRIPTION
        Configuration for Reputation service settings resource.
    .PARAMETER ProxyPassword
        Password with which user logs on. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateReputationSettings  -PassThru
    .EXAMPLE
        Invoke-NSUpdateReputationSettings  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess('reputationsettings', 'Update reputationsettings')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type reputationsettings -Payload @{ reputationsettings = $body } -RawResponse

        return $response
    }
}
# endregion Invoke-NSUpdateReputationSettings

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDtD6/PPHVqM5tt
# 3lAxfFFgj/TVLKDqEonNRLotCshLiqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg43xS
# HYNEcZj90jFxjEqX7zTisCJyxwZiCPWqEvjgxLcwDQYJKoZIhvcNAQEBBQAEggGA
# F7vP9je3zL4pOJC8pwXEcm5Npul/BK0k3R6Su9uy9S8f2dK0I6NTzSyo6Ajx7TCd
# VElHep5udQa6egBTBjfL/XFnjZuwrSxOA9eWj5kqyAea94283Ls638RGPXVdoe7t
# SZOiJgKPywSubPQP+ogFMwqrZi+DHUjnkHEmNMdSPo61aLdE//Ulad8hr62fkj5p
# wbx6PhUs2jHIvF7uaMvarCcea6OESHJnjZKtusYPHtSAuqHaNxJoXg8UGzaKEct0
# VYkyzamVJagF/22wULDBmnDt0f5mLdsEETkohTlOYwgkumVJ56DF4r9VyEZHclBZ
# 8nLMkPwsGQktMKK7kSlbMda5xPCI5V16X3FJQPcAx/ELtnMWjrNp4AufzGmKg8IV
# togZJvst31Hv8PAXKqHZHRuLacBm289hrhKGslj1aK5E79ZO92Oa02qOtYjeUwkw
# Ma5i1NeJeKkPBHPMJmPOoLrkPD9jJLP/ape8y/jao1bK9BSrJF32zIgq7PEHNTp0
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIDXtnR+BoPOVfmFJVpGC
# GeldZ520zcxiGK3u1TbO3J1/AgZqNTBfoPkYEzIwMjYwODAzMTI1MjIyLjUzM1ow
...
# IgQguzqvSN7KdbbWqTnQgSFjxrgc3bmkqaYmVBs8u2PuHhIwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgDCFPWSNYxzMjVy
# ngfEdCNMngiVuA9kKJiQGumv3CM00DhF1JijVBEnMfnmlBNmRYgy7MT2G1CTdoQo
# Nfmb9fMIzV6u3Rm41gT2vQH9AKwSKbjS6l+mOKvZfhSYdYnuXTjgKvhKuMNGXzuU
# anCaVvXmQPM1xp+nCC8zOKhw7HwcgEQx/a34rxqEu+b2W7IlGjkfdZllFY/55E6d
# RdhCynjeK0kFFRpbWqc2DEm9WsBOe4DWr3ggXtRphF8WaQGQffoyjG9gjmm+eprN
# aJY350kby+9FGzTedygWnvpDe+iJQOO6UlzTzWhTEsgUcv/jzpfwYv3tBUaNVMA+
# gUHCQ5z+sA1wvdXDqgPDCEkbnc8nE/NGpWpAR344EOt2zvHrX1O5Cn/w4t5lusMZ
# y7ik4mnYBy0L2q1LCfUxouoW0CqSY27f/S8fMaCLNaOKV43YT3D64FyflwzNvCdB
# kfhqO9CCK/5bxRJZSK0CThGjzTRESy/6JFmCutOmqlqiMbrXpKBjsVRjrAjufmmA
# n0ILzd7LDHwmeFCLSi4RH3ayusUf0hh2qbN9ortXivnDv8XRBWw7mRikgjnWbE0q
# QHapaLIWf4XVSUOjXhPRLvorA8hvm336b6LNNuGA0Uz1DGw8B1f8boKTkLPuqb2y
# 4J0N7EOchs6hOZG7U29WPEL8mHOEKQ==
