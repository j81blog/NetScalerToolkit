# Generated NetScalerToolkit Configuration bundle for category 'ulfd'.

# region Invoke-NSAddULFDServer
function Invoke-NSAddULFDServer {
    <#
    .SYNOPSIS
        Creates a NetScaler ulfdserver resource.
    .DESCRIPTION
        Configuration for ulfd server resource.
    .PARAMETER Loggerip
        IP address of the server where ulfd service is running. Minimum length = 1
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddULFDServer -Loggerip 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddULFDServer -Loggerip 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('Loggerip')) { $properties['loggerip'] = $Loggerip }
    ...
    if ($PSCmdlet.ShouldProcess("$Loggerip", 'Create ulfdserver')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type ulfdserver -Payload @{ ulfdserver = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetULFDServer -Loggerip $Loggerip -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddULFDServer

# region Invoke-NSDeleteULFDServer
function Invoke-NSDeleteULFDServer {
    <#
    .SYNOPSIS
        Removes a NetScaler ulfdserver resource.
    .DESCRIPTION
        Configuration for ulfd server resource.
    .PARAMETER Loggerip
        IP address of the server where ulfd service is running. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteULFDServer -Loggerip 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetULFDServer -Loggerip 'ulfdserver_example' | Invoke-NSDeleteULFDServer -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Loggerip", 'Delete ulfdserver')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type ulfdserver -Resource $Loggerip -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteULFDServer

# region Invoke-NSGetULFDServer
function Invoke-NSGetULFDServer {
    <#
    .SYNOPSIS
        Gets NetScaler ulfdserver configuration.
    .DESCRIPTION
        Configuration for ulfd server resource.
    .PARAMETER Loggerip
        IP address of the server where ulfd service is running. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetULFDServer
    .EXAMPLE
        Invoke-NSGetULFDServer -Loggerip 'ulfdserver_example'
    .EXAMPLE
        Invoke-NSGetULFDServer -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetULFDServer

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmGSvx/PavOhuo
# FzTcsMXxMoTp6E8k0w9YSnqreuvYVaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgd+Xf
# TCRfo7qxrmc1US7gLtJX0L8/JNiXtCnGGZ4zKvkwDQYJKoZIhvcNAQEBBQAEggGA
# Xp2OcSaxK3Dzmg9sJc/P3ECOijTCJ1+84LVgWK3c1anXpU1+wlguwu6x1WlXNev4
# 7SPOAMQYTLpKTNC1mymZFHm7cbTRQ3RWDE/gSYmuSrEiF8YX2vCyufjaUj+ZPemW
# uODO+/lFJNJbSYekxFv2aNi8591sWs2DpOP/E/Z9pENwTOr0bmZ5VqfetKqwxJ9b
# p5YB37sP9YWKXDqfw18vEaJfTnteOLQdmn0CDyF5WsY9ydnj9POwoqScGOOmlebL
# 8BXSYXIQoX5am4tDjveHvn5Ezn44W+cUFEd/pcAyoMUVMMjvVZgdv+TaD5P2nKJS
# PgD7WoBSa/b4vdAuF6ovZKbYJ/0xKltRViT0GMtmg+6gsxDwEQCV/r1RgNTPylQn
# IF75NNLSB5B7NvrxNeFmqrz3+NwY3kluR2ueAjMm8+OHY7A/2+rEbkFCykPPS2Kz
# ouo/d2xga79BD1PFYHgKVtRNcrx4j5QWXYQYkK1ZYLO3NoJBblOAa8dVvtvI9MV3
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIEK60NWOSGxXBLkVS8d2
# RcRkNY4ULSeP36cGGhAmJUa/AgZqNTBfoZ8YEzIwMjYwODAzMTI1MjQ4LjU4Nlow
...
# IgQgM+2/R6iMnof3fmK2W5UmX+68bqQeIgCHUrA1cbgiHFcwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgC7syfLRSQ7Dl2m
# HqXjbHFeDkPidtWJblZAlkZPyFmjWP8U1OCu6qQhk0HWL918YY8Svgz5eQ6XIa1k
# +2fGyEDs74ASsYTaY2Ji7TuIBpTZK/a4Fv9tObKvP2oIdsMqPM+d0+Emb8bs3u3k
# VRNGbDOv/YJW7Xpkav8XdeMGKtBUVOqQjqGfR621pRzLc92mc5tDrttWEdcWHu2I
# M0v4WMxK2GQ9qAHGIFqTNYieH2PerKpgEtMPq6gfJFf1iIi7Ze9HWh7H+Cd+bQ5i
# Hs8600e73en2/jW+TkeZ4SUBamnpvRlxBKLYae6EtXatmlqkMBzzf9/HZKi0P4bW
# i+WmanhX6XMNMGQZFkSP2/YO+nDWJ5Xbpm6RJMZIAVkprzAP4uZYZkCVMvnaZPX8
# SJMGlSwXU1L2tkr4acMUJqUWoKKYZIf4/+gPnupzCBteVv0sxwL31e+kbp2rlrjJ
# ah54EeQS1vXt8ECGIovqGNo/NKD+uRr0Y0zBoqViwIRqPFjt6qVL5+C+8+XJb0y0
# T1n4voUPEllz4mWFhRVD0lQdLkL7/KLaE4Mgr3GYTvzeGHSQhYJhoZQZsPBSJScQ
# bSPVJPWKEnpV5xfXw8M0NgI/In/aFBFco16ew7d6qHCHePX8nwp/sG+x6YcJmvcm
# yxyeqVioHNahTzOSlBJFQvNRtDer5A==
