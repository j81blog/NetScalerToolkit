# Generated NetScalerToolkit Configuration bundle for category 'cloudtunnel'.

# region Invoke-NSAddCloudTunnelVServer
function Invoke-NSAddCloudTunnelVServer {
    <#
    .SYNOPSIS
        Creates a NetScaler cloudtunnelvserver resource.
    .DESCRIPTION
    ...
    .PARAMETER Name
        Name for the Cloud Tunnel virtual server. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space,colon (:), at (@), equals (=), and hyphen (-) characters. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my server" or 'my server'). Minimum length = 1
    .PARAMETER ServiceType
        ServiceType of Listener using which traffic will be tunneled through cloud tunnel server. Possible values = TCP, UDP
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddCloudTunnelVServer -Name 'example' -ServiceType TCP -PassThru
    .EXAMPLE
        Invoke-NSAddCloudTunnelVServer -Name 'example' -ServiceType TCP -WhatIf
    .OUTPUTS
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create cloudtunnelvserver')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type cloudtunnelvserver -Payload @{ cloudtunnelvserver = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetCloudTunnelVServer -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddCloudTunnelVServer

# region Invoke-NSDeleteCloudTunnelVServer
function Invoke-NSDeleteCloudTunnelVServer {
    <#
    .SYNOPSIS
        Removes a NetScaler cloudtunnelvserver resource.
    .DESCRIPTION
        Configuration for Cloud Tunnel virtual server resource.
    .PARAMETER Name
        Name for the Cloud Tunnel virtual server. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space,colon (:), at (@), equals (=), and hyphen (-) characters. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my server" or 'my server'). Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteCloudTunnelVServer -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetCloudTunnelVServer -Name 'cloudtunnelvserver_example' | Invoke-NSDeleteCloudTunnelVServer -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete cloudtunnelvserver')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type cloudtunnelvserver -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteCloudTunnelVServer

# region Invoke-NSGetCloudTunnelParameter
function Invoke-NSGetCloudTunnelParameter {
    <#
    .SYNOPSIS
        Gets NetScaler cloudtunnelparameter configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetCloudTunnelParameter -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetCloudTunnelParameter

# region Invoke-NSGetCloudTunnelVServer
function Invoke-NSGetCloudTunnelVServer {
    <#
    .SYNOPSIS
        Gets NetScaler cloudtunnelvserver configuration.
    .DESCRIPTION
        Configuration for Cloud Tunnel virtual server resource.
    .PARAMETER Name
        Name for the Cloud Tunnel virtual server. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space,colon (:), at (@), equals (=), and hyphen (-) characters. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my server" or 'my server'). Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetCloudTunnelVServer
    .EXAMPLE
        Invoke-NSGetCloudTunnelVServer -Name 'cloudtunnelvserver_example'
    .EXAMPLE
        Invoke-NSGetCloudTunnelVServer -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetCloudTunnelVServer

# region Invoke-NSUnsetCloudTunnelParameter
function Invoke-NSUnsetCloudTunnelParameter {
    <#
    .SYNOPSIS
        Clears one or more NetScaler cloudtunnelparameter resource properties.
    .DESCRIPTION
        Configuration for Cloudtunnel parameter resource.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetCloudTunnelParameter -Subnetresourcelocationmappings  -PassThru
    .EXAMPLE
        Invoke-NSUnsetCloudTunnelParameter -Subnetresourcelocationmappings  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    param(
        [Parameter()]
        [switch] $Subnetresourcelocationmappings,
    ...
    process {
        ...
        $body = @{}
        if ($PSBoundParameters.ContainsKey('Subnetresourcelocationmappings')) { $body['subnetresourcelocationmappings'] = $true }

        if ($body.Count -le 0) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess('cloudtunnelparameter', 'Clear cloudtunnelparameter properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type cloudtunnelparameter -Action unset -Payload @{ cloudtunnelparameter = $body } -RawResponse

            return $response
        }
    }
}
# endregion Invoke-NSUnsetCloudTunnelParameter

# region Invoke-NSUpdateCloudTunnelParameter
function Invoke-NSUpdateCloudTunnelParameter {
    <#
    .SYNOPSIS
        Updates a NetScaler cloudtunnelparameter resource.
    .DESCRIPTION
        Configuration for Cloudtunnel parameter resource.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateCloudTunnelParameter  -PassThru
    .EXAMPLE
        Invoke-NSUpdateCloudTunnelParameter  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSBoundParameters.ContainsKey('Subnetresourcelocationmappings')) { $properties['subnetresourcelocationmappings'] = $Subnetresourcelocationmappings }
    ...
    if ($PSCmdlet.ShouldProcess('cloudtunnelparameter', 'Update cloudtunnelparameter')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type cloudtunnelparameter -Payload @{ cloudtunnelparameter = $body } -RawResponse

        return $response
    }
}
# endregion Invoke-NSUpdateCloudTunnelParameter

# region Invoke-NSUpdateCloudTunnelVServer
function Invoke-NSUpdateCloudTunnelVServer {
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update cloudtunnelvserver')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type cloudtunnelvserver -Payload @{ cloudtunnelvserver = $body } -RawResponse
...
# endregion Invoke-NSUpdateCloudTunnelVServer

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAN0brPyrp1bycM
# yHsxBBd/B4SkPpm3eCnoiZN7b4YrD6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg68iA
# +rRd/hrkL1XvbMgRSSZ/es3JSzPMP4ZE+xC4KuowDQYJKoZIhvcNAQEBBQAEggGA
# CJrYAK6gw1mH4Y0EzjW6eag8WYUTl43hHuCqlZWZq8Q5uZXXwE4iRh74kGB/DJDa
# gHW7NXgOtowqBX+cjXAmEpwCDHI3VGL4Z/H7F0FyIpw1f3D5gx/vuYpR4OW0L91t
# 6y0bqia1a9eBnjQC4mUWOgvk45PtdDWRcZ8De0pLEVCyub4M6pQQ0NdTVaY3F1fr
# jtFw73eefJCplTc+/3Uw/Xi8tE0TVHiR8kMw86VvDdmYEZXE6mJtYXpDipOHkRFF
# 6lgk64ltmvq1SLAJDHwtZhC9gk7Nka9Z31yJkaWXkBaAGtU3DqTTwR3wEVwjAnQE
# mr92INCqBeycpZdzrjZR4Yh1zohf7QbkbNZIqKifqqmYVWAxTRX5B4fVP0PrtqT5
# 0E/LRfIItazTXR2cnc1nywG0pY7ufzSl9Mdi5ax4CBGAZiCh2T9cK2HjfGzdYxQG
# SNM35uwvGqAPf9+zY1LGWUtAR7Uu8+xY0DlXGDejJq84+RV5D5VNrAxPX81BlYK+
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIAw7viZgiDq+gWcUvMqj
# FDYuDdjMY4xSIIor5RbrIOF7AgZqNWdcXSwYEzIwMjYwNzI3MTMxMTAxLjIwNFow
...
# IgQgQrQpRgY/a+McjUPy7RnRsxc2WVowuri8W/piENmyzb0wgd0GCyqGSIb3DQEJ
...
# lvlBdu6F8Tu5CjaMViq4hivjqTANBgkqhkiG9w0BAQsFAASCAgB2ftEPs9rllaQF
# AtYvK7r6fSjQdJyrfbQUm6ksZFjUKQj+1EwnSIlKm+CCRFsU8IJfgfZpfFVSfGMu
# kU282XLxGmi1g7JR2f19/h9p0kCJk22XWtJg4W12oQm1/kQ+1ec+x6Ss8mS79a5Q
# Ipkl1B0DCtc0WPheYiA2WkpJonxoaB9phKoa6j7TB8Z09tVXSnGlh0RQan4RtmFg
# v0Z/pCw+2WMC38/V9ul4vBXW4T+wTD8fXoPww9gTPKtUNSj6wUODBnlgMAbuGco6
# zTO04SCoVF/XS7u5UmzlMT7B8Lned7g7kvS8CPTRLeKi9yMFckLlsC7Mf2Q0PKRM
# zB+W0rqKH5uCy3hMgY+Kb298RfbSdVi2gcykapfJukbNdaHkXhXKS1RIaLXoIqaQ
# VYKfI2dl12KcsOGNTnjFb5EKoeNfcVRBuoUiRxP3hA4qng5A6saEsnrkocVWWW3L
# Ex7e5/O8iyGwJt3GjvH0rtYZcWM4xU18qEXqrivYpxNtr+ZX4C9t0A/7ig6ozWwo
# VTrZp2F7m6UdgsvSGnbfjoqjWjcFXCcu7GBhQgECPOSYsaZmnWQer1tWCuAaeHEd
# RkpW0uJBqscZa+vpebafgDliHiGKi6JYSmvYiYrb61e+ia9LqH0qmMS6PXThm2x5
# 39pU1Fl8Ll2h+4oEylY1eQ5z3zxRuA==
