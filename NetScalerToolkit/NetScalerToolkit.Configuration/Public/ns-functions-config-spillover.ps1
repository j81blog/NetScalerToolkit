# Generated NetScalerToolkit Configuration bundle for category 'spillover'.

# region Invoke-NSAddSpilloverAction
function Invoke-NSAddSpilloverAction {
    <#
    .SYNOPSIS
        Creates a NetScaler spilloveraction resource.
    .DESCRIPTION
        Configuration for Spillover action resource.
    .PARAMETER Action
        Spillover action. Currently only type SPILLOVER is supported. Possible values = SPILLOVER
    .PARAMETER Name
    ...
    .EXAMPLE
        Invoke-NSAddSpilloverAction -Name 'example' -Action SPILLOVER -PassThru
    .EXAMPLE
        Invoke-NSAddSpilloverAction -Name 'example' -Action SPILLOVER -WhatIf
    .OUTPUTS
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create spilloveraction')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type spilloveraction -Payload @{ spilloveraction = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetSpilloverAction -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddSpilloverAction

# region Invoke-NSAddSpilloverPolicy
function Invoke-NSAddSpilloverPolicy {
    <#
    .SYNOPSIS
        Creates a NetScaler spilloverpolicy resource.
    .DESCRIPTION
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddSpilloverPolicy -Name 'example' -Action 'example' -Rule 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddSpilloverPolicy -Name 'example' -Action 'example' -Rule 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create spilloverpolicy')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type spilloverpolicy -Payload @{ spilloverpolicy = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetSpilloverPolicy -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddSpilloverPolicy

# region Invoke-NSDeleteSpilloverAction
function Invoke-NSDeleteSpilloverAction {
    <#
    .SYNOPSIS
        Removes a NetScaler spilloveraction resource.
    .DESCRIPTION
        Configuration for Spillover action resource.
    .PARAMETER Name
        Name of the spillover action.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteSpilloverAction -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetSpilloverAction -Name 'spilloveraction_example' | Invoke-NSDeleteSpilloverAction -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete spilloveraction')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type spilloveraction -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteSpilloverAction

# region Invoke-NSDeleteSpilloverPolicy
function Invoke-NSDeleteSpilloverPolicy {
    <#
    .SYNOPSIS
        Removes a NetScaler spilloverpolicy resource.
    .DESCRIPTION
        Configuration for Spillover policy resource.
    .PARAMETER Name
        Name of the spillover policy.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteSpilloverPolicy -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetSpilloverPolicy -Name 'spilloverpolicy_example' | Invoke-NSDeleteSpilloverPolicy -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete spilloverpolicy')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type spilloverpolicy -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteSpilloverPolicy

# region Invoke-NSGetSpilloverAction
function Invoke-NSGetSpilloverAction {
    <#
    .SYNOPSIS
        Gets NetScaler spilloveraction configuration.
    .DESCRIPTION
        Configuration for Spillover action resource.
    .PARAMETER Name
        Name of the spillover action.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetSpilloverAction
    .EXAMPLE
        Invoke-NSGetSpilloverAction -Name 'spilloveraction_example'
    .EXAMPLE
        Invoke-NSGetSpilloverAction -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetSpilloverAction

# region Invoke-NSGetSpilloverPolicy
function Invoke-NSGetSpilloverPolicy {
    <#
    .SYNOPSIS
        Gets NetScaler spilloverpolicy configuration.
    .DESCRIPTION
        Configuration for Spillover policy resource.
    .PARAMETER Name
        Name of the spillover policy.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetSpilloverPolicy
    .EXAMPLE
        Invoke-NSGetSpilloverPolicy -Name 'spilloverpolicy_example'
    .EXAMPLE
        Invoke-NSGetSpilloverPolicy -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetSpilloverPolicy

# region Invoke-NSGetSpilloverPolicyBinding
function Invoke-NSGetSpilloverPolicyBinding {
    <#
    .SYNOPSIS
        Gets NetScaler spilloverpolicy_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyBinding -Name 'spilloverpolicy_binding_example'
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetSpilloverPolicyBinding

# region Invoke-NSGetSpilloverPolicyCSVServerBinding
function Invoke-NSGetSpilloverPolicyCSVServerBinding {
    <#
    .SYNOPSIS
        Gets NetScaler spilloverpolicy_csvserver_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyCSVServerBinding -Name 'spilloverpolicy_csvserver_binding_example'
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyCSVServerBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'spilloverpolicy_csvserver_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetSpilloverPolicyCSVServerBinding

# region Invoke-NSGetSpilloverPolicyGSLBVServerBinding
function Invoke-NSGetSpilloverPolicyGSLBVServerBinding {
    <#
    .SYNOPSIS
        Gets NetScaler spilloverpolicy_gslbvserver_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyGSLBVServerBinding -Name 'spilloverpolicy_gslbvserver_binding_example'
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyGSLBVServerBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'spilloverpolicy_gslbvserver_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetSpilloverPolicyGSLBVServerBinding

# region Invoke-NSGetSpilloverPolicyLBVServerBinding
function Invoke-NSGetSpilloverPolicyLBVServerBinding {
    <#
    .SYNOPSIS
        Gets NetScaler spilloverpolicy_lbvserver_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyLBVServerBinding -Name 'spilloverpolicy_lbvserver_binding_example'
    .EXAMPLE
        Invoke-NSGetSpilloverPolicyLBVServerBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'spilloverpolicy_lbvserver_binding'
            Query = $query
        }
...
function Invoke-NSRenameSpilloverAction {
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSRenameSpilloverAction -Name 'example' -NewName 'example' -PassThru
    .EXAMPLE
        Invoke-NSRenameSpilloverAction -Name 'example' -NewName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Rename spilloveraction')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type spilloveraction -Action rename -Payload @{ spilloveraction = $body } -RawResponse

            if ($PassThru) {
                return Invoke-NSGetSpilloverAction -Name $NewName -Session $Session
            }
...
# endregion Invoke-NSRenameSpilloverAction

# region Invoke-NSRenameSpilloverPolicy
function Invoke-NSRenameSpilloverPolicy {
    <#
    .SYNOPSIS
        Renames a NetScaler spilloverpolicy resource.
    .DESCRIPTION
        Configuration for Spillover policy resource.
    .PARAMETER Name
        Name of the spillover policy.
    .PARAMETER NewName
        New name for the spillover policy. Must begin with an ASCII alphabetic or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@), equals (=), and hyphen (-) characters. Choose a name that reflects the function that the policy performs. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my policy" or 'my policy'). Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSRenameSpilloverPolicy -Name 'example' -NewName 'example' -PassThru
    .EXAMPLE
        Invoke-NSRenameSpilloverPolicy -Name 'example' -NewName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Rename spilloverpolicy')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type spilloverpolicy -Action rename -Payload @{ spilloverpolicy = $body } -RawResponse

            if ($PassThru) {
                return Invoke-NSGetSpilloverPolicy -Name $NewName -Session $Session
            }
...
# endregion Invoke-NSRenameSpilloverPolicy

# region Invoke-NSUnsetSpilloverPolicy
function Invoke-NSUnsetSpilloverPolicy {
    <#
    .SYNOPSIS
        Clears one or more NetScaler spilloverpolicy resource properties.
    .DESCRIPTION
        Configuration for Spillover policy resource.
    .PARAMETER Name
        Name of the spillover policy.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetSpilloverPolicy -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUnsetSpilloverPolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Clear spilloverpolicy properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type spilloverpolicy -Action unset -Payload @{ spilloverpolicy = $body } -RawResponse
...
# endregion Invoke-NSUnsetSpilloverPolicy

# region Invoke-NSUpdateSpilloverPolicy
function Invoke-NSUpdateSpilloverPolicy {
    <#
    .SYNOPSIS
        Updates a NetScaler spilloverpolicy resource.
    .DESCRIPTION
        Configuration for Spillover policy resource.
    .PARAMETER Action
        Action for the spillover policy. Action is created using add spillover action command.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateSpilloverPolicy -Name 'example' -Comment 'Updated by automation' -PassThru
    .EXAMPLE
        Invoke-NSUpdateSpilloverPolicy -Name 'example' -Comment 'Updated by automation' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", '