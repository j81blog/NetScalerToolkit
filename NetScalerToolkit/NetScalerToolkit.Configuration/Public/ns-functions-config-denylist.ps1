# Generated NetScalerToolkit Configuration bundle for category 'denylist'.

# region Invoke-NSGetDenylistglobalBinding
function Invoke-NSGetDenylistglobalBinding {
    <#
    .SYNOPSIS
        Gets NetScaler denylistglobal_binding configuration.
    .DESCRIPTION
        Binding object which returns the resources bound to denylistglobal.
    .PARAMETER Type
        Label type of denylist. Possible values = HTTP_REQUEST, AAA_REQUEST, AAATM_REQUEST
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetDenylistglobalBinding
    .EXAMPLE
        Invoke-NSGetDenylistglobalBinding -Type 'denylistglobal_binding_example'
    .EXAMPLE
        Invoke-NSGetDenylistglobalBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
...
# endregion Invoke-NSGetDenylistglobalBinding

# region Invoke-NSGetDenylistglobalBindingBinding
function Invoke-NSGetDenylistglobalBindingBinding {
    <#
    .SYNOPSIS
        Gets NetScaler denylistglobal_binding_binding configuration.
    .DESCRIPTION
        Binding object showing the binding that can be bound to denylistglobal.
    .PARAMETER ViewSummary
        Requests the NITRO summary view.
    .PARAMETER Count
    ...
    .EXAMPLE
        Invoke-NSGetDenylistglobalBindingBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'denylistglobal_binding_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetDenylistglobalBindingBinding

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC/n9+4oqej1vAq
# R1PM9AERNACxGKr60kZKoiKEsxczMKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg+Gge
# lt3Jx/sFJ3kW4XJx/UYEjbdIorcXyDsgMWoNxzwwDQYJKoZIhvcNAQEBBQAEggGA
# UxGrXXCZcuDZRkUg1GpBf8qDPPHZGECr9nTFrKtIMuWCEM3xhKrpPNB1pvvOrgXG
# pRq58xKImuO3KjDAk/ltyMxKDehtm37T1i56wvgIz1gvbkWFsDcI8HJrih8vBAyD
# mz2MO6HuY8UseQ9tTYT4uz0asGMpPtq5GcYBpkyTJ7rchvS4FUpxgl+L5Fz5Fl8N
# iYAVM0O+TRDOlV9uUIrRSDLhDQz/0K60Dn6SO2kqdMaDlih9BpnHwzh3v+q16Xs+
# J3UXoJDMy3NWKFZoUyg7ENiQszhjS2oCZr2FA8GAM8wjTbYYBVdynJvYmtZ8ifpe
# JB6HW0udzKczVr0q4FWXj/+s/mV4mgH9gd84RMcGQfpClfCJWOUKeX5xRiDIUBB3
# bsIoRjioWZsEVQzwcbvgRpgaINY+sDvi3kHUWiVQpFYW7BSnA7Uj89tyCIIoeOyD
# Te8WdnFyrZvA5a9vofCPMccr/Lvgj+CXdB/YQVU7nPLbg4agyaLeyko5Qtg5ylfe
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIHG8DXXjhcHjH7PUsWXx
# /jDGvHUP8SpGsxXaat9Q36YqAgZqNTBOP0sYEzIwMjYwNzI3MTMxMTE4LjMwOFow
...
# IgQg2hYvu1+lccC2Kk+IGMWX5cV3M4rBxuBSm+b9377N4dswgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgBiTNdZPC6ckYU9
# /bOLgRra7fqWW1YU4BWbXEU6OVToPR2AJgTiINxZ8YaGNLFnrjqwm1IdGZ/cDqdf
# n77W6b4E1qVP8R/M27OWEI1OQhCSZJ7b3GkowgUl2y8IF8wMHxJhXuXgazQnRmZx
# quwWAkM0GfccPFsd1w8tOh48Sq2ZtgbidLUuNUtl+QAryfI2NEIv3GGPVENWGTwv
# mixyvm57BA0ynlzDtV8Nf6HMPBrHz8kAz8Uvhto0zk3Tbj+AHh9QwHzDr0RwkWbH
# ju4Cd4ncRwsP9Woc5L5qvm0W5+MmXFITH8Oy5GspAvswOYIuFm8plupAJBtmKheA
# kBTUSihtOTUEo4KJ23xs1RJdFDM4V11Tkv4PJcgq7L35C9By4KHnAg4CkfOcHRDH
# DHbAHRRCeNPUeCe3SaA6rL5niaPwVv2Wo6aGBGGwb7FXn5DusCTTbo8FlBIzMVbM
# vSFCqHHTPijUo+niR2tYXQKF70i5i4c9El2/USr1XGV3q4w9+D4JerAM/Ajxiger
# VVAts7rkgy5dpTNQqENDiv/m5DmEabrgKERnIZXRSb/4NLMgESh5vy64N5cuoOmJ
# bZuPCOk7FHTcD2QUc8VEpTLZnLF+z4QX+7mOL/lfxxXGTgcEju7vnATbU08bPpRs
# 7thrcbIaG2vf4JHdeMoe1jvtuCiFTw==
