# Generated NetScalerToolkit Configuration bundle for category 'endpoint'.

# region Invoke-NSAddEndpointInfo
function Invoke-NSAddEndpointInfo {
    <#
    .SYNOPSIS
        Creates a NetScaler endpointinfo resource.
    .DESCRIPTION
        Configuration for Information resource.
    .PARAMETER EndpointKind
        Endpoint kind. Currently, IP endpoints are supported. Default value: IP Possible values = IP
    .PARAMETER EndpointLabelSJson
        String representing labels in json form. Maximum length 16K. Minimum length = 1
    ...
    .PARAMETER EndpointName
        Name of endpoint, depends on kind. For IP Endpoint - IP address. Minimum length = 1
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddEndpointInfo -EndpointKind IP -EndpointName 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddEndpointInfo -EndpointKind IP -EndpointName 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('EndpointKind')) { $properties['endpointkind'] = $EndpointKind }
    if ($PSBoundParameters.ContainsKey('EndpointLabelSJson')) { $properties['endpointlabelsjson'] = $EndpointLabelSJson }
    if ($PSBoundParameters.ContainsKey('EndpointmetaData')) { $properties['endpointmetadata'] = $EndpointmetaData }
    if ($PSBoundParameters.ContainsKey('EndpointName')) { $properties['endpointname'] = $EndpointName }
    ...
    if ($PSCmdlet.ShouldProcess("$EndpointKind", 'Create endpointinfo')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type endpointinfo -Payload @{ endpointinfo = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetEndpointInfo -EndpointKind $EndpointKind -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddEndpointInfo

# region Invoke-NSClearEndpointInfo
function Invoke-NSClearEndpointInfo {
    <#
    .SYNOPSIS
        Clears NetScaler endpointinfo data.
    .DESCRIPTION
        Configuration for Information resource.
    .PARAMETER EndpointKind
        Endpoint kind. Currently, IP endpoints are supported. Default value: IP Possible values = IP
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSClearEndpointInfo -EndpointKind IP
    .EXAMPLE
        Invoke-NSClearEndpointInfo -EndpointKind IP -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = [System.Collections.Generic.Dictionary[string, object]]::new([System.StringComparer]::Ordinal)
        if ($PSBoundParameters.ContainsKey('EndpointKind')) { $body['endpointkind'] = $EndpointKind }

        if ($PSCmdlet.ShouldProcess('endpointinfo', 'Clear endpointinfo')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type endpointinfo -Action clear -Payload @{ endpointinfo = $body } -RawResponse
        }
    }
}
# endregion Invoke-NSClearEndpointInfo

# region Invoke-NSDeleteEndpointInfo
function Invoke-NSDeleteEndpointInfo {
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('EndpointName')) {
            $argumentParts += 'endpointname:' + $EndpointName
        }
        if ($argumentParts.Count -gt 0) {
            $query.args = $argumentParts -join ','
        }

        if ($PSCmdlet.ShouldProcess("$EndpointKind", 'Delete endpointinfo')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type endpointinfo -Resource $EndpointKind -Query $query -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteEndpointInfo

# region Invoke-NSGetEndpointInfo
function Invoke-NSGetEndpointInfo {
    <#
    .SYNOPSIS
        Gets NetScaler endpointinfo configuration.
    .DESCRIPTION
        Configuration for Information resource.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetEndpointInfo
    .EXAMPLE
        Invoke-NSGetEndpointInfo -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetEndpointInfo

# region Invoke-NSUnsetEndpointInfo
function Invoke-NSUnsetEndpointInfo {
    <#
    .SYNOPSIS
        Clears one or more NetScaler endpointinfo resource properties.
    .DESCRIPTION
        Configuration for Information resource.
    .PARAMETER EndpointKind
        Endpoint kind. Currently, IP endpoints are supported. Default value: IP Possible values = IP
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetEndpointInfo -EndpointKind IP -EndpointLabelSJson  -PassThru
    .EXAMPLE
        Invoke-NSUnsetEndpointInfo -EndpointKind IP -EndpointLabelSJson  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    param(
        ...
        [Parameter()]
        [switch] $EndpointLabelSJson,

        [Parameter()]
        [switch] $EndpointmetaData,
    ...
    process {
        ...
        $body = @{ endpointkind = $EndpointKind }
        if ($PSBoundParameters.ContainsKey('EndpointLabelSJson')) { $body['endpointlabelsjson'] = $true }
        if ($PSBoundParameters.ContainsKey('EndpointmetaData')) { $body['endpointmetadata'] = $true }
        if ($PSBoundParameters.ContainsKey('EndpointName')) { $body['endpointname'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$EndpointKind", 'Clear endpointinfo properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type endpointinfo -Action unset -Payload @{ endpointinfo = $body } -RawResponse
...
# endregion Invoke-NSUnsetEndpointInfo

# region Invoke-NSUpdateEndpointInfo
function Invoke-NSUpdateEndpointInfo {
    <#
    .SYNOPSIS
        Updates a NetScaler endpointinfo resource.
    .DESCRIPTION
        Configuration for Information resource.
    .PARAMETER EndpointKind
        Endpoint kind. Currently, IP endpoints are supported. Default value: IP Possible values = IP
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateEndpointInfo -EndpointKind IP -EndpointName 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdateEndpointInfo -EndpointKind IP -EndpointName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$EndpointKind", 'Update endpointinfo')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type endpointinfo -Payload @{ endpointinfo = $body } -RawResponse
...
# endregion Invoke-NSUpdateEndpointInfo

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCABHXKI9/ICyZlg
# hJJp9hMFqdq1FV+zrt1SRVxAnpHv26CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgzxAB
# yZBow+9COoeTejCCvAVD4b0Qra4v20kIASkIc+UwDQYJKoZIhvcNAQEBBQAEggGA
# Szq/RaTeRkTGzueqPSvmXNUMW4Ej43YHxOkpE8E5TaAOZJ8WyrK/KCXZqRmmZ1Q+
# 95Qgp54vDlUdbY/AGAq+254ZefREAbKAx0pSwqPIIl5OsAWSIZ6UH5lC6KywueZD
# 5dyQMK39OG12ZgDIBA0vtYJdvnFu7k8Esus1FHrF3FUJ9VkgfgPsFi4xfT8E6F5Y
# y6onu1xgSKQKyXdviRAJcagWY3+D/yxeN3MMkmQJJMZqbUUJWkNS7YR8mbjbubwq
# icSaoNKTGd7w52HGWY7mls4cbn2DqIeNaWLyOFAvZaMsDxAQH0SohhiwSHCTuddX
# GgJP7gaq8caGSwA2xbFYWyIsiowWfcKhYH9zCvm/0CxZQJKf0r9ztAfQqTIwFVL+
# K9617HmHTo5f+mrrW4EOt9HLYO2f10A8ozn6F/jTpAF4cM0jonW3Hc+vktiE8MD1
# YdKVJim/cq/xCXI48E4zeJ49LbnaGOuUV6SStXQtmrJWTVbCBqHNFqOoY6Hj6KpQ
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIPrXH+HBv6KR8ZiKw69l
# lkIq4EnvrBvc5kVLBX0qrOcoAgZqNTBOP3UYEzIwMjYwNzI3MTMxMTI1LjU2M1ow
...
# IgQgt6caUl6EB05SJtHzCU+bXDip90groOCqN7De8Isu7Nowgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgA58PX1k85KOm0l
# F8TUBDMd06P3QjZ7nTP4rG/jus44eF5SUNFEj7Imt6hFCOq70clGwmLBueF9PLCu
# M0R9RLjepsJyGW/ktIILEvE/nbyzc/0+0rWpAWryM/D54Z8R0nt+HBKU2ThCes5t
# Om2hREzEfCOouMgNrMnlRfn36I7oKw52icm90ofe3XLDGPXkJ5rIYGSnRwV5j7zU
# sjJwNdW41HX8ez7uOTLDNOKCR7MGvFyWjsoJXG/lW59re9w2g5Crdfxm/unXxgZO
# LBqGqQ81Zos22WSodme+uXDAaohaldqOHXUH4d5SbLTWHRB++F9EGFjsu6rN3lsr
# aT9HQ11yF88DVs8Uv4WRH0Ui5fIzwF1AMqLwRg1NTTomNfqxP1c49jSrygWbhEYn
# lg9fFV772BL8ht0+iiMfKUApKNzUGWYlubk1dlySdO66NezHbsnStU8CA29CBLDY
# GDqS2Q0sY+vpnd8VwM0ERUIVS2IQdGdCD7LWHDHWSLAh/BA7oH8vMDC+Zw41V6SZ
# 49U3fJhl/dmQeZJK32lc9faQ3+9Q/OMqsUgKV48EkJ0pnJn/SxuJmkYWmhVH4RcA
# Z1AoltvsmMfsyU1GAAtI5HNkki3l13O8e9/W2xmm9gyg8rMTlRbeTWklKjT6HxeH
# tsVGR0/9PshBdhyGQoCyTfZFY01g+A==
