# Generated NetScalerToolkit Configuration bundle for category 'quicbridge'.

# region Invoke-NSAddQUICBridgeProfile
function Invoke-NSAddQUICBridgeProfile {
    <#
    .SYNOPSIS
        Creates a NetScaler quicbridgeprofile resource.
    .DESCRIPTION
        Configuration for QUIC BRIDGE profile resource.
    .PARAMETER Name
        Name for the QUIC profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@),equals sign (=), and hyphen (-) characters. Cannot be changed after the profile is created. Minimum length = 1 Maximum length = 255
    .PARAMETER Routingalgorithm
        Routing algorithm to generate routable connection IDs. Default value: PLAINTEXT Possible values = PLAINTEXT
    ...
    .EXAMPLE
        Invoke-NSAddQUICBridgeProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddQUICBridgeProfile -Name 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('Routingalgorithm')) { $properties['routingalgorithm'] = $Routingalgorithm }
    if ($PSBoundParameters.ContainsKey('ServerIdLength')) { $properties['serveridlength'] = $ServerIdLength }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create quicbridgeprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type quicbridgeprofile -Payload @{ quicbridgeprofile = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetQUICBridgeProfile -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddQUICBridgeProfile

# region Invoke-NSDeleteQUICBridgeProfile
function Invoke-NSDeleteQUICBridgeProfile {
    <#
    .SYNOPSIS
        Removes a NetScaler quicbridgeprofile resource.
    .DESCRIPTION
        Configuration for QUIC BRIDGE profile resource.
    .PARAMETER Name
        Name for the QUIC profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@),equals sign (=), and hyphen (-) characters. Cannot be changed after the profile is created. Minimum length = 1 Maximum length = 255
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteQUICBridgeProfile -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetQUICBridgeProfile -Name 'quicbridgeprofile_example' | Invoke-NSDeleteQUICBridgeProfile -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete quicbridgeprofile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type quicbridgeprofile -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteQUICBridgeProfile

# region Invoke-NSGetQUICBridgeProfile
function Invoke-NSGetQUICBridgeProfile {
    <#
    .SYNOPSIS
        Gets NetScaler quicbridgeprofile configuration.
    .DESCRIPTION
        Configuration for QUIC BRIDGE profile resource.
    .PARAMETER Name
        Name for the QUIC profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@),equals sign (=), and hyphen (-) characters. Cannot be changed after the profile is created. Minimum length = 1 Maximum length = 255
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetQUICBridgeProfile
    .EXAMPLE
        Invoke-NSGetQUICBridgeProfile -Name 'quicbridgeprofile_example'
    .EXAMPLE
        Invoke-NSGetQUICBridgeProfile -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetQUICBridgeProfile

# region Invoke-NSUnsetQUICBridgeProfile
function Invoke-NSUnsetQUICBridgeProfile {
    <#
    .SYNOPSIS
        Clears one or more NetScaler quicbridgeprofile resource properties.
    .DESCRIPTION
        Configuration for QUIC BRIDGE profile resource.
    .PARAMETER Name
        Name for the QUIC profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (@),equals sign (=), and hyphen (-) characters. Cannot be changed after the profile is created. Minimum length = 1 Maximum length = 255
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetQUICBridgeProfile -Name 'example' -Routingalgorithm PLAINTEXT -PassThru
    .EXAMPLE
        Invoke-NSUnsetQUICBridgeProfile -Name 'example' -Routingalgorithm PLAINTEXT -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = @{ name = $Name }
        if ($PSBoundParameters.ContainsKey('Routingalgorithm')) { $body['routingalgorithm'] = $true }
        if ($PSBoundParameters.ContainsKey('ServerIdLength')) { $body['serveridlength'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$Name", 'Clear quicbridgeprofile properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type quicbridgeprofile -Action unset -Payload @{ quicbridgeprofile = $body } -RawResponse
...
# endregion Invoke-NSUnsetQUICBridgeProfile

# region Invoke-NSUpdateQUICBridgeProfile
function Invoke-NSUpdateQUICBridgeProfile {
    <#
    .SYNOPSIS
        Updates a NetScaler quicbridgeprofile resource.
    .DESCRIPTION
        Configuration for QUIC BRIDGE profile resource.
    .PARAMETER Name
        Name for the QUIC profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at (