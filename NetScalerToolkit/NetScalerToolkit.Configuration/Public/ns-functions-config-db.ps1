# Generated NetScalerToolkit Configuration bundle for category 'db'.

# region Invoke-NSAddDbdbProfile
function Invoke-NSAddDbdbProfile {
    <#
    .SYNOPSIS
        Creates a NetScaler dbdbprofile resource.
    .DESCRIPTION
        Configuration for DB profile resource.
    .PARAMETER ConMultiPlex
        Use the same server-side connection for multiple client-side requests. Default is enabled. Default value: ENABLED Possible values = ENABLED, DISABLED
    .PARAMETER Enablecachingconmuxoff
        Enable caching when connection multiplexing is OFF. Default value: DISABLED Possible values = ENABLED, DISABLED
    .PARAMETER Interpretquery
        If ENABLED, inspect the query and update the connection information, if required. If DISABLED, forward the query to the server. Default value: YES Possible values = YES, NO
    .PARAMETER KCDAccount
        Name of the KCD account that is used for Windows authentication. Minimum length = 1 Maximum length = 127
    .PARAMETER Name
    ...
    .PARAMETER Stickiness
        If the queries are related to each other, forward to the same backend server. Default value: NO Possible values = YES, NO
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddDbdbProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddDbdbProfile -Name 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('ConMultiPlex')) { $properties['conmultiplex'] = $ConMultiPlex }
    if ($PSBoundParameters.ContainsKey('Enablecachingconmuxoff')) { $properties['enablecachingconmuxoff'] = $Enablecachingconmuxoff }
    if ($PSBoundParameters.ContainsKey('Interpretquery')) { $properties['interpretquery'] = $Interpretquery }
    ...
    if ($PSBoundParameters.ContainsKey('Stickiness')) { $properties['stickiness'] = $Stickiness }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create dbdbprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type dbdbprofile -Payload @{ dbdbprofile = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetDbdbProfile -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddDbdbProfile

# region Invoke-NSAddDbUser
function Invoke-NSAddDbUser {
    <#
    .SYNOPSIS
        Creates a NetScaler dbuser resource.
    .DESCRIPTION
        Configuration for DB user resource.
    .PARAMETER Password
        Password for logging on to the database. Must be the same as the password specified in the database. Minimum length = 1
    .PARAMETER UserName
        Name of the database user. Must be the same as the user name specified in the database. Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddDbUser -UserName 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddDbUser -UserName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$UserName", 'Create dbuser')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type dbuser -Payload @{ dbuser = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetDbUser -UserName $UserName -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddDbUser

# region Invoke-NSDeleteDbdbProfile
function Invoke-NSDeleteDbdbProfile {
    <#
    .SYNOPSIS
        Removes a NetScaler dbdbprofile resource.
    .DESCRIPTION
        Configuration for DB profile resource.
    .PARAMETER Name
        Name for the database profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. Cannot be changed after the profile is created. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my profile" or 'my profile'). . Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteDbdbProfile -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetDbdbProfile -Name 'dbdbprofile_example' | Invoke-NSDeleteDbdbProfile -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete dbdbprofile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type dbdbprofile -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteDbdbProfile

# region Invoke-NSDeleteDbUser
function Invoke-NSDeleteDbUser {
    <#
    .SYNOPSIS
        Removes a NetScaler dbuser resource.
    .DESCRIPTION
        Configuration for DB user resource.
    .PARAMETER UserName
        Name of the database user. Must be the same as the user name specified in the database. Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteDbUser -UserName 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetDbUser -UserName 'dbuser_example' | Invoke-NSDeleteDbUser -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$UserName", 'Delete dbuser')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type dbuser -Resource $UserName -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteDbUser

# region Invoke-NSGetDbdbProfile
function Invoke-NSGetDbdbProfile {
    <#
    .SYNOPSIS
        Gets NetScaler dbdbprofile configuration.
    .DESCRIPTION
        Configuration for DB profile resource.
    .PARAMETER Name
        Name for the database profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. Cannot be changed after the profile is created. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my profile" or 'my profile'). . Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetDbdbProfile
    .EXAMPLE
        Invoke-NSGetDbdbProfile -Name 'dbdbprofile_example'
    .EXAMPLE
        Invoke-NSGetDbdbProfile -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetDbdbProfile

# region Invoke-NSGetDbUser
function Invoke-NSGetDbUser {
    <#
    .SYNOPSIS
        Gets NetScaler dbuser configuration.
    .DESCRIPTION
        Configuration for DB user resource.
    .PARAMETER UserName
        Name of the database user. Must be the same as the user name specified in the database. Minimum length = 1
    ...
    .EXAMPLE
        Invoke-NSGetDbUser
    .EXAMPLE
        Invoke-NSGetDbUser -UserName 'dbuser_example'
    .EXAMPLE
        Invoke-NSGetDbUser -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetDbUser

# region Invoke-NSUnsetDbdbProfile
function Invoke-NSUnsetDbdbProfile {
    <#
    .SYNOPSIS
        Clears one or more NetScaler dbdbprofile resource properties.
    .DESCRIPTION
        Configuration for DB profile resource.
    .PARAMETER Name
        Name for the database profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore, hash (#), period (.), space, colon (:), at sign (@), equal sign (=), and hyphen (-) characters. Cannot be changed after the profile is created. CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my profile" or 'my profile'). . Minimum length = 1 Maximum length = 127
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetDbdbProfile -Name 'example' -ConMultiPlex ENABLED -PassThru
    .EXAMPLE
        Invoke-NSUnsetDbdbProfile -Name 'example' -ConMultiPlex ENABLED -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    param(
        ...
        [Parameter()]
        [ValidateSet('ENABLED', 'DISABLED')]
        [switch] $Enablecachingconmuxoff,

        [Parameter()]
        [ValidateSet('YES', 'NO')]
        [switch] $Interpretquery,
    ...
    process {
        ...
        $body = @{ name = $Name }
        if ($PSBoundParameters.ContainsKey('ConMultiPlex')) { $body['conmultiplex'] = $true }
        if ($PSBoundParameters.ContainsKey('Enablecachingconmuxoff')) { $body['enablecachingconmuxoff'] = $true }
        if ($PSBoundParameters.ContainsKey('Interpretquery')) { $body['interpretquery'] = $true }
        if ($PSBoundParameters.ContainsKey('KCDAccount')) { $body['kcdaccount'] = $true }
        if ($PSBoundParameters.ContainsKey('Stickiness')) { $body['stickiness'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$Name", 'Clear dbdbprofile properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type dbdbprofile -Action unset -Payload @{ dbdbprofile = $body } -RawResponse
...
# endregion Invoke-NSUnsetDbdbProfile

# region Invoke-NSUpdateDbdbProfile
function Invoke-NSUpdateDbdbProfile {
    <#
    .SYNOPSIS
        Updates a NetScaler dbdbprofile resource.
    .DESCRIPTION
        Configuration for DB profile resource.
    .PARAMETER ConMultiPlex
        Use the same server-side connection for multiple client-side requests. Default is enabled. Default value: ENABLED Possible values = ENABLED, DISABLED
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateDbdbProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdateDbdbProfile -Name 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update dbdbprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type dbdbprofile -Payload @{ dbdbprofile = $body } -RawResponse
...
# endregion Invoke-NSUpdateDbdbProfile

# region Invoke-NSUpdateDbUser
function Invoke-NSUpdateDbUser {
    <#
    .SYNOPSIS
        Updates a NetScaler dbuser resource.
    .DESCRIPTION
        Configuration for DB user resource.
    .PARAMETER Password
        Password for logging on to the database. Must be the same as the password specified in the database. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateDbUser -UserName 'example' -Password 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdateDbUser -UserName 'example' -Password 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("