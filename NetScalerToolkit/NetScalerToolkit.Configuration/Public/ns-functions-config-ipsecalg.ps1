# Generated NetScalerToolkit Configuration bundle for category 'ipsecalg'.

# region Invoke-NSAddIPsecALGProfile
function Invoke-NSAddIPsecALGProfile {
    <#
    .SYNOPSIS
        Creates a NetScaler ipsecalgprofile resource.
    .DESCRIPTION
        Configuration for IPSEC ALG profile resource.
    .PARAMETER ConnFailover
        Mode in which the connection failover feature must operate for the IPSec Alg. After a failover, established UDP connections and ESP packet flows are kept active and resumed on the secondary appliance. Recomended setting is ENABLED. Default value: ENABLED Possible values = ENABLED, DISABLED
    .PARAMETER EspgateTimeout
        Timeout ESP in seconds as no ESP packets are seen after IKE negotiation. Default value: 30 Minimum value = 3 Maximum value = 1200
    .PARAMETER EspsessionTimeout
        ESP session timeout in minutes. Default value: 60 Minimum value = 1 Maximum value = 1440
    .PARAMETER IkesessionTimeout
        IKE session timeout in minutes. Default value: 60 Minimum value = 1 Maximum value = 1440
    .PARAMETER Name
        The name of the ipsec alg profile. Minimum length = 1 Maximum length = 32
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddIPsecALGProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddIPsecALGProfile -Name 'example' -WhatIf
    .OUTPUTS
    ...
    param(
        ...
        [Parameter()]
        [int] $EspsessionTimeout,

        [Parameter()]
        [int] $IkesessionTimeout,
    ...
    if ($PSBoundParameters.ContainsKey('ConnFailover')) { $properties['connfailover'] = $ConnFailover }
    if ($PSBoundParameters.ContainsKey('EspgateTimeout')) { $properties['espgatetimeout'] = $EspgateTimeout }
    if ($PSBoundParameters.ContainsKey('EspsessionTimeout')) { $properties['espsessiontimeout'] = $EspsessionTimeout }
    if ($PSBoundParameters.ContainsKey('IkesessionTimeout')) { $properties['ikesessiontimeout'] = $IkesessionTimeout }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create ipsecalgprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type ipsecalgprofile -Payload @{ ipsecalgprofile = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetIPsecALGProfile -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddIPsecALGProfile

# region Invoke-NSDeleteIPsecALGProfile
function Invoke-NSDeleteIPsecALGProfile {
    <#
    .SYNOPSIS
        Removes a NetScaler ipsecalgprofile resource.
    .DESCRIPTION
        Configuration for IPSEC ALG profile resource.
    .PARAMETER Name
        The name of the ipsec alg profile. Minimum length = 1 Maximum length = 32
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteIPsecALGProfile -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetIPsecALGProfile -Name 'ipsecalgprofile_example' | Invoke-NSDeleteIPsecALGProfile -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete ipsecalgprofile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type ipsecalgprofile -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteIPsecALGProfile

# region Invoke-NSFlushIpsecalgsession
function Invoke-NSFlushIpsecalgsession {
    <#
    .SYNOPSIS
        Clears NetScaler ipsecalgsession cache data.
    .DESCRIPTION
        Configuration for IPSEC ALG session resource.
    .PARAMETER Destip
        Destination IP address. Minimum length = 1
    .PARAMETER Natip
        Natted Source IP address. Minimum length = 1
    .PARAMETER Sourceip
        Original Source IP address. Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSFlushIpsecalgsession 
    .EXAMPLE
        Invoke-NSFlushIpsecalgsession  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = [System.Collections.Generic.Dictionary[string, object]]::new([System.StringComparer]::Ordinal)
        if ($PSBoundParameters.ContainsKey('Destip')) { $body['destip'] = $Destip }
        if ($PSBoundParameters.ContainsKey('Natip')) { $body['natip'] = $Natip }
        if ($PSBoundParameters.ContainsKey('Sourceip')) { $body['sourceip'] = $Sourceip }

        if ($PSCmdlet.ShouldProcess('ipsecalgsession', 'Clear ipsecalgsession')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type ipsecalgsession -Action flush -Payload @{ ipsecalgsession = $body } -RawResponse
        }
    }
}
# endregion Invoke-NSFlushIpsecalgsession

# region Invoke-NSGetIPsecALGProfile
function Invoke-NSGetIPsecALGProfile {
    <#
    .SYNOPSIS
        Gets NetScaler ipsecalgprofile configuration.
    .DESCRIPTION
        Configuration for IPSEC ALG profile resource.
    .PARAMETER Name
        The name of the ipsec alg profile. Minimum length = 1 Maximum length = 32
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetIPsecALGProfile
    .EXAMPLE
        Invoke-NSGetIPsecALGProfile -Name 'ipsecalgprofile_example'
    .EXAMPLE
        Invoke-NSGetIPsecALGProfile -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetIPsecALGProfile

# region Invoke-NSGetIpsecalgsession
function Invoke-NSGetIpsecalgsession {
    ...
    process {
        ...
        $argumentParts = @()
        if ($PSBoundParameters.ContainsKey('SourceipAlg')) {
            $argumentValue = $SourceipAlg
            ...
            $argumentParts += 'sourceip_alg:' + $argumentValue
        }
        if ($PSBoundParameters.ContainsKey('NatipAlg')) {
            $argumentValue = $NatipAlg
            if ($argumentValue -is [System.Management.Automation.SwitchParameter]) { $argumentValue = [bool] $argumentValue }
            if ($argumentValue -is [bool]) { $argumentValue = $argumentValue.ToString().ToLowerInvariant() }
            $argumentParts += 'natip_alg:' + $argumentValue
        }
        if ($PSBoundParameters.ContainsKey('DestipAlg')) {
            $argumentValue = $DestipAlg
            if ($argumentValue -is [System.Management.Automation.SwitchParameter]) { $argumentValue = [bool] $argumentValue }
            if ($argumentValue -is [bool]) { $argumentValue = $argumentValue.ToString().ToLowerInvariant() }
            $argumentParts += 'destip_alg:' + $argumentValue
        }
...
# endregion Invoke-NSGetIpsecalgsession

# region Invoke-NSUnsetIPsecALGProfile
function Invoke-NSUnsetIPsecALGProfile {
    <#
    .SYNOPSIS
        Clears one or more NetScaler ipsecalgprofile resource properties.
    .DESCRIPTION
        Configuration for IPSEC ALG profile resource.
    .PARAMETER Name
        The name of the ipsec alg profile. Minimum length = 1 Maximum length = 32
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetIPsecALGProfile -Name 'example' -ConnFailover ENABLED -PassThru
    .EXAMPLE
        Invoke-NSUnsetIPsecALGProfile -Name 'example' -ConnFailover ENABLED -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    param(
        ...
        [Parameter()]
        [switch] $EspgateTimeout,

        [Parameter()]
        [switch] $EspsessionTimeout,

        [Parameter()]
        [switch] $IkesessionTimeout,
    ...
    process {
        ...
        $body = @{ name = $Name }
        if ($PSBoundParameters.ContainsKey('ConnFailover')) { $body['connfailover'] = $true }
        if ($PSBoundParameters.ContainsKey('EspgateTimeout')) { $body['espgatetimeout'] = $true }
        if ($PSBoundParameters.ContainsKey('EspsessionTimeout')) { $body['espsessiontimeout'] = $true }
        if ($PSBoundParameters.ContainsKey('IkesessionTimeout')) { $body['ikesessiontimeout'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$Name", 'Clear ipsecalgprofile properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type ipsecalgprofile -Action unset -Payload @{ ipsecalgprofile = $body } -RawResponse
...
# endregion Invoke-NSUnsetIPsecALGProfile

# region Invoke-NSUpdateIPsecALGProfile
function Invoke-NSUpdateIPsecALGProfile {
    <#
    .SYNOPSIS
        Updates a NetScaler ipsecalgprofile resource.
    .DESCRIPTION
        Configuration for IPSEC ALG profile resource.
    .PARAMETER ConnFailover
        Mode in which the connection failover feature must operate for the IPSec Alg. After a failover, established UDP connections and ESP packet flows are kept active and resumed on the secondary appliance. Recomended setting is ENABLED. Default value: ENABLED Possible values = ENABLED, DISABLED
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateIPsecALGProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdateIPsecALGProfile -Name 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update ipsecalgprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type ipsecalgprofile -Payload @{ ipsecalgprofile = $body } -RawResponse
...
# endregion Invoke-NSUpdateIPsecALGProfile

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCMF2Vg10EA0iMn
# Q2J1QCasEFJS+NmmQzJ+fMsH/b5MIKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgwt6I
# 6ElnY0brVIvgYPqyCnUzkPprsfmZvW3bkDW4saQwDQYJKoZIhvcNAQEBBQAEggGA
# cEM+91+Pypc+KnpI8OCVdkV8gFMhn8Ng1bB60XD6nlLs6Nb/MLn3oTUytP5wc+e2
# LGYF8KVkoW1a9xx2drcae+lRqKRgvYF+oN9AgbpEEQsU4h/5iZj96lW6jEHKJ11f
# pPnaEbo+Chm4WbsYyI/OVk97RS69524EWs42bsg/O9oSURr3AjK3Q622Boi6FrGL
# vYsW7wRaDTK5BMqgiohauNacoCzWbNFLh+wgQz1n+b6I7ZIO2qeJsuiQdYThFkah
# HbRrxinjKMd3jmTW0HoAtD1WqsaonENVa9dEA16WBxrcs+EFP/7Co4m4W+dWj6VL
# 5d2BFTKeq+6EhBNRLyHbsVF+sTwoKL9e3QVyzHjzy3tBA5ot6656sp6nNQBVsasQ
# N1bcr7ydyOQ1/fW3WFhMCE6TyN1UaLhlMCSHRxDPu47AY04pmFxRtYtOvSLEJwg0
# A/tcDXT6vyQMHKolH5iHcp9zv9EuBAeWQ9vd6OB0AzV4QhnzV3afKEASGDvMXkA2
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIDKn4oY6T5Js68VA8wu7
# 1jwgJBJDmUEIVdUrcCAK8skOAgZqNTBfoKIYEzIwMjYwODAzMTI1MTUzLjA4MVow
...
# IgQgDoyY/9//VcfKal+VpZ3lPAFmNj6zyEdF6lkQCPZuBXMwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgDH5/eawX0c2BWt
# 4jnKTmcBAWJiyJaViniCV5Lq/qGid6LrZCRyzkgZBjx9WVXZbka/2801HjSPwv07
# UB+krX+QwjmZdUjqmUFB8nDVMqYiBwsE0yg3Hgn1NyULLxOBaGoGL/NdrDnL7qGV
# nUk5F0/qSmxuxEoUS8X0RToeBa+eI31+isDvmlPs0zYaT77nN2MSsptOlRx9F4Fh
# KOhxWDbE3je2Be1rLBgj2qigq65tTDvk8slqkQ4ZNzwUcZXLupksw5+O3i2NELQI
# +lSto+hYpAfntW2YOS24WZLlpbKcSDJT6nXDGcvl9Z9SgCtwRmMwIS+a47U74XMO
# 9ojvk1ViM/H+xpBTuF9tkEBhYdoZCIPs6R9leQ6ugcA5G7R1hxUB+P4hXnXs+qLD
# jCRdYC6/cIpTD+EeDxblYTMWANUzwoiyZEIMhWX9Z2+kKDeeqPJUc1d+NGQCg7sX
# Dgpoavv5YDqzCBb+wRignp0W1QC1HEI08+gYUJ3zddOwGCQy43crFWV0CYO9SocX
# oompyBGX+CKfuhezaSeHIyNGfN6fpEYkh5x9QDOMTsH03n3LcJOBxtnMi7z5pAn+
# M2nqs9yMEH+hb8ESCoAzK7IjYpOTdfl8nAAzq/XcATQ80Jn2M+PMufumUURqgbwj
# Qjwk5Fwk9h70kUyFsrif8v2ERlXQmg==
