# Generated NetScalerToolkit Configuration bundle for category 'authorization'.

# region Invoke-NSAddAuthorizationPolicy
function Invoke-NSAddAuthorizationPolicy {
    <#
    .SYNOPSIS
        Creates a NetScaler authorizationpolicy resource.
    .DESCRIPTION
        Configuration for authorization policy resource.
    .PARAMETER Action
        Action to perform if the policy matches: either allow or deny the request. Minimum length = 1
    .PARAMETER Name
    ...
    .EXAMPLE
        Invoke-NSAddAuthorizationPolicy -Name 'example' -Action 'example' -Rule 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddAuthorizationPolicy -Name 'example' -Action 'example' -Rule 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create authorizationpolicy')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type authorizationpolicy -Payload @{ authorizationpolicy = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetAuthorizationPolicy -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddAuthorizationPolicy

# region Invoke-NSAddAuthorizationPolicyLabel
function Invoke-NSAddAuthorizationPolicyLabel {
    <#
    .SYNOPSIS
        Creates a NetScaler authorizationpolicylabel resource.
    .DESCRIPTION
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddAuthorizationPolicyLabel -LabelName 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddAuthorizationPolicyLabel -LabelName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$LabelName", 'Create authorizationpolicylabel')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type authorizationpolicylabel -Payload @{ authorizationpolicylabel = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetAuthorizationPolicyLabel -LabelName $LabelName -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddAuthorizationPolicyLabel

# region Invoke-NSAddAuthorizationPolicyLabelAuthorizationPolicyBinding
function Invoke-NSAddAuthorizationPolicyLabelAuthorizationPolicyBinding {
    <#
    .SYNOPSIS
        Creates a NetScaler authorizationpolicylabel_authorizationpolicy_binding resource.
    .DESCRIPTION
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddAuthorizationPolicyLabelAuthorizationPolicyBinding -LabelName 'example' -PolicyName 'example' -Priority 1 -PassThru
    .EXAMPLE
        Invoke-NSAddAuthorizationPolicyLabelAuthorizationPolicyBinding -LabelName 'example' -PolicyName 'example' -Priority 1 -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$LabelName", 'Create authorizationpolicylabel_authorizationpolicy_binding')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type authorizationpolicylabel_authorizationpolicy_binding -Payload @{ authorizationpolicylabel_authorizationpolicy_binding = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetAuthorizationPolicyLabelAuthorizationPolicyBinding -LabelName $LabelName -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddAuthorizationPolicyLabelAuthorizationPolicyBinding

# region Invoke-NSDeleteAuthorizationPolicy
function Invoke-NSDeleteAuthorizationPolicy {
    <#
    .SYNOPSIS
        Removes a NetScaler authorizationpolicy resource.
    .DESCRIPTION
        Configuration for authorization policy resource.
    .PARAMETER Name
        Name for the new authorization policy. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the authorization policy is added. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my authorization policy" or 'my authorization policy'). Minimum length = 1
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteAuthorizationPolicy -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicy -Name 'authorizationpolicy_example' | Invoke-NSDeleteAuthorizationPolicy -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete authorizationpolicy')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type authorizationpolicy -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteAuthorizationPolicy

# region Invoke-NSDeleteAuthorizationPolicyLabel
function Invoke-NSDeleteAuthorizationPolicyLabel {
    <#
    .SYNOPSIS
        Removes a NetScaler authorizationpolicylabel resource.
    .DESCRIPTION
        Configuration for authorization policy label resource.
    .PARAMETER LabelName
        Name for the new authorization policy label. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the authorization policy is created. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my authorization policy label" or 'authorization policy label').
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteAuthorizationPolicyLabel -LabelName 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabel -LabelName 'authorizationpolicylabel_example' | Invoke-NSDeleteAuthorizationPolicyLabel -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$LabelName", 'Delete authorizationpolicylabel')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type authorizationpolicylabel -Resource $LabelName -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteAuthorizationPolicyLabel

# region Invoke-NSDeleteAuthorizationPolicyLabelAuthorizationPolicyBinding
function Invoke-NSDeleteAuthorizationPolicyLabelAuthorizationPolicyBinding {
    <#
    .SYNOPSIS
        Removes a NetScaler authorizationpolicylabel_authorizationpolicy_binding resource.
    .DESCRIPTION
        Binding object showing the authorizationpolicy that can be bound to authorizationpolicylabel.
    .PARAMETER LabelName
        Name of the authorization policy label to which to bind the policy.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteAuthorizationPolicyLabelAuthorizationPolicyBinding -LabelName 'example' -PolicyName 'example' -Priority 1 -Confirm:$false
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabelAuthorizationPolicyBinding -LabelName 'authorizationpolicylabel_authorizationpolicy_binding_example' | Invoke-NSDeleteAuthorizationPolicyLabelAuthorizationPolicyBinding -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$LabelName", 'Delete authorizationpolicylabel_authorizationpolicy_binding')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type authorizationpolicylabel_authorizationpolicy_binding -Resource $LabelName -Query $query -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteAuthorizationPolicyLabelAuthorizationPolicyBinding

# region Invoke-NSGetAuthorizationAction
function Invoke-NSGetAuthorizationAction {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationaction configuration.
    .DESCRIPTION
        Configuration for authorization action resource.
    .PARAMETER Name
        Name of authorization action. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationAction -Name 'authorizationaction_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationAction -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAuthorizationAction

# region Invoke-NSGetAuthorizationPolicy
function Invoke-NSGetAuthorizationPolicy {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicy configuration.
    .DESCRIPTION
        Configuration for authorization policy resource.
    .PARAMETER Name
        Name for the new authorization policy. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the authorization policy is added. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my authorization policy" or 'my authorization policy'). Minimum length = 1
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicy -Name 'authorizationpolicy_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicy -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAuthorizationPolicy

# region Invoke-NSGetAuthorizationPolicyAAAGroupBinding
function Invoke-NSGetAuthorizationPolicyAAAGroupBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicy_aaagroup_binding configuration.
    .DESCRIPTION
        Binding object showing the aaagroup that can be bound to authorizationpolicy.
    .PARAMETER Name
        Name of the authorization policy. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER ViewSummary
        Requests the NITRO summary view.
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyAAAGroupBinding -Name 'authorizationpolicy_aaagroup_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyAAAGroupBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicy_aaagroup_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyAAAGroupBinding

# region Invoke-NSGetAuthorizationPolicyAAAUserBinding
function Invoke-NSGetAuthorizationPolicyAAAUserBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicy_aaauser_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyAAAUserBinding -Name 'authorizationpolicy_aaauser_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyAAAUserBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicy_aaauser_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyAAAUserBinding

# region Invoke-NSGetAuthorizationPolicyAuthorizationPolicyLabelBinding
function Invoke-NSGetAuthorizationPolicyAuthorizationPolicyLabelBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicy_authorizationpolicylabel_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyAuthorizationPolicyLabelBinding -Name 'authorizationpolicy_authorizationpolicylabel_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyAuthorizationPolicyLabelBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicy_authorizationpolicylabel_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyAuthorizationPolicyLabelBinding

# region Invoke-NSGetAuthorizationPolicyBinding
function Invoke-NSGetAuthorizationPolicyBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicy_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyBinding -Name 'authorizationpolicy_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicy_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyBinding

# region Invoke-NSGetAuthorizationPolicyCSVServerBinding
function Invoke-NSGetAuthorizationPolicyCSVServerBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicy_csvserver_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyCSVServerBinding -Name 'authorizationpolicy_csvserver_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyCSVServerBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicy_csvserver_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyCSVServerBinding

# region Invoke-NSGetAuthorizationPolicyLabel
function Invoke-NSGetAuthorizationPolicyLabel {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicylabel configuration.
    .DESCRIPTION
        Configuration for authorization policy label resource.
    .PARAMETER LabelName
        Name for the new authorization policy label. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the authorization policy is created. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my authorization policy label" or 'authorization policy label').
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabel -LabelName 'authorizationpolicylabel_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabel -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAuthorizationPolicyLabel

# region Invoke-NSGetAuthorizationPolicyLabelAuthorizationPolicyBinding
function Invoke-NSGetAuthorizationPolicyLabelAuthorizationPolicyBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicylabel_authorizationpolicy_binding configuration.
    .DESCRIPTION
        Binding object showing the authorizationpolicy that can be bound to authorizationpolicylabel.
    .PARAMETER LabelName
        Name of the authorization policy label to which to bind the policy.
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabelAuthorizationPolicyBinding -LabelName 'authorizationpolicylabel_authorizationpolicy_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabelAuthorizationPolicyBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicylabel_authorizationpolicy_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyLabelAuthorizationPolicyBinding

# region Invoke-NSGetAuthorizationPolicyLabelBinding
function Invoke-NSGetAuthorizationPolicyLabelBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicylabel_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabelBinding -LabelName 'authorizationpolicylabel_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLabelBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicylabel_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyLabelBinding

# region Invoke-NSGetAuthorizationPolicyLBVServerBinding
function Invoke-NSGetAuthorizationPolicyLBVServerBinding {
    <#
    .SYNOPSIS
        Gets NetScaler authorizationpolicy_lbvserver_binding configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLBVServerBinding -Name 'authorizationpolicy_lbvserver_binding_example'
    .EXAMPLE
        Invoke-NSGetAuthorizationPolicyLBVServerBinding -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'authorizationpolicy_lbvserver_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthorizationPolicyLBVServerBinding

# region Invoke-NSRenameAuthorizationPolicy
function Invoke-NSRenameAuthorizationPolicy {
    <#
    .SYNOPSIS
        Renames a NetScaler authorizationpolicy resource.
    .DESCRIPTION
        Configuration for authorization policy resource.
    .PARAMETER Name
        Name for the new authorization policy. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the authorization policy is added. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my authorization policy" or 'my authorization policy'). Minimum length = 1
    .PARAMETER NewName
        The new name of the author policy. Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSRenameAuthorizationPolicy -Name 'example' -NewName 'example' -PassThru
    .EXAMPLE
        Invoke-NSRenameAuthorizationPolicy -Name 'example' -NewName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Rename authorizationpolicy')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type authorizationpolicy -Action rename -Payload @{ authorizationpolicy = $body } -RawResponse

            if ($PassThru) {
                return Invoke-NSGetAuthorizationPolicy -Name $NewName -Session $Session
            }
...
# endregion Invoke-NSRenameAuthorizationPolicy

# region Invoke-NSRenameAuthorizationPolicyLabel
function Invoke-NSRenameAuthorizationPolicyLabel {
    <#
    .SYNOPSIS
        Renames a NetScaler authorizationpolicylabel resource.
    .DESCRIPTION
        Configuration for authorization policy label resource.
    .PARAMETER LabelName
        Name for the new authorization policy label. Must begin with a letter, number, or the underscore character (_), and must contain only letters, numbers, and the hyphen (-), period (.) pound (#), space ( ), at (@), equals (=), colon (:), and underscore characters. Cannot be changed after the authorization policy is created. The following requirement applies only to the Citrix ADC CLI: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my authorization policy label" or 'authorization policy label').
    .PARAMETER NewName
        The new name of the auth policy label. Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSRenameAuthorizationPolicyLabel -LabelName 'example' -NewName 'example' -PassThru
    .EXAMPLE
        Invoke-NSRenameAuthorizationPolicyLabel -LabelName 'example' -NewName 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$LabelName", 'Rename authorizationpolicylabel')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type authorizationpolicylabel -Action rename -Payload @{ authorizationpolicylabel = $body } -RawResponse

            if ($PassThru) {
                return Invoke-NSGetAuthorizationPolicyLabel -LabelName $NewName -Session $Session
            }
...
# endregion Invoke-NSRenameAuthorizationPolicyLabel

# region Invoke-NSUpdateAuthorizationPolicy
function Invoke-NSUpdateAuthorizationPolicy {
    <#
    .SYNOPSIS
        Updates a NetScaler authorizationpolicy resource.
    .DESCRIPTION
        Configuration for authorization policy resource.
    .PARAMETER Action
        Action to perform if the policy matches: either allow or deny the request. Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateAuthorizationPolicy -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdateAuthorizationPolicy -Name 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update authorizationpolicy')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type authorizationpolicy -Payload @{ authorizationpolicy = $body } -RawResponse
...
# endregion Invoke-NSUpdateAuthorizationPolicy

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB3dGoLUPzjKNgF
# aOUXfceMsNVu0JTW/EZYmu3XSBSI9KCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQ