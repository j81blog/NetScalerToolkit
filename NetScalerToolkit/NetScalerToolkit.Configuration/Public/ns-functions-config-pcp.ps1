# Generated NetScalerToolkit Configuration bundle for category 'pcp'.

# region Invoke-NSAddPCPProfile
function Invoke-NSAddPCPProfile {
    <#
    .SYNOPSIS
        Creates a NetScaler pcpprofile resource.
    .DESCRIPTION
        Configuration for PCP Profile resource.
    .PARAMETER AnnounceMultiCount
        Integer value that identify the number announce message to be send. Default value: 10 Minimum value = 0 Maximum value = 65535
    .PARAMETER Mapping
        This argument is for enabling/disabling the MAP opcode of current PCP Profile. Default value: ENABLED Possible values = ENABLED, DISABLED
    .PARAMETER MaxMaplife
        Integer value that identify the maximum mapping lifetime (in seconds) for a pcp profile. default(86400s = 24Hours). Minimum value = 1 Maximum value = 2147483647
    .PARAMETER MinMaplife
        Integer value that identify the minimum mapping lifetime (in seconds) for a pcp profile. default(120s). Minimum value = 1 Maximum value = 2147483647
    .PARAMETER Name
    ...
    .PARAMETER Peer
        This argument is for enabling/disabling the PEER opcode of current PCP Profile. Default value: ENABLED Possible values = ENABLED, DISABLED
    .PARAMETER ThiRDPArty
        This argument is for enabling/disabling the THIRD PARTY opcode of current PCP Profile. Default value: DISABLED Possible values = ENABLED, DISABLED
    .PARAMETER Session
    ...
    .EXAMPLE
        Invoke-NSAddPCPProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddPCPProfile -Name 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('AnnounceMultiCount')) { $properties['announcemulticount'] = $AnnounceMultiCount }
    if ($PSBoundParameters.ContainsKey('Mapping')) { $properties['mapping'] = $Mapping }
    if ($PSBoundParameters.ContainsKey('MaxMaplife')) { $properties['maxmaplife'] = $MaxMaplife }
    if ($PSBoundParameters.ContainsKey('MinMaplife')) { $properties['minmaplife'] = $MinMaplife }
    if ($PSBoundParameters.ContainsKey('Name')) { $properties['name'] = $Name }
    if ($PSBoundParameters.ContainsKey('Peer')) { $properties['peer'] = $Peer }
    if ($PSBoundParameters.ContainsKey('ThiRDPArty')) { $properties['thirdparty'] = $ThiRDPArty }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create pcpprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type pcpprofile -Payload @{ pcpprofile = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetPCPProfile -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddPCPProfile

# region Invoke-NSAddPCPServer
function Invoke-NSAddPCPServer {
    <#
    .SYNOPSIS
        Creates a NetScaler pcpserver resource.
    .DESCRIPTION
    ...
    .PARAMETER PCPProfile
        pcp profile name.
    .PARAMETER Port
        Port number for the PCP server. Default value: 5351 Range 1 - 65535 * in CLI is represented as 65535 in NITRO API
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSAddPCPServer -Name 'example' -Ipaddress 'example' -Port 80 -PassThru
    .EXAMPLE
        Invoke-NSAddPCPServer -Name 'example' -Ipaddress 'example' -Port 80 -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSBoundParameters.ContainsKey('Name')) { $properties['name'] = $Name }
    if ($PSBoundParameters.ContainsKey('PCPProfile')) { $properties['pcpprofile'] = $PCPProfile }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create pcpserver')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type pcpserver -Payload @{ pcpserver = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetPCPServer -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddPCPServer

# region Invoke-NSDeletePCPProfile
function Invoke-NSDeletePCPProfile {
    <#
    .SYNOPSIS
        Removes a NetScaler pcpprofile resource.
    .DESCRIPTION
        Configuration for PCP Profile resource.
    .PARAMETER Name
        Name for the PCP Profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my pcpProfile" or my pcpProfile).
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeletePCPProfile -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetPCPProfile -Name 'pcpprofile_example' | Invoke-NSDeletePCPProfile -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete pcpprofile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type pcpprofile -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeletePCPProfile

# region Invoke-NSDeletePCPServer
function Invoke-NSDeletePCPServer {
    <#
    .SYNOPSIS
        Removes a NetScaler pcpserver resource.
    .DESCRIPTION
        Configuration for server resource.
    .PARAMETER Name
        Name for the PCP server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my pcpServer" or my pcpServer).
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeletePCPServer -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetPCPServer -Name 'pcpserver_example' | Invoke-NSDeletePCPServer -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete pcpserver')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type pcpserver -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeletePCPServer

# region Invoke-NSGetPcpmap
function Invoke-NSGetPcpmap {
    <#
    .SYNOPSIS
        Gets NetScaler pcpmap configuration.
    .DESCRIPTION
        Configuration for server resource.
    .PARAMETER NatType
    ...
    .EXAMPLE
        Invoke-NSGetPcpmap
    .EXAMPLE
        Invoke-NSGetPcpmap -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetPcpmap

# region Invoke-NSGetPCPProfile
function Invoke-NSGetPCPProfile {
    <#
    .SYNOPSIS
        Gets NetScaler pcpprofile configuration.
    .DESCRIPTION
        Configuration for PCP Profile resource.
    .PARAMETER Name
        Name for the PCP Profile. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my pcpProfile" or my pcpProfile).
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetPCPProfile
    .EXAMPLE
        Invoke-NSGetPCPProfile -Name 'pcpprofile_example'
    .EXAMPLE
        Invoke-NSGetPCPProfile -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetPCPProfile

# region Invoke-NSGetPCPServer
function Invoke-NSGetPCPServer {
    <#
    .SYNOPSIS
        Gets NetScaler pcpserver configuration.
    .DESCRIPTION
        Configuration for server resource.
    .PARAMETER Name
        Name for the PCP server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my pcpServer" or my pcpServer).
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetPCPServer
    .EXAMPLE
        Invoke-NSGetPCPServer -Name 'pcpserver_example'
    .EXAMPLE
        Invoke-NSGetPCPServer -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetPCPServer

# region Invoke-NSUnsetPCPProfile
function Invoke-NSUnsetPCPProfile {
    ...
    process {
        ...
        $body = @{ name = $Name }
        if ($PSBoundParameters.ContainsKey('AnnounceMultiCount')) { $body['announcemulticount'] = $true }
        if ($PSBoundParameters.ContainsKey('Mapping')) { $body['mapping'] = $true }
        if ($PSBoundParameters.ContainsKey('MaxMaplife')) { $body['maxmaplife'] = $true }
        if ($PSBoundParameters.ContainsKey('MinMaplife')) { $body['minmaplife'] = $true }
        if ($PSBoundParameters.ContainsKey('Peer')) { $body['peer'] = $true }
        if ($PSBoundParameters.ContainsKey('ThiRDPArty')) { $body['thirdparty'] = $true }

        if ($body.Count -le 1) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess("$Name", 'Clear pcpprofile properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type pcpprofile -Action unset -Payload @{ pcpprofile = $body } -RawResponse
...
# endregion Invoke-NSUnsetPCPProfile

# region Invoke-NSUnsetPCPServer
function Invoke-NSUnsetPCPServer {
    <#
    .SYNOPSIS
        Clears one or more NetScaler pcpserver resource properties.
    .DESCRIPTION
        Configuration for server resource.
    .PARAMETER Name
        Name for the PCP server. Must begin with an ASCII alphanumeric or underscore (_) character, and must contain only ASCII alphanumeric, underscore CLI Users: If the name includes one or more spaces, enclose the name in double or single quotation marks (for example, "my pcpServer" or my pcpServer).
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetPCPServer -Name 'example' -PCPProfile  -PassThru
    .EXAMPLE
        Invoke-NSUnsetPCPServer -Name 'example' -PCPProfile  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $body = @{ name = $Name }
        if ($PSBoundParameters.ContainsKey('PCPProfile')) { $body['pcpprofile'] = $true }
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Clear pcpserver properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type pcpserver -Action unset -Payload @{ pcpserver = $body } -RawResponse
...
# endregion Invoke-NSUnsetPCPServer

# region Invoke-NSUpdatePCPProfile
function Invoke-NSUpdatePCPProfile {
    <#
    .SYNOPSIS
        Updates a NetScaler pcpprofile resource.
    .DESCRIPTION
        Configuration for PCP Profile resource.
    .PARAMETER AnnounceMultiCount
        Integer value that identify the number announce message to be send. Default value: 10 Minimum value = 0 Maximum value = 65535
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdatePCPProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSUpdatePCPProfile -Name 'example' -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update pcpprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type pcpprofile -Payload @{ pcpprofile = $body } -RawResponse
...
# endregion Invoke-NSUpdatePCPProfile

# region Invoke-NSUpdatePCPServer
function Invoke-NSUpdatePCPServer {
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update pcpserver')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type pcpserver -Payload @{ pcpserver = $body } -RawResponse
...
# endregion Invoke-NSUpdatePCPServer

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAfw7H/4HeiTni+
# jrwy1iZL9aWfDRguuChIShGEd3eWAaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgLml+
# VNFIzGb4p3vccMDnCQGxynbR4luZSKon8CkU7xswDQYJKoZIhvcNAQEBBQAEggGA
# mlacntcF9i7rj9u0nqxUNSLS9bzOHZ4POvQ+4gqGd7CPpgiKNTBno8i+AvpJuhtv
# D+fGfLpZ5naAmE9LSZ8Uvgk84nWFfWNxoNuIyTOWiYk4emkqjmLuKI+l1idClYA9
# mkn/JF4ckNZOZgxF17TiIMAxgmcKBK5KskOux6m/YCih3z2Us6fiFxJvSp+lQU1R
# JIjWsN1IVmVSWn51MA2pe9kl7MeaIqw5+3P2NheHA+R1UJ4dA6l5RaLMJlCK1nXm
# yu+tqY1ZFLKIfCyX0N1H/AFnKGVrKYiWldhKuhJQSODqYdZJ0hS/I9zaYSomXvEC
# oaCfY78DLLFdKppjU0sR4f1zprFs39E/lpa4omFzosvfI2HJECcSJP0+z0NI0Mom
# Hbvw6lOGAfhPITMkd8yQ1hhcFxxSq2bpJsjpaNwMnCiwxIfEt9hz0kJiGaIOxhSQ
# 9sc1RoBrsBLS8EqPrD9UQ6kd6gvF6iTtngMbmIFQG/dzZI+wI828QzN4455hqA0/
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIHBUlZZlqcPciEUBB8g1
# ZisuGHNOnj/prt//XeGZ+z+OAgZqNTBfoOUYEzIwMjYwODAzMTI1MjExLjU0OFow
...
# IgQgNwAvti38endUf1Bk0ILABh7N0dl+tkqLd6OhsgpsG98wgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgDfx9fSUiJYZcsN
# w7o5tB2j0fN/G/2RiKma+Y6tckFXzXG+6odZx9vFUt5B7+vlwL79npZlOoJ2nk+9
# Yu6c0r6rw952L+45UW9CUmp0plnnWIE7JybmEG/0W5znK+gOyv0hrqa187VaOUgA
# z+UiufmUUQq/SyNIx0y7lTyQ7EzBgHdhqG7Ygx46sJxil/TsHdZYzJpfV8I/oRia
# Ax/mB6q1tNpzuQuZtqk35ObpGy6aE7QDWsGr2OPsQCPesJ9t1OqT33Dq+hVAsdAv
# GuNsPuENlHBDMm2iOjBq1U9/bhoaoMqWKFCrgn+GBGwjeBB+v3/Ghw2PZrn1xhfl
# e3u84L7x9n6EiryPhVXrmHj8F/U6L+JGsdpvAmAYs9SOeBVD40IQK6up0uD0uMDA
# S208Cpu0TvFfmk1vraeJ0EeZgOkIc3KvTu5EYuf4+onOpOm/xbweJHEX8XT7VDHm
# YoRnwH4XK3jF7RT+c8p+3zJTlpbPC31eIgsJ2OH0/H2n8McMpIliBe6F4YiXKs3K
# 6RtYglVYgzyXAZSgVFQxgPdbVz2ZdWCd8FGYWyCB7+vmxAdE4X53Z2Y71yn+1283
# hhikdUUBZq1bqBL/J6DWaGQCeCvP10Il+qgMqd1TBKfUl4IlbHmAfoyoXiN3kHhk
# Vzve/Ap+ybq5ZFl6uW8Jy6SClsZnfw==
