# Generated NetScalerToolkit Configuration bundle for category 'ipsec'.

# region Invoke-NSAddIPsecProfile
function Invoke-NSAddIPsecProfile {
    <#
    .SYNOPSIS
        Creates a NetScaler ipsecprofile resource.
    .DESCRIPTION
        Configuration for IPSEC profile resource.
    .PARAMETER Encalgo
        Type of encryption algorithm (Note: Selection of AES enables AES128). Possible values = AES, AES192, AES256
    .PARAMETER HashAlgo
    ...
    .PARAMETER Name
        The name of the ipsec profile. Minimum length = 1 Maximum length = 32
    ...
    .EXAMPLE
        Invoke-NSAddIPsecProfile -Name 'example' -PassThru
    .EXAMPLE
        Invoke-NSAddIPsecProfile -Name 'example' -WhatIf
    .OUTPUTS
    ...
    if ($PSBoundParameters.ContainsKey('Encalgo')) { $properties['encalgo'] = $Encalgo }
    if ($PSBoundParameters.ContainsKey('HashAlgo')) { $properties['hashalgo'] = $HashAlgo }
    if ($PSBoundParameters.ContainsKey('IkeretryInterval')) { $properties['ikeretryinterval'] = $IkeretryInterval }
    if ($PSBoundParameters.ContainsKey('Ikeversion')) { $properties['ikeversion'] = $Ikeversion }
    if ($PSBoundParameters.ContainsKey('Lifetime')) { $properties['lifetime'] = $Lifetime }
    if ($PSBoundParameters.ContainsKey('LivenesscheckInterval')) { $properties['livenesscheckinterval'] = $LivenesscheckInterval }
    if ($PSBoundParameters.ContainsKey('Name')) { $properties['name'] = $Name }
    if ($PSBoundParameters.ContainsKey('PeerpublicKey')) { $properties['peerpublickey'] = $PeerpublicKey }
    if ($PSBoundParameters.ContainsKey('Perfectforwardsecrecy')) { $properties['perfectforwardsecrecy'] = $Perfectforwardsecrecy }
    ...
    if ($PSBoundParameters.ContainsKey('Replaywindowsize')) { $properties['replaywindowsize'] = $Replaywindowsize }
    if ($PSBoundParameters.ContainsKey('Retransmissiontime')) { $properties['retransmissiontime'] = $Retransmissiontime }
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create ipsecprofile')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type ipsecprofile -Payload @{ ipsecprofile = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetIPsecProfile -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddIPsecProfile

# region Invoke-NSDeleteIPsecProfile
function Invoke-NSDeleteIPsecProfile {
    <#
    .SYNOPSIS
        Removes a NetScaler ipsecprofile resource.
    .DESCRIPTION
        Configuration for IPSEC profile resource.
    .PARAMETER Name
        The name of the ipsec profile. Minimum length = 1 Maximum length = 32
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSDeleteIPsecProfile -Name 'example' -Confirm:$false
    .EXAMPLE
        Invoke-NSGetIPsecProfile -Name 'ipsecprofile_example' | Invoke-NSDeleteIPsecProfile -Confirm:$false
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete ipsecprofile')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type ipsecprofile -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteIPsecProfile

# region Invoke-NSGetIpsecparameter
function Invoke-NSGetIpsecparameter {
    <#
    .SYNOPSIS
        Gets NetScaler ipsecparameter configuration.
    .DESCRIPTION
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetIpsecparameter
    .EXAMPLE
        Invoke-NSGetIpsecparameter -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetIpsecparameter

# region Invoke-NSGetIPsecProfile
function Invoke-NSGetIPsecProfile {
    <#
    .SYNOPSIS
        Gets NetScaler ipsecprofile configuration.
    .DESCRIPTION
        Configuration for IPSEC profile resource.
    .PARAMETER Name
        The name of the ipsec profile. Minimum length = 1 Maximum length = 32
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetIPsecProfile
    .EXAMPLE
        Invoke-NSGetIPsecProfile -Name 'ipsecprofile_example'
    .EXAMPLE
        Invoke-NSGetIPsecProfile -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetIPsecProfile

# region Invoke-NSUnsetIpsecparameter
function Invoke-NSUnsetIpsecparameter {
    <#
    .SYNOPSIS
        Clears one or more NetScaler ipsecparameter resource properties.
    .DESCRIPTION
        Configuration for IPSEC paramter resource.
    .PARAMETER Encalgo
        Type of encryption algorithm (Note: Selection of AES enables AES128). Default value: AES Possible values = AES, AES192, AES256
    .PARAMETER HashAlgo
        Type of hashing algorithm. Default value: HMAC_SHA256 Possible values = HMAC_SHA1, HMAC_SHA256, HMAC_SHA384, HMAC_SHA512, HMAC_MD5
    .PARAMETER IkeretryInterval
        IKE retry interval for bringing up the connection. Minimum value = 60 Maximum value = 3600
    .PARAMETER Ikeversion
        IKE Protocol Version. Default value: V2 Possible values = V1, V2
    .PARAMETER Lifetime
        Lifetime of IKE SA in seconds. Lifetime of IPSec SA will be (lifetime of IKE SA/8). Minimum value = 480 Maximum value = 31536000
    .PARAMETER LivenesscheckInterval
        Number of seconds after which a notify payload is sent to check the liveliness of the peer. Additional retries are done as per retransmit interval setting. Zero value disables liveliness checks. Minimum value = 0 Maximum value = 64999
    .PARAMETER Perfectforwardsecrecy
        Enable/Disable PFS. Default value: DISABLE Possible values = ENABLE, DISABLE
    .PARAMETER Replaywindowsize
        IPSec Replay window size for the data traffic. Minimum value = 0 Maximum value = 16384
    .PARAMETER Retransmissiontime
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUnsetIpsecparameter -Encalgo AES -PassThru
    .EXAMPLE
        Invoke-NSUnsetIpsecparameter -Encalgo AES -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    param(
        ...
        [Parameter()]
        [switch] $Replaywindowsize,

        [Parameter()]
        [switch] $Retransmissiontime,
    ...
    process {
        ...
        $body = @{}
        if ($PSBoundParameters.ContainsKey('Encalgo')) { $body['encalgo'] = $true }
        if ($PSBoundParameters.ContainsKey('HashAlgo')) { $body['hashalgo'] = $true }
        if ($PSBoundParameters.ContainsKey('IkeretryInterval')) { $body['ikeretryinterval'] = $true }
        if ($PSBoundParameters.ContainsKey('Ikeversion')) { $body['ikeversion'] = $true }
        if ($PSBoundParameters.ContainsKey('Lifetime')) { $body['lifetime'] = $true }
        if ($PSBoundParameters.ContainsKey('LivenesscheckInterval')) { $body['livenesscheckinterval'] = $true }
        if ($PSBoundParameters.ContainsKey('Perfectforwardsecrecy')) { $body['perfectforwardsecrecy'] = $true }
        if ($PSBoundParameters.ContainsKey('Replaywindowsize')) { $body['replaywindowsize'] = $true }
        if ($PSBoundParameters.ContainsKey('Retransmissiontime')) { $body['retransmissiontime'] = $true }

        if ($body.Count -le 0) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess('ipsecparameter', 'Clear ipsecparameter properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type ipsecparameter -Action unset -Payload @{ ipsecparameter = $body } -RawResponse

            return $response
        }
    }
}
# endregion Invoke-NSUnsetIpsecparameter

# region Invoke-NSUpdateIpsecparameter
function Invoke-NSUpdateIpsecparameter {
    ...
    if ($PSCmdlet.ShouldProcess('ipsecparameter', 'Update ipsecparameter')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type ipsecparameter -Payload @{ ipsecparameter = $body } -RawResponse

        return $response
    }
}
# endregion Invoke-NSUpd