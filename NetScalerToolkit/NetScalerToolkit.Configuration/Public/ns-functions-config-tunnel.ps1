# Generated NetScalerToolkit Configuration bundle for category 'tunnel'.

# region Invoke-NSAddTunnelglobalTunnelTrafficPolicyBinding
function Invoke-NSAddTunnelglobalTunnelTrafficPolicyBinding {
    ...
    .PARAMETER Priority
        Priority.
    .PARAMETER State
        Current state of the binding. If the binding is enabled, the policy is active. Possible values = ENABLED, DISABLED
    .PARAMETER Type
        Bind point to which the policy is bound. Possible values = REQ_OVERRIDE, REQ_DEFAULT, RES_OVERRIDE, RES_DEFAULT
    .PARAMETER Session
    ...
    if ($PSCmdlet.ShouldProcess('tunnelglobal_tunneltrafficpolicy_binding', 'Create tunnelglobal_tunneltrafficpolicy_binding')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type tunnelglobal_tunneltrafficpolicy_binding -Payload @{ tunnelglobal_tunneltrafficpolicy_binding = $body } -RawResponse

        return $response
    }
}
# endregion Invoke-NSAddTunnelglobalTunnelTrafficPolicyBinding

# region Invoke-NSAddTunnelTrafficPolicy
function Invoke-NSAddTunnelTrafficPolicy {
    ...
    .PARAMETER Action
        Name of the built-in compression action to associate with the policy. Minimum length = 1
    .PARAMETER Comment
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Create tunneltrafficpolicy')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type tunneltrafficpolicy -Payload @{ tunneltrafficpolicy = $body } -RawResponse

        if ($PassThru) {
            return Invoke-NSGetTunnelTrafficPolicy -Name $Name -Session $Session
        }

        return $response
    }
}
# endregion Invoke-NSAddTunnelTrafficPolicy

# region Invoke-NSDeleteTunnelglobalTunnelTrafficPolicyBinding
function Invoke-NSDeleteTunnelglobalTunnelTrafficPolicyBinding {
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess('tunnelglobal_tunneltrafficpolicy_binding', 'Delete tunnelglobal_tunneltrafficpolicy_binding')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type tunnelglobal_tunneltrafficpolicy_binding -Query $query -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteTunnelglobalTunnelTrafficPolicyBinding

# region Invoke-NSDeleteTunnelTrafficPolicy
function Invoke-NSDeleteTunnelTrafficPolicy {
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Delete tunneltrafficpolicy')) {
            Invoke-NSRestRequest @transportParameters -Session $Session -Method DELETE -Task config -Type tunneltrafficpolicy -Resource $Name -RawResponse
        }
    }
}
# endregion Invoke-NSDeleteTunnelTrafficPolicy

# region Invoke-NSGetTunnelglobalBinding
...
# endregion Invoke-NSGetTunnelglobalBinding

# region Invoke-NSGetTunnelglobalTunnelTrafficPolicyBinding
function Invoke-NSGetTunnelglobalTunnelTrafficPolicyBinding {
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'tunnelglobal_tunneltrafficpolicy_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetTunnelglobalTunnelTrafficPolicyBinding

# region Invoke-NSGetTunnelTrafficPolicy
...
# endregion Invoke-NSGetTunnelTrafficPolicy

# region Invoke-NSGetTunnelTrafficPolicyBinding
function Invoke-NSGetTunnelTrafficPolicyBinding {
    ...
    .PARAMETER Name
        Name of the tunnel traffic policy for which to show detailed information. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER ViewSummary
        Requests the NITRO summary view.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'tunneltrafficpolicy_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetTunnelTrafficPolicyBinding

# region Invoke-NSGetTunnelTrafficPolicyTunnelglobalBinding
function Invoke-NSGetTunnelTrafficPolicyTunnelglobalBinding {
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'config'
            Type = 'tunneltrafficpolicy_tunnelglobal_binding'
            Query = $query
        }
...
# endregion Invoke-NSGetTunnelTrafficPolicyTunnelglobalBinding

# region Invoke-NSRenameTunnelTrafficPolicy
function Invoke-NSRenameTunnelTrafficPolicy {
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Rename tunneltrafficpolicy')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type tunneltrafficpolicy -Action rename -Payload @{ tunneltrafficpolicy = $body } -RawResponse

            if ($PassThru) {
                return Invoke-NSGetTunnelTrafficPolicy -Name $NewName -Session $Session
            }
...
# endregion Invoke-NSRenameTunnelTrafficPolicy

# region Invoke-NSUnsetTunnelTrafficPolicy
function Invoke-NSUnsetTunnelTrafficPolicy {
    ...
    process {
        ...
        if ($PSCmdlet.ShouldProcess("$Name", 'Clear tunneltrafficpolicy properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type tunneltrafficpolicy -Action unset -Payload @{ tunneltrafficpolicy = $body } -RawResponse
...
# endregion Invoke-NSUnsetTunnelTrafficPolicy

# region Invoke-NSUpdateTunnelTrafficPolicy
function Invoke-NSUpdateTunnelTrafficPolicy {
    ...
    if ($PSCmdlet.ShouldProcess("$Name", 'Update tunneltrafficpolicy')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type tunneltrafficpolicy -Payload @{ tunneltrafficpolicy = $body } -RawResponse
...
# endregion Invoke-NSUpdateTunnelTrafficPolicy

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBSqxruj/RbiqZI
# W6SHbPz4Xygpq3kuQgYNJgfCxb0ebaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQguYlI
# 5G6r6J0mmA28powL4Dzpfkj1yniHd6nlWK+FwHswDQYJKoZIhvcNAQEBBQAEggGA
# hAUk9oT0CTrqbxkUC1EGCDFu7k1SRuSGcbG+Dy1SrnvywlDeFlLxX+XcaFuqfwdY
# gJrgiAgmYfNw5k9N+sxeFd5Cm5VioI9L1fKLcLubbDaZetgDv/qAtpcwJ6A3q+4Q
# 2Wff4fGRTHRAa19CWvKB3tIqnyckAMn99YnuZEhBGLZDqrp6i9FhCjN8KU6oAX60
# dPB9FjxKiEgPmiStlSbn72+CAfvvl1rn749zCrWDeMIzScrBSGNLeK6kobCUTYSV
# M6bP36CRK3ADP/AuC0BkMAWuFp8iZ+MgGtd/9HdSm9wf5MHEz+Cqwzk22cIJ1qqL
# qw2fNZ5JjPaZ2++oPCAVbdFFq2WRBSu9pHrSsEwa5ldkO/1HmnpDcYbNSQYgPCrf
# m7LZ6WXGqlD2qMc3lrS2v2nTvh074Z64qC2/gzqeDOKwiRC7d6aRc9gKJCWuVvOK
# KRFPJOGiqNakQ6ZlDsofIQWNkhPF9MhkW8C6SvRIGQrDP/JsYYtjbpogGJw4Tw2n
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIDLjCMaP4Tmk6uamig02
# F16RXSvmAiN0HWCr4B8vbQAIAgZqNWdtxPgYEzIwMjYwODAzMTI1MjQ2LjgyNVow
...
# IgQgq8DGeRdcy69Z4JQkjk1G7UYO9OkOc2SBWUO45Y15n0cwgd0GCyqGSIb3DQEJ
...
# kTahOynpFQpsK7T7qt7engOZRjANBgkqhkiG9w0BAQsFAASCAgCAb1Y+zb4dRoG/
# RNhprPjreIoAWsHp7rne+C6lSwHlCXPxBgepgS33w4KyPAG8qvKPGLsvGdL2zkt/
# JmRQ9B1uiK8VN/JPLS/uoN/EJ2SCpddl0RyxxmeOdOzT6pQgdxZQs4fJU1iJ7Qwt
# tOp+fmABPvnKzyMT7LPtDvLbQas11lt2nMnK57d0ItqBqOcNRftDhLL6ih0PYInD
# uSelgJCzk02folnKENE+gQU2rRosebX+bnbVzsA7JZ2bWqVs2J206fvsA9+66ip9
# 9PbSoaJyOXfq6l1bFsts4e03UO2x1vlW3yHvOS65XUC1YP6Xo9iQWRcX2CNFsBXB
# 3A0NtgyhJhV01X8VbF0JVs0/SibkhzKe5g9sWYncZh3Ou6mxrt4hRSN2GmFmWzre
# AuYQUxoqQl2HJyMP8EVCuZlYwNJKeRXUcHCHF+c+3v9QL1/cJx27D3w1Mnx6s0tA
# OJOQQhBnYqdreRRd9gBS0Gnz97+2EHlaOQXFR0zYPlVBI6Exk2I2dS/M0wEmwbaT
# Dsm/Z5BtTfB4CAt0b4wZXPVCYA9r9kGbp5UI7/lEb1yXxal7aV4k0m/Pb/eInPGy
# gW2S7NsQ1fZ3HBnC041sEX4DCuGijXwS3IRXps8094t9TmKZX1P0U8Yff+j/KaRA
# rinOUoKqyR9rjlSYZhIodXY52zRilQ==
