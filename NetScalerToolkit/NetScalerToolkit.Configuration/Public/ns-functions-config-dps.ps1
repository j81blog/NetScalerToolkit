# Generated NetScalerToolkit Configuration bundle for category 'dps'.

# region Invoke-NSGetDpsparameter
function Invoke-NSGetDpsparameter {
    <#
    .SYNOPSIS
        Gets NetScaler dpsparameter configuration.
    .DESCRIPTION
    ...
    .EXAMPLE
        Invoke-NSGetDpsparameter
    .EXAMPLE
        Invoke-NSGetDpsparameter -Filter @{ servicetype = 'HTTP' }
    .OUTPUTS
...
# endregion Invoke-NSGetDpsparameter

# region Invoke-NSUnsetDpsparameter
function Invoke-NSUnsetDpsparameter {
    <#
    .SYNOPSIS
        Clears one or more NetScaler dpsparameter resource properties.
    .DESCRIPTION
        Configuration for dps parameter resource.
    .PARAMETER CustomErid
        Customer ID of the Citrix Cloud customer. Default value: "None" Minimum length = 1
    .PARAMETER Deployment
        Describes if the customer is connecting to Commerical/JapanCloud/Gov Citrix Cloud customer. Default value: COMMERCIAL Possible values = COMMERCIAL, GOV, JAPANCLOUD
    .PARAMETER ServiceURL
        Service URL of the Citrix Cloud customer. Minimum length = 1
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    .PARAMETER IgnoreNotFound
        Returns null instead of throwing for known NITRO not-found responses.
    ...
    .EXAMPLE
        Invoke-NSUnsetDpsparameter -CustomErid  -PassThru
    .EXAMPLE
        Invoke-NSUnsetDpsparameter -CustomErid  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    param(
        ...
        [Parameter()]
        [ValidateSet('COMMERCIAL', 'GOV', 'JAPANCLOUD')]
        [switch] $Deployment,
    ...
    process {
        ...
        if ($PSBoundParameters.ContainsKey('Deployment')) { $body['deployment'] = $true }
        if ($PSBoundParameters.ContainsKey('ServiceURL')) { $body['serviceurl'] = $true }

        if ($body.Count -le 0) {
            throw 'Specify at least one property switch to clear.'
        }

        if ($PSCmdlet.ShouldProcess('dpsparameter', 'Clear dpsparameter properties')) {
            $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method POST -Task config -Type dpsparameter -Action unset -Payload @{ dpsparameter = $body } -RawResponse

            return $response
        }
    }
}
# endregion Invoke-NSUnsetDpsparameter

# region Invoke-NSUpdateDpsparameter
function Invoke-NSUpdateDpsparameter {
    <#
    .SYNOPSIS
        Updates a NetScaler dpsparameter resource.
    .DESCRIPTION
        Configuration for dps parameter resource.
    .PARAMETER CustomErid
        Customer ID of the Citrix Cloud customer. Default value: "None" Minimum length = 1
    ...
    .PARAMETER PassThru
        Returns the updated resource after the operation completes.
    .EXAMPLE
        Invoke-NSUpdateDpsparameter  -PassThru
    .EXAMPLE
        Invoke-NSUpdateDpsparameter  -WhatIf
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    if ($PSBoundParameters.ContainsKey('ServiceURL')) { $properties['serviceurl'] = $ServiceURL }
    ...
    if ($PSCmdlet.ShouldProcess('dpsparameter', 'Update dpsparameter')) {
        $response = Invoke-NSRestRequest @transportParameters -Session $Session -Method PUT -Task config -Type dpsparameter -Payload @{ dpsparameter = $body } -RawResponse

        return $response
    }
}
# endregion Invoke-NSUpdateDpsparameter

# SIG # Begin signature block
# MII6AQYJKoZIhvcNAQcCoII58jCCOe4CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCARoP6YgqhhiWbZ
# g2udqJIMr0ZfAxcvDHtC5mD+y7/nb6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgd+oU
# ZXLRFWaVqv0pqTMJXTC/FJtb6WIL5ty7HEPYL9EwDQYJKoZIhvcNAQEBBQAEggGA
# AvXPbOPv7pFYATyhCAEZCVARjP80O3QVZl9nw+Vdv9xOKcvaLXCGwlA6yslERKtO
# MFSLnNVHDa85Q778wXKg/vAvteYrefKamKPtuOzmr67nBmOnCVpFQjUSMXhQB1MM
