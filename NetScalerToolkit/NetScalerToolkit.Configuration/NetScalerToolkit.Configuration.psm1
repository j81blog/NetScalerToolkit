$commonModulePath = Join-Path -Path (Split-Path -Path $PSScriptRoot -Parent) -ChildPath 'NetScalerToolkit.Common\NetScalerToolkit.Common.psd1'
Import-Module -Name $commonModulePath -Force

$commonPrivatePath = Join-Path -Path (Split-Path -Path $PSScriptRoot -Parent) -ChildPath 'NetScalerToolkit.Common\Private'
@(
    'Assert-NSParameterValue.ps1'
    'Resolve-NSMetadataVersion.ps1'
) | ForEach-Object {
    . (Join-Path -Path $commonPrivatePath -ChildPath $_)
}

$privatePath = Join-Path -Path $PSScriptRoot -ChildPath 'Private'
$publicPath = Join-Path -Path $PSScriptRoot -ChildPath 'Public'

function Get-NSPowerShellSourceFile {
    param(
        [Parameter(Mandatory)]
        [string] $Path
    )

    $bundleFiles = @(Get-ChildItem -Path $Path -Filter 'ns-functions-*.ps1' -ErrorAction SilentlyContinue)
    if ($bundleFiles.Count -gt 0) {
        $bundleFiles | Sort-Object Name
        return
    }

    Get-ChildItem -Path $Path -Filter '*.ps1' -ErrorAction SilentlyContinue | Sort-Object Name
}

Get-NSPowerShellSourceFile -Path $privatePath | ForEach-Object {
    . $_.FullName
}

Get-NSPowerShellSourceFile -Path $publicPath | ForEach-Object {
    . $_.FullName
}

function Get-NSModuleManifestFunctionExport {
    param(
        [Parameter(Mandatory)]
        [string] $Path
    )
    ...
    $exportBlock = [regex]::Match($manifestText, '(?s)FunctionsToExport\s*=\s*(?:@\((?<body>.*?)\)\s*|(?<body>.*?))\r?\n\s*CmdletsToExport\s*=')
    if (-not $exportBlock.Success) { return @() }

    [regex]::Matches($exportBlock.Groups['body'].Value, "'((?:''|[^'])*)'") | ForEach-Object {
        $_.Groups[1].Value -replace "''", "'"
    }
}

$moduleManifestPath = [System.IO.Path]::ChangeExtension($PSCommandPath, '.psd1')
Export-ModuleMember -Function (Get-NSModuleManifestFunctionExport -Path $moduleManifestPath)

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgUQxBdFvTmteo
# GVQgXO4xmslqiRdh7c0rJl/sJb/i16CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgzCjj
# ERSbFuq62gSWviMPGR3Bx3V6eLXrNisxkIVy/XkwDQYJKoZIhvcNAQEBBQAEggGA
# bt5h0H5IVoglOnau93nU9mRSjGyhteIAGNroSobI5+B5wAWC9qGD40lF0g5RByxC
# nr9k9l9w5LrSmYFO4B+P1KZgHNcJ2z3j/0rJpcH5Zgr7NphmbC05KShkx0B4jkCn
# lwyfKvVBRt7SWBMHHBxbwzYynV//hGIBGiUibXoK56oLAWBA/kHnyJQyhENezIgw
