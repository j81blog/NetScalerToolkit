# Generated NetScalerToolkit Statistics bundle for category 'system'.

# region Invoke-NSGetSystemBwStats
function Invoke-NSGetSystemBwStats {
    <#
    .SYNOPSIS
        Gets NetScaler systembw statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetSystemBwStats

# region Invoke-NSGetSystemCpuStats
function Invoke-NSGetSystemCpuStats {
    <#
    .SYNOPSIS
        Gets NetScaler systemcpu statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetSystemCpuStats

# region Invoke-NSGetSystemMemoryStats
function Invoke-NSGetSystemMemoryStats {
    <#
    .SYNOPSIS
        Gets NetScaler systemmemory statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetSystemMemoryStats

# region Invoke-NSGetSystemStats
function Invoke-NSGetSystemStats {
    <#
    .SYNOPSIS
        Gets NetScaler system statistics.
    .DESCRIPTION
        System statistics.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
...
# endregion Invoke-NSGetSystemStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB0RbsOSvso+ebj
# SI9D4HSw8BmoRoxTxthk8Uo8lgCe0KCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgTW74
# qpgQSYo6dd924ykAdhvI5yXq02UCE5cLaabQI4EwDQYJKoZIhvcNAQEBBQAEggGA
# Tjt35bJ+fwMyBSe+7qyKm+PXM1Tbm/JfNEJ+R7luV8RfivcI2qbUBzpM6yeLGbXK
# Q+8tSI5ajCLUye7PA3RXkLkn/fnqfe1y+dbOgE+oJuqaa/DnjTOoZ4tcEsCQOmgZ
# LFRAGYp3Mf7A6HYw5Or57kJw0quEVG6+zMPaEj/HYpACzBPCfekmJvWP2MFr9cav
# qfUp9G/gPrMinxGbdpWyFGvzXP1Wr3xbUCAl8mS01R30Oa6tusO0Y4zUEBzGEH5s
# M+Wl6WcUK0Ev6eHvRQZ2l67KcC2P2jQw1ge58go77pYyZnb9Vbxcd45caeRMMW18
# o2WVW8XbPoaKYkmOI9Jzf2p1hGGRQKlUB+SH1IaN9Y2igzVqF9+sbWpAug1PR7O4
# r/0XYJL5NsSVVFDDEEcC1H8XFarEL+tgg4Jps5IftRXsFGMtdwXtKUE7OPM/3muM
# MyRC6PyUD4FIZSRE5AnpKnvT7JQuemMn3+Xoo2FJhm4x5bqrvD3DWyaaN3UwD5Fu
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIH/j7c7uqeZeuhHHFvoX
# 7VGTE0+sKf/zvKe4eiJJwB8aAgZqNWdcY4YYEzIwMjYwNzI3MTMxNDU4LjQ0NFow
...
# IgQgugeqSWIxkYfweQI6OP9GUUK1RDgzxnkp+DfgdTioSYUwgd0GCyqGSIb3DQEJ
...
# lvlBdu6F8Tu5CjaMViq4hivjqTANBgkqhkiG9w0BAQsFAASCAgAm8QqsqStERILQ
# SyNcE9R8eM5w8erzvR4f/yKnCodSOInKDscAflzTgngMDdwbfcC4TuBZpSboK/qa
# SD2b08DvD/jw9weg9ippkPCmArOEF3YIdP7rgt+ModxDUhVUuFc4bx2q24MG+ob9
# FPbd06O5Uw64zX1d5F9sNIF5UCNoyCqu8nb2TVqqqFd3VcGi/ayPbqwDDGtbtfW9
# D/+UCVjhdRqrFyP6vkEMl8wKD9Wd+GzHTLgsG2kIuzy9CcAW9LIEYmavFmicvDiD
# ItNTFEhTMqvI5HXVeY0qsYu+buoAfaw93MMxU5N0owAEtdeVqip2r3gc9Y77cuHS
# pFpdGxEV0tm/fLqfurAd8uP1e2ZGUaoRPrqBwzIzzqgCOu+tAAXpR69M6BQHd7Sb
# c4sD73Tc29mF4o8gcMKjAcpw7fQMHtnMRi+EFtk5EU3woivcC37TzpjqkSZDmulV
# cubnqBK0GZzJhrB1hUBbE9joorHMaDJCxUGvw4CuO6AbqQIH5zWiNmxhTYqaQ3l2
# 2JgiGeaK4OthZvZHpznDQX0obkKzBYvqpmB93CNuj/mnX/w8q5DB8sXkSSTsuF3r
# 8u+3Cei3BZz0ITUroW1B9JHB3RRnJlemcNbSIhlx6LUg6wyl1Q6LfSUJ0ab5Ejo7
# wvbYt6eyw+tXX+Rt6KEbILXK8wWH6A==
