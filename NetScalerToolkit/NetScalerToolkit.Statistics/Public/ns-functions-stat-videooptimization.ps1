# Generated NetScalerToolkit Statistics bundle for category 'videooptimization'.

# region Invoke-NSGetVideoOptimizationDetectionPolicyLabelStats
function Invoke-NSGetVideoOptimizationDetectionPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler videooptimizationdetectionpolicylabel statistics.
    .DESCRIPTION
        Statistics for videooptimization detection policy label resource.
    .PARAMETER LabelName
        Name of the videooptimization detection policy label. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetVideoOptimizationDetectionPolicyLabelStats -LabelName 'videooptimizationdetectionpolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetVideoOptimizationDetectionPolicyLabelStats

# region Invoke-NSGetVideoOptimizationDetectionPolicyStats
function Invoke-NSGetVideoOptimizationDetectionPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler videooptimizationdetectionpolicy statistics.
    .DESCRIPTION
        Statistics for videooptimization detectionpolicy resource.
    .PARAMETER Name
        Name of the Video Optimization detection policy for which to show detailed statistics. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetVideoOptimizationDetectionPolicyStats -Name 'videooptimizationdetectionpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetVideoOptimizationDetectionPolicyStats

# region Invoke-NSGetVideoOptimizationPacingPolicyLabelStats
function Invoke-NSGetVideoOptimizationPacingPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler videooptimizationpacingpolicylabel statistics.
    .DESCRIPTION
        Statistics for videooptimization pacing policy label resource.
    .PARAMETER LabelName
        Name of the videooptimization pacing policy label. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetVideoOptimizationPacingPolicyLabelStats -LabelName 'videooptimizationpacingpolicylabel_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetVideoOptimizationPacingPolicyLabelStats

# region Invoke-NSGetVideoOptimizationPacingPolicyStats
function Invoke-NSGetVideoOptimizationPacingPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler videooptimizationpacingpolicy statistics.
    .DESCRIPTION
        Statistics for videooptimization pacingpolicy resource.
    .PARAMETER Name
        Name of the Video Optimization Pacing policy for which to show detailed statistics. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetVideoOptimizationPacingPolicyStats -Name 'videooptimizationpacingpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetVideoOptimizationPacingPolicyStats

# region Invoke-NSGetVideooptimizationStats
...
# endregion Invoke-NSGetVideooptimizationStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDmYC3CZRmKhxdi
# 8QzNCHsud7t6PrGue0zKW/BzdQGhX6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg8kF5
# gsPb2Aqg2pWlAFUJBtHTI+qhYkcN7iWl2GebXH0wDQYJKoZIhvcNAQEBBQAEggGA
# AXbbcNtBLaIiAqFI7OMLyKJRWQD/761k942byekP01pdc5unGXbNw09GeZ00L2Zb
# tN28HFHC70mXsuqm2/SyBxhcRMPBQd4HuOponrFFIYUrjIHREW6GhRMg476Wq9ua
# Iouda8zEhb32yq8SHPjQDGcvHHoEsSjrbHAsl/uwm3F3yk3KxFZgUQKrvlIRAwxO
# kkFFqEO84KlArVU/oyRZKsA+MsG37GRu5DgJfb3aYJYKF/ENaXwM/wlPqM7tOb51
# hzk6jRJXs+Ki+G3X6QK8QEHMwO3ojPSxzg80XQPoG2fR8LLrAimEW1VpKeTO33Sp
# X4bgk9g2C3l1jZ8l2tgKfX0JdRwJTl+q6+cSoTuzvylDG1nOnLuA7YDzd4u8A8Oq
# 92M+V4H1BmmvX9bjCDyACzKN/hTiAflNZuT1zFvYAra31fZra7YVAzbSZz6TuuM2
# Fr4tMFvGdrZL4ITrYQQn32sYA73zANYbfq9fsK73N0FgdpAEe6ZrMx1cOH9RfCfg
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIPqW0GxVqHCx7vxJmFIw
# u7q+IUdVDgDGOZhLTV1uteh1AgZqNTBfpAEYEzIwMjYwODAzMTI1NDE5LjUzNlow
...
# IgQgx/21y6kRKIaTpupiICtMKBaqkbgTJts0Phv4SM5FDOQwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgB2fKIl0bBiXotb
# e2Vdpt0GI+eTyHpLOeDriyTToh08Y7uAmcHqCYYY2gJCx/+pqRuuAQKZ46fD9STU
# NgFkqP1CrTNQzRmokd1Tz4SdOgZaOGKKJWOaAHSJTFD3pvLjujp4icI5V9fpRNbt
# S77jE5pR5Tcaw6dhdRahR0+74S3ul+RcN8DVt8tM39WsFHUqUOfUR6Uj6cUepjR+
# ILlJCa/HeIiqj2zguynD8Qpj22YVydE8dWW2gFGyD8DuKCi5Gbe2GS/Cu/UOGgeo
# kcOODgXAg+rsxK/Fp5qQ9XlhhiJotAdf9C4OTouiNaeWiv7H2/qCyZONmYEGUSG3
# EX/lcAPVGhmXganv1Aaysst9cCfVHxj5vOYSK2KSks8Ak6Q9qpsCDXbtJAXa/QUK
# v6m8R0lv1S4pVREEOw1zfd39I3sEBq7N5zEtzXCavTTHXIbaXmNnoT7jKiU5wqCW
# xYLyIa+99rVBWjoPuGHyY33YH4rcPIJbkdHxt8lAV2lD3yAeQUjG88SWwmgwseRJ
# KPyUdyZSWP3ClJ0U3m4Hhsgq0lX4mUdZgIpX8l41jHR9uw0A27aQbw/LACV/vnHg
# vJRxI+xcPr/RrAgzdzdPGHR573e5zXcYXDFLBPgmN521vxUFxEALDXRNECOhypIT
# /rTu9Ja1z+gshbGrIac+0JOnhEywIA==
