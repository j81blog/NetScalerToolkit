# Generated NetScalerToolkit Statistics bundle for category 'lb'.

# region Invoke-NSGetLBPolicyLabelStats
function Invoke-NSGetLBPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler lbpolicylabel statistics.
    .DESCRIPTION
        Statistics for lb policy label resource.
    .PARAMETER LabelName
        Name of the LB policy label. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetLBPolicyLabelStats -LabelName 'lbpolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetLBPolicyLabelStats

# region Invoke-NSGetLBPolicyStats
function Invoke-NSGetLBPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler lbpolicy statistics.
    .DESCRIPTION
        Statistics for lb policy resource.
    .PARAMETER Name
        Name of the LB policy for which to show detailed statistics. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetLBPolicyStats
    .EXAMPLE
        Invoke-NSGetLBPolicyStats -Name 'lbpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetLBPolicyStats

# region Invoke-NSGetLBVServerStats
function Invoke-NSGetLBVServerStats {
    <#
    .SYNOPSIS
        Gets NetScaler load balancing virtual server statistics.
    .DESCRIPTION
        Statistics for Load Balancing Virtual Server resource.
    .PARAMETER Name
        Name of the virtual server. If no name is provided, statistical data of all configured virtual servers is displayed. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetLBVServerStats -Name 'lbvserver_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetLBVServerStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAj6aS7kpyP1lyR
# gzvYrwljmtpWq+/Ppi80HejjWFWGiaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgU1xj
# 6KHaM4sdNvTkAlQ0XIh/yqX6slIkZxgFrzBUZRYwDQYJKoZIhvcNAQEBBQAEggGA
# RU/oKZCkpSkaYJfFfyL6W2TTpWndZFt1isFkacf1FtDSNr3fOv8Ss36wfgwp7OWO
# 7i8hU68RAcmWvZBaExFne3sSkwFv6rdVeSeFzj9gSoQ8SDOufCKZFPIAvXlPQwv+
# OjKmPLEcO3fbU1jOt2AHAdUukIg3L4qCjDUf0gKhyJcQBvhhw80Y5RTm+f+gkcMb
# T4ZrxDzJduX7vQvqEJeGI1LRcj66fIzjIzIjOSloj3phJDEw0zfPBhDEMxszT8+i
# 9Jo8fXsBHi4tAL0RwAvlYV6VtX760C0HEYowNgVlSYrta1IUVx+Bkp14dAiqBtJd
# GqqIXaFsL3jwTX7FbSafVGm1Nh2335abupI+IrEqLsgwvJZ2D1kRkccK9HrhFgqq
# 8uJkw3YVgVKRWM5idQKDpwdKayIFbLVY+n/2YGclnAFCdRu73AeJKlmB+etX98Fy
# dJx/30L29paCt8///GCV02w4g0UPFWvVnQAI51GDMpsUEVnTHN48i5xbXu2ORCXf
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIMmAnCXlCR5XiJXP4zsY
# YVYuDSTe/MOLhiWviGzfrTrtAgZqNWdtxu0YEzIwMjYwODAzMTI1MzQ2LjU0Nlow
...
# IgQgEZmq4w5FRoRQsvC+ofue0qIK9iUKBxXEOWtU/PXb0GYwgd0GCyqGSIb3DQEJ
...
# kTahOynpFQpsK7T7qt7engOZRjANBgkqhkiG9w0BAQsFAASCAgBDQLRG3nsdiC9E
# gNzxY+N5WeNWuANM2mPlGTP74O1lxwROiqvl6jEL454dE2qQXmFrQm2i+u1cH2qq
# gFsJrL0UyfgZmkkBWn4QtjGEFhV175/xBMrE1sPOTdpBZzwtVYV+q36x6BFzX4KH
# U20m5QLyWYr+thUJB2x1Vfj2mwiO9YuOC6sSa/yl4Qo5TkrPAtowioHUhLJHp1x9
# dVumaLK/4clg7TmgcKZKny1xGMK7we5iwfLX1Rw3Q/QGBZaOJH9OBqgnCX2Z/4W8
# qoZ9vWPy2+FvlSB3tk9+QvfAbt3zHsifbNfVCqLu7PjBBempQpGClE/RFaVv17ms
# Icaj8Q91kJsSwN3O45sQ7LNbY1UwFAXe0eLW2vi3wojWlVCUYpEy3ZSrGZbUW4/8
# sKWQXvsrBfg0NL692ozA2frIjWYCO4AAIVnmfFGD6X/ElzZ7cZ2yfDItBDzthTcq
# oq3cLLAQfr9cj00S3pYaAZdILQvI2NSS3eJy1pJIAdjPG2TbAnmlbX41zXCscLJ9
# cEom0wBY8XmGc6XKkobDd9UNEL9pi6LFA+fPw0a45/MuUXMlY9mnt5rEIsDcbb4p
# fj/l54OjPwN8ZDVA973tD9h/xuTgY23CUmcYCd5beSiuoP1DutKskiO70wtytwlv
# Acq1HFvhL1FGOS5eaLd42TVqcxCErw==
