# Generated NetScalerToolkit Statistics bundle for category 'gslb'.

# region Invoke-NSGetGSLBDomainStats
function Invoke-NSGetGSLBDomainStats {
    <#
    .SYNOPSIS
        Gets NetScaler gslbdomain statistics.
    .DESCRIPTION
        Statistics for GSLB domain resource.
    .PARAMETER Name
        Name of the GSLB domain for which to display statistics. If you do not specify a name, statistics are shown for all configured GSLB domains. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetGSLBDomainStats -Name 'gslbdomain_example'
    .OUTPUTS
...
# endregion Invoke-NSGetGSLBDomainStats

# region Invoke-NSGetGSLBServiceGroupMemberStats
function Invoke-NSGetGSLBServiceGroupMemberStats {
    <#
    .SYNOPSIS
        Gets NetScaler gslbservicegroupmember statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetGSLBServiceGroupMemberStats

# region Invoke-NSGetGSLBServiceGroupStats
function Invoke-NSGetGSLBServiceGroupStats {
    <#
    .SYNOPSIS
        Gets NetScaler gslbservicegroup statistics.
    .DESCRIPTION
        Statistics for GSLB service group resource.
    .PARAMETER ServiceGroupName
        Name of the GSLB service group for which to display settings. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetGSLBServiceGroupStats -ServiceGroupName 'gslbservicegroup_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetGSLBServiceGroupStats

# region Invoke-NSGetGSLBServiceStats
function Invoke-NSGetGSLBServiceStats {
    <#
    .SYNOPSIS
        Gets NetScaler gslbservice statistics.
    .DESCRIPTION
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetGSLBServiceStats
    .EXAMPLE
        Invoke-NSGetGSLBServiceStats -ServiceName 'gslbservice_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetGSLBServiceStats

# region Invoke-NSGetGSLBSiteStats
function Invoke-NSGetGSLBSiteStats {
    <#
    .SYNOPSIS
        Gets NetScaler gslbsite statistics.
    .DESCRIPTION
        Statistics for GSLB site resource.
    .PARAMETER SiteName
        Name of the GSLB site for which to display detailed statistics. If a name is not specified, basic information about all GSLB sites is displayed. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetGSLBSiteStats
    .EXAMPLE
        Invoke-NSGetGSLBSiteStats -SiteName 'gslbsite_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetGSLBSiteStats

# region Invoke-NSGetGSLBVServerStats
function Invoke-NSGetGSLBVServerStats {
    <#
    .SYNOPSIS
        Gets NetScaler gslbvserver statistics.
    .DESCRIPTION
        Statistics for Global Server Load Balancing Virtual Server resource.
    .PARAMETER Name
        Name of the GSLB virtual server for which to display statistics. If you do not specify a name, statistics are displayed for all GSLB virtual servers. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetGSLBVServerStats
    .EXAMPLE
        Invoke-NSGetGSLBVServerStats -Name 'gslbvserver_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetGSLBVServerStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDoEaBuKzH2LspK
# moFHVrpPHMFV4wDtJcb0G06BKUdm46CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQ