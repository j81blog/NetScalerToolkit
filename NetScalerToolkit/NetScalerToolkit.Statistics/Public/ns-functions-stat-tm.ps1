# Generated NetScalerToolkit Statistics bundle for category 'tm'.

# region Invoke-NSGetTMSessionPolicyStats
function Invoke-NSGetTMSessionPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler tmsessionpolicy statistics.
    .DESCRIPTION
        Statistics for TM session policy resource.
    .PARAMETER Name
        Name of the advanced tmsession policy for which to display statistics. If no name is specified, statistics for all advanced tmsession polices are shown. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetTMSessionPolicyStats -Name 'tmsessionpolicy_example'
    .OUTPUTS
...
# endregion Invoke-NSGetTMSessionPolicyStats

# region Invoke-NSGetTMTrafficPolicyStats
function Invoke-NSGetTMTrafficPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler tmtrafficpolicy statistics.
    .DESCRIPTION
        Statistics for TM traffic policy resource.
    .PARAMETER Name
        The name of the TM traffic policy for which statistics will be displayed. If not given statistics are shown for all policies. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetTMTrafficPolicyStats -Name 'tmtrafficpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetTMTrafficPolicyStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAAb+QHLTcfaDqb
# UG8gt7otwiTA9HSAAFkzjoNly62HEaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg5QRi
# ueKJ9RA/qUxXITaeX0oN4X6TiBg204m7LHmSzDIwDQYJKoZIhvcNAQEBBQAEggGA
# X94uGLDsZ7ZNq/SMsYXQOoseuoBwoC+hvBL4vZjgbFKJaj/P7Gsehfjh2nuKdx7+
# hn5rFGAn5TlVMbtx9zjPDKzriK5+kdnzGRhBU6FufMTaXBhP4BD2QL71OxsL0k0n
# +teipc5ohloAHC/750zrwkoMFnx6qx8P9VRVVbHan0sN/yaMo+DsJIjb85ZH2dOM
# ervPo3NAw1alBhCSUtyDTPXyG8KIJ/7HDq1PS/eEGHwm1LsHI8aFe76bkrNOr/By
# 0eT/wtjM4fo2F/RDOJKcVMWH/gqZnpyy96nSQ7ysDzauakfZw0gDYp1f0uiwh0rh
# fVkLYgFPq2YUhvUJe9DETyBk92geZjnYcGzBBdrCFnqlxOI1UyvuH2G1FoBflO/f
# Ku3AIfiDQ0Wfl3XKgJMFRPBlbuo1A74hQDjKB2SIKz5wBWr2jZRwriG1flUWvn0W
# 4uut5o6g6INsitFjhioNDfVkOUNWkNMgAOiqyRjkRPX27YYpdjn6fuMXeEvJK0RC
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIE2xwgR9aRYf3PXG6nAo
# mma5+YoZcyvO+pYJR8onFAOfAgZqNTBORJAYEzIwMjYwNzI3MTMxNTAwLjgyNFow
...
# IgQgzhJhNifxVaAmb0kneTTXiB1QKcOCER0qdYKcUZ4eGBUwgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgBwTofPyihb9W9U
# vEEXTZoy+AnScQE4gyOW2+LiJbaWvSj4GnWhnjNABO5VRu9H2l5UB3nmcB9TxWst
# 82Oye5FgVb5DcUDPnqm+EvS72OWYRiCVjkvSDYUYguY4On1PIAF122z7y7/SWWUJ
# gYSZ+tyKeeEhpENP5SwYlE4Ij4DTVU9/FH8ydT46ugaqrNXoDLoGagDXjpCYMNrV
# BXxdiScGd+tYjZ1hq0t8204US+bDkOzh4+RdetK30IHSjje+aMp3Yo6HI+pzSUdH
# +I8fVKRioi5uQyorvPfTAQOUCxPbGogFJPuxoYXuvAhhOWMXLYuRk3RSx3lLu8xy
# 61NSHrsQrGoCXJuPDgcAGV9CQDgG5QNVxF18D+AtOEUWhnhgGrMFSF1EvzVSWx14
# gLvmNlnr4tPZfrsxdenO32GfCVscEVZOZnExVAhGgaPuRwDe5YbZ+l3fcVLvVBkc
# PmPJMxt9K56B8sBl6WdIk1djSim2MDUmYsQpbcGJUlngGntjH6jkJ1/4d1j20JoO
# ExvwPQA5Xcow7zoCRf/K5+tK7gFGDRYRzpdjwoaQ9Fohn+1fTH8eFhZrFOYyPk+Y
# R6mesIY7AxMLLTubz1nXVm+CE8W14kjbN9nyWASX2FIy/rubRLpjPoDjqf0n8Vvg
# E2nYhTki3AguiYPK97DyqhNGSUsSxA==
