# Generated NetScalerToolkit Statistics bundle for category 'basic'.

# region Invoke-NSGetServiceGroupMemberStats
function Invoke-NSGetServiceGroupMemberStats {
    <#
    .SYNOPSIS
        Gets NetScaler servicegroupmember statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetServiceGroupMemberStats

# region Invoke-NSGetServiceGroupStats
function Invoke-NSGetServiceGroupStats {
    <#
    .SYNOPSIS
        Gets NetScaler servicegroup statistics.
    .DESCRIPTION
        Statistics for service group resource.
    .PARAMETER ServiceGroupName
        Name of the service group for which to display settings. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetServiceGroupStats -ServiceGroupName 'servicegroup_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetServiceGroupStats

# region Invoke-NSGetServiceStats
function Invoke-NSGetServiceStats {
    <#
    .SYNOPSIS
        Gets NetScaler service statistics.
    .DESCRIPTION
        Statistics for service resource.
    .PARAMETER Name
        Name of the service. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetServiceStats
    .EXAMPLE
        Invoke-NSGetServiceStats -Name 'service_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetServiceStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAModMy/FzYk+Ij
# tx9fEiHM4UrmPloiFpVv5lbGZoj18qCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg30Wh
# Z0uwzx7Tmj++CWxW0ILVlY+E23+Dk2qS9FiE6UowDQYJKoZIhvcNAQEBBQAEggGA
# dBEqwJy9YjdjNuF50uNogP8CTckzbE5qFMiOWIjC+EjEkh142X4oniN+ORZeENM1
# QAwlNbdHkirca4nVOEBqrKbSNanReyo12V7/FDwyihEtHhgQAlvc+2CJ06EsaesJ
# 8+3H4n73i56QDilZl64SEi3a/bF9kN9LJrUujncyyxfO01ccg7HBKVtM0kCE529S
# 6xSinN/ZdRYgzpE2SI6b6jktjFpjjfDBdcYSX8WiCtOr7xtAjFt8XHqM7ohZ5RZJ
# mG7hp2uugLo/S3mkvMw3PG10rNxvH5JryncyRmjMOekDFf/JioMafcO/O+4r4zbx
# HzuTfPibzYKoWNv83aas0Kun0azUSDXpRLuPalgIEeRiILoyLtnKIg9EBAqajLps
# dgJiC6YB8nulHIu1fTFmbLeaAnIL+L1wHElZ5ZEivdASWGeYgSbtksduXrSx4vaG
# ckW82cLrB5tnjs3/Pdl9Al2zFhryR1b5CiMcxZDfb33DxfsDOxkd2GtWdX7zJYdZ
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEICKee9Smvj363FqyE8q3
# v5oH1hXg7IEdUWlO6ks++RsNAgZqNTBOQqcYEzIwMjYwNzI3MTMxMzM0Ljc4NFow
...
# IgQgBt4A7hA12MlR3Bh/SXvGiMLSN6l5hGNlPaJDV4AOl/4wgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgBvFNCjz0EsTZpW
# Qt8zXRaNRUZXuevV1NDz5G3Q1ndEqFrssQ/vmUHNM4woB9CTdo0Cg+Ga4GLxvkOi
# z2eN7Gkxk2sYNDWkCxqk3MtWDioSga0DuV1GbECthdBd36lrEJ4EEpTf4KYYwIyD
# YYGrFh2O0VUy+qceRhet1Aaa8UOvuytKtS4L+oL0v+FrdA2AZmjsG6eH7/Ak2fBI
# FGb7AWmeQ1fLJ5ebAzu76W1oy8oLyDt0da0O12hMWgwT36rTOXdVh9V65cwGUjE4
# 1Fk2E+8NH+/7H+Yc7myHF27nht8sRIc8twj+zZkXnqFYwUut8x2IzKwMAIWgDjMA
# gDpXOn1PxGl0qaLnArut7YjjIrOtK8d5rGu0o8nYrTYul3gdBzT0iSUVl98K0Hgv
# C/6sK4/sUwSu3qRfSY/xtJf16YfhGBaDXU7AzEw2YxzwSa6DAPkpAemc4D1R77Rp
# vGbFw7ATc1iqcw64R3jBMTzyRDTuN0kp+1dvyYTbx/00hYq5Py/DpqAXNeNxsgtr
# 74UEBYMI3AQUlxY1tJF1qN+UyBlti/NTomMLU2kS+3xAof2f6oy4botQGVP4VnQz
# z2BL/51qfLGFpse2ML15HBWoSKeX63ne7y4dQACBDtFhjthRyyHeZsDaglYWUg1Q
# IGvcTBJ79M8JKvb267SIHdutHGSIAw==
