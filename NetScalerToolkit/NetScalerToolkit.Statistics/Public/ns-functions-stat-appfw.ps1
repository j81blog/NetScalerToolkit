# Generated NetScalerToolkit Statistics bundle for category 'appfw'.

# region Invoke-NSGetAppFwPolicyLabelStats
function Invoke-NSGetAppFwPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler appfwpolicylabel statistics.
    .DESCRIPTION
        Statistics for application firewall policy label resource.
    .PARAMETER LabelName
        Name of the application firewall policy label. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetAppFwPolicyLabelStats -LabelName 'appfwpolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetAppFwPolicyLabelStats

# region Invoke-NSGetAppFwPolicyStats
function Invoke-NSGetAppFwPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler appfwpolicy statistics.
    .DESCRIPTION
        Statistics for application firewall policy resource.
    .PARAMETER Name
        Name of the application firewall policy. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetAppFwPolicyStats -Name 'appfwpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAppFwPolicyStats

# region Invoke-NSGetAppFwProfileStats
function Invoke-NSGetAppFwProfileStats {
    <#
    .SYNOPSIS
        Gets NetScaler appfwprofile statistics.
    .DESCRIPTION
        Statistics for application firewall profile resource.
    .PARAMETER Name
        Name of the application firewall profile. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetAppFwProfileStats -Name 'appfwprofile_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAppFwProfileStats

# region Invoke-NSGetAppFwStats
function Invoke-NSGetAppFwStats {
    <#
    .SYNOPSIS
        Gets NetScaler appfw statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetAppFwStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTaA4ESgd2hybc
# qGmFlvr+Bf4f8HxeygxQkkTcwocjc6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg6/bV
# 155/ONW/vTpJJ68lNcXazkxNLU+6AHCoFtCwzGcwDQYJKoZIhvcNAQEBBQAEggGA
# QRW2xQzPWa7ys6vrZKPPdEYpgqygjqxE1TUyyDI0MQjyFkjaY7G28vKMynZJYxjb
# vFpyAYzknqx9s7OMJZFrKjEoSv/DXU3U21g4GrrNmwRd6p7ZcAYs4nkBEHb8HIYh
# 7YiLDE7HB4iA5ZJnWZLT9ZF8AFtFIs4ljuQYdR2dNAU1b6CmzinNoTDWu0KLHsm3
# k6yw1PBNk9ALVU6T8PPyluPmw0QdbsGzGCNmBBnIFu5rwcZH9bd4tu2a5Cs9i8oA
# Bva3iTEIcR6P3YvRPiJGYbgOzANhud0MXKmHCaXDH9D1+TkMSufGCfYxL99Xjo4W
# B8OJ2Bb/On9lbme7QPqaPubSHlh3oAHnM9Uzndv7kp7UbdV1tOQfI20z8b9aWs+o
# T/U4lkp2CKhABw03NXq9pE6EM+0XXH/aLfwCLEDHuGgyNxYQjeJGxKQzS/lqFLVB
# uo94/IGlJV0JcKloud9UxFQ5IazAtxMmYBDzLs9WUxlavcmpamnCVWx7aOb54JHu
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIFI8ohN/TsHwO9GfBQ+e
# xeX+HCz2+TnX2YZPuzJU9WoNAgZqNTBOQlsYEzIwMjYwNzI3MTMxMzIwLjI5Nlow
...
# IgQgljBfJ5Kircc0VrM+2rlWE7gLts5bDVze5rBY/FT4JPgwgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgA207s3tVidPZUw
# 6dMYqCRrVOV+Xu19Zam92hNfZyVWaDwWcGyZy9fNNXip6BPW6W3uMCK9ikBsV8xX
# FkkkMRZXBpyR/as5npdFl5zvYs2uy7KuqaG3td04ShpHbo81NWX11vrMpMC0ANGI
# 5f9Uz6n7Tco+xMrD5FFqZNnfrTk/j+I4e5UdrZuyMk964wnLW1x+AcEZtWlH8vy1
# nWwzC0GeZqgb3ZT2+82G8bXBHfKALjxvTmeOLmT1q8GaMbvNN9MnaBeiS8QODvqg
# u2AhBjXwuccjSfr1NS9T0wPTr5GsiifSqd6tu2ajOYWSwNLoJp2UycQONbVufKcC
# 7feGw+fetMNVzj1i+QtIaW4B0Z+m5vUKRFMn8u0NRIjCaHFSqo9ebmhULyirzwRQ
# SAmU6iQvG2Tb3sxarnhqFv6qnw2Ik+6X1JP9c3hzea6grBcVDJm4QqwiT1trB8uh
# BU0vkcst+Va7LYuC9nZ2gwsWUHqj64SxggtbJ4DC7m7i+x1tsi7jIaKcGonkB/uP
# B3zKkW13hK9gXGmiIT38OkqL3S5IE/pln2wPcfl6mZkVjddt2BoOXtC+0jgC326Z
# TV+ldm60butSBYn/U5W7NPTzz9zjxlk98N4TUrgHkviGrM383tb4TcgQbSbNGDkm
# fVsnQV/WeFkPuitPENq/vKlNd/6MOw==
