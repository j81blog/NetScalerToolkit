# Generated NetScalerToolkit Statistics bundle for category 'cache'.

# region Invoke-NSGetCacheContentGroupStats
function Invoke-NSGetCacheContentGroupStats {
    <#
    .SYNOPSIS
        Gets NetScaler cachecontentgroup statistics.
    .DESCRIPTION
        Statistics for Integrated Cache content group resource.
    .PARAMETER Name
        Name of the cache contentgroup for which to display statistics. If you do not set this parameter, statistics are shown for all cache contentgroups. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetCacheContentGroupStats -Name 'cachecontentgroup_example'
    .OUTPUTS
...
# endregion Invoke-NSGetCacheContentGroupStats

# region Invoke-NSGetCachePolicyLabelStats
function Invoke-NSGetCachePolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler cachepolicylabel statistics.
    .DESCRIPTION
        Statistics for cache policy label resource.
    .PARAMETER LabelName
        Name of the cache-policy label for which to display statistics. If you do not set this parameter statistics are shown for all cache-policy labels. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetCachePolicyLabelStats -LabelName 'cachepolicylabel_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetCachePolicyLabelStats

# region Invoke-NSGetCachePolicyStats
function Invoke-NSGetCachePolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler cachepolicy statistics.
    .DESCRIPTION
        Statistics for Integrated Cache policy resource.
    .PARAMETER PolicyName
        Name of the cache policy for which to display statistics. If you do not set this parameter, statistics are shown for all cache policies. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetCachePolicyStats
    .EXAMPLE
        Invoke-NSGetCachePolicyStats -PolicyName 'cachepolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetCachePolicyStats

# region Invoke-NSGetCacheStats
function Invoke-NSGetCacheStats {
    <#
    .SYNOPSIS
        Gets NetScaler cache statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetCacheStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBcEozeM2acNeQ4
# DG4lZSZXGr+Pgad9YKAQYzPpwP1eH6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgJLID
# IfY005lpDI/pK+Pe0q9uCf6Z2tBkB1i31t/PKFkwDQYJKoZIhvcNAQEBBQAEggGA
# VgbMq21/yvPTH1VGo2OdObi9CQHXo9JQerf0l8/apf0VrHwJYd47KNIwImQ3Q+9r
# 7YNp2JkDB5AwvrgkgwuKcz7Yg9axtuviJu05gFOXe9Rl5XjLeLWPu/hWdGN2gFIg
# ACqip4olMWtbYRZqZ0UP+IjFL3CJuEYPEj1+QvX/sN/mqZqhnHbQ6i3WO6n+TDod
# u5GID1DIxx0Q60kjiQIQGoOCPeeMeDo92XeO1t4wIE91VQntZ7cTFKBZ+aNwI1NF
# gwXo+yYCy4eNzjkLHLWTK9AOcoG4i6PjYtxYeK/WoreLITohfvnYwnf2fexawLLH
# CahcmNn2QsdS7xOvEgTgrxPaCpYzFs8Jy5OuGaqzefVdjuIEm8dgKNhjpOrZup2s
# B0uiFnUTLucJNVgNnoC+KcIlnv8NL0ErtT/wDqYzWik2uZGOzz5Xb+oSjH1OoE5Q
# 9JhA+jnL4QZD5rFJM6hQc8WF0S9maGfs4Mxs404YVHEGUR9sU4d6mN60UP+uTT2B
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIJVWbjJNwKNXbipW/5X2
# qDKmYbIQibStJx12H18izOffAgZqNTBOQscYEzIwMjYwNzI3MTMxMzM5LjU4NVow
...
# IgQgFwnMykY/oF6/v+ANE5IBWUC7kvtTOvvxSyD9WELg9Ikwgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgAeGSIayQhlJeSh
# Yxyd15K5hCWT0TLcIWRDP7+dTMR5QLX9IGt4WJb3mRUGHDJtzMb12e46yWht38nv
# LmucsYoYICgrTIZbN6N157zwqBLGKG4wtWZINOBLrgrTKpnAx5Ph3vH+V8OTkSWF
# NVowoGKuqJZQEwrSqHhpXiM7znvJ2igYyu1V2nat6DoFWu0qxrxhUrqVgzx/CDeE
# LAtSiPhtEuAZ+5sHX1OzTrgBQWFDRRzTpzQyF8W3WZTkqHE/R7iu7JCC0j7TvipB
# xTWgUhpy46/xDZzRINm/fNomF3CXr/2kAUzOA2xK5Yxeo3dxbZcHr/cq3HHrgJDr
# MxYWNQLBpF8oi8OBiefMQTF55Wul6lYoUCV8bq6UfMM7EvHzFr4Lr8t5CPhSCWzL
# 57I8QXkxkU2EnQ/cXPZL3mbR7AcN1Rp2yhFkBRI1I5+CqjoKi+MFWofZ6lmU8fAv
# Pmlo9Dc+gXH8CQ2chjxmx5KcyAO/0ktzmhnmAqZZ4QuoyHLsCZD95UzqYGp9QJWk
# yXyA2F47XWhWXQa18BPXb/oAjQ7Ya6Gsw7xTgaQLL5McLo+n/2nNEAnjH0UCbmSf
# HVnDXhC+cj7PEA/LcUPrB4bSjjCGagtMnsxFETnq86Ylq3x/qXG1r0tA0sLfE/tj
# m3NFdzW6i4v4wY4qpz3cEcXg358myg==
