# Generated NetScalerToolkit Statistics bundle for category 'authentication'.

# region Invoke-NSGetAuthenticationLoginSchemaPolicyStats
function Invoke-NSGetAuthenticationLoginSchemaPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler authenticationloginschemapolicy statistics.
    .DESCRIPTION
        If any, the warnings are displayed in the "X-NITRO-WARNING" header and the HTTP status code is 209.
    .PARAMETER Name
        The name of the LoginSchema policy for which statistics will be displayed. If not given statistics are shown for all policies. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetAuthenticationLoginSchemaPolicyStats -Name 'authenticationloginschemapolicy_example'
    .OUTPUTS
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'stat'
            Type = 'authenticationloginschemapolicy'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthenticationLoginSchemaPolicyStats

# region Invoke-NSGetAuthenticationOAuthIDPPolicyStats
function Invoke-NSGetAuthenticationOAuthIDPPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler authenticationoauthidppolicy statistics.
    .DESCRIPTION
        Statistics for AAA OAuth IdentityProvider (IdP) policy resource.
    .PARAMETER Name
        The name of the OAuth Identity Provider (IdP) policy for which statistics will be displayed. If not given statistics are shown for all policies. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetAuthenticationOAuthIDPPolicyStats -Name 'authenticationoauthidppolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
    ...
    process {
        ...
        $request = @{
            ...
            Method = 'GET'
            Task = 'stat'
            Type = 'authenticationoauthidppolicy'
            Query = $query
        }
...
# endregion Invoke-NSGetAuthenticationOAuthIDPPolicyStats

# region Invoke-NSGetAuthenticationPolicyLabelStats
function Invoke-NSGetAuthenticationPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler authenticationpolicylabel statistics.
    .DESCRIPTION
        Statistics for authentication policy label resource.
    .PARAMETER LabelName
        Name of the authentication policy label. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetAuthenticationPolicyLabelStats -LabelName 'authenticationpolicylabel_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAuthenticationPolicyLabelStats

# region Invoke-NSGetAuthenticationPolicyStats
function Invoke-NSGetAuthenticationPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler authenticationpolicy statistics.
    .DESCRIPTION
        Statistics for Authentication Policy resource.
    .PARAMETER Name
        Name of the advanced authentication policy for which to display statistics. If no name is specified, statistics for all advanced authentication polices are shown. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetAuthenticationPolicyStats -Name 'authenticationpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAuthenticationPolicyStats

# region Invoke-NSGetAuthenticationSAMLIDPPolicyStats
function Invoke-NSGetAuthenticationSAMLIDPPolicyStats {
    ...
    .PARAMETER Name
        The name of the SAML Identity Provider (IdP) policy for which statistics will be displayed. If not given statistics are shown for all policies. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
...
# endregion Invoke-NSGetAuthenticationSAMLIDPPolicyStats

# region Invoke-NSGetAuthenticationVServerStats
function Invoke-NSGetAuthenticationVServerStats {
    <#
    .SYNOPSIS
        Gets NetScaler authenticationvserver statistics.
    .DESCRIPTION
        Statistics for authentication virtual server resource.
    .PARAMETER Name
        Name of the authentication virtual server. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetAuthenticationVServerStats -Name 'authenticationvserver_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetAuthenticationVServerStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDyku5mQL25ZeX9
# 2zhgnz8vheiFc4eFXJFK40ZDfBVyoKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQ