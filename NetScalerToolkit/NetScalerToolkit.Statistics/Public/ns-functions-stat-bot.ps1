# Generated NetScalerToolkit Statistics bundle for category 'bot'.

# region Invoke-NSGetBotPolicyLabelStats
function Invoke-NSGetBotPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler botpolicylabel statistics.
    .DESCRIPTION
        Statistics for Bot policy label resource.
    .PARAMETER LabelName
        Name of the bot policy label. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetBotPolicyLabelStats -LabelName 'botpolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetBotPolicyLabelStats

# region Invoke-NSGetBotPolicyStats
function Invoke-NSGetBotPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler botpolicy statistics.
    .DESCRIPTION
        Statistics for Bot policy resource.
    .PARAMETER Name
        Name of the bot policy for which to show detailed statistics. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetBotPolicyStats
    .EXAMPLE
        Invoke-NSGetBotPolicyStats -Name 'botpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetBotPolicyStats

# region Invoke-NSGetBotProfileStats
function Invoke-NSGetBotProfileStats {
    <#
    .SYNOPSIS
        Gets NetScaler botprofile statistics.
    .DESCRIPTION
        Statistics for Bot profile resource.
    .PARAMETER Name
        Name of the bot profile. Minimum length = 1 Maximum length = 31
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetBotProfileStats -Name 'botprofile_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetBotProfileStats

# region Invoke-NSGetBotStats
function Invoke-NSGetBotStats {
    <#
    .SYNOPSIS
        Gets NetScaler bot statistics.
    .DESCRIPTION
        Bot Management.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
...
# endregion Invoke-NSGetBotStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDa66VRVbKYxZof
# +56KfmDmPt2zYxe/xPOnUEKLgPcjdKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgwS4k
# B66eMGaVLnNPLKY+gQxeBO/OW864/R8UxKZbkHIwDQYJKoZIhvcNAQEBBQAEggGA
# m9oTnQDzQ0X/ywMxs6qQjRuxyglkJF7d6otfVNguAk98wACcFdm5ZIDa+HN4+r+l
# 5F6EuCESVGu2pvD0TvKGH1ubwRoIdjuQtFqMmmhmZ2gXN/wIxHelHUFuf02fgeix
# 8Zf9hLlDy3DrsEDqOUKRZNp7IeOCUAVnKGM4fo7p+oTIpQyWeDIjUrYKEhrOwksc
# 864QzOeQ+0k9IgyYCxnA3KAgl1L+T0M4vfQKOyngdjF28sHj/zJ3/3kovMY0t5dN
# vdCeq5jRC6yEWddiBusjuVEGa+AhqwSvTpY105NnJct1+t1iZNnhftoKqY8B+Cr3
# 0ymNAOZN9EEeZ4HPPjvNfbHrg8how7TS00KQY5LDYiI7aqkSW+4RVFAfM6k70X64
# d88W8haVDKJzWZZg7JdCbxcYunD+x+yZzHNP435YFg+pKXLDrDh7wWeHEUUhipG1
# Lsclwr2UZNyOFn+ipsJarrP9lNMUrL5RX5IMBtm7qOFyWUCep6bS2g4ocqAyeSAS
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIOEQXj6c87dbT3eaP1q0
# KRuHWu4Kqgkr+bgGcQi6a/l4AgZqNWdtxhcYEzIwMjYwODAzMTI1MzE3Ljc5OVow
...
# IgQg6mQ7mKm0JSUyv8WX/+LTRSNIOqjaAxtHoS/4XlycYygwgd0GCyqGSIb3DQEJ
...
# kTahOynpFQpsK7T7qt7engOZRjANBgkqhkiG9w0BAQsFAASCAgBxQZoPiB3KjPvQ
# ihMM+dDGzvn12At+VvCyTWvgrQ4TVq0XEMr3vyQyiw8GC0JeAzvhq/triBIQEZmG
# T1m8zurOjWb5r0ziDaNGwJyGv5cdxxuLyy7qRGqTDHyeYCMRP4bN2YazUMK+fNIb
# chRLGHwYlVt7YvCjt7CEuQhSOdnt28tOHuPMA1rNhKTVmcdA03wAfgpXo6JHfaqJ
# i3kg8aeAvmwWQqNzylvbpXoadM38Z5uTJV79e3rHfj2ioqW6AQYvzsBXhD+BdLvB
# fum9gBRu/JpKk2pGRnEL10aZI20JiUHiD+5K8HeLYe658MigzhumVFyWpDVzpXp7
# ggIOcSOPjTUq/kbQIud3a/Z2WkAqD0G7HDLGk+FDGmptbyIG5wAdoe35ZnTOpdk4
# U+NZ77ybIDUNiRow6EY0szxzXn+M/uPE64ZWlXedmQ6qgfRMiXlr32BEfhbkuSRd
# nwe9b3efyB/znaOw/ohEYC5NvXjOYa0aCeSLWKkoO5MG+zZuRBS+Jh9Ka3xVtNpV
# OqOfPBPjKyy2YOwERRs7hrGIzoIsj/71KvK07O0ZXRhheFk8PXKrCSxWkUfik/gF
# JQ1wPSKFlGE15Rx4P11idIWSIKFPTvNGTMGX+sNAv/OU63v77+K/Ff6FQXPf6P+j
# WXUj1OVvF1oxvbeQVoJbMIR8cuhPkQ==
