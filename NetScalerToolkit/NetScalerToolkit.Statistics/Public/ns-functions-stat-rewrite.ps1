# Generated NetScalerToolkit Statistics bundle for category 'rewrite'.

# region Invoke-NSGetRewritePolicyLabelStats
function Invoke-NSGetRewritePolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler rewritepolicylabel statistics.
    .DESCRIPTION
        Statistics for rewrite policy label resource.
    .PARAMETER LabelName
        Name of the rewrite policy label. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetRewritePolicyLabelStats -LabelName 'rewritepolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetRewritePolicyLabelStats

# region Invoke-NSGetRewritePolicyStats
function Invoke-NSGetRewritePolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler rewritepolicy statistics.
    .DESCRIPTION
        Statistics for rewrite policy resource.
    .PARAMETER Name
        Name of the rewrite policy. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetRewritePolicyStats -Name 'rewritepolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetRewritePolicyStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQvpMJdGvbaHO9
# 2XOBCjnJAog1EwiwboFzS61i5tTUHqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgqkHz
# /1SF8N/VWkfJKf056nH7/NA+qvOLITSQ7UtOGAMwDQYJKoZIhvcNAQEBBQAEggGA
# idr/CmtUt/qQ4NTkF9yuzO1FdMDpubX9jE2anBy05mvI2ilFZheS8eFL3NZS0/mn
# 3J9KnqblXlk4YKwkJ7JjHKgJvDJAWLTZvJPHiZx78cOuyVmYqG6lTZ13uWi5er7t
# HOlWCEY+lPp/8iZUmpv6SMxOYogL9qfruvvKAsvob34tx0YVn58DbuQD9CSN0lnC
# FULEf0wyXfm4BB5hMuk1rVx4a3tQPVIAJAzK2BC8s6gPnmYzdCHz6WbK6zZDFL48
# mzSxsfVPCfe7dnagrA3xaEEr63KcPAJT8R9BxedeWhuZ1pY8fAlv99jsjUy3a6BO
# 1bCwh/qnqeMZKhrcdCDSjRDDXNGoscQe11VbqXgFUYOrP4ofWTBC+n8+iNJ9KC2d
# KOpvHD86o6gPQl9EpAm6/KXkp9J73NohpvNJBVJRsoNxyEiMfM/oiP3Fjn0X5PCT
# gfURG0vD0DwW95z9HNmyAb8lTa7hpQvMEjJnU4t53wx3/8cBf1cyqGAqfPLax6on
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIOtOsdIugw4gzGLLl6zO
# pdOtiZXNzsWXoZn6mTrsMYtvAgZqNTBfo4UYEzIwMjYwODAzMTI1NDAzLjAxOVow
...
# IgQg9lU6ELrdhDjMUDirFxIzcDR85fggtcnaaSICLqXU/GUwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgBeGsjCA9anKbWF
# WZWRH18XySmXHK/6zFDFLQafArZ2m0E0l96RNK6aLeWcSiduNFuSHV/O2HBCbhBF
# 7MC8qH2cxibbpxIEnsj0rNm/2r/CpwcbczZuk87kXPmD+KMYb6GeedPeHi1injzX
# 4luPWJPYskwZ4tu6D6xDkYeNzsPiwx6Djh/Fb7Zln3ZY4DOSi7EwmT1K1jUTEhYY
# fAR+/EuYbdom73PrFrDQIu3a6Ye8A1ThTLThBHGscMhezlv7brhnv2x4uciKdPeC
# 3FMnu6+GCzE9ttYgzM5cMF+Fgm63CtZtIhzec7A0do8Gwn5B1UeVyXHLkFLJuXg0
# A8TOiudVeFrvdPZO3+uWBNZ6XET8YZ1M9s1SAS/ZCv4HtPATNodeISdN9kw99LOy
# dTqW1JfnhCm905IRvFZ0PI9RgbTcSSX9qQeNq8ejorHdBlkyDxUOU60DScLjhCQG
# Ub48mQmV6HZDSxlngauowvS68kLmkOg3sQxEy2md7C1rXLUbxXJ9QYVjq58P+kIc
# L+TsE4lhOuMqadSqyEzHDKP5wYZNdC4CimWzAdeg61LyjCFUE4cJaGDCsEpankfA
# +hscBLsWyEX3cvMt9TXm3L3Bosc4b/6Kcnml37BrWA1NA7rNy36NlieiC37svLAC
# fA9Na4BPfmAZkjKmqdvAfWYoQVMdYg==
