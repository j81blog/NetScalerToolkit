# Generated NetScalerToolkit Statistics bundle for category 'vpn'.

# region Invoke-NSGetVPNStats
function Invoke-NSGetVPNStats {
    <#
    .SYNOPSIS
        Gets NetScaler vpn statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetVPNStats

# region Invoke-NSGetVPNURLPolicyStats
function Invoke-NSGetVPNURLPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler vpnurlpolicy statistics.
    .DESCRIPTION
        Statistics for VPN url policy resource.
    .PARAMETER Name
        The name of the vpn urlPolicy for which statistics will be displayed. If not given statistics are shown for all policies. Minimum length = 1
    .PARAMETER Filter
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetVPNURLPolicyStats
    .EXAMPLE
        Invoke-NSGetVPNURLPolicyStats -Name 'vpnurlpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetVPNURLPolicyStats

# region Invoke-NSGetVPNVServerStats
function Invoke-NSGetVPNVServerStats {
    <#
    .SYNOPSIS
        Gets NetScaler vpnvserver statistics.
    .DESCRIPTION
        Statistics for VPN virtual server resource.
    .PARAMETER Name
        Name of the virtual server for which to show detailed statistics. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetVPNVServerStats -Name 'vpnvserver_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetVPNVServerStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAyBdRAifpExMGb
# haowUNgPhTkTz1i2OmoKqAPfkVvEfaCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg73lJ
# OdqZDvMt+vmyeRmARGeowdO0wFnPkk4W0K1Mj3EwDQYJKoZIhvcNAQEBBQAEggGA
# aQrfgCVM+cRdeebn/oiUM4Bd2N21qUV/GfY3wDRqyBTSOvEikvtfkLVwNhl1TtZN
# mdUR5/e0Df3X5ylDk+8f6UkT3AMF6XnD3HqqwE53DRK8acReTfSwtlCpDDZ+e8TU
# yhOVgvqg1NMrVytSfVaJHlBAKToMwSR0tbgoTGVxCyFayZuzfliRxu1QJzpFlW45
# 0n5yIYgSRUDw5kWlBA4sGwT4QfYJV2oF319wFBxDZb9yD9+Cyhtz0lya1HEGgPxd
# uupRw4myZ5od7pprLbNO2RXRelsH9QAI9Bzq3H5O5xo4eWBawDJIxj8NM3FbnxzP
# XMabIApcA0NIjkbnP17jHkyKVVkHxoMEkid0MzHxrgplMgxySCG6Vc8l9cT/1tsm
# 0pd/cIEYCpZFoMIz6/YVUCv9txxn7MOgttAXcbqgst/b+Yqkn+1l9hCuM2veh89I
# PvuTKz6MgOcuRfskBP1Qbg3BQnWlQekPB4QrIjENv8CEdNh15l2rtHrKZG53/AVO
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIEEazg+OotlxFr0IxcT8
# Y2BAO/hcWBzD+dISsZ6FnP7DAgZqNTBORK4YEzIwMjYwNzI3MTMxNTEyLjc3OVow
...
# IgQgNCZefAAxT19c65k7uHJ8A7Nwf7yoSXQFCD2I3pHPTI8wgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgC1RdjOTVcj4mnc
# EFa5ZdAlSLjjsFRYfSrz7Mw6+1bsv64gtL0OWQcqeGgByuX2yTsivm2QSa8lrqH8
# FZI1nTYLuSLXmcwkcF4fDI9kklRCSGv1yr5nHiTSAqkXUnjvnWY44mTBVOW4w3I7
# voRMwe7m2lYyKf8pqoHmRw69t1l4fPTMiB7RbWJhPpXHwbyl2Uc/Rus0cwRU4Ga0
# HnrVURngZ9SE6Bkz1/Hv/pE7E8sAwVo0+4m9sYaTIcju1G65hW2OpIFy1X8QgmJV
# xCVvQ12PnNruVDcpTBDgOEZUSEJbU7u/ceVLE30t9+hoe+iw6dIcey4RL88HALpF
# EN77JC12cq/yBV3EFLT0JGw9UlVJ2L0DepvxKt1QaghTmA6hmFAlXfbKd8Ogca5L
# RZzbGuHSJegHzDwHJPxec6+bz6l9Qn2ZkweAQ0ki3IBBKiT3Tltt4QschurrbwrL
# SFNQOPNvfHPGHeqPksldYO2eJ8nG5gjtUcgD10MbOSgUYdukPsg3oW2+oKvF9ygW
# XKsAMHEN3wafg2TiOYxQE5TFPSulQx2TCteDpcQGK1C6qet183TPbyXaXOdy7b3i
# 6epvdoPCqtbeEqWjCZ86aTQ8iMv5ccUpIZdQWuE9t2NQ2Er065dGZpBo2axNcFtY
# HlUzwpxk2wSBHvK6LZ2vSsEL34JvBw==
