# Generated NetScalerToolkit Statistics bundle for category 'cluster'.

# region Invoke-NSGetClusterInstanceStats
function Invoke-NSGetClusterInstanceStats {
    <#
    .SYNOPSIS
        Gets NetScaler clusterinstance statistics.
    .DESCRIPTION
        Statistics for cluster instance resource.
    .PARAMETER CLID
        ID of the cluster instance for which to display statistics. Minimum value = 1 Maximum value = 128
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetClusterInstanceStats
    .EXAMPLE
        Invoke-NSGetClusterInstanceStats -CLID 'clusterinstance_example'
    .OUTPUTS
...
# endregion Invoke-NSGetClusterInstanceStats

# region Invoke-NSGetClusterNodeStats
function Invoke-NSGetClusterNodeStats {
    <#
    .SYNOPSIS
        Gets NetScaler clusternode statistics.
    .DESCRIPTION
        Statistics for cluster node resource.
    .PARAMETER Nodeid
        ID of the cluster node for which to display statistics. If an ID is not provided, statistics are shown for all nodes. Minimum value = 0 Maximum value = 31
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetClusterNodeStats
    .EXAMPLE
        Invoke-NSGetClusterNodeStats -Nodeid 'clusternode_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetClusterNodeStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBR22/3lvwA3UON
# CPJe0yNFkm7UoP/Uo2Fo4RkcT1fuxqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgvP4D
# coYkRGJuP8TpvpPihQGzFexnvmxEXHg+vTWEhg8wDQYJKoZIhvcNAQEBBQAEggGA
# VDO2msRTOgbGyJb5113Q3fHEjxBal9GyFhHs+0bmbb/gGJStRqZaiTKEYPMwC5cI
# 1UEbYjoGxi165ZhXLpE/HJNAcI+EwOxXVS+hzbsAh26Oq5x9V5ZhSmrR9eQsHMyb
# T36fO5G9uPn6+Chei/SaBtzAOs8dx9ZRM2kUIJS+mgNMZS5crjRt4Q/d31O/t+cA
# cGRj3Qavh6o5dm+JyETwAY9jx6ruElX8XWuYAA8EBDRVRTV+ufiVPWG1dDppQ824
# UdW/hdH3/Xs14ZEhpyKHozcysoj4mlBiOg0lful2bxkSSIAxvWAn9h0dfWcPxh9h
# cymu2W40R3z/J+Um8veqzieMMOlUhKpoJujbyoEXL/l0RRQ6Tf8ygWYfoYSlU0eZ
# Rw/yUobfFPclwnKxizYHJfMZ52SdRJvPjoBTLy0rrotcyxD7Lw6EDQkOTkJqDzF7
# UeecyZyuqU1t/MmTkPA3U4F2gOfKVFMoCmDB2QVNdptdrN/wQZomT/3MtfKGRYiO
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEII+pfBAbf9e0jWh0noOH
# S1br3APw3wEFhWbuTElARdTqAgZqNTBfoj8YEzIwMjYwODAzMTI1MzIxLjk5Mlow
...
# IgQg7lV/8WfpG9xVqHZruOKlivW12pfyGCvjv6KWV1kwdV4wgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgAN7UTT8iSpRWy3
# rY7fQ7a7TUg8elVGWykvQZEEHNzaBNXDl1PHThlTyqYIMaQJXnUyQppURMbe2kGM
# DOH+9xKXMIR6Fb3dUaCg+b7lgBUohe9l6PwFUjlEnEVNttmdn46mlb+qwk96ptzN
# Y/5N9PEzAxci4Hwc/AVDZk7tbMsmac4ulI/Sy2PDkQYpv9A31fGgbzzeqafQLAZp
# a5hidRJ/09g4vKJj7+rYyPl9kwyAr+kTm9bt4LcAYCtYX44hey4EjygaZ8b8YnXj
# ysL1ugZRcWP1NwF2FAepOGPds1EIPA61994H3mBsse1KbaSD5uQJJvwgGyR5yJi+
# TCqIOa7ufuxJYcqMb0YM2xRxxV1h1d0BqFZGJCBRw+XbBT3bIK7XUP6ejeujAFw1
# /K/4MgU+mohbwKn1tOUcTGAHmOmvfoyVJJUnwhc8Ab/OeF3uh9wQjRY8zW0yw+1X
# dKVmCQKKFUyevgX+xcWVkDzZj5bo1ts0jC3PFufPwUF9ucnM4x2Oa8ekNApxzLXr
# 8uEtDiDk+622o26RmzxPXVns1tu/i+JNDC6roAv4YoKD9MOCa4FZ66LpVgQDbTlm
# F32BKRfKQMEERuPQ9qF4bcgFn1P+evuzKGvKsKQv0YnwYagWEu/8Jglm81nEOTBV
# o0xd+KDqPTzyisiItI6ZAwDdw5DBUA==
