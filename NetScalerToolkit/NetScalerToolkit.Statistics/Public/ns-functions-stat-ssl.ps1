# Generated NetScalerToolkit Statistics bundle for category 'ssl'.

# region Invoke-NSGetSSLStats
function Invoke-NSGetSSLStats {
    <#
    .SYNOPSIS
        Gets NetScaler ssl statistics.
    .DESCRIPTION
        SSL statistics
    .PARAMETER Session
...
# endregion Invoke-NSGetSSLStats

# region Invoke-NSGetSSLVServerStats
function Invoke-NSGetSSLVServerStats {
    <#
    .SYNOPSIS
        Gets NetScaler sslvserver statistics.
    .DESCRIPTION
        Statistics for SSL virtual server resource.
    .PARAMETER VServerName
        Name of the SSL virtual server for which to show detailed statistics. Minimum length = 1
    .PARAMETER Filter
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetSSLVServerStats
    .EXAMPLE
        Invoke-NSGetSSLVServerStats -VServerName 'sslvserver_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetSSLVServerStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCALiNZGcm8svkzH
# Re0yqzxqW2+odIeCnpF6fYAmYGX9A6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgoXdG
# HUdIIkHeKo4hSnfrsJ1kTLcvE4jyslfn0EH/j7owDQYJKoZIhvcNAQEBBQAEggGA
# GQZqfM5qpkx9+V7YkOnPnZ/Qu/EV3vktveAEseZU96nPtHQmxSZlwLBB2Z51UjfZ
# dE7YD4z42kxdupqbYQg3vc1ntqgf6LI44izAU3B+rsQVGa+hiMXPr7mQZz7cNTAF
# q5MCiLSQEAQy/b2Xk3N2usf73/SVuLV6fqfVUcDLtTuOtfvoC7M0rsl5ijMsfgV1
# ShKfx5RTbHF3SOa8lTg65Gz/cTsF+HKK0h7Ea4903Gx/eNRAJ2ny21bxePFnViOJ
# K8PaV1w+MtbwXa4x2G5klDBzRpzD+6/w5WdHp9en0foq+5/mmzJtmlHXaKNvnVxM
# UjrJHaQPy/qcra05bg8IB3qWrJ7S9gizyHdm8CgLeZgVCHYccq444GaGjrBcLsjY
# TT1JXPTXYcPrbW0k7k7U33A0AmYRNwu1OK6n3YvE1MK6OwjDUkdno5NO36HEujeD
# u9pRUHgdBnJFFUtmPefOaDzhdVVDlvsUk6dEzP54SGvqii1+P3A91pZRP83iS7PL
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIC48nDwhXFQc8baX0pQf
# x8/kJQp85MMU5Yaq5bW5HObhAgZqNTBORHYYEzIwMjYwNzI3MTMxNDUwLjA3N1ow
...
# IgQg33vEqDRL2jWtHO76L1E993mVlVcwYsWsR0AekXCfpE4wgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgBM7KCb9OXXQaxw
# iHavE76nsB4xjKMJa81EvZfK/0PD+KTgk7idG4RANqrb7QqaMSirGqDwxxx8x+WU
# XwbflCt4hY5rlvdqY8948Gian9oH282/ckQbHiLqMm1Hkg+7HxL+aOTphVsNdBbK
# rswKBCm4FJ6xd9MHmFQFsY7X5lfT/hWR/q8JDuJuLVVMhhIArsYbR395PZ51D3Oh
# DKXLHt7IHJiDM7uXkxIzDUP0o+goD5huICEwc0IxCIWATcynjjyrh+5rRJ6ES0EG
# 7U+v8avBjcMwocsFOB7Oo74LW0C3qjH+i/x6HjuSnRirPwWWDtAF3M4B/HrclUJd
# Jgy2LwnswuEUsBv9/97Mw/dNj1LS0YWtaJQw6tvdFjFqRSvqDQlL6c1pXm4yk+hC
# 4uxG+g1f0GLeO/U5htG0oZNr2ZtKw2WVI3i4iPu2TGTy6YhAf/VM6mH8h+QTId12
# Qcb+fz+BqFHLco1biEhWTDqyCeYYLrwZIWep+4hVuFLRyRF/qh+MXNma6uAJZ3EN
# juZlsDFHl99hpy0pfLf7hN5PzCH+0TD7L2jC0ojg7Mk7WZmUQamEwmuI8ZHuB/qi
# RKVHqAUFe8JXZxmLubeA+1+/cohLemkSJC5hrUW2gniZX8x3aAj7JV7YUbBWsw+b
# xSjeaOLQ9eXRB+1Ir7eGO4g0oFPKsQ==
