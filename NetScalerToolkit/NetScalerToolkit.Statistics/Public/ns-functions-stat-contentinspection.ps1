# Generated NetScalerToolkit Statistics bundle for category 'contentinspection'.

# region Invoke-NSGetContentInspectionPolicyLabelStats
function Invoke-NSGetContentInspectionPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler contentinspectionpolicylabel statistics.
    .DESCRIPTION
        Statistics for ContentInspection policy label resource.
    .PARAMETER LabelName
        Name of the contentInspection policy label. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetContentInspectionPolicyLabelStats -LabelName 'contentinspectionpolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetContentInspectionPolicyLabelStats

# region Invoke-NSGetContentInspectionPolicyStats
function Invoke-NSGetContentInspectionPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler contentinspectionpolicy statistics.
    .DESCRIPTION
        Statistics for ContentInspection policy resource.
    .PARAMETER Name
        Name of the contentInspection policy for which to show detailed statistics. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .EXAMPLE
        Invoke-NSGetContentInspectionPolicyStats -Name 'contentinspectionpolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetContentInspectionPolicyStats

# region Invoke-NSGetContentInSpecTionStats
function Invoke-NSGetContentInSpecTionStats {
    <#
    .SYNOPSIS
        Gets NetScaler contentinspection statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetContentInSpecTionStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBrOAW5MZR5aYPx
# /upsM0AGXR5CQqWwKGUWGmGIHTDTjKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg0MrL
# YwK+OjCNF6NureyywCLPMaovZYEMj1Pha7L73MwwDQYJKoZIhvcNAQEBBQAEggGA
# XRBteEbB4TrT4qB9jQ1Jm0AXGz2e7iCeerCGKo9MSGyI9rAKIoUu8VUeuazArA4P
# Eqg7kFH5lNFtLVaQFFqgsXUi+Rqbxl+jxVTeX0TxqHV47MCn+l9Wyx/cabxWrtqj
# kdLP+vR3dgpKdBWgR4RrYiQharGegK4s9OM9AuyJn1psCvHLcq5BiWof+1JY7spe
# 4GgtkNmPSn0IItxIQQoNBVlfcTgNA8FMaXVJg5vV/8ZbXG7K2wQjkcl8sloOr9cy
# YpsHbokn5VLu3lm0EUtkUZ8I2fC2HZa/uKl4IKJKxGIAdXBfSN+bO5eBTLjzvbiJ
# li9cxwIUKRnbmSaEFaP8n2ubTNlhynVgEg/aRyDF+0uxup3p8ieemesF6utGnOig
# X8m+efUfNw/Ultv6rwuCuQStWe0mnL2dLOylwwTDE7szoMKyrSSOuJ13TLADkIe8
# H5hqpWFRlVVrHF5F1sjNl9GECvpkjt+0sgMtk5E/S2giHPvDIroMar6dMOqoXEjg
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEILYmhM7y1a2t2srX8R2r
# d55BkCgwhK7m/f+wB4SfxH8/AgZqNWdcYfQYEzIwMjYwNzI3MTMxMzQ5LjA1NVow
...
# IgQgghl0w5ABmmD/wp0wdpf+bhEQQqaoBQ8zpj+Fa0UjOv8wgd0GCyqGSIb3DQEJ
...
# lvlBdu6F8Tu5CjaMViq4hivjqTANBgkqhkiG9w0BAQsFAASCAgA+8fOHGpqpCYrK
# ZnyF2PGtiPFjoMGB4fXrFmeY8ohEAjDup5VSRhSbK7X+3X3qhmh4nZIs6F/J9s2S
# duMY0MBf9ydQdkAo+yB7UagRGLocgXZsqQRO5yXXmET/TBiWaexT5FuzmBzRukuR
# jblzV8duh2p4mZmPGJeWkjLhFEpwiDQt/4ndaV/BfwCFTWU5TKuYE7kWvPeuc2u6
# YEfJjq7pVKrc8KoVr0gcNGYWh9wREirHOnf53kf9mCaSECbroY5jqDp6KzCgK4Ig
# yztNW3nftpN2u1mq8AQOluiV+RuShEzLgiOn7D5Um21MeXK0S68m3vSQorge7lY4
# w7s8g/2EQ90oIuM/QQScuFN95mwJLKpuUyePJXC+8P3ZbNZKP2qv6LhhOh1UCEKI
# rVbsNiIjR2ojEwxeKqyVpKDLzDgGH7W1bhLliDHvQjdaDajST7BqKaUqDpoJ1kIW
# xEwir/YdRMxO6VGdmGiuKHBYDvPmozN89x2UZBMndwvjE5/YSp6z+SRIDpuEvSUT
# MZlmT7JKd+uRjWP/qtawTg1p/AEXfqsfoRFisGb9YuM9VHM7AkskRZwzL7heLK7A
# TkyFCfgUq05hXcPWCJTa/akmIlnBG35gZ3IK9rEsfYRXRdqHlsTJX8nF/3c1uNpd
# lWe54WcEDx7p7qfzIO2JnDyswFKDRw==
