# Generated NetScalerToolkit Statistics bundle for category 'lsn'.

# region Invoke-NSGetLsndsliteStats
function Invoke-NSGetLsndsliteStats {
    <#
    .SYNOPSIS
        Gets NetScaler lsndslite statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetLsndsliteStats

# region Invoke-NSGetLSNGroupStats
function Invoke-NSGetLSNGroupStats {
    <#
    .SYNOPSIS
        Gets NetScaler lsngroup statistics.
    .DESCRIPTION
        Statistics for LSN group resource.
    .PARAMETER GroupName
        Name of the LSN Group. Minimum length = 1 Maximum length = 127
    .PARAMETER Filter
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetLSNGroupStats
    .EXAMPLE
        Invoke-NSGetLSNGroupStats -GroupName 'lsngroup_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetLSNGroupStats

# region Invoke-NSGetLsnnat64Stats
function Invoke-NSGetLsnnat64Stats {
    <#
    .SYNOPSIS
        Gets NetScaler lsnnat64 statistics.
    .DESCRIPTION
        If any, the warnings are displayed in the "X-NITRO-WARNING" header and the HTTP status code is 209.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
...
# endregion Invoke-NSGetLsnnat64Stats

# region Invoke-NSGetLSNPoolStats
function Invoke-NSGetLSNPoolStats {
    <#
    .SYNOPSIS
        Gets NetScaler lsnpool statistics.
    .DESCRIPTION
        Statistics for LSN pool resource.
    .PARAMETER PoolName
        Name of the LSN Pool. Minimum length = 1 Maximum length = 127
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetLSNPoolStats
    .EXAMPLE
        Invoke-NSGetLSNPoolStats -PoolName 'lsnpool_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetLSNPoolStats

# region Invoke-NSGetLsnStats
function Invoke-NSGetLsnStats {
    <#
    .SYNOPSIS
        Gets NetScaler lsn statistics.
    .DESCRIPTION
        Statistics for lsn.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
...
# endregion Invoke-NSGetLsnStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCNctjiZc9MM61
# w+aH8OncGCpEh8nWNOauFG5J72xJDKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgOAC/
# 8obq34LxwdiSxFPgTdHbD0ZVUqGUga12f2gynoUwDQYJKoZIhvcNAQEBBQAEggGA
# NRtRIg/WZk4qzWqYQ4gcPhNzIXPC596XKbJNl3NLMBHVNX/EYuUrAgmTiEhMfa5w
# a8hA5ffbJUF9Evno4RW3dvAcUVbx2d0oFWYhSy6dWT/D9ncCYdFnf1WrfYwaZ6v4
# BG1sPj7TsU9ZDXtkJ73jnjYL8BHvIZUtCD3+ox3YSWFdo95GeGd9gCNkumULP8O6
# fN7o1eNW+paXyiFRR2pAna62jn4ZKR+3OEmtftkFcv2z80bFjeJ+XZNZ90oKk+af
# MF5mKMYscYYPk6YM2/W8a2SlX3TkDjDRJeGrIFJJIDSjBKzwvwNFDU3Ac8xssVMt
# 3DkCni6eGIG+RbjXWGpWdHFS/r7vfRcqOWlP2zIU+x/8IAVJxviyGA0/6KYwVrSS
# XVdYVRTJeybgx5V+71+z5OT1N6EfiULRPRi2MXM/jT/NyzXMuvcy8DGYbBOrRhSf
# 8xYoV73lu7jOG7QHu7m8Sd0kUi9leuuPa0P1H1whZvOIDb6+hkfkUdaU130y/PvT
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIGDpaPZk/Xqlz2u35AGS
# DW5rJV2irotjoVmut9JKhwQcAgZqNTBfowwYEzIwMjYwODAzMTI1MzUwLjA3Mlow
...
# IgQgcFcFg+C6tQmFzMGOMnNGvoiEYpJE7MDoQahyiUhxEREwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgDrsCL1R+U9ahSh
# jpWft44plkC8HxU0cd94wXkL/LZkcb0uJVHSFawqMWX05APSvbQVwgL3QUvH1zOI
# IWY4bF1YCyp2Un8u0sAg8dQHt1OY/Edm9/d9GapwF2Px1hyRbdPPb1gHBV9R4heB
# 5RAowg2kp79aI/9ixlsUOls+0fpC664FLMiEZ/7MeBb4LfgwhcAPUYCEiDMxugP+
# Fa+QCAE6kkes3LYVReML+6cqSbbWAIjr3yrclQSiU3/7li2qud6pBXhPpbxuN06x
# plr7W/FQfscGNey4ZGDRqXnXEkDYquVqgrzqzPzhSmAsRjLUVUMQxlmMjvH3P9qH
# 9RYdWos8Ie3RJM2Ssi1J/Zr9buSFU56/E/FnHT+nFz1fq1I1NGKEbYekACSbv2a2
# 88YnERly0+zmAgPD1g/tsJ2f2cjqbapL9JGmB0IgPB1r1j0xt2D2unx91RiUfQiX
# XEPPSQ0pr9Toi6mQ94QL0QVDK/FuN/6F5Z6k+VpKS6dm1f2TBTeY7X37PK/ltVRV
# wQEGIUOpXK0K7Eh2PzYCS2APTlrCCNSDMwZ/0Gb8mmlwqXjWC+DZ/Kyo7Ue5frnC
# M1Tx2JBngFz5MAHZBtJKs9P5rx9/s81eYrmG8PsbntqnpwBX1Ove28sgVRmI8pkI
# jMxtoVR1e4e+gBQYFOwkZJ/djT5T0A==
