# Generated NetScalerToolkit Statistics bundle for category 'cmp'.

# region Invoke-NSGetCMPPolicyLabelStats
function Invoke-NSGetCMPPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler cmppolicylabel statistics.
    .DESCRIPTION
        Statistics for compression policy label resource.
    .PARAMETER LabelName
        Name of the compression policy label for which to display statistics. If not specified, statistics are displayed for all compression policy labels. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetCMPPolicyLabelStats -LabelName 'cmppolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetCMPPolicyLabelStats

# region Invoke-NSGetCMPPolicyStats
function Invoke-NSGetCMPPolicyStats {
    <#
    .SYNOPSIS
        Gets NetScaler cmppolicy statistics.
    .DESCRIPTION
        Statistics for compression policy resource.
    .PARAMETER Name
        Name of the compression policy for which to display statistics. If no name is specified, statistics for all compression polices are shown. Minimum length = 1
    .PARAMETER Filter
        NITRO filter values as a hashtable.
    .PARAMETER Session
        The NetScaler session. If omitted, the current default session is used.
    ...
    .PARAMETER ThrowOnWarning
        Treats NITRO warning responses as terminating errors.
    .EXAMPLE
        Invoke-NSGetCMPPolicyStats
    .EXAMPLE
        Invoke-NSGetCMPPolicyStats -Name 'cmppolicy_example'
    .OUTPUTS
        System.Management.Automation.PSCustomObject
    .NOTES
        Generated from NetScaler NITRO API metadata.
...
# endregion Invoke-NSGetCMPPolicyStats

# region Invoke-NSGetCMPStats
function Invoke-NSGetCMPStats {
    <#
    .SYNOPSIS
        Gets NetScaler cmp statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetCMPStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDnGSSOlrAdExpr
# 3nSGw3LtECzpmISL35egMS+k7cLn6qCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgLftb
# s6cuyablOnU/hgpyFcgJmKrAevxu/yXevLTytO4wDQYJKoZIhvcNAQEBBQAEggGA
# YN6MYEfbVbTg/uaY+vVTDY2sCVAsVa/HoNB0DsVZWljxs8TsA0kfOIpNkjWfVHhC
# yQZhTutdCw8Z925xGIUYmiy/PQKijvj3OzbUG3Yh1ymJNFYfKvOhBzo7n6NUKOZ6
# F3j9mU3O4w0/SFs/XkHVJPNRyT+JGp4VOF92jlQ+o2garkg8iiWmIi7pH4bfQy+d
# WD+3A2m2UhcvgwdmX4Cw8BrfN1uJVT5zIw3hfIPFeC53I6CQquBgYauANO8b5YgA
# dUPlqZo/dfWfxVHxO8MHIO5f9WnkO3IG/MfGI6MZqMSoTeBBLkFLL8E1UiF54d2M
# ZY38Iah+FxudGf28ferUj/cJS9SzzRo1XwTDCB2iKtVUFaN3CeSYBW1rOt/KDO/z
# 1KWoH83EpZgwTK5ooy1X+nu2cvGZP6uHXZyaeXGtYSRt7/D3+WE5Ifn2JY8OTt3k
# hQ91a48osSU2/bTjfHXMQF+qyCzqdod3I2GShGJDdYvq2sqH0bxRqqZ1UZJgDtlc
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIN3wQlb/m2xJaxk+84zZ
# hfQ3sJSHbVosunJRL2DZrumAAgZqNTBfokgYEzIwMjYwODAzMTI1MzIzLjc0M1ow
...
# IgQgb5NjEtaXJC+0LD9Eibsti5gTndMxN3d8LWL8r92zReUwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgAOzKDHppeANqsf
# RRKuIUrSk21wmLmPst4Z4bQh+Er5D0qXsV4mpI6v6utu6t1JdgxELyt5505CnHGJ
# Crlp10FDlJGQf7MaL2PBhM7Vgw7Smi15Riquox3p2swFGzZ+6b0Lhx0ZwIiEoNAz
# N9lnJgHFwvJkAvG1C2nynO2OUMENZzBVnLIkBrBMmEUKcYS4qcvYzTiVxv4d62ei
# i5newqjnE0AHVYdAAhVYErXvLSRIGCAcrCc+AUpsB8coliERG/VNhHiHhfIilrU9
# IgUzm6y+QSQXABIwmTg0cp6kGsnOtOu7/KpndZXN3m1Q0p4RRZtbWrhPlZqTYOVR
# impUiIYuHO+dwunSTZXK/u/f6jm6M9ktqP3klCuXRsKsyRx1kpKrja2HVhheExqw
# tDwkhJ4uTTQ8UZjMIEGmsBITISAXGBBSKprWhP4EAQ5ot2e9nKt+X0HKtzG1no8n
# NEuB78ZmAtTiOx6GbBHeMtsNufS6wHgq5jgnlmLS43Xx47PvdanjqjMgizk94TYo
# 7XBGMhWNHPy2qoU/0sMT97zpyB23/3+ZWN3TclYF/ariyQUB9nrpbRPd5Wol8Ie9
# JFWAftP+SVERwKrBjA7H7rR6jCHE2AUC+mvwhDHoWFigQ/zzIjkBphkMsF7iC1po
# LFbL+8TLWc0xmEKbwPlVqe3PNpKDxw==
