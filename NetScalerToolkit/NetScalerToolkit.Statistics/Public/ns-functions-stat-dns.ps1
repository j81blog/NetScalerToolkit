# Generated NetScalerToolkit Statistics bundle for category 'dns'.

# region Invoke-NSGetDNSPolicyLabelStats
function Invoke-NSGetDNSPolicyLabelStats {
    <#
    .SYNOPSIS
        Gets NetScaler dnspolicylabel statistics.
    .DESCRIPTION
        Statistics for dns policy label resource.
    .PARAMETER LabelName
        The name of the dns policy label for which statistics will be displayed. If not given statistics are shown for all dns policylabels. Minimum length = 1
    .PARAMETER Filter
    ...
    .EXAMPLE
        Invoke-NSGetDNSPolicyLabelStats
    .EXAMPLE
        Invoke-NSGetDNSPolicyLabelStats -LabelName 'dnspolicylabel_example'
    .OUTPUTS
...
# endregion Invoke-NSGetDNSPolicyLabelStats

# region Invoke-NSGetDNSRecordSStats
function Invoke-NSGetDNSRecordSStats {
    <#
    .SYNOPSIS
        Gets NetScaler dnsrecords statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetDNSRecordSStats

# region Invoke-NSGetDNSStats
function Invoke-NSGetDNSStats {
    <#
    .SYNOPSIS
        Gets NetScaler dns statistics.
    .DESCRIPTION
...
# endregion Invoke-NSGetDNSStats

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBt2To1Q6cwd1ty
# jC9pzAo5docw19qkCEpkR2G6+MolR6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgYvVA
# vUjoQoTmcYv7n43Q26mrfCDyhqk9CXenpjRFPU0wDQYJKoZIhvcNAQEBBQAEggGA
# cSgx1+Uj+iZDM0+0Dmh6Uxp9UiSaja9+kcbobR1i+bbfewr1IudZh3yF9HJ52wZ5
# k6RzyScqrg9zebXtFKjv/YbWVJ2QLXwh4Fx4f5md9ugvK/yu3GeDA5vyn4Eup6sM
# UjIclBY2D8PoTwQu/BZBwhIhpKuNbr5dcGsb184r7LnqpqsixEfPAr+mIcg6Uw2+
# Jk2w5E4hq8Y//s6U9FVuUYU08KPLs3MzLysSte0aQ7M0/uTajMNr4EOTFj5dbc/c
# uv1Q+QC71bULd0VCxZ2CAqron13v5r8dv9lRJcnR/B//+UR1ATPAdpzxpyCIVCtb
# MjsclSb5Nz5PwW0j8vRTbtG/IBuAbnIM6EnSdvvNhwhAFvR3zS9PZ7qI6n/2kzhj
# jkY+FSS9Abq7k2VjfKtLFN33yBhskgb6Kbl3AL2Gx3PAeB9aC1lzQRXSjICAPyrN
# ZeeZPu45HsKPx/WJcRENlY5ILsrcbGgpbgI+XBREW9V1FuyMgbcUN6RBosLtrkaU
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIMqtpdIT5tcX+DJE3Fmv
# O4EpOY64DaxcCJ8KfeB1IfPzAgZqNWdcYh4YEzIwMjYwNzI3MTMxMzU4LjQ4N1ow
...
# IgQg7VjoCUrr3gJRugGq6+6YkmQ+hr0FvQN1CVHvcJMrKyAwgd0GCyqGSIb3DQEJ
...
# lvlBdu6F8Tu5CjaMViq4hivjqTANBgkqhkiG9w0BAQsFAASCAgAS62xTHGhQ8UOw
# PcxZUwJPcyMXbXf7PK7mGxLLrxXLVaB6/83n5KAbrkRlPvgrdYh4SRKeIpE/j7f3
# isIGsZTXwHXHfiBV/J68y1SJS44vxqHk7PeSSA4ul53t4UpCbsxt/GH2q9b5zuhR
# LqmM9vXD097dO+0jOdpQjDrURr2Yd+J5UiYcTlsjSM4FtZFUFOOCv+l4RfzQpe/l
# awo1r06NDWx/RKsvXOfQn1KTFgpitQ4af6lL8EMrRvomT9AVbaNf8aK7VO0cG23k
# 9CwUaPeWl8gMKLKXf5HO9jVwiGlgE+qaZrJLDnUg0+DSOKxa6CoOeUGzxuyAMQ1L
# aK001QtqRuI+dAC5Pkw1kIxZdQ4UVyRbzYHiTIqg0bu2CxGqqFk2BEjl5T3n2vXI
# J/Sdm4qQHOjrFZDcFvJQ0HRVlDbYm7unJoUWAa/JPLIjQqO9RNwkTxXl+4moHIuR
# pgga/2Rhdzjf/W3O/2OlklaG5zdAmt6UT9V7t3V/BV/JFbvdZy3vxZ0ujhFDiQDc
# Mwb7aoNNVWP2xvf9OXPVi7g8CFd70TkmD3HpkFC1CYMo+QoM5MgvuvrzDuSRUGNZ
# O/DthlUvWcpGGpvSTRolbkqzaGC7Mo846a8HFcQWMHpe334yKsYO1e4P1YFqFjrr
# yW+fbacnzYOeU2V7r9eBSzWfbKAAKQ==
