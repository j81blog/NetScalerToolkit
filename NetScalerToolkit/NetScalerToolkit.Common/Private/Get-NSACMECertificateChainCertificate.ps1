function Get-NSACMECertificateChainCertificate {
<#
    .SYNOPSIS
        Reads CA certificates from Posh-ACME certificate artifacts.

    .DESCRIPTION
        Parses PEM certificate files produced by Posh-ACME and returns the
        provided chain certificates. ChainFile is preferred because it excludes
        the leaf. FullChainFile is used as a fallback and the leaf certificate is
        filtered by thumbprint.
...
#>
    ...
    function Read-NSACMECertificatePemFile {
        param(
            [Parameter(Mandatory)]
            [string]$Path
        )
        ...
        foreach ($match in $matches) {
            ...
            $certificates += [System.Security.Cryptography.X509Certificates.X509Certificate2]::new($bytes)
        }
    ...
    if ($chain.Count -eq 0 -and $Certificate.FullChainFile) {
...
# vVKW0tXpQdCMwLOzo8vJxn7+2tO8W6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgjWFa
# XheCzCJN0mgNaWOufGPL1MATDoxRcaB79izh2VowDQYJKoZIhvcNAQEBBQAEggGA
# G9w3LFnuJr0g4I0sNCf6B4oMcIaxEVmO4zdUBPHoYttUw+5nA65KnI00JoUl5qX0
# NwYFFbhdO7FYrcOQdGlPYnTStR8sg8y6e86/PJ2NY8/JS4rcc0pIBlcqUuO7GqJ1
# 5cOElKjny1aSX+w/RQVYRfFCVTnBeFKPCOg0WEgorSuqzZs1niCMTfXI+0YxOKfR
# vqwtQXjFF0P6ixzLrAJRSpyD5IPtuSeUxd+x1R0ueOs9IOJsz0mM4SB05UVp0CLL
# nOSPieEf+hqNNnkVCUisYJ2Lp624Rs8llThIW/aQEcIMP5LhcVvzmK9KrjiYZvf6
# xU3lOGuGkCH39np70YlARJmorj4NdchiwVVkIZIj3TZzxAig5ir8vCOScYfPstGX
# C5G9OeimD+xpT/fVOXEVzg3bOWZlaZS0iqj0tD2CohoM6QpJE17FxgK6o6mJKc2G
# UV/czRyZwFDeSxw06Wz5CXmmi1pJX/yhpXRtuWz5aXgS3p8v0j/U2Ut+UkE404BC
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEICD8g0jv8bh+XYrMfSe7
# wWKVnL5QTXf/KPBPiFXysUX2AgZqNTBfnBEYEzIwMjYwODAzMTI0OTIxLjIxM1ow
...
# IgQgwOIACOK+AB/otaX/n29nsTcvXWVoCbs2NuDKtU7nXucwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgAsPeRfxOOfk6o9
# 9FtnSM74H3faJNz1vwOY+2IUxE6Xiu0bZ6a5xRXdbsxFEMKlgwdaEGaSwfZ+eVUh
# tSkcosGr7/TldyCaj30ZLshP9WaH4o81XM17Cn8DC++O6uc+Nm7SJxZN5LnJ3Dx7
# 0zJK2h2RROyZopTb1cFL6Gr6yRLIdGGmyLq3UzROoEk8hPkLY4NFjNJ1uXYqs+pi
# EXCDPQ596RIQrkLGuXWMtJ2a/2cDj225cO391QQoY7UUaaUmlNAO/5DwKjGh/isx
# 4AX52j5qs0qLml7D4tCpmWXNlpvITbPZb4EuTjTK9ABUyOhSpII6E1zTunj/NA97
# ZYzG+ret59GcX3k5MGtzzqH0KOe+Ohyu+8bOZ+ivEVF9fnUt4ojCemMh9aSFBzfU
# IDtXrBoz0WkivQol9Rui22JyeF1b7XiYcUXhcqineXrS15U3stjCtOEq9Ulv0PvZ
# vktdLqtWWci7ydDVnxh+ZfGUZAxTVsiqhaLoyCiph+3eOnjtpCwCZ4zk8pEdVWbr
# zcHuiFvqLjjfPd2WS62JCSDUTvy2TdPUNUcsjrY2SAraQ2xl9rlA3lL5f6qgxKLI
# P35pmlz3Z0OrdMCkVCqqfXpXGKGrvtyTMo13LMUZedK/y+YsbUyArKedUukTKhKg
# 34jRu+ejaRmcM+hKX+x08L8ZnZSFfw==
