function ConvertFrom-NSACMECertificateLegacySecret {
<#
    .SYNOPSIS
        Converts legacy request-certificate secret values.

    .DESCRIPTION
        Converts plain text, SecureString, PSCredential, and legacy JSON password
        objects into a SecureString or clear text value. Legacy encrypted values are
        decrypted with the historical static AES key used by GenLeCertForNS.

    .PARAMETER Object
        Secret object to convert.

    .PARAMETER AsClearText
        Returns the secret as clear text instead of SecureString.
...
#>
    ...
    if ($null -eq $Object -or [string]::IsNullOrEmpty([string]$Object)) {
        if ($AsClearText) { return '' }
        return [securestring]::new()
    }

    if ($Object -is [securestring]) {
        if ($AsClearText) { return (New-Object pscredential ' ', $Object).GetNetworkCredential().Password }
        return $Object
    }

    if ($Object -is [string]) {
        if ($AsClearText) { return $Object }
        return ConvertTo-SecureString -String $Object -AsPlainText -Force
    }

    if ($Object -is [pscredential]) {
        if ($AsClearText) { return $Object.GetNetworkCredential().Password }
        return $Object.Password
    }

    if (($Object.PSObject.Properties.Name -contains 'Password') -and ($Object.PSObject.Properties.Name -contains 'IsEncrypted')) {
        if ($Object.Password -eq '<null>') {
            if ($AsClearText) { return '' }
            return [securestring]::new()
        }
        if ($Object.IsEncrypted) { $secure = ConvertTo-SecureString -Key (0..15) $Object.Password }
        else { $secure = ConvertTo-SecureString -String ([string]$Object.Password) -AsPlainText -Force }
        if ($AsClearText) { return (New-Object pscredential ' ', $secure).GetNetworkCredential().Password }
        return $secure
    }

    throw "Unsupported secret object type '$($Object.GetType().FullName)'."
}

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB22F+jNqsSE6ll
# 7+yM/dAgdYlxE9naphm3xs3nSbMFoqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg4U1b
# cOh0ktDhXcVSCBO42m6oyWIV9KAbCtSjqJjQ+RswDQYJKoZIhvcNAQEBBQAEggGA
# GoMO5Q+fd7NPw5ontUcz5U47CpwmlO/aI+K9qysiwu4zY5ErqDKJVg+9lWxaNldw
# pQHp6JtvHGATwKTJZWguzy62Doy1trws/pL7xc3FGSamxZkAguwsm0sCjaZgcnkG
# qejVo/du/CfB2GVCk1ozQAVKv23MylsOu/9MSX1xo0Xyou0LjsRkgFQN0x6s0QXF
# w0CWt1PzErOQT/8Qq5HKs+NRmcm1FRRb93U9QGFsPXwsce8vKTNWUk0y5PkYDKUe
# HFGCyGJSUpDM9L23D0J7aaI3QUvn8ZYJCRvGZGDNa/vNBdKHMlqG9E16JRRsLEZS
# VgB2PWKKXiZ5/EFzWTloOb4qDIf+gd7qoLvgfOzL3mjgrSi14LcSwYptXBn6CX9B
# y9a8MD46eVLDZT+rvuocL2a9QSvQOGLnPyY1ujaCEPZhYUVN0PwRWd3T1jqyDrjg
# yDD4cD6qXLWgtfr7Xu5uV4wocZbyw0jni3cFSDjFtI9lRohHoBfjJ/1JGQSxj71x
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIFNyga5+rd6nfs5gJglJ
# CAeojC8YcaWQ0qV6stu/QH2HAgZqNWdtv3sYEzIwMjYwODAzMTI0OTA4LjEzM1ow
...
# IgQgFeX7p7wxwDbnnxI62YK9NfO9hcTeaFzyEtyt8DaEN1cwgd0GCyqGSIb3DQEJ
...
# kTahOynpFQpsK7T7qt7engOZRjANBgkqhkiG9w0BAQsFAASCAgAmh8tLXZB8il4V
# ZSGjrrt37u7J3HOccK96uSA+pYejcGHoPwEAiuHZ1FuBKPCT+Q6LY0mXCOu/f5BW
# wZCNYB2zj3ipQecLv8/t+aoet7r4JAH7LN2rhgk1yISPQWz7LINaYeAxxclG9fT2
# 5lG4JVRujcoxwQ5Inj9OkoeDoB8YBPr3UPWcP0DZZLIMmjR7S0i0nwo3qmSbTfS6
# tWL4+/rJLh2xvQXy/kLgSQVBATavELmIJ0R6n4wdProtjQ7EBe6ZOFOpjQP5m8tM
# nh93+6TSpFhXL6jS9O2VlnJXbH7ov2EUkMh+Sld+Kusk+6nvdxOBXhGs3KKfv2sX
# TkfdiS4ybShWQ5xM/cUsR8nH7EPuaTUx7DaYB1FJOxkqCkNAhmCWx0Y42bdOoLTu
# YFWqM88WeaCpCkiD23yEfnnjmkPEeoqIMgYqqlbxOhNI74nlKEF7OoyTDVHVuVsp
# euOF52bXXOtD5JH9zlYuuQws0ZaAbHxvcGiXL/DrRj3eZuyFjp8D4++vce4U0FrQ
# N/8HyZg8U0huGpCfYiXj8jHn5FwKCpdQn3gOAbwPyV9nKM6bW+nU+lWFojJQr7Yp
# hfLzkSnvPpfneLchNiB+sBV8F3sOHAhfGMJqA8Fxnde3fBqVibBK+gCjz2SafwlP
# yBBUkkmisYY2sdTnuBff55TfFbh+rA==
