function ConvertTo-NSFilterValue {
    [CmdletBinding()]
    param(
        [Parameter()]
        [hashtable] $Filter
    ...
    $items = foreach ($key in ($Filter.Keys | Sort-Object)) {
        if ($null -ne $Filter[$key] -and $Filter[$key] -ne '') {
            '{0}:{1}' -f $key, $Filter[$key]
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCznKNNlBP4U+EA
# 3WbEMZCx4+LwXBGfOIpoBNaP4OfAjKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg1S+O
# Ufsik65PJBoBaAvM2LFt8yYq0WLQ0gAGxvCNGZEwDQYJKoZIhvcNAQEBBQAEggGA
# o2x6iJgjHJy9g0Nvo061JW5G4biahsGg6v77nAaE8FhFII80LGAlcefrsgWiu//q
# cHeLNvlZknMZYq6SF7yFnJNnOyZmvpdtFV6M4WATjGDlmzvgo546qj6czBZfASiz
# xR111uRUJFqQyV4IeVobMATyw6gpi2ibr1fLSqyH2Cc0E0zSnvyFRWasReALYgAr
# OkLFW+Un0ODN5+h888pxkHclD0tymdNklz9KE5pXI4u8Nn5usCBmaPccdexmJpig
# cYElqtrkrJneBlPXs7HFgD4kcqyESNLl5uahantPvJ+3CluzSQCZqV7kGeerEKt1
# lMmY4QYUNOaSH5le14A/FNZTiiv2LlfPI9hFbu2QlYijgPCgV2CDomzU/iAxZVkU
# 0nWREFy0NdhpD1YVvo6io6dN2uhr0lhZyv8Pf4REW1eK18nwk2cd6FOGP3htc/3Q
# Jje47VXqBBzVZxqOz+pXB8zNZFwX7QEOQJRhvo+gUGG0Jd/KyquY39qqBCD6quFK
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIIsZs2c2RvUCmrA6m7Rg
# ahZSu9oszeO8hG7LPyGxck7oAgZqNTBfm78YEzIwMjYwODAzMTI0OTE1LjU5OFow
...
# IgQgP0G646JQFrpxdQqmZBlTOhzPLErs0wH06i+I6CU9aFYwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgCewkgYvmyvMbkA
# i4bKBy/t+sGOiGvni1X8J516McLiK2SO0qMhMgNXxWlYwc56EYCudD1wdRtM1JfN
# JnqqgrSw1SuZwty8WIiVv6YLBgevdLwO0zqoTQShdA2u3wUi3PYeMv6vT3kZ5Sgf
# 40fMLFYjK9apcZEzCL/wWuw15dAr3AuNTnre0ThUdlHtzJIvbJ49tWkj4YhVmj4d
# Wk4dXfzDG9BTHkLM5vx1P9KqYi2+xPfA668HxQxjHX0Sjlz6DuPcvvgsKILKUTlE
# hfF1RQBkv9BQyShP0d0SAk+Z9nz769HK0f9qqylZ5Q4RO1XRW3KHbaluruVmO0lT
# 16IjnndGneUNacl75JLAOhJXkkBsQlwyPyk5XdJ/rqvEPvzNhdgtv46QI3oDjLz+
# 1Hv6duxY2yQbquFn2OW9WSIQ7la2Hh6Bw0sB/H0BBRDMA1CBMfMuzCerIY33frhW
# h8bMRggRfm0ifcU/xhILtY5xvdEo4cUT9fwsze5ZVl1ALe5GOlw51Bznp+K2Xln6
# XjbsfUaqfMpzeTFc+eW7MSnkEa6dL8yNN1+BQ6DMcyJR+MT2rNl8UbtAgUpHNATz
# LdZmL+vD1HMDNAJXJBwH2zB/M1NZBp/h2DwSxRgBVXOxLBn89EiPnEte4XiogaXV
# El43FxyPkmB2JNTggCRk71L68k3klg==
