function ConvertTo-NSACMECertificateLegacySecret {
<#
    .SYNOPSIS
        Converts a secret to the legacy encrypted JSON secret object.

    .DESCRIPTION
        Converts plain text, SecureString, PSCredential, and existing legacy
        password objects to the GenLeCertForNS-compatible JSON representation
        with Password and IsEncrypted properties. Encryption uses the historical
        static AES key so existing config files remain portable in the same way
...
#>
    ...
    $secure = ConvertFrom-NSACMECertificateLegacySecret -Object $Object
    [pscustomobject]@{
        Password    = ConvertFrom-SecureString -SecureString $secure -Key (0..15)
        IsEncrypted = $true
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA57Q2tpLDWi0tt
# liPEiI/FhjwK54KCw9uscmPx96xpMKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgpPEA
# qOfzthArmBEmlYr6f58GghEmpecEbkc5pv5O8B0wDQYJKoZIhvcNAQEBBQAEggGA
# ihzCLyi1Zz8KLISkNx9h5yzVHm4bqjPK7vYT3BTe7mjzw+Q6f9eMJwFnYMDNYx5r
# XEaxpmfervyNhrpVT7r3s7mpvOPuaaouZL+zZ6XiEtqNoy+jYiMYXqLqPNd+1iYr
# rFsHKt+Ktlf4hAi8CkkVHWJ5XmPoDc5Z5KMw3XyaetqLhmSVluRh210+ksPhDkbe
# K5jMfRv9cMSK068WVe5t/00XdAkI9g6u/otcUSpCmaOh9EIDeRkXmdnQJLjrygnB
# ugAvdnwkui7Pa9uvbahzt+Nf5Zk5NWMJ24q34x7XhDorm+6q+U5kYOPBQPIrfP2X
# 3yNCzORjlVcot1Vl6K0UcS9QHEMEkhJcRUmaQSObBDW8KVcjVe1xYIBFn/TWYo/5
# JlznJ08o2DghphTBaoqfXX5ThN3kL6ckwcSAhCUoPONmuX8itHzcTQXGcNkhPerH
# Mvwi3y73eYlWfpd7aoLR/QYviqcUBudtAO4zo63in/nHvXfgWxaxkDwGSovd9xD6
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEICbOVwBE5UOjpV2+4dyl
# 9BoLaD2n3FfGNmgZNs3sssMOAgZqNWdtv5wYEzIwMjYwODAzMTI0OTEyLjc3Nlow
...
# IgQgC+U/H0kXuzg0w1vWPYp9wtdO8FbqxEEJovpO5uhppyowgd0GCyqGSIb3DQEJ
...
# kTahOynpFQpsK7T7qt7engOZRjANBgkqhkiG9w0BAQsFAASCAgAjxRzZx6YXbqbG
# m0Z2l4KyQzaIaon8TuKEQyMaevLLerQYuboJrYOJdOxdDVSJkEpbysItZiDK6EX4
# B+KVO4axjd6qKNtY5a3E4O6jYB0qWruk/XEHcECzqPSV/cX+J4D7AOQHIkr1Loqv
# BIqE1PrfxylHiNcPmfk8FVHjjhScUoyTOQWbWkUKBJiCQGnzDEKvCqNlurWri+fl
# ECtEfr7tTZ6UpTL6RKCPlZoU7l/ZuSZt8n78aAECeDyix6jmqnV0lV4Acj5OyjkZ
# pYmO7b9P1rtodULgcLXRIoA9PCKkp+8s+IfD+TJF+dLpwOUfuuyUf9TuJLvItmUO
# FIPKua5/za39GTdR18l0aTGkBebfUJSmuXtoxsWOJxFAzp7dmD8RFh7nNQMhyFGC
# xBxdxD/DgbkGuDz3f0hpu8eXuuZAXmtEnqxcidWBwYyRuDjfXbkODcDUtWGyyFGm
# 8q0LDjIFncJLoyKh+kbUkdUfDdEt6WXnSgvhnkMB2TT0VUaIm2x2r4CXExw+OWbm
# bcaDoDvq8QCYyBsGPL0IIxfYDCFEZtEYvoEJhf0g8I1ed/UIrWrpnLlztyyIMQWO
# OKxtqI6TLeHGPV3gIATAT51V9foW/Fp4+BvccxHvWV4yKIeYIlU/QDRogo8kdkuj
# bml8uGTx1TRcdR+K0sI3sRMX9LiHsw==
