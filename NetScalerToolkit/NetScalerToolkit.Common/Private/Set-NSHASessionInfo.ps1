function Set-NSHASessionInfo {
    ...
    $Session.HAInfo = $HAInfo
    $Session.IsHA = [bool] $HAInfo.IsHA
    $Session.IsStandalone = [bool] $HAInfo.IsStandalone
    $Session.ConnectedNodeIP = $HAInfo.ConnectedNodeIP
    $Session.ConnectedNodeState = $HAInfo.ConnectedNodeState
    $Session.IsPrimary = [bool] $HAInfo.IsConnectedToPrimary
    $Session.IsSecondary = [bool] $HAInfo.IsConnectedToSecondary
    $Session.PrimaryIP = $HAInfo.PrimaryIP
    $Session.SecondaryIP = $HAInfo.SecondaryIP
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAoDa99OcbrJW1Z
# 1FxDLFDavsfzDuW5IYgvVN3rWq3DkKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQggarL
# AiIyFnIEmUIWKG5lhKVFdhDV5yI5Y3TR2uzQAEcwDQYJKoZIhvcNAQEBBQAEggGA
# O47SA2NjPfh2dRzCv2Hv+EtGcLK3O+5kuNRXWic5plTcBsOMEAIYwRZpMC4mVX1o
# i23rjHo1UnrbJOGlMYvV7VQqgXpFnR6P0RMmiOeTH+waSIlT9FuQDtrk/jvVpVVT
# CI2vocMWiUWqxqliIKlrOhJUh6+9y7KuVY3N7uf7R7+Myrj4xmpCSF7KRxiuGWUW
# 7eMWwPuZRo7N/rGLq2kwDOJ6KUBv5b3cN96Aru22mwkGtZwfrp+HHfx6aUugT6nV
# gYpbjkg9bmlTKPFnOrLBUXEx4ZeH0tHLNnvfCF5q4v9Ajrf+QDvozwU7/jxQn8LN
# lK2bAgzdau2sK/G+doXiaIpnrYR8/XTKIFmMBPe8EWzHUne9QWidY0Dee9WIOdNm
# hznKFTXJ/upwpSSrc6l0Cj+NgoXf8yRx+jJFPn5FSv+5TahyzaHKWMczLhqa2cDE
# Ue0EQXUw4vpjRoqq+xKUWz7VoOGsgILw+WQ9OGwhYy2V1UCrqUPRCtRFt5Soxpfq
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEINcL4/RTPavNlNf2U02+
# /qzG1c3a+eDhqfnd1jHF1cWaAgZqNWdcWswYEzIwMjYwNzI3MTMwOTI4LjcwM1ow
...
# IgQgS6iIz30XL7VNIkjxYmhBE9ge6nN30njG8buxX4o5nEgwgd0GCyqGSIb3DQEJ
...
# lvlBdu6F8Tu5CjaMViq4hivjqTANBgkqhkiG9w0BAQsFAASCAgB7EnXb8sA4EZ/Z
# 45t6bOqPC1mH/dB0lLxheUOS35XXKORc/LyeWqlFKnKPKEb3PFjvYPfD1Mz1V6xG
# UFtyfjxj33XqCVj3bIO3NsN7dgUXFnbrAsA90EuBgu14OcnAvOAMnVeMWLIrZW/J
# +LqAO07ryS84x4w4L9tXQuUngAiJi+9NQmqSg4EPyLsMjVovjyo7Q7NB1m5Mvbcu
# Kok6T/AcWAmxXlMoxV1UPceA8w8uynJpDeIUu73zwDktdADi1qciT+pIV1k9xYdn
# e+Xcr7CeqoTIctLaPEaM2KeWRKF/8bqXqsAWPg5j5QH2Z0hXXM7r4Fi3N/W9CPJG
# +IQbbxNw0QyceNlODIxOtosyTTg2vzpoQhVhyhXFWBFFe6ksSVq3obJMaG6hf39t
# HMNcAMmx/I7ptOvvdf9aPuMchbEHogvWbtORL/4ZRx3Q5MpjhvjF1xLAlW7Yicew
# CZXvK5vhDZJjqzj3O60wRQ9UFjDFkKfx/GC97Q5qFdUAYrjsf0FEZLjC0mDGX68B
# yrJR9LKGAxESqCH/FA630PXzZkU2OSL1ecO9wsc2eBZ9wrHdOIlKFeeLv79Whotg
# mtx+pCqE5cdS66gHkEVk3t7eP/xbei7r/xpCprH07uxB+TvjzIOIATVXS+e6WOTW
# 3dRqWdBdE4lok+rNQ968Lxsjg/GpbA==
