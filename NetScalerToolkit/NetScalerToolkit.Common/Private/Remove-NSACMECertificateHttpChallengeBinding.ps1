function Remove-NSACMECertificateHttpChallengeBinding {
<#
    .SYNOPSIS
        Removes temporary NetScaler HTTP-01 challenge bindings.

    .DESCRIPTION
        Removes responder policy bindings, responder policies, and responder actions
        created for ACME HTTP-01 validation.

    .PARAMETER Session
        Existing NetScaler session returned by Connect-NSNode.

    .PARAMETER ChallengeBindings
        Collection of challenge binding objects returned by Publish-NSACMECertificateHttpChallenge.

    .PARAMETER Settings
        Normalized request settings object containing the validation LB vServer name.
...
#>
    ...
    foreach ($binding in @($ChallengeBindings | Where-Object { $_ })) {
        try {
            ...
            Write-NSACMECertificateLog Warning 'Cleanup' "Could not unbind responder policy $($binding.PolicyName): $($_.Exception.Message)"
        }
        try {
            Invoke-NSDeleteResponderPolicy -Session $Session -Name $binding.PolicyName -IgnoreNotFound -Confirm:$false | Out-Null
        } catch {
            Write-NSACMECertificateLog Warning 'Cleanup' "Could not remove responder policy $($binding.PolicyName): $($_.Exception.Message)"
        }
        try {
            Invoke-NSDeleteResponderAction -Session $Session -Name $binding.ActionName -IgnoreNotFound -Confirm:$false | Out-Null
        } catch {
            Write-NSACMECertificateLog Warning 'Cleanup' "Could not remove responder action $($binding.ActionName): $($_.Exception.Message)"
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCChTj042t59BWOn
# dk3FfruIuj0NEWJNn9E6X3uA4OKcI6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgz7q8
# sE7r1PPaR06jx+8WgddTsnBKxqPzTSt/7xrMksQwDQYJKoZIhvcNAQEBBQAEggGA
# vWRw34OEu7tPSMaoIlIKQnAJ4AXsWsPRvibfycUAuVi+XSxsqRHjYN+WI1t2cFLE
# qyKHMpPyHzUwsMD6oCmUs9RjTjL6mNpHFAQ956Mg0CI3bbbIS1dwVHimohL0zAcG
# So6QYkPDglrvYFWv9rdXdzp4OGKt2DgoglGELWZc4uFz2e4h9JVe5hDMFdj8Tksq
# 2BvMsR6oFM1I3Ep5Lhfh9jpSyBDUYi1ync0Hy6G8TbwmW4FEnZqkuTLAns9bCb3n
# MEvdrDrCb1Np/mhFDSJVlnYsSZ6xbiu0NJBIpWrz3Ics5bAOboZ/Msf8dc825lgJ
# Bd9JgjdEyQPipnIugzMOFk58GTpMGki3v1CwWpVxiZUdmBmumo3MYHYsZeza3keM
# hBgBgzbfURWMdy4po6jYx6MiH+KHyn8i2Uho6l6UM5Rzoo1IppiltHjMjTJPK5nu
# E/beZPI0+FSS6yRUPwbft2dSeDfDnHKn8g59b48xQeyaihfxuOQHJffZjVSERuAf
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIL5tu7KvWTugk9VK4+Py
# HLS7m2Aiz2opejpySVhHPN4EAgZqNWduFqUYEzIwMjYwODAzMTQwODAwLjg1MVow
...
# IgQgQ7T6YfI3QD5ViyglOCO3opzCyh7d/hp2SzQPr4pK2sEwgd0GCyqGSIb3DQEJ
...
# kTahOynpFQpsK7T7qt7engOZRjANBgkqhkiG9w0BAQsFAASCAgAgWSria2QRqTUv
# yFdlg9K3POveQar//ra+5QkEewRvx6jl7It8H1YnQBdyGP6b+pzza50aOVG3JmKc
# +LlcLUdAN4ppNpG7RtgrD7bWrKMK96z3qbD1UbZA2h5wT+NpUDmghcpvm4Uv/d8F
# fQgbLh6VKBd8l1TFX6hyj4ggb/a30qdmpqv4KZTpOAwTJed5Mq5pytwmlTr3qBIN
# If61I1bJmJH7wAcxsXtmqtchnx7VWXzOXp032uu5hTbFadap6BRV/2lshv5n6Kyq
# P8JfTNakw9E+thhXaDdSRt56YcrKByZtRz2erGgHD1RyOTosVya1VS+1mtALjvJs
# jDvNii3NtKnevZjx1DAnMv4ZeByzMvON1sIBe0tRBVXeQJeYJ5Ver0LKKKgnW40F
# RMWXkbJCF2yuONzNYgPZAZQxPf1VXXutGwkfNEB4Mdtal9WwWrkU4TksN3LDMqmH
# /bqobMCbRPW+uHuXQSd1lCaM7WjxgobSF/K/Z7TQNRWuGGhN3wE3lx8dWRIY1x5e
# kEmio0zPjPHD5Ex9wOvPSGBz+xTgRZtnkPKrSTvo2MeGuflquCxBuf1/MeJKGfsC
# Lmlw8pGjXQ6vK5mkYnFX27qtZaqut72X+1pORzdaM5qXUEc7BxUAIBkf/3ksJkn7
# B5ETajXqNLHPj2aNFmHAmjtShCYNWg==
