function Copy-NSACMECertificateNetScalerFile {
<#
    .SYNOPSIS
        Uploads a local certificate file to a NetScaler appliance.

    .DESCRIPTION
        Uploads a local file to /nsconfig/ssl by using the generated systemfile
        functions. If the file already exists on the appliance, the existing file is
        deleted and the upload is retried.

    .PARAMETER Session
        Existing NetScaler session returned by Connect-NSNode.

    .PARAMETER Path
        Local path to the file that must be uploaded.

    .PARAMETER FileName
        Target file name to use under /nsconfig/ssl on the NetScaler appliance.
...
#>
    ...
    try {
        Invoke-NSAddSystemFile -Session $Session -FileName $FileName -FileContent $FileContent -FileLocation '/nsconfig/ssl/' -FileEncoding 'BASE64' | Out-Null
    } catch {
        if ($_.Exception.Message -notmatch 'File already exists|\[1642\]') { throw }
        Write-NSACMECertificateLog Info 'NetScaler' "Replacing existing uploaded file '$FileName'."
        Invoke-NSDeleteSystemFile -Session $Session -FileName $FileName -FileLocation '/nsconfig/ssl/' -IgnoreNotFound -Confirm:$false | Out-Null
        Invoke-NSAddSystemFile -Session $Session -FileName $FileName -FileContent $FileContent -FileLocation '/nsconfig/ssl/' -FileEncoding 'BASE64' | Out-Null
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD13JlSYiTim9oY
# ShjoINxArAB9La5QW3utQxNxwHIbS6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgYZa2
# GAiVHj56r3fAPEkcoxK2g2dc2tptW3GvAKfRmkwwDQYJKoZIhvcNAQEBBQAEggGA
# hJUywlX0tZZfjqwIIj17jknTDQB1X98X5UxCenbMIdoDAe9XMZMIQ8MvjJE040o7
# qNxbzCOS8ZA5eoWKLtKLv7wQI8KPyBamArHtowHpjZ/dFSAzPZbyrray4hC3D69X
# 7XHsZ26HCEUe7kmOzW5du538691vdC9jJOry1OtL5km5FfjDkJxfg6HlyCBsGUmF
# 7EzFibmxqwsSx41Vxl9wz9gwhNv+E3ExM4G4JwAfuyp0IRW5kJdhkhNvOeQOj0Vt
# 38W4a1PChjqFIQtdeVVOEf2JQKqoIg2UxkgjS83AqDYOLAHFMZBz9yOUctJ/QCW6
# 1HM73KrK8tZLlvgOlChKWR9O7YUo72f0ejRmc/ehRqnlUAYSNnvp5uZxsyEN0yPY
# L0zZTh3LMRXEYo+a36IRdLJOf/eRX4nghkKU62azJuWoh5AnYyLNe1SPZrFTrzCr
# J9XJq9JJe2RiNidejRfOFDouL4YSVHL6BCcCayYaWOSG8UwAAyOYXCjXq+bOQ4LZ
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIOGqQViKWqwl7l/H+/Ig
# sx6ULHl6OkarFrpyWA+7B8j4AgZqNWdcWRgYEzIwMjYwNzI3MTMwODIxLjQxMVow
...
# IgQghLfQt5YXJdFe1/DIBGFyDv8RQFH2ZqY/ZIaBnvxqUOIwgd0GCyqGSIb3DQEJ
...
# lvlBdu6F8Tu5CjaMViq4hivjqTANBgkqhkiG9w0BAQsFAASCAgBp3qRmWPUNHfde
# NTKZdZkHBM3kMzkRbdB1dVenrXgrWE/LewK7SULyA27kx+Qe744cj5lBhEI8yGcK
# iN1XaNCyJDFyt6knwInz3L0EWOEmORq997VBEJdAyxeJvUnnXHarHN1wtUUabYrl
# xX7/WicDIJjCq6Ajb63WUDkv5idI4o3NFUzZsfeCGlxwTj1nkfYLKU4t7Q2ChmhW
# OlVT5Yv0oRTbcda1ShtUiRuvLvIr2jxQ2snxo8aPdd0vW58rsqIlYTvmVILEDMtw
# koBzuao1Ly14T6NZimY/DR3TYlR/3EeZa6yZxQkcxLLSuFNgo7CU9LnvBvcQhUb5
# MKKBksJ0LrmPeN2zeaNFc7P6URhQqSmUy1tpzdZFbUTiJVxD6gBO99dunhWfeila
# oJ4BIlsN9ec4iiv+Q4rLr/ZQtQxosnw+mI6OKNJ673UMNescSaggkrhTo4uYKKJh
# 9sd5QZ0i2/y1ZjLDPl7DW+xSQsuplqEh+RGYr/Z/LHziQsEyH/x2vLvGwViKHU1u
# ZHn1id7fz6gXAHjZpkfLO/fRzRzgOgzp9IGI4XFmx/81dnWZT11t8IFkdpWhOEqv
# r+Yl5n54rNpW6wALFccwpvlwSJ9lXAAKAABBsmLPDW7PrJ+xKN76hMiOMt9/yycf
# JqYvu72HkERr8HOIEM4pCSgqQ3nnfg==
