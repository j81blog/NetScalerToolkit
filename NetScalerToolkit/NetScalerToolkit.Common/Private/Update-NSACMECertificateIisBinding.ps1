function Update-NSACMECertificateIisBinding {
<#
    .SYNOPSIS
        Imports a PFX and updates an IIS HTTPS binding.

    .DESCRIPTION
        Implements the legacy UpdateIIS behavior only when explicitly requested. This
        operation is Windows-only and typically requires elevation.
...
#>
    ...
    if (-not $IsWindows -and $PSVersionTable.PSEdition -ne 'Desktop') {
        throw 'UpdateIIS is only supported on Windows.'
    }
    Import-Module WebAdministration -ErrorAction Stop
    $cert = Import-PfxCertificate -FilePath $PfxPath -CertStoreLocation Cert:\LocalMachine\My -Password $PfxSecret -ErrorAction Stop
    $binding = Get-WebBinding -Name $SiteName -Protocol https -ErrorAction SilentlyContinue | Select-Object -First 1
    if (-not $binding) {
        New-WebBinding -Name $SiteName -Protocol https -Port 443 -ErrorAction Stop | Out-Null
        $binding = Get-WebBinding -Name $SiteName -Protocol https | Select-Object -First 1
    }
    $binding.AddSslCertificate($cert.Thumbprint, 'My')
    [pscustomobject]@{ SiteName = $SiteName; Thumbprint = $cert.Thumbprint; Status = 'Updated' }
}

# SIG # Begin signature block
# MII6AgYJKoZIhvcNAQcCoII58zCCOe8CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtIiP2V6RmnNn6
# Fd0Rh+08QSsm/JVGYKCBrJV7hLf8+6CCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgtgs4
# ch+rOZsSU5stMNAwWam8V4WU2MolO1lhKf1OEL4wDQYJKoZIhvcNAQEBBQAEggGA
# BppRMmbaevgQgAI1rrmLezYDC9hotmrotFh08p2s3Hqd4aaB8bfWgfMOyZpcXtDV
# Yqgi+nu5yIjv+XZSs2wfRfgCrA1WcUEJrCWEBNjcvlJA3WXT80qrdY8OErXtaZIH
# 6P4XWUi82pTbtxFNyB8Wfewn83EAU4zzNI9I9wkFCuhDdWKJSgzdXaPk+SAmBcyo
# daXRWOjZa5AdkYruGPJcDQkZLaakdI+Y9qr+2lECzrKbdjP9/aLKMOm1T1mzqXe/
# b7R3IL6XmeKJ/JjSwqIa2XI54UHHRHzMO1rnQtoH9xxbVA8ote36ZDH7JjKfDMQC
# aaxYlO40bpOdFHJrv5+Zr+lcjdnICNNA2zvPi3wwf5syBqC/fASX8+n7SUtJqtjg
# sjrLrkQ0osJrCgI55ZqcZaGau+YBXh8ePJKQrnUun3Az9p/aOdfaI0YawWY21Vy1
# bTnieKDBSjrXhw/qYtmD1jfIaVevw8wExQCscEBKf0HBdbxCZOJDEXz5mfIGnIy2
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIMljqWDUQ9F3MQqYX0kL
# kNPccZJxREisSsnHOqWKqGt1AgZqNTBOPJwYEzIwMjYwNzI3MTMwOTM4LjEwM1ow
...
# IgQgV3Pozw3kXb/banP4PAA7uFNZSY0jjzmUnWo8DKVPKGEwgd0GCyqGSIb3DQEJ
...
# C4pfvGQpmxVmt9dVg+iQDGdTljANBgkqhkiG9w0BAQsFAASCAgCnOE997qmBFAvH
# t9nFTys8Ad+jFBSaRYK83iIMallICiy/Gn4cQQSC6J5TRwv8R+z6KDui/GgQ7sTn
# xoZsw4AdZDDbuJvD0Jlfs4tPHuAkk3xJ0Qy6v1E/IFwpLkyguyXA/3jX9VLOUWNv
# 0XmSJODcazr0Wns6n7ZQrTBHF+XIjUb/SF4FufRzlMYWTl6jc9zGsXqG2F18/PP9
# w141fBFJj8xod2Ad62fLxJqiP5Vrq0v/qXOugK5q1aLvZDmK03Y79+o0wyIXiwOc
# J/zkPfEvl/arxEDeeNKJKPnjaZmi28EWqVBx+MxCEADRl5DneI9vw9WAymTJ3O6s
# 1cj2KkLGlW6BbRQKdvv5IMvej+sdTgYUNlFLeZlNhYY0SK0N47bMmi4Z0WQftUWg
# ueLoj+Gx4+lx/unJxMEXGL1/i9AA69rj1F8jASjKRMBhoh5l1T2ZeO7V/fhuR9dl
# Xu+tkUOCTOwZRfrc7kLdkDWpaG1FbFYwc76xb+1fxD5V8OmhRs5u5Vv6m3RFmtca
# 86d+laM5iT3PMXS7Ms0tasY6t9Zq91lw1d+0XgEXnySdDoqc9yZYTJLxoiBlur50
# qOWoDGbT9Bwcaaml98/31diFfPs4z3PIMUkRzgOZBEIst77ZCKannMH9PD4DtXmE
# 4tHn10m1d0OsDj7b9R6alilDEzFcPw==
