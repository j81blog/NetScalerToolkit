function Assert-NSParameterValue {
    [CmdletBinding()]
    param(
        [Parameter(Mandatory)]
        ...
        [Parameter(Mandatory)]
        [hashtable] $AllowedValuesByVersion,
    ...
    if (-not $AllowedValuesByVersion.ContainsKey($MetadataVersion)) {
        throw "No allowed value metadata exists for parameter '$ParameterName' on metadata version '$MetadataVersion'."
    }

    $allowedValues = @($AllowedValuesByVersion[$MetadataVersion])
    ...
    foreach ($item in $values) {
        if ([string] $item -notin $allowedValues) {
            throw "Parameter '$ParameterName' value '$item' is not supported for NetScaler metadata version '$MetadataVersion'. Allowed values: $($allowedValues -join ', ')."
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCClXdm6feZorSQN
# 8NU6ZbRlJ4FfQlc1GbKIGi95npPlFqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgI+K6
# QFhqqmdgP+2b6p771Z9CSJEuJCr3C97SsgrmxcYwDQYJKoZIhvcNAQEBBQAEggGA
# Jd3LCdDdqGw0w0vaFHFH8jzK3X01GRxrUuvi3WNGwOgqlC6RsqAZ8grLX9IxMYDJ
# oNOwQ2mY77Vu2igEUlNwzkHBtwL7ANdooz7uYfsTZtmldS5z5cBUDjwY4SxLmoDU
# PfuoAipv/sgPbhc6ZdaiXTqFOT3wMVEpf7cfIc42kSlEjeKeGOHjc+O/P0FIinjD
# yaMYl2RG7Cbd3k5LrapfIE8KYUkAwASdwJGOCSdtjo1314fO3HgAMeREZkJkMpCc
# 4IemvIjATC5iXojE3HPMIrHTHMJSBxs99L6bl2s/Dzz2NF8Sa7ZiMf1aakKMeTRU
# I1eIjezSjb9MbR4ZOWkTrREVN+CuPgOM/aWH9mNEKDishJlrruXc8qHPwEGdcVQ6
# 69i6ohIFFk4RUTIUJ4ihVDakvlciVEA+++adGue/ax0VSmWURdjA8kLajuZP0F/o
# RJliLuYsoWQAAkQZAoLO5MRNy2/ZdLsc8/e4lhtaZkROkmR9vpeWshOyOI+Uwhct
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIGGDU4XIhAYbZPRNg4cm
# rpuhtYrkGo8EtQa7MPrleBYvAgZqY0xd9bQYEzIwMjYwNzI3MTMwNzU3LjY0N1ow
...
# IgQgGkqb5M3k7rRY2Xr+njVkWt+nRBLRxqWbN1OZ39DAW8Uwgd0GCyqGSIb3DQEJ
...
# e3HD+l/k7kSAMB0qHDpqQwel0DANBgkqhkiG9w0BAQsFAASCAgBN2jUd5hu17HIa
# QUh2QFyWrP5A+iQKMO/f/Swy+1iUUijbeL7kq7hUh7+DNlV31x8smLw/0/TiFtqd
# gNUMbeWcoT8vsR91lMPyWOY3Wmx17Mp2QCk07Ms9Y/X2/ZWZ2EW9k5DHdapLtyK+
# ncP2yK8uXGz5YOtze5HOBUIAr4jPZZQNp9HP2DLG8dqnOiTM36o9TbRaV6HR93M4
# qZ5VHzQAoYD9h9pAyu+vN2LkhhNeymU4qf1WQxf2ujSPBd+RoH7la9r6xnx3uBCr
# R9bD0cdCx8rbs9ngre7XFHozaOCXGHlB3czLEGPs28UfZfVgle1qLAap5hIs8r4n
# GflY8l2DM+Dl86LWFHFKDJ3QOq12xkGDFVVyTiD2Z1U+spVPzQuAlJ+7CgBneTQn
# 5cplYQ+NunIxxjFbyubtYAo2DaobaETDVDA6VmS1biQKOrrbO1Dec9Wr0mQvWUZo
# kmaCfUQu2ce75HJWVEqhxL+tzCQqZ5lbBu/jzlc4xtL44jigfBJ/qtfHdMfbIkSR
# 11hO13PL2nQ9+RVNICeTxsrqurymVY3SSHXI56lTr09Hoiy1Jewqbv9Q0iqHcXqx
# rogIXvvgpJerGp9pvTcf77ePzX4NbeRxVjIVjP2UYt7AZ4KxV2H4E6qWoAqxEIJX
# 3YQLkPz83eGEXYf+ZSQceXHDrKoQVw==
