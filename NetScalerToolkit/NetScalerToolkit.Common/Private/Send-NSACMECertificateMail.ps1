...
#>
    ...
    $params = @{
        ...
        Port       = if ($Settings.SMTPPort) { [int]$Settings.SMTPPort } else { 25 }
        ErrorAction = 'Stop'
        WarningAction = 'SilentlyContinue'
    }
    if ($Settings.SMTPUseSSL) { $params.UseSsl = $true }
    if ($Settings.SMTPCredential -and $Settings.SMTPCredential -ne [pscredential]::Empty) { $params.Credential = $Settings.SMTPCredential }
    if ($Settings.LogAsAttachment -and $LogFile -and (Test-Path -LiteralPath $LogFile)) { $params.Attachments = $LogFile }

    try {
        Send-MailMessage @params
        Write-NSACMECertificateLog Info 'Mail' "Completion mail sent to $(@($Settings.SMTPTo) -join ', ')."
    } catch {
        Write-NSACMECertificateLog Warning 'Mail' "Completion mail failed: $($_.Exception.Message)"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD5G9a+rVvo41wc
# x5VqH9aBzcFR5fnJtFquJPIvs0GJoKCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQg7W+8
# XJqkQ9OJUaAALQv9HQc7YoN0IptSv8iy2IGbeqIwDQYJKoZIhvcNAQEBBQAEggGA
# HW9IMOSA0CWjEqGHaZcmWAUwpb2s1kHzsUJvxOuz0IdKYZtCMuEnTo1c16PwTZyI
# 0fxvUIZ7xLaaPQByOM0xQg5JN9Uw5XSy5qtEfmhZhHj3xyunCy9qG9+XEoziX/du
# 0POnyACepUl7xFlXzEBOCvDtJ6pKxqDxV4HRQhH0VcAOEM1IsG7EXxEuAeEViIBj
# vpIxfrJEBssL5p7ZTIckiAhZ9l6YOYL7MBZAiAuvT3QDC9Px5g4AS4a5C2hpPnDK
# qEBVwiSKt9ExGLTQUj6Hb38aShEScQdwLdJ+iC6VSpcrNiPIhXlNhXFfMmUYtM9x
# 21Y869l+Fkr8GzI8K2t6agUwRiXg6B9Jj18ARJYpnt/iHnrjSBkwcVFNVN0NdP1K
# BQ06Jhd021932l33rA7R0RZ+NgOmCphMt30kGksQlWBQtHlsWwbclt+mqCIwDA1g
# 7Y9ZsKz5CSdjkX0bUHVIngJh6c4G4he0xTxnC/uKti52sACfaWSzl5EN6cqBe212
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIKiMY2h9CnzOTpy6oEst
# BFVqh/KlpncHCVwPEZGfFf1sAgZqNWdcWpYYEzIwMjYwNzI3MTMwOTE5LjMzNFow
...
# IgQgcyF9xAQ4ghvuwKU3QEr5+OrNsRCfvN4qQUIEqkGhV7Ywgd0GCyqGSIb3DQEJ
...
# lvlBdu6F8Tu5CjaMViq4hivjqTANBgkqhkiG9w0BAQsFAASCAgCDMf9QvQw3GSU3
# T34VMzQN1Xmg2E2QrRi1+j8SfjNi9m3BTK4x8s3kl3T/evppoLDS2JHI7HbxYyXz
# qo4OSbWxYdrlRaqP9gI6lfCAwIflOAhLCdVkAGhI9k3pF62F6xBcInpfhjH177C4
# 0Nn3a0mlv6ibw2llOU7tIoFGfiRAK+urMA4pU01JhINHTIbFUhPg1IQtcrnpH65E
# zs/VTsq6/2c1Zs//1S/vdPnRil3TMfVg09rTnb5PY5DgupO5iMN3g16G+GUZxES+
# s9wwkAL/xo6HWExD+DGnZG+SUtiXuw1f6amTnPdyYORSJObCT20XTupecy6l7LNP
# oMCeRngwEgOZ7rxm+BFQq6vyPRHGVK1Y53Y6i6T9lWxmVln3Jep6I4zF1cNq+JE/
# KhbdAVM8zUZgta+nk04FuwoipJyk3Q6T2OHqbV+oEmdF5FEejvrUMazt7chEF6b8
# qMTjJEWuPF6l430JmEyBmTvCMcc18xBWXwILi6v/k3/GkJl0zoB9MbMaaMxsu+gQ
# P9eQTG69mdxhHlgn5PtU7wggy1820OdWXbWo50a01e3KRUj9vEkx/OBtbME8LYQL
# JChbl7y7DoLyAW72KT9bbD2b66sI1G1p3P8WBUR7cOzYyhKxwngI6BQFHbp1i+MQ
# 2Krp+DPE0oNV1MOmYUlGWx2jznS/7w==
