function Write-NSACMECertificateErrorDetail {
<#
    .SYNOPSIS
        Writes useful ACME/NetScaler exception details without exposing secrets.
#>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory)]
    ...
    while ($current -and $depth -lt 5) {
        ...
        # Some exception types expose an unusable Data dictionary; record the shape instead of indexing it.
        if ($null -eq $current.Data -or $null -eq $current.Data.Keys) {
            Write-NSACMECertificateLog Debug $Component 'Exception data unavailable.' -Data ([ordered]@{
                Type = $current.GetType().FullName
                DataIsNull = ($null -eq $current.Data)
                DataType = if ($null -ne $current.Data) { $current.Data.GetType().FullName } else { $null }
                KeysIsNull = ($null -eq $current.Data.Keys)
            }) -ConsoleDataKeys @('Type', 'DataIsNull', 'KeysIsNull')
        } else {
            foreach ($key in @($current.Data.Keys | Where-Object { $null -ne $_ })) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBX1D1//a4mKf+u
# K5QyquAynEQ7eQx58ajeT5vjrpqBraCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgwZRV
# 6ek4/VlPa4QAAEXfz4kqishZWptDvlxfQsUt8KEwDQYJKoZIhvcNAQEBBQAEggGA
# jhkpcwERZtjV2pmMfSMwc7YxX7udPFvLQ66cyXab3/kP8pq1ul4OKkHLTgNlRWdQ
# w8QMEVMsgrYy3UMtC6Rina7XSK9IYMykJz5JrhDTHiLbYwb8GXZUmb/t+uEu4BFS
# j3/5zMvi3EZuQNshW746rb0/qm9o/0uOxYR5xT9AaTSzEF/nRnH3TUWnaXX6Npgl
# ypuPvY6joDJ9jNc2mwdBdjHuggsaJLpbY3sl+1gwiIgLcaBwcZX7YVwdq79c2err
# E24osH9USjGJutrIouLElp+/fZT1g6Esl84z3pQtbo2GQbH+8NySuFYJRHz6fUog
# x4cACG6n9yXDfRAOavYPIbvM8krkfvr0XsjjTJ3OQ57ivlfCjX4jm4KJBgcjbw/O
# DgFV77x9hDGUpA/pbtrAZXqrRwiBUtQ+vH9ktc5qe1ITrxgTqdlsgoFQZbXQUgZ4
# o9msM4MjCE0cZQIJVH11TWwYhUC+7Rf1h8dWaMIrjXTPQH4QGCTKOPCOsDIyJSxc
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIPKPfwiQ2LyCz2vvUddi
# 3HQRMyECAq54hDcZrHCK+hdMAgZqNTBfntkYEzIwMjYwODAzMTI1MDIzLjgxN1ow
...
# IgQgGfRMQI+OXwrKAVJATyYVSmySDrXn/xamO9yach0ZGoQwgd0GCyqGSIb3DQEJ
...
# HHeWregoVp5960ewGO9kUZr6FDANBgkqhkiG9w0BAQsFAASCAgBgYvJJqz+xk/DY
# hVsgUFKJRKy6senRsaFFjSy/pdZEssE89qKK86pstFDtnxxp3/dlQDAxj+JzA65f
# WOy5XHYoiU0fLu1DsfpUCAisUNQa0iCvushbxQs54rsBNzbKVYYoorCn8y06c1Bm
# xsoTW+fmRRXQq6yt/2n8JD/EFXJ6s6ZtnqJP0VOF6dCyErWUOxvCXzCi/FTzaV/S
# AY7n1WuIQqx5mCrTcsh51hWj9hiaN0QCyt/MyAOe24uH4je2dCgJwZgPpXvOSCj7
# 2OeZaOgLFzlakEMcNEEbvHlQ3QxHtB9Ng3nDnx7Ku960MGoiFxrmcU99yActImLR
# YTDQIxngclSM1mZFVYHT4KUksrNJGX8GjZK3FWojQYmZMQA34rwIiSOJ4EEqsRck
# ggdtNFO/PrTW8d7nQtWkHgv22ZRSahz76Sq2TAufeGfCWmh97sGG7GM3Mtht7q/0
# iZ5psK5+FtbCdrSeb4urFMP2SN7llFLWg/CKXcfUdmfhVA7P/qIHr00JoH46kJbW
# iOaUF6mWzNdWROmfXkspXlfjzA0KKVNeYHHElU1zPzkoB9bhxK5wLyWs+eP4s4lz
# ufCv7GEHisfLRH5Hjt3f5rcBFQPoWEGa1o/rXdeuSoznAE8+99xwQYpxl2eQuMXx
# UJ1g7p1LNrwk8Bx/4TdHoEsIEDRFJw==
