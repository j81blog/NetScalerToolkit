...
#>
    ...
    function Test-NSACMECertificateRenewalWindow {
        ...
        if ($now -lt $RenewAfter) {
            return New-NSACMECertificateRenewalDecision -ShouldRenew $false -Reason "Certificate is still valid and outside the renewal window. Renewal can start after $($RenewAfter.ToString('yyyy-MM-dd HH:mm:ss')).`r`nUse -ForceCertRenew (or -Force) to renew now." -Summary 'Outside renewal window. Use -ForceCertRenew to renew now.' -CertExpires $CertExpires -RenewAfter $RenewAfter -Source $Source -Strategy $Strategy
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDNvgByqY4BYbg3
# eRg4CMJV8CQp0c/BtpI4wcHS0kThjqCCIiYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# ADAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgRY4l
# J/B3MAXLJmSQtjviD66pdQyHt+j4w68eF9USOo8wDQYJKoZIhvcNAQEBBQAEggGA
# ArGNi4SiqSx+MbhyvJdUGEc6KAVKxDwVszDK7tKmeGGzko4UBeYfNa4KyILYbiia
# PaPvzGVzq4Vv8nZJ16cv13waPz8hYDQ6NMBrxirCLki+VJ/RmCstnvyy5z+jNvMp
# dDad8kduJtjB872Z8TtT6e1QtxijVPyRNP8Aq9ob5IXQacgl/u85jNi1+eZpf7ez
# 0VFU+1mzpQgPG4wpSF1rScdnF5ttyNskWlR+GLKnlcUrXAcLP2Mjas94OJwqGc0e
# wCuki0saxb+lYBHNzY8b9cyKYej4Bgl+mArTxiGsW0XAXf2ccchVGlrv8ac/uWf2
# tA1QfK7Pu5MeAtbecpG3cAdrXShscNPPUA8yY4Ikx3Ztw3GDY1KvzLtgjKUNTdZX
# p//et3pXc9OLNg/W6EL23Dp5RZZBidXrHd6QpeAeAHZiRSjbIdSwbQXbgMQf62nr
# Q2obalxHYM9niSBcgZLzyn0D6v9cxYPIzDTrBFS3dUdFk61ML0js4EhRKs3yFF+H
# oYIUsjCCFK4GCisGAQQBgjcDAwExghSeMIIUmgYJKoZIhvcNAQcCoIIUizCCFIcC
# AQMxDzANBglghkgBZQMEAgEFADCCAWoGCyqGSIb3DQEJEAEEoIIBWQSCAVUwggFR
# AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIAHNE/4Nyufk2J+rHkD+
# mfHN+J2vKeQnsLlUL5Dy4gjxAgZqg90eIfAYEzIwMjYwODI0MDgwNTIzLjY2Nlow
...
# IgQgccYSxvZ7htgASzjux4K7P2HrlijwbiU5Gg8Gk6bOhkYwgd0GCyqGSIb3DQEJ
...
# kkZUoAiPfBjjohe+prFgrmKKkDANBgkqhkiG9w0BAQsFAASCAgBb4dFoifZPgd5M
# 9DxO7UKj+HEKBT4YicE9ahZrHt0FERJFe1/zRbqPHBACC2huK57ZCnbJDlINvDN3
# pHLUigEvL8SVudW6fBfQuj2Q5qfwAqMKw50nvbSyGmUGETLUKSgUbqCgrSA2wvnZ
# THlhnAp/MaibAoQE2gWwxDEBu8dO4eKJrPfvoQVMDVYqqgycKW9bKjpB+SblKJjr
# YoB3NUQ6AOxOJNsZpBL+tiA1uxBU9nNrENTfez4uZNOhFwt2gNm/YrorZegj7+g4
# 2l1f03IL+04DcSuac0ol5bf/OH/S0YAgQMLXVridKxJ8pTT9UtJaVcA35zHomLgj
# QcN0mV/8LDsg+Rf/J30PSt40jgW2pb/7K8KbWREG7dHxa/NsU7fI5Z0VCWml5E9N
# 30TZSa4M/xg/wVUyqcb/ouh+JKX+zCpMlmw3KW+7LR61eccxJVlEio+4i4E1idst
# UHSPtMhIup5zP3SAud30dwir5M/3nrUjjzoT1Mi3XzgLGimOI3fP3lkFyk7jHrDN
# 9OhUplq+ulniNvUuWE2ELT04Vk66YzPxHf1KeJAB1onZf+07rzzyuBySiU2gvv7u
# YQi4F0rNdjRbwwQlQkogQmwPtlJH5Y4vI1IlkxlDLN6ShByhvsv9etc5+Hvwih4c
# U1+wS0HcDf9eAuE4/z4zFVJeiB8/eg==
